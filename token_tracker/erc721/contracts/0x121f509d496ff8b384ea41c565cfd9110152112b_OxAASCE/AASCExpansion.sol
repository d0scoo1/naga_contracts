...
contract OxAASCE is Ownable, ERC721A, ReentrancyGuard {
    uint256 public immutable maxPerWallet = 150;
    uint256 public immutable maxPerFreeMint = 2;
    uint256 public immutable freeMints = 500;
