...
contract ApeDoods is ERC721AQueryable, Ownable {
  ...
  constructor() ERC721A("Ape Doods", "APEDD") {
  }
  ...
  function mint() public callerIsUser {
    ...
    require(mintedBalance[msg.sender] + 1 <= maxMintAmount, "max NFT limit exceeded for this user");
    //
