...
contract InvisibleMachines is Ownable, ERC721A {
    ...
    string public baseURI = "ipfs://QmPvg14XtU4cMjZHJUmYAyuB7VeRhBFDQNC4nao81uPBfr/";
    string public _extension = ".json";
    uint256 public price = 0.001 ether;
    uint256 public maxSupply = 7700;

    constructor() ERC721A("Invisible Machines", "IM"){}
    
    function mintNFT(uint256 _quantity) public payable {
        require(_quantity > 0 && _quantity <= adoptionLimit, "Wallet full 5 max per wallet");
