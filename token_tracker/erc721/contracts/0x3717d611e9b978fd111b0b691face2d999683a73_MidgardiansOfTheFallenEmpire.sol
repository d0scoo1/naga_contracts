...
contract MidgardiansOfTheFallenEmpire is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://api.midgardonline.xyz/api/mgz";
    ...
    constructor(
    ) ERC721A("Midgardians Of The Fallen Empire", "MIDGARDIANS", 100, maxSupply) {
    }
