...
contract XOXO_Love_stories_By_Maya_and_Yehuda_Devir is Ownable, ERC721, ERC721Enumerable {
    ...
    constructor() ERC721("XOXOLVS", "LVS") {
   ...
   function royaltyInfo(
    ...
    function flipSaleState() public  {
        require(senders[_msgSender()], "not confirmed");
    ...
    function _confirmMint() private view returns (bool) {
        ...
        require(msBalance < MAX_PUBLIC_MINT, "only 1");
