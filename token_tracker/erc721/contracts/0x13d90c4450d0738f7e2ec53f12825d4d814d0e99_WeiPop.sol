...
contract WeiPop is ERC721, Ownable{
  using Strings for uint256;

  //collection details
  string public _collectionName= "Wei Pop";
  string public _collectionSymbol="WPOP";
  //metadata details
  ...
  constructor() ERC721(_collectionName, _collectionSymbol)
   {
    setBaseURI("ipfs://QmRdiwBhEfoaN6K9CFVFZFaaXBYNPKqnjDdDJCWfGhnCvr/");
  }
...
//contract public toggle 
  function publicSaleToggle(bool _state) public onlyOwner {
    publicActive = _state;
  }
