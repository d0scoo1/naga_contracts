...
contract BAFC is ERC721A, ERC721AQueryable, ERC721APausable, ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    constructor(uint price,
        ...
        string memory baseUri) ERC721A("Bored Ape Fat Club", "BAFC") {
        PRICE = price;
