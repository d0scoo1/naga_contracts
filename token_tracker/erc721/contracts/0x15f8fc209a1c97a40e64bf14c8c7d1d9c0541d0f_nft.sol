...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    //maximum number of NFTs a person can hold
    ...
    function _transfer(
        ...
        require(balanceOf(to) < maxBalance, 'Recipient has reached max NFTs amount');
...
contract nft is ERC721Enumerable, Ownable {
    ...
    address public constant shareholder1 = 0xcb360409F76e6E3c0fedf5f1889B4D28f65a97c9; //willie
    address public constant shareholder2 = 0x0C8998E2b9e8436C3288BD6d441943b423487fA9; //silvan
    address public constant shareholder3 = 0x5F5AfC4284784c9D26899A3470BF309FE13cf790; //frank
    address public constant shareholder4 = 0x0EE8c52dA93057d9aE63C03D7264f5B6b8fb30c7; //leona
    address public constant shareholder5 = 0xa43F4FcDC230aA9D852acbc793d3FcB777e7B017; //david
    address public constant shareholder6 = 0x9552F25029a325F6F2d232a2aEA2fF63326a601f; //chris
    address public constant shareholder7 = 0x6bc6Ad40eFe363f4f3762B3a16C14dBCef7D806D; //eddie
    address public constant shareholder8 = 0xE6eb52F8Bf89325C3F1C96CF2E7fbCCEBab43461; //enrique
    address public constant shareholder9 = 0xF31FC1A5BfA8345218426435a6a02Bd286e0ed68; //arthur
    address public constant shareholder10 = 0x2aC2420deF456B326c4E12A1E292e6627bE38CAE; //casper
    address public constant dev = 0x318cBF186eB13C74533943b054959867eE44eFFE; //andre
    
    address public constant communityWallet = 0xa553FEaE5C81B583425223259CF6895ADEd1CaEb; 
    ...
    */
    ...
    function withdrawAll() external onlyOwner {
        ...
        withdraw(payable(dev), ((balance * 5) / 1000));
        withdraw(payable(shareholder1), ((balance * 2125) / 10000));
        withdraw(payable(shareholder2), ((balance * 20) / 100));
        withdraw(payable(shareholder3), ((balance * 10) / 100));
        withdraw(payable(shareholder4), ((balance * 10) / 100));
        withdraw(payable(shareholder5), ((balance * 7) / 100));
        withdraw(payable(shareholder6), ((balance * 3) / 100));
        withdraw(payable(shareholder7), ((balance * 3) / 100));
        withdraw(payable(shareholder8), ((balance * 2) / 100));
        withdraw(payable(shareholder9), ((balance * 2) / 100));
        withdraw(payable(shareholder10), ((balance * 125) / 10000));
        withdraw(payable(communityWallet), accountBalance()); //to avoid dust eth, a little over 20%
    }
