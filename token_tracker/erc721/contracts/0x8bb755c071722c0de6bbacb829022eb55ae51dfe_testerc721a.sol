...
contract testerc721a is ERC721A, Ownable {
    ...
    string public baseURI = "ipfs://QmesBrxS6z3BGc3FpQACsbeGt2kRvqMB4CVBsYseffJvNf/";
    string public notRevealedBaseUri = "ipfs://QmQ9ghwwq37vAgFsSVx4Ed8HZQoUuuHbtdHnyGB9LdY8Xe/";
    string public baseExtension = ".json";

    address[] public whitelistedAddresses;

    constructor() ERC721A("Out of the closet", "OOTC") {}
    ...
    function mint(uint256 quantity) external payable {
        ...
        if(msg.sender != owner()){
            ...
            require(quantity + _numberMinted(msg.sender) <= needToUpdateMaxMints(supply), "Exceeded the minting limit");
    ...
    function needToUpdateMaxMints(uint256 _supply) internal view returns (uint256 _maxMints) {
        if(_supply < freeMints + 1){
            return 3;
        }
        if(_supply <= _supply){
