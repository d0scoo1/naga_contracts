  ...
  Ownable
{
  ...
  uint256 public constant MAX_SUPPLY = 3670;
  uint256 public constant MAX_NFT_PURCHASEABLE = 20;

  uint256 private _reserved = 100;
  uint256 private _mintPrice = 0.0666 ether;
  ...
  constructor() ERC721('NeonDaemons', 'ND') {
    _metadataBaseURI = 'https://api.moonwalk.com/v1/metadata/collection/619d548e055d53c897d08da6/token/';
