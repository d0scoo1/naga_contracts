...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0aCaf3f9324cf7727e74ED09415cb45DF0B42fE0];
    ...
    
{
  ...
  ) ERC721A(tokenName, tokenSymbol, 4, 250) { }
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://bafybeiaaxcwf6jm5g76n2aps2pr6x2m6citcp3ilmxqv3vqrazeg2fyjzm/";
...
// File: contracts/InfiniteDodosContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract InfiniteDodosContract is RamppERC721A {
    constructor() RamppERC721A("Infinite Dodos", "dd0x0"){}
}
