...
contract BMC is ERC721, ERC721Enumerable, Ownable {
	...
	uint public CURR_MINT_COST_1 = 0.14 ether;
	uint public CURR_MINT_COST_2 = 0.17 ether;
	
	//---- Round based supplies
	string private CURR_ROUND_NAME = "Presale/Raffle";
	uint private CURR_ROUND_SUPPLY = 7605;
	...
	function verify(bytes32 user, bytes32[] memory proof, bytes32 hash) public pure returns (bool)
	{
