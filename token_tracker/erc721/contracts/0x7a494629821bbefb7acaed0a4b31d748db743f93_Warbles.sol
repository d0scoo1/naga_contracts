...
contract Warbles is ERC721, ERC721Enumerable, Ownable {
    ...
    uint256 private _mintPrice = 0.04 ether;
     ...
     /**
     * @notice Mint warble 
     * @param numberOfTokens number of warbles to mint
     */
    ...
    // treasury
    address treasuryAddress = 0x9cC57fD8da348AB662C39bF826fCDd4D4887ab79;

    constructor( string memory _initBaseURI) ERC721("The Warbles", "WARBLE") {
        setBaseURI(_initBaseURI);
        // preallocate 40 warbles for airdrop
        for (uint256 i = 1; i <= 55; i++) {
            _mint( treasuryAddress, i);
        }
    }
     ...
     * @param newPrice mint price if neccessary
     */
