...
/**
 * @title HeraldsOfCthulhu contract
...
contract HeraldsOfCthulhu is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.002 ether;
  uint public          maxPerTx          = 10;
  uint public          maxFreePerWallet  = 5;
  uint public          totalFree         = 55;
  uint public          maxSupply         = 555;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("Heralds of Cthulhu", "HOC"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Heralds...");
