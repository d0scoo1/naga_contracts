// Contemporary Metti Four consists of seven unique artworks from contemporary artist Pumpametti, a contemporary response to Warhol's Shot Marilyns, inspired by the MadSaki interpretations: https://www.highsnobiety.com/p/madsaki-if-i-had-a-dream-exhibition/ 
// One work from the ContemporaryMetti series will stay with the artist, the rest of the works from the series will be raffled to Metti Art Patrons via Twitter. You can only win one Contemporary Metti artwork from each series.
// If you are an artist and wish to use this smart contract for your artworks, you can find the Tutorial at MettiForArtists: https://www.pumpametti.com/mettiforartists You can read about the art practice of Pumpametti via: https://www.pumpametti.com/ Current Pumpametti art that's minting now: MettiApe and Metti Team Six.
...
// File: contracts/ContemporaryMettiFour.sol
...
contract ContemporaryMettiFour is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Enumerable, Ownable, Royalties {  
    ...
    constructor() ERC721("ContemporaryMettiFour", "ContemporaryMettiFour") {}
