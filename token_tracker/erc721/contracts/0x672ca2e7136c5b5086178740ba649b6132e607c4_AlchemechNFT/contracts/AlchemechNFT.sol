...
contract AlchemechNFT is ERC721, IAlchemechNFT, AccessControlEnumerable {
  ...
  modifier onlyMinter() {
    require(hasRole(MINTER_ROLE, _msgSender()), "AlchemechNFT.onlyMinter: msg.sender not minter");
    _;
  }
