...
contract FoundersClubToken is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    string public tokenrevealURI = "https://microminers.mypinata.cloud/ipfs/QmbtSr2djbPoEnKcYNYqvEc7yyQhCtxWa5k7aTA5xNQP9a/unreveal.json";
    bool public reveal = false;

    bool private endSale = false;

    string private _baseURIextended = "https://ipfs.io/ipfs/";
    uint256 private _priceextended = 55000000000000000;
    ...
    constructor() ERC721("Founder's Club Token", "FCT") {
    }
