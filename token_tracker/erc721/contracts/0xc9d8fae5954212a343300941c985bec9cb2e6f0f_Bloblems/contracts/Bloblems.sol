...
contract Bloblems is ERC721A, Ownable, ReentrancyGuard {

    string public baseURI = "ipfs://bafybeigyin7ajftxxdpclxy5ac2qyoxb6ma7xghipya2hkbsqwkgsrxqtu/";
    string public baseExtension = ".json";
    uint256 public multiplePrice = 0.00666 ether;
    uint256 public maxPerTx = 5;
    uint256 public maxSupply = 3666;
    uint256 public nextOwnerToExplicitlySet;
    bool public mintEnabled = true;

    constructor() ERC721A("Bloblems", "BLOBLEMS"){
