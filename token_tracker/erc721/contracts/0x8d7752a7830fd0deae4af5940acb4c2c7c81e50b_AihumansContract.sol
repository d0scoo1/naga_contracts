...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe0abc668437D8e36cB60bCD920c84423bC63d462];
...
abstract contract EarlyMintIncentive is Ownable, ERC721A {
  ...
  uint256 public earlyMintTokenIdCap = 144;
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmdKFU6XngGZbnsySAz73vvbx8YJm44EUEkHuzQ7EEXyst/";
...
// File: contracts/AihumansContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AihumansContract is RamppERC721A {
    constructor() RamppERC721A("AI HUMANS", "AIHUMANS"){}
}
