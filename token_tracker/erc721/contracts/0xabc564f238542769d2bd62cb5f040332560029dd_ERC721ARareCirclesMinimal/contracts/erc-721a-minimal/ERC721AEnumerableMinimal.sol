 ...
 * account.
 */
abstract contract ERC721AEnumerableMinimal is
    ERC721AMinimal,
    IERC721Enumerable
{
    ...
    function supportsInterface(bytes4 interfaceId)
        ...
        view
        virtual
        override(IERC165, ERC721AMinimal)
        returns (bool)
    {
        return
    ...
    {
        require(
            index < ERC721AMinimal.balanceOf(owner),
            "ERC721EnumerableMinimal: owner index out of bounds"
        );
    ...
    {
        uint256 tokenBalance = ERC721AMinimal.balanceOf(owner);
        require(
            tokenBalance > 0,
            "ERC721EnumerableMinimal: owner has no tokens"
        );
    ...
    function totalSupply()
        ...
        view
        virtual
        override(ERC721AMinimal, IERC721Enumerable)
        returns (uint256)
    {
        return ERC721AMinimal.totalSupply();
    }
    ...
    {
        require(
            index < ERC721AEnumerableMinimal.totalSupply(),
            "ERC721EnumerableMinimal: global index out of bounds"
        );
    ...
    function _addTokenToOwnerEnumeration(
        ...
        for (uint256 index = 0; index < quantity; index++) {
            ...
            uint256 length = ERC721AMinimal.balanceOf(to);
    ...
    function _removeTokenFromOwnerEnumeration(
        ...
        for (uint256 index = 0; index < quantity; index++) {
            ...
            uint256 lastTokenIndex = ERC721AMinimal.balanceOf(from) - 1;
