...
contract LetsApe is ERC721A, Ownable {
    ...
    function mint(uint256 count) public payable {
        require(totalSupply() + count < supplyApe, "Excedes max supply.");
        require(totalSupply() + 1  > freeApe, "Public sale is not live yet.");
    ...
    function freeMint() public payable {
        require(totalSupply() + 1 <= freeApe, "Public sale is live");
    ...
    function setSupply(uint256 _newSupplyApe) public onlyOwner {
        supplyApe = _newSupplyApe;
    }

    function setfreeApe(uint256 _newfreeApe) public onlyOwner {
        freeApe = _newfreeApe;
    }
