...
contract tinydinossummer2022 is Ownable, ERC721, NonblockingReceiver {
    ...
    constructor(string memory baseURI_, address _layerZeroEndpoint)
        ERC721("tiny dinos: summer 2022", "summer 2022 dino")
    {
        _owner = msg.sender;
    ...
    function traverseChains(uint16 _chainId, uint256 tokenId) public payable {
        ...
        require(
            ...
            "tiny dinos summer 2022: msg.value not enough to cover messageFee. Send gas for message fees"
        );
    ...
    function withdraw(uint256 amt) external onlyOwner {
        ...
        require(sent, "tiny dinos summer 2022: Failed to withdraw Ether");
    }
