...
//
// Looking for more info on this token? Try our token locator: https://sloika.xyz/token/{address}
//
//
//
// Building with Sloika contracts? Reach out to us at: gm@sloika.xyz
