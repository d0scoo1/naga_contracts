/** 
 ...
 .----------------.  .----------------.  .----------------.  .-----------------.  .----------------.  .----------------.  .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. |
| | ____    ____ | || |     ____     | || |     ____     | || | ____  _____  | | | |     ______   | || |      __      | || |  _________   | |
| ||_   \  /   _|| || |   .'    `.   | || |   .'    `.   | || ||_   \|_   _| | | | |   .' ___  |  | || |     /  \     | || | |  _   _  |  | |
| |  |   \/   |  | || |  /  .--.  \  | || |  /  .--.  \  | || |  |   \ | |   | | | |  / .'   \_|  | || |    / /\ \    | || | |_/ | | \_|  | |
| |  | |\  /| |  | || |  | |    | |  | || |  | |    | |  | || |  | |\ \| |   | | | |  | |         | || |   / ____ \   | || |     | |      | |
| | _| |_\/_| |_ | || |  \  `--'  /  | || |  \  `--'  /  | || | _| |_\   |_  | | | |  \ `.___.'\  | || | _/ /    \ \_ | || |    _| |_     | |
| ||_____||_____|| || |   `.____.'   | || |   `.____.'   | || ||_____|\____| | | | |   `._____.'  | || ||____|  |____|| || |   |_____|    | |
| |              | || |              | || |              | || |              | | | |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------' 
...
contract mooncat is Ownable, ERC721A {
    ...
    address constant internal TEAM_ADDRESS = 0x12A2889EFB3ce614c78758DAB8659a76e74c7bA5;

    string private _baseTokenURI="ipfs://QmZhyt5KaFXYQQidZ1qi42xX7ZkaAbdtMJKaHR9TNP3HU4/";

    mapping(address => uint256) public freeMintedAmount;
    mapping(address => uint256) public mintedAmount;

    constructor() ERC721A("MOON CAT", "moon cat") {
