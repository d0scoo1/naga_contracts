...
contract GoatTradersNFT is ERC721A, Ownable {
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) external {
        if (msg.sender != owner()) {
            ...
            require(isWhiteListed(toLeaf(msg.sender, _index, _amount), _proof) == true, "You are not whitelisted");
            ...
            require(MAPPING_WHITELIST_MINT[msg.sender] <= _amount,"Sorry you cant mint more");
        }
