...
contract Trainer_Eggs is ERC1155 , Ownable {
    ...
    function mint (address account) public onlyOwner{
        _mint(account , supply , maxSupply , "");
        supply ++;
    }
    ...
    function transfer (address account , address receiver , uint256 id , uint256 amount) public {
        require (msg.sender == account);
        _safeTransferFrom (account , receiver , id , amount , "");
    }

    function transferBatch (address account , address receiver , uint256 [] memory ids , uint256 [] memory amounts) public {
        require (msg.sender == account);
        _safeBatchTransferFrom (account , receiver , ids , amounts, "");
    }
