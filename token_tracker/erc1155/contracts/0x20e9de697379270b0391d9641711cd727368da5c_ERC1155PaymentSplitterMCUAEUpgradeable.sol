...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155Upgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/IERC1155ReceiverUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/IERC1155MetadataURIUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/ERC1155Upgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/ERC1155SupplyUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/ERC1155BurnableUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/security/PausableUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC1155/extensions/ERC1155PausableUpgradeable.sol@v4.3.3
...
// File contracts/additional/ERC1155MCUAEPresetUpgradeable.sol

pragma solidity ^0.8.0;
contract ERC1155MCUAEPresetUpgradeable is Initializable, ContextUpgradeable, OwnableUpgradeable, ERC1155SupplyUpgradeable, ERC1155BurnableUpgradeable, ERC1155PausableUpgradeable {
    ...
    modifier onlyTrustedMinter() {
        require(_trustedMinterList[_msgSender()], "ERC1155MCUAE: caller is not trusted minter");
        _;
    }

    function __ERC1155MCUAEPreset_init(
        string memory name_,
        ...
        __ERC1155Burnable_init_unchained();
        __ERC1155Pausable_init_unchained();
        __ERC1155MCUAEPreset_init_unchained(name_, symbol_);
    }

    function __ERC1155MCUAEPreset_init_unchained(
        string memory name_,
        string memory symbol_
    ) internal initializer {
        _name = name_;
    ...
    function uri(uint256 tokenId_) public view virtual override returns (string memory) {
        string storage tokenUri = _tokenUris[tokenId_];
        return bytes(tokenUri).length > 0 ? tokenUri : super.uri(tokenId_);
    }
    ...
    function updateTokenUri(uint256 tokenId_, string memory tokenUri_) public virtual onlyOwner {
    ...
    function updateRoyaltyParams(address royaltyAddress_, uint256 royaltyPercent_) public virtual onlyOwner {
        require(royaltyPercent_ <= _100_PERCENT, "ERC1155MCUAE: invalid percent");
        _royaltyAddress = royaltyAddress_;
        _royaltyPercent = royaltyPercent_;
        emit RoyaltyParamsUpdated(royaltyAddress_, royaltyPercent_);
    }

    function addToTrustedMinterList(address account_) public virtual onlyOwner {
        require(account_ != address(0), "ERC1155MCUAE: invalid address");
        _trustedMinterList[account_] = true;
        emit AddToTrustedMinterList(account_);
    }

    function removeFromTrustedMinterList(address account_) public virtual onlyOwner {
        require(account_ != address(0), "ERC1155MCUAE: invalid address");
    ...
    function mint(
        ...
        uint256 amount_,
        bytes memory data_
    ) external virtual onlyTrustedMinter {
...
// File @openzeppelin/contracts-upgradeable/security/ReentrancyGuardUpgradeable.sol@v4.3.3
...
// File @openzeppelin/contracts-upgradeable/token/ERC20/utils/SafeERC20Upgradeable.sol@v4.3.3
...
// File contracts/additional/PaymentSplitterUpgradeable.sol
...
// File contracts/additional/PaymentSplitterUAEPresetUpgradeable.sol
...
// File contracts/mc-uae-nft/ERC1155PaymentSplitterMCUAEUpgradeable.sol


pragma solidity ^0.8.0;
contract ERC1155PaymentSplitterMCUAEUpgradeable is Initializable, ContextUpgradeable, ERC1155MCUAEPresetUpgradeable, PaymentSplitterUAEPresetUpgradeable {
    function initialize(
        string memory name_,
        string memory symbol_,
        string memory uri_,
        ...
        address trustedMinter_,
        uint256[] memory tokenIds_,
        string[] memory tokenUris_
    ) public virtual initializer {
        __ERC1155PaymentSplitterMCUAE_init(name_, symbol_, uri_, payees_, shares_, royaltyPercent_, trustedMinter_, tokenIds_, tokenUris_);
    }

    function __ERC1155PaymentSplitterMCUAE_init(
        string memory name_,
        string memory symbol_,
        string memory uri_,
        address[] memory payees_,
        ...
        __PaymentSplitter_init_unchained(payees_, shares_);
        __PaymentSplitterUAEPreset_init_unchained();
        __ERC1155PaymentSplitterMCUAE_init_unchained(royaltyPercent_, trustedMinter_, tokenIds_, tokenUris_);
    }

    function __ERC1155PaymentSplitterMCUAE_init_unchained(
        uint256 royaltyPercent_,
        address trustedMinter_,
        uint256[] memory tokenIds_,
        string[] memory tokenUris_
    ) internal initializer {
        require(tokenIds_.length == tokenUris_.length, "ERC1155UAE: arrays length mismatch");
        updateRoyaltyParams(address(this), royaltyPercent_);
        addToTrustedMinterList(trustedMinter_);
        for (uint256 i = 0; i < tokenIds_.length; ++i) {
            updateTokenUri(tokenIds_[i], tokenUris_[i]);
        }
    }
}