    ...
    ERC1155BurnableUpgradeable
{
    ...
    function initialize() public initializer {
        ERC1155Upgradeable.__ERC1155_init("", "VBIT MULTI NFT", "VMN");
        __Ownable_init();
        _tid = 1;
    ...
    function setTokenAddress(address _valobitdexaddress) public onlyOwner {
    ...
    function valobitdxserviceFunction(uint256 _valobitdxserviceValue)
        public
        onlyOwner
    {
    ...
    function _saleToken(
        ...
        uint256 val = pERCent(amount, fee).add(amount);
        if (
    ...
    function acceptBId(
        ...
        _acceptBId(bidtoken, bidaddr, amount, tokenId, owner(), tokenAddress);
