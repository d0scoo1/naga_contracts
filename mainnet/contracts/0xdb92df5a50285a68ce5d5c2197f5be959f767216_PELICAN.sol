...
contract PELICAN is Context, IERC20, Ownable {
    ...
    constructor () {
        _projectWallet = payable(0xBB4e195c56193B36800d367DAA3a453625Aa873a);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0xBB4e195c56193B36800d367DAA3a453625Aa873a);
        ...
        emit Transfer(address(0xFf736b0bb3630494e6BA0B5Dae29f39B7440D179), _msgSender(), _tTotal);
    }
