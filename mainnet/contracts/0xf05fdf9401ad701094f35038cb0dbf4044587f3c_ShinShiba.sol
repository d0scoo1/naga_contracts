...
contract ShinShiba is ERC20, Ownable {
    ...
    constructor() ERC20("ShinShiba", "SSI") {
        ...
        marketingWallet = address(0x4a59faC3753FFe20810C8b1126be002fF7fb4520); // set as marketing wallet
        devWallet = address(0x4a59faC3753FFe20810C8b1126be002fF7fb4520); // set as dev wallet
