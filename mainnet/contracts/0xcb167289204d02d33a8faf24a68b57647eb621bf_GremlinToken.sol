...
// Gremlin Tokens on a fixed supply.

contract GremlinToken is ERC20PresetMinterPauser {    
    // _amount = 1000000000000000000000000 (mints 1M tokens right away)

    constructor(
        address _vestingBeneficiary,
        uint256 _amount
    ) ERC20PresetMinterPauser('Gremlin DAO', 'GRMLN') {
