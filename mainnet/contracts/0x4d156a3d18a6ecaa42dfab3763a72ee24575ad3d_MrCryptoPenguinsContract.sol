...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xB43CEbE27595eAC4A693a0c4CC6FAF67815fEC8A];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmaAhKJffAz23ysWhPFzyKkciRrHEc6TEg3rEg7DX3E3iC/";
...
// File: contracts/MrCryptoPenguinsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MrCryptoPenguinsContract is RamppERC721A {
    constructor() RamppERC721A("MrCryptoPenguins", "MRCPENG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ht2bgpgD1JJVneUpjjYb/contract-metadata";
    }
}
