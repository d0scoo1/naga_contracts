...
contract BigBankWhales is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Big Bank Whales";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xDF15D6A437318287735F57Bc38aBB325588C46C0);
	    teamFeeReceiver = address(0xDF15D6A437318287735F57Bc38aBB325588C46C0);
