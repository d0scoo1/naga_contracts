...
contract BOXT is Context, IERC20, IERC20Metadata, BlacklistManagerRole, Pausable {
     ...
     * on a supply of 500M tokens, only 50M are free at launch, on the treasury wallet
    ...
    function initialize() external {
        ...
        */
        _transfer(address(this), IVesting(_vestingContract).treasury(), 500000000*10**6);
     ...
     * overridden;
     * BOXT token is using 8 decimals instead of 18
     *
