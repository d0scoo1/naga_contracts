...
contract SadaharuNodes is Ownable {
    ...
    IERC20 public sadaharuToken = IERC20(0xa207b975E63046187C07825152Ef209787C07E95);  //token contract
    ...
    constructor() {
        ...
        claimFee = 5;
        lpAddress = address(0xB2E00e6489b7932Ec18D662979C7E97405b468b4);  // deployer address
    }
    ...
    function createNode(string memory name, string memory desc, uint256 amount) external {
        ...
        require(sadaharuToken.balanceOf(msg.sender) > totalCost, "Insufficient Funds in wallet");

        uint256 lpFee = totalCost.mul(10).div(100);

        sadaharuToken.transferFrom(msg.sender, address(this), totalCost.sub(lpFee));
        sadaharuToken.transferFrom(msg.sender, lpAddress, lpFee);
    }
    ...
    function claimEarnings(uint256 nodeId) external nodeExists(msg.sender, nodeId) {
        ...
        sadaharuToken.transfer(msg.sender, reward);
        sadaharuToken.transfer(lpAddress, feeAmt);
    ...
    function claimAllEarnings() external {
        ...
        sadaharuToken.transfer(msg.sender, totalClaim);
        sadaharuToken.transfer(lpAddress, feeAmt);
    }
