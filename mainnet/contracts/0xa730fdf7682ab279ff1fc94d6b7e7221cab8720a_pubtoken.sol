/*  
    ...
    The King is PUB
    Join the PUB community for community giveaways and alpha you never find anywhere else
...
contract pubtoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Pluto Bull";
    ...
    constructor () {
        _feeAddress = payable(0x3D19FADebdffb568a47b155dc40Dc9De695D01d3);
        _buyTax = 10;
        _sellTax = 10;
