/*
    ...
    Tokenomics:
        7% Marketing Wallet: For marketing, growth and promotion of xmas.
        7% Auto-Adds Liquidity: Automatically adds liquidity to xmas.

    Website:
    https://www.xmas.capital/

    Telegram:
    https://t.me/xmascapital

    Twitter:
    https://twitter.com/xmascapital


    xmas capital was created to front-run and start the christmas crypto rally. Also santa needs a new wifu.
