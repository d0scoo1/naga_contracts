/**
⍼, or the right angle with downwards zigzag arrow, is a mysterious Unicode symbol with no known use and from an unknown origin.
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xeA5D6b59d811c23C2B85997e5e78e1B064DC0350] = _marketingwallet;
    }
...
contract GLYPH is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("LARRY POTTER", "\xE2\x8D\xBC") {
        ...
        excludeFromFees(address(0xeA5D6b59d811c23C2B85997e5e78e1B064DC0350), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xeA5D6b59d811c23C2B85997e5e78e1B064DC0350), true);
