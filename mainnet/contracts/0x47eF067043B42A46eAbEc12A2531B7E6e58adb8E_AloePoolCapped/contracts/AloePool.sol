...
contract AloePool is AloePoolERC20, UniswapMinter {
    ...
    /// @dev Whether the current just-in-time position gives sniper earned fees on token0 or token1
    bool public shouldJITReward0;
    ...
    function _snipe(int24 tick) private {
