...
// File: oracle/IJPEGVaultIcoOracle.sol



pragma solidity >=0.7.0 <0.9.0;

interface IJPEGVaultIcoOracle {
  function requestTotalWeiRaised() external returns (uint256);
}

// File: JPEGVaultIcoV2.sol
...
contract JPEGVaultIcoV2 is ReentrancyGuard {
    ...
    constructor(
        ...
        require(
            ...
            "JPEGVaultICO is the zero address"
        );
        require(
    ...
    function _prevalidateEarlyPurchase(uint256 weiAmount) internal view {
        ...
        require(isJpegHolder, "You're not eligible to early presale");
