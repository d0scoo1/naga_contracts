// File: contracts/PaletteLoot.sol
...
contract PaLoot is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Palette #', toString(tokenId), '", "description": "Palette Loot is randomized color palette generated and stored on chain. Feel free to use Palette Loot in any way you want.", "image_data": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
