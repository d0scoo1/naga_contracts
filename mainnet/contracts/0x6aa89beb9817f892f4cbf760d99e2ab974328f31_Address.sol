...
contract bigc is Context, IERC20, Ownable {
    ...
    string private _name = "Biggs Coin";
    string private _symbol = "bigc";
    ...
    address public marketingWallet = 0x7Af58700c0C2A5470c8a16e85EAaA4927f045C91;
    ...
    uint256 public numTokensSellToAddToLiquidity = 500000000 * 10**8;
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee) <= 10, "tax too high");
        _taxFee = taxFee;
