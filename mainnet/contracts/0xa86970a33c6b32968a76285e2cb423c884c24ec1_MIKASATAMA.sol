...
/*
  ...
  __  __ _____ _  __           _____      _______       __  __          
 |  \/  |_   _| |/ /    /\    / ____|  /\|__   __|/\   |  \/  |   /\    
 | \  / | | | | ' /    /  \  | (___   /  \  | |  /  \  | \  / |  /  \   
 | |\/| | | | |  <    / /\ \  \___ \ / /\ \ | | / /\ \ | |\/| | / /\ \  
 | |  | |_| |_| . \  / ____ \ ____) / ____ \| |/ ____ \| |  | |/ ____ \ 
 |_|  |_|_____|_|\_\/_/    \_\_____/_/    \_\_/_/    \_\_|  |_/_/    \_\
                                                                        
                                                                        
Telegram: https://t.me/mikasatama
*/
...
contract MIKASATAMA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mikasa Tama";
    string private constant _symbol = "MIKASATAMA";
    ...
    bool private _enableMaxTxn = true;
    uint256 private _launchTime;
    uint256 private _maxtxn = 2; 
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (
            ...
            if (from == _uniswapV2Pair && to != address(_uniswapV2Router) && _enableMaxTxn) {
                uint walletBalance = balanceOf(address(to));
                require(amount.add(walletBalance) <= _tTotal.mul(_maxtxn).div(100));
            }
            ...
            if (!_inSwap && from != _uniswapV2Pair) {
                if (contractTokenBalance > 0) {
                    ...
                    uint256 tokenBurn = contractTokenBalance.div(4);
                    
                    contractTokenBalance -= tokenBurn;
                    _burnToken(tokenBurn);
    ...
    function _burnToken(uint256 tokenBurn) private lockTheSwap(){
        _transfer(address(this), address(0xdead), tokenBurn);
    }
    ...
    function setMaxONOFF(bool onoff ) external onlyOwner() {
        _enableMaxTxn = onoff;
    }
