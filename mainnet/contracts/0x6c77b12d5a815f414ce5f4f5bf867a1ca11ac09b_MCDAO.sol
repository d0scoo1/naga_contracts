...
contract MCDAO is Context, IERC20, Ownable {
    ...
    // ********************************* START VARIABLES **********************************
    string private _name = "McDAO";                                                // name
    string private _symbol = "MCDAO";                                             // symbol
    ...
    uint256 public _contractTokenBalance = 0;

    uint256 public _marketingFee4Sellers = 12;

    bool public feesOnSellersAndBuyers = true;

    uint256 public _maxTxAmount = _tTotal.div(1).div(200);                                           // max transaction amount
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);                     // contract balance to trigger swap & send
    address payable public marketingWallet = payable(0xDcfA5e3114978248F8dD4cB4D998571b68A67e61); // marketing wallet
    ...
    function _transfer(
        ...
        _contractTokenBalance = contractTokenBalance;
    ...
    function SwapAndSend(uint256 contractTokenBalance) private lockTheSwap {
        ...
        _contractTokenBalance = _contractTokenBalance - contractTokenBalance;
