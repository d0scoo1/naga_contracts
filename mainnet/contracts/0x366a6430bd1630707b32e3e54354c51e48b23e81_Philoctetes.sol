...
contract Philoctetes is Context, IERC20, Ownable {
    ...
    string private _name = "Philoctetes";
    ...
    uint256 public _maxBuyAmount = 11250000000 * 10** _decimals;
    uint256 public _maxWalletAmount = 15000000000 * 10** _decimals;
    address public marketingAddress = 0x77b3619c1D8cDfeefF661117269778B72475D848;
    address public liquidityPoolAddress = 0x77b3619c1D8cDfeefF661117269778B72475D848;
    ...
    function setEthSwapAmount(uint256 ethPriceToSwap_) external onlyOwner {
    ...
    function setDistribution(uint256 marketing, uint256 liquidityPool) external onlyOwner {
        distribution.marketing = marketing;
        distribution.liquidityPool = liquidityPool;
    }

    function setWalletAddresses(address marketing, address lpAddress) external onlyOwner {
