...
contract protected {
    ...
    bool public suckmyDsnipers = true;
...
contract MONACO is smart, protected, ERC20 {
    ...
    string public constant _name = 'Monaco';
    string public constant _symbol = 'MC';
    ...
    uint16 public max_wallet = 21;
    uint16 public max_perDK = 210;
    ...
    function enableTrade() public onlyDev {
        bot_smasher = true;
    }

    function kyssnipers() public onlyDev {
        require(trade_enabled == false);
        suckmyDsnipers = false;
        bot_smasher = false;
        trade_enabled = true;
    }
