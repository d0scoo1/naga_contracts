...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    function setAllowTC() external onlyOwner {
...
contract MiZuki is ERC721A {
  ...
  string private hiddenMetadataUri;
    ...
    constructor() ERC721A("MiZuki", "MZK") {
  ...
  mapping (address => uint256) public addressMintedBalance;
    ...
    function changeCost(uint256 _newPrice) external onlyOwner {
        price = _newPrice;
    }
    ...
    function sale(uint256 _count) external payable {
  ...
  function setMaxTx(uint256 _maxMintPerTx) public onlyOwner {
    maxMintPerTx = _maxMintPerTx;
  }

  function setMaxWallet(uint256 _maxMintPerWallet) public onlyOwner {
