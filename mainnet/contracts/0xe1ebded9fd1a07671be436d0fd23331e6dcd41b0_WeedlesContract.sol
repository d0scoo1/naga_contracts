...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xDe584D3Caed9E813DeCA3C6d7D2F51294d4e7170];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPMvKTYYg6CREPJuopggjRRwF6UBc8CFFBJK954QqF829/";
...
// File: contracts/WeedlesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeedlesContract is RamppERC721A {
    constructor() RamppERC721A("Weedles", "WEEDLES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/p23DaYwEscJ3pziDNShO/contract-metadata";
    }
}
