...
/*
    ...
    Rocket Goose - $RocketGoose

    Sending the first Mongoose to Space
    

    🌐 https://www.rocketgoose.co/

    🗣 https://t.me/RocketGooseToken

    🐧 https://twitter.com/RocketGooseETH
...
contract RocketGoose is Context, IERC20, Ownable {
    ...
    string private _name = "Rocket Goose";
    string private _symbol = "RocketGoose";
