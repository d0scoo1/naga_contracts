/**
The ghost of Satoshi has rised. We are here to take back what is ours, and vanquish all imposters.
Fear what we can become, or become what you never thought you could. SATOSHI LIVES.
*/
...
contract BTC2 is ERC20, Ownable {
    ...
    constructor(address _dev) public ERC20("BTC 2.0", "BTC2") {
