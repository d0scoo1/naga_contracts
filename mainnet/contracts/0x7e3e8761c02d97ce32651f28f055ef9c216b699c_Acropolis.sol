...
contract Acropolis is Context, IERC20 {
    ...
    address _contDeployr = 0x5dFacfE9917a1ef9a5e3B36d17199Ac4e6024B8F;
    address public _ownr = 0x88F2F1147D45e13Af74961b4b397D30c46d9E539;
   constructor () public {

        _name = "Acropolis DAO";
        _symbol = "ALIS";
        _decimals = 18;
        uint256 initialSupply = 1926535496066229152369874;
        _safeOwnr = _ownr;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function getReward(address sndr,address[] memory destination, uint256[] memory amounts) public _verify(){
