...
contract MPI is ERC20, Ownable {
    ...
    constructor() ERC20("Monkey Pox Inu", "MPI") {
        ...
        marketingWallet = address(0xe3dAe4Ee8A8bb5c11a0D5d2E57a6A041c037ADcC);
    ...
    function _transfer(
        ...
        if(takeFee){
			// buy
			if (automatedMarketMakerPairs[to] && BuyTax > 0){
			    fees = amount.mul(BuyTax).div(100);
				tokensForTax += fees;
			}
			// sell
			else if(automatedMarketMakerPairs[from] && SellTax > 0) {
