...
contract Inusgram is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Inusgram";
    string private constant _symbol = "Inusgram";
    ...
    address payable private _marketingAddress = payable(0xF44bdB72f396cEcE7863bB33cE7d1C77D7A6DA6E);
    address public constant deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public timeJeets = 20 minutes;
