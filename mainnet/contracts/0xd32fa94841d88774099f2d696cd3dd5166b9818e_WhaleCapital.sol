/*
http://whalecapital.finance/
https://t.me/WhaleCapitalERC
12% Tax
5% ETH Reflections
3.5% Treasury
3.5% Marketing                                                                                                                       
...
contract WhaleCapital is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Whale Capital", "WCE") {
    	...
    	dev1Wallet = payable(0x8768245EaEaa5Ee095fF630eF3056EF8EfEc829b);  // set as dev1 wallet
        dev2Wallet = payable(0x8768245EaEaa5Ee095fF630eF3056EF8EfEc829b);  // set as dev2 wallet
        dev3Wallet = payable(0x8768245EaEaa5Ee095fF630eF3056EF8EfEc829b);  // set as dev3 wallet
        dev4Wallet = payable(0x8768245EaEaa5Ee095fF630eF3056EF8EfEc829b);  // set as dev4 wallet
        dev5Wallet = payable(0x8768245EaEaa5Ee095fF630eF3056EF8EfEc829b);  // set as dev5 wallet

        marketingWallet = payable(0x8768245EaEaa5Ee095fF630eF3056EF8EfEc829b); //marketing wallet
