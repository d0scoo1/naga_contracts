...
contract KevinDoods is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;

    //Basic Configs
    uint256 public maxSupply = 9999;
    uint256 public _price = 0.003 ether;
    ...
    constructor(string memory _initBaseURI,string memory _initBaseExt) ERC721A("Kevin Doodles", "KVD") {
