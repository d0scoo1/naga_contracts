...
/**
 * @title Solana Summer Club contract
 */
...
contract SolanaSummerClub is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Solana Summer Club", "SSC"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Passes...");
