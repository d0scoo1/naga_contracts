...
contract LiquidityMiningV2 is ILiquidityMining, Initializable, UUPSUpgradeable, ReentrancyGuardUpgradeable, OwnableUpgradeable {
        ...
        accumulateRewards(accountOf[msg.sender].referrer)
    {
        ...
        account.vestedBoostedStake -= Math.min(vestedBoostedStake, account.vestedBoostedStake).toUint128();
