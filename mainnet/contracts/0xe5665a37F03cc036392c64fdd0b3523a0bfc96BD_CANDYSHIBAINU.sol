/*
🍫🍭🍬Build your candyland with us!🍫🍭🍬
            [$CINU]
        🍬🍭🍫🍬🍭🍬🍫🍭🍬🍫🍭🍬


🍫Telegram: https://t.me/Candy_Inu
🍫Website: https://candyshibainu.com/
🍫Twitter: https://twitter.com/CandyShibaInu
...
contract CANDYSHIBAINU is Context, IERC20, Ownable {
    ...
    uint256 private _feeAddr2 = 11;
    address payable private _feeAddrWallet1;
    address payable private _feeAddrWallet2;

    string private constant _name = "CANDY SHIBA INU";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xA075c37dF5478F6d79cB0bc6aBf9bd9A7D0EbC10);
        _feeAddrWallet2 = payable(0xA075c37dF5478F6d79cB0bc6aBf9bd9A7D0EbC10);
        ...
        if (from != owner() && to != owner()) {
            ...
            if (
                ...
                if(!_isExcludedFromSellLock[to] && sellLock[to] == 0) {
                    ...
                    if(elapsed < 120) {
                        uint256 sellLockDuration = (120 - elapsed) * 240;
                ...
                require(sellLock[from] < block.timestamp, "cooldown for anti-bot!! please wait or contact admin.");
            }
