...
contract KORIinu is IERC20, Ownable {
    ...
    uint256 _maxWalletSize = (_totalSupply * 2) / 200;
    ...
    address payable public liquidityFeeReceiver = payable(0x91Db9ae320205B4E6fD43fb0D4FD0F656C709c73);
    address payable public marketingFeeReceiver = payable(0x91Db9ae320205B4E6fD43fb0D4FD0F656C709c73);
