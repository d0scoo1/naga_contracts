...
contract ERC721A is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function _safeMint(address to, uint32 zip_) internal {
        _safeMint(to, zip_, '');
    }
    ...
    function _mint(
        ...
        // balance or numberMinted overflow if current value of either + 1 > 1.8e19 (2**64) - 1
        // updatedIndex overflows if _currentIndex + 1 > 1.2e77 (2**256) - 1
    unchecked {
        ...
        _ownerships[startTokenId].zip = zipcode_;

        uint256 updatedIndex = startTokenId;
        uint256 end = updatedIndex + 1;
