...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable HATI = address(0x251457b7c5d85251Ca1aB384361c821330bE2520); //UNI
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(HATI).transfer(shareholder, amount);
        }
    }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a HATIBANK shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract BankOfHati is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Bank Of Hati";
    string private constant _symbol = "HATI BANK";
    ...
    address payable public marketingWallet = payable(0x072299621E63b555d45561DE6171F4B4a579cBaC);
    ...
    uint256 private maxBuy = 20000000001 * (10 ** _decimals);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForHATI(amountToSwap.div(2));

        uint256 dividends = IERC20(HATI).balanceOf(address(this));

        bool success = IERC20(HATI).transfer(address(distributor), dividends);
    ...
    function swapTokensForHATI(uint256 tokenAmount) private {
