...
contract SuicuneInu is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Suicune Inu";
    string constant _symbol = "SUICINU";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xdB1238F2365f007398215C4a0de7C92359445Cc6);
	    teamFeeReceiver = address(0x246F491eb31F139eB6fcb4A7c597dd849981B55E);
