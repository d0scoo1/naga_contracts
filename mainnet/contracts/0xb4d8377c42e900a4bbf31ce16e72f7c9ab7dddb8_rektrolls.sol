...
contract rektrolls is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbAFxnxERUvCNz78zjALsaeXyAD6SLhTEvtiSvjfM2rch";
    ...
    uint256 public NUM_FREE_MINTS = 1069;
    ...
    constructor(
    ) ERC721A("rektrolls", "trolls", 100, maxSupply) {
    }
