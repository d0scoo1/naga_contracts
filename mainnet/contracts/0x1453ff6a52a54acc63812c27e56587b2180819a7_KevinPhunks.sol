...
contract KevinPhunks is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmdnhtMHUorggLvtxjyt4uoFDn7u1TnA21tCDQKq4buvm4";
    ...
    constructor(
    ) ERC721A("Kevin Phunks", "KEVINPHUNKS", 1111, maxSupply) {
    }
