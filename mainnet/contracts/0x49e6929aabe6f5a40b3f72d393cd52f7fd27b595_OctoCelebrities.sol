...
contract OctoCelebrities is ERC721Enumerable, Ownable {
  ...
  uint256 public PricePS = 0.04 ether;
  uint256 public MaxToken = 8888;

  constructor(string memory _initBaseURI,string memory _initnotRevealURI)
    ERC721("Octo Celebrities", "OCTO") { setBaseURI(_initBaseURI); setnotRevealURI(_initnotRevealURI); }
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    require(ownerMintedCount + _mintAmount <= 3, "Max NFTs Reached");
        if (isPresales == true) {
