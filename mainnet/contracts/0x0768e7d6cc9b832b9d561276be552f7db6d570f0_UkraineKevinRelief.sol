...
contract UkraineKevinRelief is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmadw4RVjxKuX1k9qa5RRpsjcFuN6h1vEwN74Jbf6VTvqS";
    ...
    address public constant withDrawalAddressAllMoneySentToUkraineThroughReli3f = 0x087FC456471f5f88F7756c84F04159dF3A3621D9;
    ...
    constructor(
    ) ERC721A("Ukraine Kevins Reli3f (All money goes to RELI3F Multisig)", "UKRAINEKEVINS", 1000, maxSupply) {
    }
    ...
    function withdrawToReli3fMultisig() public {
        uint256 balance = address(this).balance;
        payable(withDrawalAddressAllMoneySentToUkraineThroughReli3f).transfer(balance);
    }
