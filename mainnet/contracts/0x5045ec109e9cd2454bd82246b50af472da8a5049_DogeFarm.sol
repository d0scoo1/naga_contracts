/*
Welcome to the DOGEFARM. You can stake DOGEFARM, eat/drink DOGEFARM, and ultimately, 
LIVE DOGEFARM!

📈 Sellers get REKT with 4% fees on sells - 2% is sent to the Marketing Wallet while 2% is burned.
💹 DOGEFARM Yield Farming Pool will be created soon. This way you can stake part of your HARVEST and some ETH for WETH-HARVEST LP 
and gain even more returns! Staking will be available although at a less APR% with HARVEST itself.
🚀 BULLISH - We use a similar contract to MYOBU, so there is a cooldown of 30 minutes between each sell to prevent major dumping.
...
contract DogeFarm is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 600000 * 10 ** 18;

    constructor () ERC20('Doge Farm','HARVEST') {
