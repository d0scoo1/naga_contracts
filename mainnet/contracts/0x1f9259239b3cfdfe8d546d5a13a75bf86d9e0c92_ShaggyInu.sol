...
contract ShaggyInu is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Shaggy Inu";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x1492E2f0CC7E0F631c71dd2f1d01dc739F084DBE);
	    teamFeeReceiver = address(0x6B45739de60823Fd2e1EEb44D754717dCae8bd6D);
