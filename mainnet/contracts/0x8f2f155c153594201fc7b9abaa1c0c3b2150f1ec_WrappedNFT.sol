...
contract WrappedNFT is ERC721Enumerable{
    ...
    constructor(
    ) ERC721("W-BoredApeCronosClub", "WBACC") {
        nftBridge = 0x149d7F5eBB4f39Be4cF027FaF78BB04B34Bb7032;
    }
    ...
    function bridgeMint(
        ...
        require(!_exists(id), "id already exist");
        _mint(to, id);
        _setTokenURI(id, uri);
    }
