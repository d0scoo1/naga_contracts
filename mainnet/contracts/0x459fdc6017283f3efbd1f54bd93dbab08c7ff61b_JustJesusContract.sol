...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x76897795a0109a00bBa6Dd8DF1e570e96c2a98D1];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 888 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeUWfb1XLhWDjEi95rrtW2rfNtSrCUvaVpQ2mxWTFD8Wr/";
...
// File: contracts/JustJesusContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract JustJesusContract is RamppERC721A {
    constructor() RamppERC721A("JustJesus", "JEGG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/kGQPgLM2Yv84B3MHKwwh/contract-metadata";
    }
}
