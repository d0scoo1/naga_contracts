...
// File interfaces/tokenomics/IVestingEscrow.sol
...
// File contracts/tokenomics/VestingEscrow.sol
...
contract VestingEscrow is ReentrancyGuard, Ownable, IVestingEscrow {
    ...
    function setUnallocatedSupply() external override onlyOwner {
        ...
        require(
            ...
            "contract does not own any tokens"
        );
    ...
    function vestedOf(address _recipient)
        external
        view
        override
        returns (uint256)
    ...
    function lockedOf(address _recipient)
        external
        view
        override
        returns (uint256)
