...
contract BabyYoda is ERC721A, Ownable {
    using Strings for uint256;

    constructor() ERC721A("BabyYoda", "Grogu") {
    }
    ...
    uint256 public freeMintAmount = 44;

    uint256 public price = 0.004 ether;

    string private baseTokenURI;

    string public unRevealedURI = "https://ipfs.io/ipfs/QmPEL78kYFyuJWej4jP9GDC3huBDFseFk1JasLdY7edfen";
