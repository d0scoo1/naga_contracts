...
// File: contracts/ReqVRF_ChainLink.sol
...
function fulfillRandomness(bytes32 requestId,uint256 randomness) internal override{
        ...
        index+=1;
       randomResult = randomness.mod(4444).add(1);
       randomNumbers[index] = randomResult;
...
function withdraw() external onlyOwner{
    ...
    LinkTokenInterface(link).transfer(msg.sender,LINK.balanceOf(address(this)));
}
