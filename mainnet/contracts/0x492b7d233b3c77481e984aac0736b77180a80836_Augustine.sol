...
contract Augustine is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Augustine";
    string private constant _symbol = "Augustine";
