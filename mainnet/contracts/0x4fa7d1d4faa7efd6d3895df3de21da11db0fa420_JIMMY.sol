...
contract JIMMY is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x1218d1C1564099AcF2FB06C321cEe2F1a08A917F);//
    address payable private _marketingAddress = payable(0x1898cDD3a00ea50156e2456a9f4fceAF83F1BB0e);//
    ...
    uint256 public _maxWalletSize = 125000 * 10**9; //
