...
/*
Simple, Decentralised and Secure.
Trustworthy messaging.
With Whatsape, you'll get accessible, reliable, secure and most importantly decentralised messaging communication DAapp, available all over the crypto world.
Whatsape Messenger, or simply Whatsape, is an internationally available blockchain freeware with decentralised characteristics. 
It provides instant message and voice over IP service. Whatsape messenger, requires your wallet address to sign up.

It allows users to send text messages and voice messages, make voice and video calls, and share images, documents, and other content on blockchain. 
WhatsApe will be mainly accessible from desktop computers but we aim to deliver mobile app service. 

Telegram: https://t.me/whatsapeportal
*/
...
contract WhatsApe is Context, IERC20, Ownable {
    ...
    string public constant name = unicode"WhatsApe";
    string public constant symbol = unicode"WhatsApe";
