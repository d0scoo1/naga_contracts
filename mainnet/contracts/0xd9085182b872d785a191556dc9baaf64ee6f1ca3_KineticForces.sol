...
contract KineticForces is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRHDaoMRBrmjZ9xt79UJkTi37NW1d1UrAG4Z6SvskS2r7";
    ...
    constructor(
    ) ERC721A("Kinetic Forces", "FORCE", 100, maxSupply) {
    }
