...
// Modified and updated to 0.8.0 by Gerardo G�mez
...
contract TheVikingArmy is ERC721, Ownable, nonReentrant {
    ...
    uint256 public thevikingarmyPrice = 20000000000000000; // 0.02 ETH

    uint public constant maxTheVikingArmyPurchase = 15;
	...
	uint public constant MAX_THEVIKINGARMYRESERVE = 244;	// total team reserves allowed
