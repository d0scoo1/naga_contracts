...
contract AlienVibeTribe is ERC721Enumerable, Ownable {
  ...
  string public baseURI = "https://alienvibetribemint.com/contract/metadata/";
  string private _contractURI = "https://alienvibetribemint.com/contract/avt.json";
  ...
  function setMaxSupply(uint256 max) public onlyOwner {
    require(max >= totalSupply(), "Should not be less then current total supply");
	  maxSupply = max;
  }
}
