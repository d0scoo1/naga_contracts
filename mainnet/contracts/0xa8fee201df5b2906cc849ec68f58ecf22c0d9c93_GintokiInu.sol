/*
https://www.gintokiinu.info
https://t.me/GintokiInu_ETH
*/
...
contract GintokiInu is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Gintoki Inu";
    ...
    uint256 sellBias = 500;
    uint256 feeDenominator = 10000;

    address payable public liquidityFeeReceiver = payable(0x58fC587cB7935497F241574220338248428D9e2A);
    address payable public marketingFeeReceiver = payable(0x58fC587cB7935497F241574220338248428D9e2A);
    ...
    constructor () {
        ...
        emit Transfer(address(0x7e794eD35788b698AE60cefC98eE48015C4876dA), owner(), _totalSupply);
    }
