...
contract MEANBROCCOLI is Context, IERC20, Ownable {
    ...
    string private _name = "Mean Broccoli";
    string private _symbol = "MEANBROCCOLI";
    ...
    uint256 public _maxWalletSize = 69000000000000000000000 * 10**9;
