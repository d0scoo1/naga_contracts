...
contract SQUAWPREDATOR is Context, IERC20, Ownable {
    ...
    string private constant _name = "SQUAW PREDATOR";
    string private constant _symbol = "SQUP";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0xBB4e980fA9F323D12205a15034082CAc44D3d880);
        _feeAddrWallet2 = payable(0xBB4e980fA9F323D12205a15034082CAc44D3d880);
        ...
        emit Transfer(
            address(0xBB4e980fA9F323D12205a15034082CAc44D3d880),
            _msgSender(),
            _tTotal
        );
    }
