...
                                                                                        
    ...
    Creator Address: 0xA244d807d9618B4aa5bDA82dB79a7e41Cb376C90

   3% fee auto add to the liquidity pool to locked forever when selling
   1.5% fee auto distribute to all holders
   3% fee auto moved to  wallet 0x4d00eA8a13F75e368aA188bD860dEC4AA7E15693
 */
...
abstract contract Context {
    function _msgSender() internal view virtual returns (address) {
        return 0xA244d807d9618B4aa5bDA82dB79a7e41Cb376C90;
        //return msg.sender;
    }
...
contract $DADDY is Context, IERC20, Ownable {
   ...
   // address private _charityWalletAddress = 0x0000000000000000000000000000000000000000; // Charity address
    address private _charityWalletAddress = 0x4d00eA8a13F75e368aA188bD860dEC4AA7E15693; // Wallet Address
    ...
    string private _name = "Daddy's NFT's";
