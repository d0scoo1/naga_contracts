...
contract CoreDrop721 is Ownable, ERC721, INA721Standard, INA721DropStandard, AdminFunctions, DropFunctions, PresaleFunctions, IRaribleRoyaltiesV2 {
    ...
    function internalMint(address to, uint256 quantity) internal {
        ...
        // Sometimes you can find love where you would least expect it.
        // Rmlyc3QgdGhyZWUgKDMpIHBlb3BsZSB0byBlLW1haWwgYXBAaW1ub3RhcnQuY29tIHdpdGggc3ViamVjdCBsaW5lICdWYWxlbnRpbmUncyBTdXJwcmlzZScgd2lsbCByZWNlaXZlIGEgZ2lmdCEgPDM=
    }
