...
contract CheethV3 is ERC20Burnable {
    ...
    function claimCheeth(uint256 outcome, bytes calldata signature) external {
        ...
        _mint(msg.sender, genesisClaimableCheeth + babyClaimableCheeth + outcome);
    }
    ...
    function setIsSignatureClaimEnabled(bool _isSignatureClaimEnabled) external {
        require(msg.sender == _admin, "not allowed");
