/*
  "A Stealth Launch" - $STEALTH

  - it's just a stealth launch...
  
  t.me/StealthLauncher
  stealthlaunch.com
*/
...
contract Immutable is Ownable {
  ...
  function Claim() onlyOwner ifImmutableOff public {
    special = true;
    emit ImmutableOn();
  }

  function LaunchToken() onlyOwner ifImmutableOn public {
    special = false;
    emit ImmutableOff();
  }
}
...
contract AStealthLaunch is Context, IERC20, Ownable, Immutable {
    ...
    string private _name = "A Stealth Launch";
