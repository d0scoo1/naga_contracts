...
contract NFT is ERC721A, Ownable, Pausable {
    ...
    uint256 public constant _maxCountMint = 5;
    ...
    address public _address_95 = 0x67c7d06ED1AF133b96deE4399F249623E7F4E087;
    // whitelist
    ...
    function setPrivate() public onlyOwner {
        isPrivateSale = true;
    }
    ...
    function privateMint(uint256 _count, bytes32[] calldata _merkleProof) public whenNotPaused payable validateProof(_merkleProof){
        require((getCountWalletNft() + _count) <= _maxCountMint, "You cant by nft.");
