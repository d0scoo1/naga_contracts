...
contract SmithWin is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Everybody Support Smith";//
    string private constant _symbol = "SMITHWIN";//
    ...
    address payable private _developmentAddress = payable(0xBC5BB31A5f17Cb4525e0f65359babea38A31BEda);//
    address payable private _marketingAddress = payable(0xBC5BB31A5f17Cb4525e0f65359babea38A31BEda);//
