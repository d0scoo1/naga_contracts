...
contract Shibastellar is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Shibastellar Capital";
    ...
    address payable private _developmentAddress = payable(0xa0ce19440FE478b56b6bE5862989e1537D237871);
    address payable private _marketingAddress = payable(0x0b610Aab9A65f56698a8d77B96a507102711b7C8);
    ...
    uint256 public _maxTxAmount = 240000 * 10**9; //0.24%
