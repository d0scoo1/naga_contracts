...
contract TheRestorian is Context, Ownable, ERC165, IERC721Metadata, IERC721Enumerable {
    ...
    string public constant THE_RESTORIAN_PROVENANCE = "1e099b651361a21c0761d31bf91d5234aa73267b03bd55d447b5b3d661de37cb";

    uint256 public constant SALE_START_TIMESTAMP = 1616716800;
    ...
    */
    function mintNFT(uint256 numberOfNfts) public payable {
         ...
         */
        if (startingIndexBlock == 0 && (minted == MAX_NFT_MINTED || block.timestamp >= REVEAL_TIMESTAMP)) {
