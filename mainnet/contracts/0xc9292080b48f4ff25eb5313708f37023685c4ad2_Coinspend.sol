...
contract Coinspend is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xFC466c0904e3b944fF76f6BB4E3B10a971F89Abb); // Marketing Address
    ...
    string private _name = "Coinspend";
    string private _symbol = "COINSPEND";
