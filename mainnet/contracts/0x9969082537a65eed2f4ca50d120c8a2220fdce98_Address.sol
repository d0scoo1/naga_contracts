...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xD907b650837B476D405e084572119EEFA001E530];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmYPZoXNPE4EoYzsppb9Ya5FUya1CnyJMX8u2NjEjXCjjQ/";
...
// File: contracts/DinoNautsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DinoNautsContract is RamppERC721A {
    constructor() RamppERC721A("DinoNauts", "DinoNauts"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vqSCvgKIvXTB4yI4bcds/contract-metadata";
    }
}
