...
// File: contracts/CryptoWarUkraineNFT.sol
...
contract CryptoWarUkraineNFT is ERC721A, Ownable {
    ...
    function mint(address _to, uint256 _quantity) public onlyOwner {
        ...
        require((totalAvailable() - _quantity) >= 0, "QUANTITY NOT AVAILABLE");
    ...
    function mintP(uint256 _quantity) public payable {
        ...
        require(allowMint == true, "MINTING IS NOT ALLOWED");
        require((totalAvailable() - _quantity) >= 0, "QUANTITY NOT AVAILABLE");
        require(msg.value >= assetPrice * _quantity, "INSUFFICIENT FUNDS");
    ...
    function contractURI() public view returns (string memory) {
        return string(bytes.concat(bytes(baseURI), "", bytes("0")));
    }
    ...
    function withdraw(uint256 _amount, address payable _to) public onlyOwner {
        ...
        require(_amount <= getContractBalance(), "INSUFFICIENT BALANCE");
