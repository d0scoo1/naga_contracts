...
contract McGoblinUnHappyMeal is ERC721A, Ownable {
    ...
    constructor() ERC721A("McGoblin UnHappyMeal", "MGUHM", MAX_MINTS, MAX_SUPPLY) { 
        
    }
    

    function MINTMeal(uint256 numTokens) public payable {
