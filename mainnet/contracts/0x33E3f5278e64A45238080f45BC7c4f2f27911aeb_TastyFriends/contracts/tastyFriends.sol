...
contract TastyFriends is ERC721A, Ownable {
    ...
    uint256 public constant FREE_SUPPLY = 699;
    uint256 public constant PAID_SUPPLY = 6270;
    uint256 public constant MAX_SUPPLY = FREE_SUPPLY+PAID_SUPPLY;

    constructor() ERC721A("Tasty Friends", "TFRENS", MAX_TXN) {
        saleEnabled = false;
        price = 0.0069 ether;
    }
