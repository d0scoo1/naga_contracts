...
contract MetaEther is ERC20, Ownable {
    // -- Mappings --
    ...
    string constant _name = "MetaEther";
    string constant _symbol = "$MTER";
    ...
    address public treasuryReceiver = 0x19F98C850E98650613a697D8a48707b875295E73;
    address public marketingReceiver = 0xdF49FE7E3781977887C29B3DB09268982EE288D3;
    ...
    constructor () Ownable(msg.sender) {
        ...
        buyFee.liquidityFee = 10; buyFee.treasuryFee = 0; buyFee.marketingFee = 20;
        buyFee.total = buyFee.liquidityFee + buyFee.treasuryFee + buyFee.marketingFee;

        // Set Initial Sell Fees -- Base 1000 Set 10 for 1%
        sellFee.liquidityFee = 10; sellFee.treasuryFee = 10; sellFee.marketingFee = 140;
