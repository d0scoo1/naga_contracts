...
Contract: Scab Shop Auction
Forked From: https://github.com/ourzora/auction-house
Original Creators: Zora
**/
...
import { IMarket, Decimal } from "./ScabShopAuction/IMarket.sol";
import { IMedia } from "./ScabShopAuction/IMedia.sol";
import { IAuctionHouse } from "./ScabShopAuction/IAuctionHouse.sol";
 ...
 */
contract ScabShopAuction is IAuctionHouse, ReentrancyGuard {
    ...
    // The address of the Shop Pass contract, to gete bids
    address public shopPassAddress;
     ...
     * Constructor
     */
    constructor(address _shopPass, address _zora, address _weth) {
        shopPassAddress = _shopPass;
        zora = _zora;
        wethAddress = _weth;
    ...
    nonReentrant
    {
        ...
        require(IERC721(shopPassAddress).balanceOf(msg.sender) >= 1, "Must own a Shop Pass to bid");
