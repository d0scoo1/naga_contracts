...
// | '  | | ; |  ; |  | '  | |  | |   | |   | |  | |   | ' | |   | |   | |  | |   | |   \ \   
// '  `-' | ' `-'  |  ' `-' ;   | |   | |   | |  | |   ' `-' ;   | |   | |  | |   | |    \ .  
//  `.__. | `.__.'_.   `.__.   (___) (___) (___)(___)   `.__.   (___) (___)(___) (___ ) (___) 
//  ( `-' ;                                                                                   
//   `.__.                                                                                    
...
// File: contracts/GablinTink.sol
pragma solidity ^0.8.0;

contract GablinTink is ERC721A, Ownable, ReentrancyGuard {
    using Address for address;
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 9999;
    uint256 public constant MAX_MINT_PER_TX = 40;
    uint256 public constant MAX_FREE_MINT_PER_WALLET = 5;

    uint256 public freeMinted;
    uint256 public salePrice = .002 ether;
    ...
    constructor() ERC721A("GablinTink", "GABTINK") {
        _baseTokenURI = "ipfs://bafybeigleoptdlgtfxipliequnnsfmdza6u2belj3sl7nybxnvgrhbxsiy/";
    }
    ...
    function makeGablinTinkFast(uint256 _quantity, address _receiver) external onlyOwner {
    ...
    function toggleTinking() external onlyOwner {
