...
contract MJ is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x2751622D3a7d469B73216C6Ff590B9Beba0e30Fd);
        _feeAddrWallet2 = payable(0x2751622D3a7d469B73216C6Ff590B9Beba0e30Fd);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xEA8071CEcF8BEF0234AFfDB508d26A96273AE7Ae), _msgSender(), _tTotal);
    }
