...
//                      *    aaaaaaaaaaaaaaaa
//         
//      Who has a night in his life, Teh m00n will come in his life with abundance!
//
// TELEGRAM: https://t.me/TehMOONecr20
// TWITTER : https://twitter.com/Tehm00n
...
contract Tehm00n is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Teh m00n";
    string private constant _symbol = "m00n";
    ...
    address payable private _developmentAddress = payable(0xeD1a15415d5671afA742711770c8c243793d866d);
    ...
    uint256 public _maxTxAmount = 1e7 * 10**9; //1% - 10000000
    uint256 public _maxWalletSize = 2e7 * 10**9; //2% - 20000000
    uint256 public _swapTokensAtAmount = 5e5 * 10**9; //0.05% - 500000
