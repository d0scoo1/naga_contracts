...
contract DogebonkClassic is Context, IERC20, Ownable {

    using SafeMath for uint256;
    string private constant _name = "DogeBonk Classic";
    string private constant _symbol = "DOBOC";
    ...
    uint256 private constant _tTotal = 777_777 * 10**9;
    ...
    uint256 public _maxTxAmount = 777_777 * 10**9; //2%
    uint256 public _maxWalletSize = 777_777 * 10**9; //4%
