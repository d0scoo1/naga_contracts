...
// File: contracts/TheEggzLowGas.sol
...
contract TheEggzLowGas is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("The EggZ", "TE") {
    setHiddenMetadataUri("ipfs://QmQemCWc3op2NtaGB3VdiqGBFuAoq16UXkvCtNVTSQPeZF/hidden.json");
  }
