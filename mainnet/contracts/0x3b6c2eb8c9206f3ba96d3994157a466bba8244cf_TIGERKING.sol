...
contract TIGERKING is Context, IERC20, Ownable {
    ...
    function setSellFee(uint256 IronBankFee, uint256 reflectionsFee, uint256 sellMarketingFee)
        external
        onlyOwner
    {
        _IronBankFee = IronBankFee;
        _reflectionsFee = reflectionsFee;
        _sellMarketingFee = sellMarketingFee;
        require(_IronBankFee + _reflectionsFee + _sellMarketingFee <= 30, "Must keep taxes below 30%");
    }
