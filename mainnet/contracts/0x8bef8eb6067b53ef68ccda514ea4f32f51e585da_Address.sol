...
//** Author Ishanshahzad: PIFNFT 2022.6 */
...
// File contracts/interfaces/IPIFNFT.sol
...
contract PIFNFT is IPIFNFT, ERC721Enumerable, ERC721URIStorage, IERC2981, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("PIF_DeFi_NFT", "PIFNFT")  {
    ...
    function multiMint(string[] calldata URIs, address _to) override external  {
