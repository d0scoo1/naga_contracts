...
contract VamPunks is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    function airdropAdditional(address recipient) external { 
        uint256 tokenId = ADDITIONAL_AIRDROPS_START + ADDITIONAL_AIRDROPS;
        require(msg.sender == _allowedAirdropper || msg.sender == owner(), "Not authorized.");
        require(tokenId <= MAX_SUPPLY, "Out of additional airdrop tokens.");

        _totalSupply = _totalSupply + 1;
        ADDITIONAL_AIRDROPS = ADDITIONAL_AIRDROPS + 1;
