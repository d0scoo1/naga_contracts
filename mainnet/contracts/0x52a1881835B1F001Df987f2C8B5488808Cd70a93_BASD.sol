/*
                    ...
                    website: https://basd.money
                    twitter: https://twitter.com/BASDmoney
                    telegram: https://t.me/BASDmoney          
...
contract BASD is Ownable, IERC20 {
    address UNISWAPROUTER = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "BASD - BORED APE SAITAMA DAO";
    string private _symbol = "BASD";
    ...
    address payable public devWallet =
        payable(0xf3Bc5c1d357371e92a77707B2Ca57689d355a509);
    address payable public treasuryWallet =
        payable(0xb7B8920C13Ac82858f8864e4C4E3f1b51f41C0a4);
        ...
        returns (bool)
    {
        ...
        require(
            currentAllowance >= subtractedValue,
            "BASD: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            currentAllowance >= amount,
            "BASD: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(
            ...
            "BASD: Token isn't tradable yet"
        );

        require(!isBlacklisted[sender], "BASD: Sender is blacklisted");
        require(!isBlacklisted[recipient], "BASD: Recipient is blacklisted");

        require(sender != address(0), "BASD: transfer from the zero address");
        require(recipient != address(0), "BASD: transfer to the zero address");
        ...
        require(
            senderBalance >= amount,
            "BASD: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "BASD: approve from the zero address");
        require(spender != address(0), "BASD: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "BASD: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "BASD: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "BASD: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function compound() public {
        require(compoundingEnabled, "BASD: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "BASD_DividendTracker";
    string private _symbol = "BASD_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "BASD_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "BASD_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "BASD_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "BASD_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("BASD_DividendTracker: method not implemented");
    }
