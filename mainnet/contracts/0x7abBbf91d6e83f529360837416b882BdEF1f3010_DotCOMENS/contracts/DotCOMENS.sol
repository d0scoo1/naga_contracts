...
contract DotCOMENS is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmNmRxUMBJsBwPBXz8i3sQ1EnK9EWQERcCKKSdN9JaTWL8";
  ...
  ) ERC721A("4 Digital Dot COM", "4 Digital Dot COM") {
