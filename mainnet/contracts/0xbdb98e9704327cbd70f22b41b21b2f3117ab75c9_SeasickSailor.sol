...
// File: contracts/SeaSickShiba.sol

  

pragma solidity >=0.7.0 <0.9.0;

contract SeasickSailor is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Seasick Sailor", "SSS") {
    setUriPrefix("ipfs://QmWjuSgpxw8uQ3beqTUMyV5xzLSxDpa76K8baA9LPvuE2R/");
  }
