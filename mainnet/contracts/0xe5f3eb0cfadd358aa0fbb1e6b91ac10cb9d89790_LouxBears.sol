...
contract LouxBears is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("LouxBears", "LouxBears"){}

  function mint(uint256 amount) external payable
  {
    require(contractEnabled, "contract not enabled yet please wait");
    uint256 freeMint = 2;
    ...
    if(numberMinted(msg.sender) >= freeMint) freeMint = 0;

    require(msg.value < (freeMint-amount) * price,"Not enough funds");
  ...
  function withdraw() external onlyOwner nonReentrant {
    ...
    (bool Xmre, ) = payable(0x0c06080E0192ef08B9748d761211dF39a21bbF2F).call{value: share}("");
    require(Xmre, "Failed");


    (bool CommunityTreasure, ) = payable(0x7023AaCa1eF198927de04aa757Cfc48E9273b13D).call{value: share}("");
    require(CommunityTreasure, "Failed");
