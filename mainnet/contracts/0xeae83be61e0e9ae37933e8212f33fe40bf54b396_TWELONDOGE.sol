...
contract TWELONDOGE is ERC20, Ownable {
    ...
    constructor() ERC20("TWELONDOGE", "TDOGE") {
        ...
        TreasuryAddress = address(0xbB0ffD25e24d7860ed53f07fCCF6387d68Ee2908);
        RewardsAddress = address(0xbB0ffD25e24d7860ed53f07fCCF6387d68Ee2908);
    ...
    function updateMaxBuyAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 100000)/1e18, "Cannot set max buy amount lower than 0.1%");
        maxBuyAmount = newNum * (10**18);
        emit UpdatedMaxBuyAmount(maxBuyAmount);
    }

    function updateMaxSellAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 100000)/1e18, "Cannot set max sell amount lower than 0.1%");
        maxSellAmount = newNum * (10**18);
        emit UpdatedMaxSellAmount(maxSellAmount);
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 3 / 100000)/1e18, "Cannot set max wallet amount lower than 0.3%");
