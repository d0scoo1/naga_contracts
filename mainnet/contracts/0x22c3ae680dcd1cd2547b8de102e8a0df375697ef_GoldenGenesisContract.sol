...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe32516C12310364b31948c93543176A043C1DA3E];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 1656 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmQX6tuFTf3afwMyQWABzacCEpqAd1FQAphJW5drxLr58Q/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1656");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1656");
...
// File: contracts/GoldenGenesisContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoldenGenesisContract is RamppERC721A {
    constructor() RamppERC721A("Golden Genesis", "GG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/XTlhSl0Usiw42rylZlwd/contract-metadata";
    }
}
