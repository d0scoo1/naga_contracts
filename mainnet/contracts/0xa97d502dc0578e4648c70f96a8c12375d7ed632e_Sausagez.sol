...
contract Sausagez is ERC721A, Ownable, ReentrancyGuard {
  ...
  ) ERC721A("Sausagez Official", "SAUSAGEZ") {
  ...
  function mint(uint256 tokens) public payable nonReentrant {
    ...
    require(_numberMinted(_msgSender()) + tokens <= MaxperWallet, "fMax NFT Per Wallet exceeded");
