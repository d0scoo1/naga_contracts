...
contract EmployeesOfTheWeek is ERC721A, ERC2981ContractWideRoyalties, Ownable {
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmUGgxHAH4QppZLF7xTkhYwcsXkFPMwGsf6HbTs5inMSPL/";
    ...
    address constant public ROYALTY_RECIPIENT = 0x54A29eadbaA3fd280F1782573968F38F28b2871f;
    ...
    constructor () ERC721A("Employees Of The Week", "EOTW", 10) {
    ...
    function mint(uint256 quantity) public payable {
        ...
        require(totalSupply() + quantity <= TOKEN_MAX_SUPPLY, "No more EOTW left");
