...
// File: contracts/MettiForArtists.sol
...
contract MettiForArtists is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    ...
    uint256 private _MAX_UniqueWork = 1000000;
    
    //
    uint16 internal royalty = 800; // base 10000, 8%
    ...
    /*
     * @dev hard limit of _MAX_UniqueWork single tokens
     */
    ...
    function mintEditions(
        ...
        _mintEditions(to, tokenId, count, _tokenURI);
    ...
    function _mintEditions(
        ...
        for (uint256 i = 0; i < count; i++) {
            _mintUniqueWork(to, tokenId + i, _tokenURI);
        }
    }
    ...
    function setRoyalty(uint16 _royalty) public virtual onlyOwner {
        require(_royalty >= 0 && _royalty <= 2000, 'Royalty must be between 0% and 20%.');
