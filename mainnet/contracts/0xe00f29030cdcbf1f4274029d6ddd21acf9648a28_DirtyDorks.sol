...
contract DirtyDorks is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://www.DumpsterDorks.com/dorks";
    ...
    constructor(
    ) ERC721A("Dirty Dorks", "DORKS", 100, maxSupply) {
    }
