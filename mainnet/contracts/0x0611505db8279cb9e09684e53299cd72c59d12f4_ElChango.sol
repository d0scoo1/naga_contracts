...
"'El Chango' also known as the Sicario monkey was a pet member of La Familia Michoacana
a notorious cartel in Mexico. It and its apparent owner were killed during a standoff 
between state security forces and the organised criminal group." 

El Chango did not die in vain, his soul will live on becoming the next viral ape sensation following
in the footsteps of Harambe! 

RIP El Chango, your life and death has made the world a different place

https://twitter.com/ElChangoErc
...
contract ElChango is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "El Chango";
    string private constant _symbol = "CHANGO";
    ...
    address payable private _marketingAddress = payable(0x1B60b16f543BeA07176BB69107F148EfB7444C88);
