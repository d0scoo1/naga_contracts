...
//
//   ________            ____                            
//  /_  __/ /_  ___     / __ \____  ____ ____  __________
//   / / / __ \/ _ \   / /_/ / __ \/ __ `/ _ \/ ___/ ___/
//  / / / / / /  __/  / _, _/ /_/ / /_/ /  __/ /  (__  ) 
// /_/ /_/ /_/\___/  /_/ |_|\____/\__, /\___/_/  /____/  
//                               /____/                  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x0fDE3272D36D4D9B184E75a719c7914BB39EA775];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 555 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmfDa2kq2dJt86humqDgCFpmHuDkSWbFj2q3MtBGNsECty/";
...
// File: contracts/TheRogersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract TheRogersContract is RamppERC721A {
    constructor() RamppERC721A("The Rogers", "ROGERS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/F0vHTtr7ItFQ2y2KQFgL/contract-metadata";
    }
}
