...
abstract contract Governor is Ownable, ERC165, EIP712, IGovernor {
    ...
    uint256 public lastMaxTokenSupply;
    uint256 public lastMaxVotes;
...
abstract contract GovernorCountingSimple is Governor {
    ...
    {
        ProposalVote storage proposalvote = _proposals[proposalId];
        return (proposalvote.tokenHasVoted[tokenId]);
    }
...
{
    uint256 private _votingPeriod = 23000; // ~0.5 week
