...
library Fees {
    ...
    function init(
        Data storage data,
        RoyaltiesStorage.Data storage _storage,
    ...
    function updateFeeDestinationPercents(Data storage data, RoyaltiesStorage.Data storage _storage, uint256 dividendsPercent, uint256 marketingPercent, uint256 mysteryPercent) public {
    ...
    function swapAccumulatedFees(Data storage data, RoyaltiesStorage.Data storage _storage, uint256 tokenAmount) public {
