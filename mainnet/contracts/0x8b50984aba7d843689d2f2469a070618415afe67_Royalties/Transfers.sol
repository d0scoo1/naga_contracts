...
library Transfers {
    ...
    function handleTransferWithFees(Data storage data, RoyaltiesStorage.Data storage _storage, address from, address to, uint256 amount, address referrer) public returns(uint256 fees, uint256 buyerMint, uint256 referrerMint) {        
