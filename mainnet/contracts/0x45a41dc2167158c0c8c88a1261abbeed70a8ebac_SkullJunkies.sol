...
// Contract: SkullJunkies NFT
// Token ID: "Skulljunkies"
// Token Symbol: "SKLJNKS"
// Author: Sean Pentiboyina
// ---- CONTRACT BEGINS HERE ----

pragma solidity ^0.8.0;

contract SkullJunkies is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public walletLimit = 150;
  ...
  constructor(
    ...
    //mint(msg.sender, 5);
    // After launching and giving 100 tokens to Oner, maxMintAmount
    // sets to 20 and walletLimit sets to 3.
    maxMintAmount = 5;
    //walletLimit = 50;
    payments = payable(_skullsplitterAddress);
  }
    ...
    returns (string memory)
  {
    require(
      _exists(tokenId),
      "ERC721Metadata: URI query for nonexistent Skulljunkies NFT"
    );
