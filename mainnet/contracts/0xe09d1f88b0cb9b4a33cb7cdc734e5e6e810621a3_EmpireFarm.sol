...
ReentrancyGuard
{
    ...
    string public constant collectionName = "EmpireFarm";
    string public constant collectionSymbol = "EFM";
    uint256 public constant maxQuantityPerMint = 10;
    uint256 public mintPrice = 0.045 ether;
    uint256 public wl_mintPrice = 0.028 ether;
    uint256 public maxTotalSupply = 3555;
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        if (whitelist[_msgSender()]) {
            currentPrice = quantity * wl_mintPrice;
        }
    ...
    function changeMintPrice(uint256 newPrice, uint256 wl_newPrice) public onlyOwner {
        mintPrice = newPrice;
        wl_mintPrice = wl_newPrice;
    }
