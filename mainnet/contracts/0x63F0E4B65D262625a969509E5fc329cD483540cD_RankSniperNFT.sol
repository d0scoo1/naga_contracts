...
contract RankSniperNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;

  address private walletTeam = 0xb0DA683bD0662193F35c26c92F91eb997ecD3422;
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    if (msg.sender != owner()) {
      if (onlyWhitelisted == true) {
        ...
        require(supply + _mintAmount <= 250, "First whitelist limit exceeded (250)");
      }
  ...
  function withdraw() public payable onlyOwner {
    ...
    (bool success1, ) = payable(walletTeam).call{value: balance}("");
    require(success1, "Failed to withdraw to walletTeam");
  }
}