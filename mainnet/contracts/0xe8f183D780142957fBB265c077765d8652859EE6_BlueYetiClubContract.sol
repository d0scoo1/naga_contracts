...
//  |____/|_|\__,_|\___|    |_|\___|\__|_|  \_____|_|\__,_|_.__/ 
//                                                               
//                                                               
//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf34979879A439ea22a57F87A8F79FB15AC0Ae4aF,0xfb26520811cE2AEE195943b654fFF280887728Ef,0x647838E9EE6c672240c3316FC1712b21955a2D37];
  uint256[] public payableFees = [5,40,35,20];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmYHEiwbyAfmon1PRMFYRrew6grV4GQRbhrGYCMqS33wr1/";
...
// File: contracts/BlueYetiClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BlueYetiClubContract is RamppERC721A {
    constructor() RamppERC721A("Blue Yeti Club", "BYC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/aX4D68dHbuoq0e9749GJ/contract-metadata";
    }
}
