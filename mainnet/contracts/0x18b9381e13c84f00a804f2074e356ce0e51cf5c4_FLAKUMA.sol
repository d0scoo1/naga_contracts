...
contract FLAKUMA is ERC721A, Ownable {
    uint16 public constant MAX_SUPPLY = 5555;
    uint8 public constant MAX_PER_WALLET = 2;

    string private baseUri = "https://gateway.pinata.cloud/ipfs/QmfMvvaUdK5mt82xCBiHiBit9wXmyjvgnqCnzJ3CsQzq8Z/";
    uint96 private royaltyBasisPoints = 1000;

    constructor() ERC721A("Flakuma", "FLAKUMA") {}
