...
pragma solidity ^0.8.0;
 contract MajesticDeersMintPass is ERC721Enumerable, Ownable {
    ...
    uint256 public price = 0.0275 ether;
    ...
    constructor(uint256 supply) ERC721("Majestic Deers NFT Pass", "MDMP21") {
        maxSupply = supply;
    }
    ...
    function editPresale(address[] memory presaleAddresses) public onlyOwner {
        for(uint256 i; i < presaleAddresses.length; i++){
            presaleWhitelist[presaleAddresses[i]] = 5;
        }
    }
