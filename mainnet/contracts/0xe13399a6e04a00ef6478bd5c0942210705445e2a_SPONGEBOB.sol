...
contract SPONGEBOB is Context, IERC20, Ownable {
    ...
    address private _owner = 0x0B5fE78883B5B77d87dD3c7Ef14fB49075939389;
    ...
    constructor() payable {
        ...
        _rOwned[address(this)] = _rTotal / 1000 * 0;
        ...
        marketingAddress = payable(0xa76b2AA28a2F335CCF348b8eA0d8eaDacc22871F); // Marketing Address
        
        devAddress = payable(0x0B5fE78883B5B77d87dD3c7Ef14fB49075939389); // Dev Address
        ...
        emit Transfer(address(0), address(this), _tTotal * 0 / 1000);
    }
