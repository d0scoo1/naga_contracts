...
contract wSQUID is ERC20 {
    ...
    constructor( address _staking, address _SQUID, address _sSQUID ) ERC20( 'Wrapped sSQUID', 'wsSQUID' ) {
        require( _staking != address(0) );
        staking = _staking;
        require( _SQUID != address(0) );
        SQUID = _SQUID;
    ...
    /**
        ...
        @return uint
     */
    function wrapFromSQUID( uint _amount ) external returns ( uint ) {
    ...
    /**
        ...
        @return uint
     */
    function unwrapToSQUID( uint _amount ) external returns ( uint ) {
    ...
    /**
        @notice converts wSQUID amount to sSQUID
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts sSQUID amount to wSQUID
        @param _amount uint
        @return uint
     */
    function wSQUIDValue( uint _amount ) public view returns ( uint ) {
