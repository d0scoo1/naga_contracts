/**
    High tax coins are just as bad as rugs. NO MORE HIGH TAX. 
    Devs don't need more than 1% and rest of funds should be split between LP/Marketing.
    4% round trip tax (2% in, 2% out). 
    1% dev, 1% lp, 2% marketing. 

    Lets start a new meta.
...
contract NoMoreTax is Context, IERC20, Ownable {
	...
	string private constant _name = "No More Tax";
