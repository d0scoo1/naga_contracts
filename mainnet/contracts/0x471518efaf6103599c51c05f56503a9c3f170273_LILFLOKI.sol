...
contract LILFLOKI is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x15C713BB33EC7347123b5EfeF65E73C633645797); // Marketing Address
    address public liquidityWallet = address(0x5df357438F0215e9bd5249E15BAd38f8F1d8EdD9);
    ...
    uint256 public _maxWalletToken = 60000000000000 * (10**18);
    ...
    function _transfer(
        ...
        if (from != address(this) && to != address(this)) {
            if (!automatedMarketMakerPairs[to] && !_isExcludedFromFee[to])
