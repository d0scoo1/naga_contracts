...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7c18B5159e38aa564256C4dbAf49ed6A88a87319];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 6, 444 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qme3j9Qr2eFaKUyAjMMNno26PW6c9ku5XpiDWAi8yncDoo/";
...
// File: contracts/MoonWithoutBirdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MoonWithoutBirdContract is RamppERC721A {
    constructor() RamppERC721A("Moon Without Bird", "OnlyMoon"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/W1SUmUzqj9zeWMm3MtOq/contract-metadata";
    }
}
