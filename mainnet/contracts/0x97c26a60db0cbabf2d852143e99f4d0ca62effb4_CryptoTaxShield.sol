...
contract CryptoTaxShield is ERC721Enumerable, Ownable {
    using SafeMath for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIds;

    uint256 public MAX_SUPPLY = 2650;
    ...
    constructor(string memory baseUR) ERC721("Crypto Tax Shield", "CTS") {
        setBaseURI(baseUR);
    }
