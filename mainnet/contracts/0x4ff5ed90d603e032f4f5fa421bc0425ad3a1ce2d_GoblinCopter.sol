...
contract GoblinCopter is Ownable, ERC721A {
    string private baseURI = "";
    string private baseExtension = ".json";
    uint256 public MAX_FREE_MINT = 500;
    uint256 public MAX_PUBLIC_MINT = 3000;
    uint256 public MAX_SUPPLY = MAX_FREE_MINT + MAX_PUBLIC_MINT;
    uint256 public mintRate = 0.0059 ether;
    ...
    constructor(string memory _initBaseURI) ERC721A("GoblinCopter", "CopterCopter") {
