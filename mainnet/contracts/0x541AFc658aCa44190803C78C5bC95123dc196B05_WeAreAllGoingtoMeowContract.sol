...
//*********************************************************************//
//
//  _ _ _ _____    _____ _____ _____    _____ _____ _____ _____ _____    _____ _____    _____ _____ _____ _ _ _ 
// | | | |   __|  |  _  | __  |   __|  |   __|     |     |   | |   __|  |_   _|     |  |     |   __|     | | | |
// | | | |   __|  |     |    -|   __|  |  |  |  |  |-   -| | | |  |  |    | | |  |  |  | | | |   __|  |  | | | |
// |_____|_____|  |__|__|__|__|_____|  |_____|_____|_____|_|___|_____|    |_| |_____|  |_|_|_|_____|_____|_____|
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 2896 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://93f028255035b61df476b13b9dba3c4f06f60e51b9b4caee31680b389aef327f/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 2896");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 2896");
...
// File: contracts/WeAreAllGoingtoMeowContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeAreAllGoingtoMeowContract is RamppERC721A {
    constructor() RamppERC721A("We Are All Going to Meow", "WAGMEOW"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/31dWZ676xbzPvYXoUJxp/contract-metadata";
    }
}
