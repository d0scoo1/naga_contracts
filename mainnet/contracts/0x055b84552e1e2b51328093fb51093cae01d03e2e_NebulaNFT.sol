...
//  \ \ , ` \  /'__`\ \ '__`\/\ \/\ \ \ \ \   /'__`\   
//   \ \ \`\ \/\  __/\ \ \L\ \ \ \_\ \ \_\ \_/\ \L\.\_ 
//    \ \_\ \_\ \____\\ \_,__/\ \____/ /\____\ \__/.\_\
//     \/_/\/_/\/____/ \/___/  \/___/  \/____/\/__/\/_/
...
contract NebulaNFT is ERC721Enumerable, Ownable {
    ...
    // Truth.　
    constructor() ERC721("NebulaNFT", "NEB")  {
        setBaseURI("https://gateway.pinata.cloud/ipfs/QmeRTDipcYiRyLya7ZaSq1Jia2MNUtRMWDmUpqRFVWZ4Pf/");
    }
    ...
    function mint(uint _count) public payable saleIsOpen {
        require(totalSupply() + _count <= MAX_NEB, "Max limit");
        require(totalSupply() < MAX_NEB, "Sale end");
