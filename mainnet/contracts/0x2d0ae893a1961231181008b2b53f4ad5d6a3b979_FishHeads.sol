...
// @title: FishHeads
// @author: FishHeads Team
contract FishHeads is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    uint256 public AIRDROP_ITEMS = 7;
    ...
    address public constant creatorAddress = 0xa9EDC0581127180F632281cf74BCA07902cBdbbe;
    address public constant devAddress = 0x38ef58880492083cdF8A713f72ee39581E243428;

    event CreateFishHead(uint256 indexed id);

    constructor(string memory baseURI) ERC721("Fish Heads NFT", "FishHeads") {
        setBaseURI(baseURI);
        pause(true);
        presale = false;
        sale = false;
    ...
    function mintReserve(uint256 _count, address _to) public onlyOwner {
        ...
        require(total <= MAX_ITEMS + AIRDROP_ITEMS, "Supply limit");
        require(total + _count <= MAX_ITEMS + AIRDROP_ITEMS, "Max limit");
    ...
    */
    ...
    function withdrawAll() public payable {
        require(_msgSender() == devAddress || _msgSender() == creatorAddress, "Withdraw not allowed");
