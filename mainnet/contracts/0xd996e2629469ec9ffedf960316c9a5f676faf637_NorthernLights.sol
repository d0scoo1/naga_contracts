...
contract NorthernLights is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmcsm1798RwdTuEKGg1z2CNz3B7D8UgEskjgoweLx5st6b/";
    ...
    constructor(
    ) ERC721A("Northern Lights", "NLT", 100, maxSupply) {
    }
