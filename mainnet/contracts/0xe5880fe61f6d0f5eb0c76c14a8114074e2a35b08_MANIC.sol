...
contract MANIC is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1690000000 * (10**18);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "TRASHART";
    string private _symbol = "MANIC";
    ...
    address payable public marketingWallet = payable(0xbc93d1eaD13D972e244497Ae830996Ed7Eb1bc05);
    ...
    uint256 public _maxTxAmount = 1690000000 * 10**18;
    ...
    function _transfer(
        ...
        //transfer amount, it will take tax, burn, liquidity and marketing fee
        _tokenTransfer(from,to,amount);
    }

    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        uint256 liquidityTokenShare = contractTokenBalance.mul(_liquidityFee).div(_liquidityFee.add(_marketingFee));
