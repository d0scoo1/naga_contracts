...
contract PenisEyes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNk1bEakWdMm4diDszBqLrvDzvuuchZTodz72tdtAzTAu";
    ...
    constructor(
    ) ERC721A("PE", "PenisEyes", 100, maxSupply) {
    }
