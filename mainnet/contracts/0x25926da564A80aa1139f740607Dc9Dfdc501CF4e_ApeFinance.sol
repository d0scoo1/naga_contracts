...
Trade and earn forever anonymously. Ape Finance is implementing their very own GhostSwap, which will give the security, 
and peace of mind on everyday trading. The Ape Finance GhostSwap is currently being polished, 
and is set to be released post launch. Holders of 0.2% of Ape Finance supply will automatically 
receive a whitelist spot during the testing stages and implementation of utilities.

Trade and earn with Ape Finance, and let’s change this space one step at a time. 

Website: ApeFinanceERC.com
Twitter: Twitter.com/ApeFinanceERC
Telegram: t.me/ApeFinancePortal
...
contract ApeFinance is Context, IERC20, Ownable {
    ...
    uint256 public maxWalletAmount = _tTotal / 200; // 1% of supply
    ...
    string private constant _name = "ApeFinance";
    ...
    // Max Tax at launch to avoid snipers & bots. Changed to 4% LP 6%Marketing later
