...
contract InariFox is ERC721, Ownable, PaymentSplitter {
    ...
    constructor(address[] memory _payees, uint256[] memory _shares) ERC721("InariFox", "IFox") PaymentSplitter(_payees, _shares) payable {
        //  Max amount of tokens
        maxAmntTokens = 288;
        //  Max tokens per transaction
        maxTknPerTxs = 20;
        //  Price per NFT in wei
        price = 5000000000000000 wei;
        //  Deactivate sale
        saleIsActive = false;
        //  Unlock URI
        URIlocked = false;
