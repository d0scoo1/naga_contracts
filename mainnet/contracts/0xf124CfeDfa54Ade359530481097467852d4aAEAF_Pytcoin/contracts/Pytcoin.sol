...
/*
 * Pytcoin is the ERC20 token for the Pytcoin platform. It is received and
 ...
 */
contract Pytcoin is ERC20Capped, Ownable {
    ...
    function claimOffchainGrant(
        ...
        require(validity <= block.number, "Pytcoin: too early");
        require(!nonceUsed[from][nonce], "Pytcoin: nonce already used");
