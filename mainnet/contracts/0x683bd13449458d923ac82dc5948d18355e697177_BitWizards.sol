...
contract BitWizards is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPJszBFx5Bzc6j9ZmpkbguBjWKQ3EyEXboDazgLpbt8yJ";
    ...
    constructor(
    ) ERC721A("BitWizards", "Bitwizards", 100, maxSupply) {
    }
