...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 15000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmeXni1WZvV4Ca1W4KbRocCW521XtabM2sUeMrucjuKbbF/";
...
contract TheGrCryptoBeeContract is RamppERC721A {
    ...
    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/AwnFNJxXYU2LcQQXvIe4/contract-metadata";
    }
}
