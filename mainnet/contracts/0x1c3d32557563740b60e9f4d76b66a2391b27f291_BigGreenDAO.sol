...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Pausable.sol@v4.4.0
 ...
 */
contract BigGreenDAO is Context, AccessControlEnumerable, ERC20, ERC20Pausable, BurnPausable {
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "BigGreenDAO: must have minter role to mint");
        _mint(to, amount);
    }
    ...
    function burnFrom(address account, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "BigGreenDAO: must have minter role to burn");
    ...
    function burn(uint256 amount) public virtual {
        require(!burnPaused(), "BigGreenDAO: self burn paused");
    ...
    function burnPause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "BigGreenDAO: must have pauser role to pause");
        _burnPause();
    }
    ...
    function burnUnpause() public virtual {
        require(hasRole(PAUSER_ROLE, _msgSender()), "BigGreenDAO: must have pauser role to unpause");
        _burnUnpause();
    }
