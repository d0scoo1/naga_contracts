...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmRN5UgvokFzVYLkith8ezKu4NyP9AmskzJgevuN3rk9QX/";
...
// File: contracts/BirdWithoutMoonContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BirdWithoutMoonContract is RamppERC721A {
    constructor() RamppERC721A("Bird Without Moon", "OnlyBird"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/fnVqazSV86nenjwLocWS/contract-metadata";
    }
}
