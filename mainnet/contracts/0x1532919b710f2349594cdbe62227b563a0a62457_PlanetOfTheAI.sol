...
contract PlanetOfTheAI is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmV13cakQrzSDQDW8DLxErP5BKVEWe3HHuf3BQBHr4v52D";
    ...
    constructor(
    ) ERC721A("Planet Of The AI", "PLANET", 100, maxSupply) {
    }
