...
contract Saitapes is IERC20 {
    ...
    string constant private _name = "Saitapes";
    string constant private _symbol = "Saitapes";
    ...
    TaxWallets public _taxWallets = TaxWallets({
        marketing: payable(0x6b24d23a5993657875d5311162Cf51D5279eB8f0),
        development: payable(0x6b24d23a5993657875d5311162Cf51D5279eB8f0),
        treasury: payable(0x6b24d23a5993657875d5311162Cf51D5279eB8f0)
        });
...
//===============================================================================================================
    ...
    function setTaxesBuy(uint16 reflect, uint16 burn, uint16 marketing, uint16 development, uint16 treasury) external onlyOwner {
        uint16 check = reflect + burn + marketing + development + treasury;
    ...
    function setTaxesSell(uint16 reflect, uint16 burn, uint16 marketing, uint16 development, uint16 treasury) external onlyOwner {
        uint16 check = reflect + burn + marketing + development + treasury;
        require(check <= maxBuyTaxes);
        _buyTaxes.reflect = reflect;
        _buyTaxes.burn = burn;
    ...
    function setTaxesTransfer(uint16 reflect, uint16 burn, uint16 marketing, uint16 development, uint16 treasury) external onlyOwner {
        uint16 check = reflect + burn + marketing + development + treasury;
        require(check <= maxBuyTaxes);
        _buyTaxes.reflect = reflect;
        _buyTaxes.burn = burn;
    ...
    function setRatios(uint16 marketing, uint16 development, uint16 treasury) external onlyOwner {
        _ratios.marketing = marketing;
        _ratios.development = development;
        _ratios.treasury = treasury;
        _ratios.total = marketing + development + treasury;
    }
    ...
    function setWallets(address payable marketing, address payable development, address payable treasury) external onlyOwner {
    ...
    function contractSwap(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingBalance = amtBalance - (treasuryBalance + developmentBalance);
