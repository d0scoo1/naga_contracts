...
contract Arenamon is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;
    using Address for address;

    uint256 public MAX_SUPPLY = 10000;
    uint256 public PUBLIC_SUPPLY = 9960;
    ...
    constructor() ERC721("Arenamon", "ARN") {
