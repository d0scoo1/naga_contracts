...
contract XGOLD is ERC20Pausable, ERC20Burnable, ERC20Mintable, MultiTransferToken {
  string public constant name = "XIDO Gold Game";
  string public constant symbol = "xgold";
