 ...
 * */
 ...
 contract Ytoken is Context, IERC20, Ownable {
     ...
     string private constant _name = "Y Token";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x50e6953B9cf3cD26f7977d979ffabfe2225AFc01);
         _feeAddrWallet2 = payable(0x50e6953B9cf3cD26f7977d979ffabfe2225AFc01);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x50e6953B9cf3cD26f7977d979ffabfe2225AFc01), _msgSender(), _tTotal);
     }
