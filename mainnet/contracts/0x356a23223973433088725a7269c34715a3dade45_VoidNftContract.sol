...
//*********************************************************************//
//
//  ___      ___ ________  ___  ________          ________   ________ _________   
...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0x28560722a0A60490f5439497D36bd91421e9bC9C;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x28560722a0A60490f5439497D36bd91421e9bC9C];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 555 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSWj92rc1HJg5NL85U1i2Yxs7azpwDhVE1MypssRzePaF/";
...
// File: contracts/VoidNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract VoidNftContract is RamppERC721A {
    constructor() RamppERC721A("Void NFT", "Void"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/tSPxORaRxfTCrxgATy3v/contract-metadata";
    }
}