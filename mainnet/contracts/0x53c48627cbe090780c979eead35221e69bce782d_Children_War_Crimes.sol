...
contract Children_War_Crimes is Ownable, ERC721 {
    
    uint public tokenPrice = 1 ether;

    uint constant maxSupply = 60;
    ...
    uint public maxPerWallet = 2; //Max Limit for Presale
  
         
    constructor() ERC721("Children War Crimes", "CWC"){}
   ...
   function buy(uint _count) public payable{
    ...
    function _baseURI() internal view virtual override returns (string memory) {
     ...
     function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 90 / 100);//owner wallet
        payable(0x2098145E7D5572828209f89FB972568B765605C7).transfer(_balance * 10 / 100); 
    }
}