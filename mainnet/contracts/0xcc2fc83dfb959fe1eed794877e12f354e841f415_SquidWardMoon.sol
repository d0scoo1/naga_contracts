...
Telegram Portal: https://t.me/SquidwardMoon
Website: https://squidwardmoon.live/
Twitter: https://twitter.com/SquidwarMoon
...
contract SquidWardMoon is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xf1cd17F2c775F2D53a00cD798905B305674E60a4));
    address payable public _devwallet =
        payable(address(0xcB2A000039858117CAf57436c266732ADd158B26));
    address public _exchangewallet =
        payable(address(0x34f6695d10A29dFB8B94e5bacDfB872E5Be8B6D2));
    address _partnershipswallet =
        payable(address(0xf1adBf08BbF58F675ADA759A5E319EF5c621686d));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "SquidWardMoon";
    string private _symbol = "SQWARMOON";
    ...
    uint256 public _maxTxAmount = 21000 * 10**19 * 10**9;
