...
//
//     __    __                                      __                 
//    / /   / /   ____ _____ ___  ____ _____  ____ _/ /_____  __________
//   / /   / /   / __ `/ __ `__ \/ __ `/ __ \/ __ `/ __/ __ \/ ___/ ___/
//  / /___/ /___/ /_/ / / / / / / /_/ / / / / /_/ / /_/ /_/ / /  (__  ) 
// /_____/_____/\__,_/_/ /_/ /_/\__,_/_/ /_/\__,_/\__/\____/_/  /____/  
//                                                                      
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 4000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmToKTkcZwLFJD3grhSwA1A5A4FjozEPE3KUcCHA7CedD8/";
...
// File: contracts/LLamanatorsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LLamanatorsContract is RamppERC721A {
    constructor() RamppERC721A("LLamanators", "LLAMA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/r0piUNe4u0gRegdw7Ohs/contract-metadata";
    }
}
