 ...
 */
contract IslandBois is ERC721, Ownable {
    using SafeMath for uint256;

    uint256 public constant maxSupply = 3333;
    uint256 public constant price = 69*10**15;
    uint256 public constant purchaseLimit = 10;
    uint256 internal constant reservable = 50;
    uint256 internal constant team = 10;
    string internal constant _name = "Island Bois";
    string internal constant _symbol = "ISLND";
    address payable immutable public payee;
    address internal immutable reservee = 0x1F17D3CC6D48f35481E419d26A7A09f501b4cbb0;

    string public contractURI;
    string public provenance;
    bool public saleIsActive = true;
    uint256 public saleStart = 1635811140;
