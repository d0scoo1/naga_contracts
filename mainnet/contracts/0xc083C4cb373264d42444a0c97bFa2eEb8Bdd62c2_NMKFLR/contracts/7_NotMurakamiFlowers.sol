...
contract NMKFLR is ERC721A, Ownable {
    ...
    uint256 public constant FREE_MAX_SUPPLY = 5555;
    ...
    constructor() ERC721A("Not Murakami Flowers", "NMKFLR") {}
    ...
    function freeMint(uint256 _amount) external payable {
        ...
        require(MAX_PER_WALLET >= hasMinted[_caller] + _amount , "Excess max per paid tx");
