/**
 *
 * Telegram: https://t.me/Shinpanzee
 * 
 * SHINPANZEE
 *
 *
 * https://shinpanzee.com
 * https://t.me/Shinpanzee
 * https://twitter.com/Shinpanzee_             
 *
 *
 * だいたい
 * 豊臣(Toyotomi)は京都郊外の小さな村で生まれごく平凡な生活を送っていた、17歳の誕生日を迎えるあの日までは....
 *
 * 17歳の誕生日を迎える日、豊臣は友人と森に探検へ出かけた。森へ分け入っていくと、彼らは楓の葉に覆われているとて
 * も古い祠を発見した。忍隠れ里の祠であろうか？祠を囲むようにチンパンジーを祀ったかのような様々なモニュメントが並べ
 * られていた。
 *
 * 碑文を読んだ豊臣は、碑文に刻まれた文章を読み上げたい衝動に駆られた。そして、彼は自分の体が人間サイズのチンパ
 * ンジーに変化していくのを感じた。その時、豊臣の頭には彼の先祖である忍び達の膨大な知識が詰め込まれてきた。
 * この日から豊臣の人生の全てが変わり、シンパンジー(Shinpanzee)としての新たな人生が始まった。          
 *                                                   
*/                                                                           
...
contract Shinpanzee is Context, IERC20, Ownable {
    ...
    string private _name = "Shinpanzee";
    string private _symbol = "SHINPANZEE";
