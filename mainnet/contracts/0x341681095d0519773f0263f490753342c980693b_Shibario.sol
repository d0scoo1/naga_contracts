...
contract Shibario is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Shibario";                                           // name
    string private _symbol = "$SBO";                                            // symbol
    uint256 private _tTotal = 1000000000 * 10**18;      // supply is 1 Billion
    // % to holders
    ...
    uint256 public _maxWalletAmount = 20000000 * 10**18; // 2% Tokens // 20,000,000 token
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(10000);
    address payable public marketingWallet = payable(0xDEDe594Eab81608994d5227B9c2b11A276716a34);
