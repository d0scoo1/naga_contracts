...
contract KishuKing is Context, IERC20, Ownable {
    ...
    uint256 private _swapTokensAtAmount = 1 * 10**9; // 1 token
    ...
    string private constant _name = "Kishu King";
    string private constant _symbol = "KISHKI";
  ...
  _isExcludedFromFee[adr2] = false;
    ...
    function openTrading() external onlyOwner {
        ...
        _maxWalletAmount = 2000000000000000 * 10**9;
        tradingOpen = true;
