...
contract RyuWorld is ERC721A("RyuWorld", "RyuW"), Ownable, ERC721ABurnable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    string public notRevealedUri;
    uint256 public cost = 0.1 * 1e18;
    uint256 public maxSupply = 5000;
    uint256 public reservedSupply = 150;
    uint256 public maxMintAmount = 10;
    uint256 public publicmintActiveTime = 1652191200;
    ...
    uint256 public presaleActiveTime = 1652104800;
    uint256 public presaleMaxMint = 5;
    bytes32 public whitelistMerkleRoot;
    uint256 public itemPricePresale = 0.07 * 1e18;
