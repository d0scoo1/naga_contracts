...
contract FreshLemons is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 0.03 ether;
    uint256 private whitelistCost = 0.00001 ether;
    ...
    function mint() external payable {
        ...
        if (totalSupply + 1 > 4444) revert SoldOut();
