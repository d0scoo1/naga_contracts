...
contract InvestorsEndToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Investors End";//
    ...
    address payable private _developmentAddress = payable(0x20985582819d1E0CAE4e30C50000dfA4C7464985);//
    address payable private _marketingAddress = payable(0x9Dbf03c37D61D5BdB2fDED02843086B6f0017299);//
