...
contract NATSU is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x250C71A96a6d5E533974C7dC18dc7C2444C33888);
        _feeAddrWallet2 = payable(0x250C71A96a6d5E533974C7dC18dc7C2444C33888);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x9eb932D9f926d3d68D4ac1f3dd8b9C82228A1C38), _msgSender(), _tTotal);
    }
