...
import "./XanaArtTradablePrivate.sol";

contract XanaArtFactoryPrivate is Ownable {
    ...
    */
    ...
    /// @notice Method for deploy new XanaArtTradablePrivate contract
        ...
        returns (address)
    {
        ...
        XanaArtTradablePrivate nft = new XanaArtTradablePrivate(
            _name,
            _symbol,
            mintFee,
            feeRecipient,
