...
contract Legacy is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNaEvntjmwJNG3jicgS3fVMkYXJ8oVTG9rqpvnCAhyo7X";
    ...
    uint256 public NUM_FREE_MINTS = 120;
    ...
    constructor(
    ) ERC721A("Legacy: XXXTentacion", "Legacy", 100, maxSupply) {
    }
