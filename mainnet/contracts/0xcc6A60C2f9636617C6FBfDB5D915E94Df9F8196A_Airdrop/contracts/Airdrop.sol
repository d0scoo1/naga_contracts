...
contract Airdrop is Ownable {  
  ...
  function setPrice(uint256 _ethPrice, uint256 _token0Price, uint256 _token1Price) external onlyOwner {
    ethPrice = _ethPrice;
  ...
  function buyChestWithEth() external payable returns (uint256) {
    require(msg.value >= ethPrice, "Insufficient payment");
