...
contract TeslaFun  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "TeslaFun";                                          
    string private _symbol = "$TSLAFUN";                                           
    ...
    address payable public marketingWallet = payable(0x5ee3735414db0e79F7296ebeBc0cB631CD799c28);
