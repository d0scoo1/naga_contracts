...
contract BridgeElonGoatETH is Context, Ownable {
    ...
    address public elongoat;
    address public system = address(0xbaDFFC001727e77F018a8B0e768a2dC1c17A0708);
    ...
    function updateElongoatContract(address _elongoat) external onlyOwner {
       elongoat = _elongoat;
   }
    ...
    function swapBack(
       ...
       if(fees > 0) {
            TransferHelper.safeTransfer(elongoat, bridgeFeesAddress, fees);
       }
       
        TransferHelper.safeTransfer(elongoat, to, temp);
    }
