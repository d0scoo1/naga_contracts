...
contract RoflPunks is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public MAX_SUPPLY = 555;
    uint256 public mintPrice = 0.005 ether;

    string public baseURI = "ipfs://QmYH9wkYrPTMvgLSPg2pTT8Xg9FN4orEutGEDuyHMyiUW1/";

    constructor() ERC721A("Rofl Punks", "ROFLPUNKS") {}
