...
contract Pumptopia is Context, IERC20, Ownable {
  ...
  string private _name = 'Pumptopia';
  string private _symbol = 'PTPA';
  ...
  address payable public _PTPAWalletAddress;
  ...
  uint256 private _maxWalletToken = 200000 * 10**9; // 2% of total supply
  ...
  constructor(
    address payable PTPAWalletAddress,
    address payable marketingWalletAddress
  ) {
    _PTPAWalletAddress = PTPAWalletAddress;
    _marketingWalletAddress = marketingWalletAddress;
    _rOwned[_msgSender()] = _rTotal;

    IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
      0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D
    ); // PCSV2 for BSC network
  ...
  function excludeAccount(address account) external onlyOwner {
    require(
      account != 0xB9Bf912D9C3a88aBf10168F5897fA441da9b7C10,
  ...
  function _transfer(
    ...
    if (recipient == uniswapV2Pair || _isUniswapPair[recipient]  || recipient == owner() || sender == owner())
    {
      ...
      require(
          ...
          'Exceeds maximum wallet token amount of 2%.'
      );
    }
  ...
  function sendETHToTeam(uint256 amount) private {
    _PTPAWalletAddress.call{ value: amount.div(2) }('');
  ...
  function _getMaxWalletToken() private view returns (uint256) {
  ...
  function _setPTPAWallet(address payable PTPAWalletAddress) external onlyOwner {
    _PTPAWalletAddress = PTPAWalletAddress;
  }
