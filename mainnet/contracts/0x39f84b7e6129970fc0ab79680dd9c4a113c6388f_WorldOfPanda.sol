...
// File: contracts/WorldofPandas.sol
...
contract WorldOfPanda is ERC721, ERC721URIStorage, ERC721Burnable, Ownable, ERC721Royalty {
    ...
    event payment_Sent(bool payment_Sent);
        ...
        ERC721(_contractName,_contractSymbol)
     {
         ...
         maxSupply = 8008;
         _blackPandaURI = "https://dweb.link/ipfs/bafybeidke67gy7db4zwt7umvu2wyjcyawo232q5gc2yp2lj6td7dzxxh5a/mystry.json";    
         lengendaryURI = "https://dweb.link/ipfs/bafybeiewb6bqgvckoimcpmx7q36qwgjmp2g57kphglx3bfrlmxmmyla7ze/8003.json" ;

         setAdmin( owner() );
         addWhiteList ( msg.sender );
         _setDefaultRoyalty(msg.sender, _royality);
         preSaleTime = 1649894400 ;
         NFTshowtime = 1650240000;
         actualSale = 1650067200  ;
