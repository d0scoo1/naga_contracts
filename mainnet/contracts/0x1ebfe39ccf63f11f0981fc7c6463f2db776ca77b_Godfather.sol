...
contract Godfather is Context, IERC20, Ownable {
    ...
    string private _name = "Godfather";
    string private _symbol = "MAFIA";
    uint8 private _decimals = 9;

    address payable private marketingWalletAddress = payable(0xE6d25C76306F3B6E47e71b0D4297F3C0E67cEA8d);
    address payable private developmentWalletAddress = payable(0x2E3c11598c6bb9EA3764Db722C27d9cEF881Cfb1);
    ...
    uint256 private _buyLiquidityFees = 2;
    uint256 private _buyMarketingFees = 3;
    uint256 private _buyDevelopmentFees = 2;
    uint256 private _sellLiquidityFees = 2;
    uint256 private _sellMarketingFees = 3;
    uint256 private _sellDevelopmentFees = 2;
    ...
    uint256 public _totalSupply = 666666666666 * 10**9;
    uint256 public _maxTxAmount = 666666666666 * 10**9;
    uint256 public _walletMax = 19999999999 * 10**9;
    ...
    function adjustMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (666666666666 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
