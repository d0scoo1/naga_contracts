 ...
 *Website: https://www.pompacoin-eth.com

 *Telegram: https://t.me/pompacoinETH
...
🐸 Defi Project, Utility, and Strong Community 
...
contract Pompa is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1 * 69e18 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private constant _name = unicode"Pompa Coin";
    string private constant _symbol = unicode"$POMPA";
    ...
    uint256 public maxWallet =  1000000000000000001 * 10**9; 

    uint256 private _BuytaxFee = 2;
    uint256 private _BuyteamFee = 12;
    // Early Sell Tax First 24 Hours
    uint256 private _SelltaxFee = 2;
    uint256 private _SellteamFee = 26;
    ...
    function addLiquidity() external onlyOwner() {
        ...
        _maxBuyAmount = 1000000000000000001 * 10**9; // 1.4% TX LIMIT 
