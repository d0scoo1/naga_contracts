// WELCOME TO SIMBA LION 🦁!
// Meet the new king! SIMBA LION is here.
//🦁 SIMBA LION Simba will have its own NFT Marketplace Platform. Leveraging blockchain technology, the platform replaces the traditional auction house and verifies the content’s source. The platform will in this way enable NFT enthusiasts to display their NFTs and sell them either at a fixed price or through an open auction. The buyers can keep up with the NFT rankings as they are updated regularly and purchase their favourite NFT by paying directly with their wallet.  

// ✅ Telegram: https://t.me/simbalion_token
// ✅ Website: https://www.simbalion.cc/
// ✅ Twitter: 
...
contract SIMBALION is Context, IERC20, Ownable {
    ...
    string private _name = 'Simbalion.cc';
    string private _symbol = 'SIMBALION';
