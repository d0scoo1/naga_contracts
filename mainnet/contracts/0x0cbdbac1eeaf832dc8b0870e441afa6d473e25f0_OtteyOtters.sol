...
// File: contracts/OtteyOtters.sol

pragma solidity 0.8.7;

contract OtteyOtters is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    using ECDSA for bytes32;

    uint256 public constant MAX_SUPPLY = 3000;
    uint256 public constant MAX_PER_PURCHASE = 6;
    uint256 public constant MAX_PER_PRESALE_PURCHASE = 2;
    uint256 public constant RESERVE_QTY = 40;
    ...
    string public Provenance = "fea6ea616e8234da7b648ff37eb0a2eb442cbaf2eab1e4f972aa931996f960f2";

    // Payout addresses
    address private constant _otterJef = 0xd089c873B885b843D5aCf8619B567eDC8cf5FCE8; // Founder
    address private constant _otterPico = 0x86190c50d1dD3Eeb2Ab1dbb8E7195F2195AF321f; // Solidity dev
    address private constant _otterSpencer = 0xf1cD6C7a5944129E0edDBcc625f447A38a230a6a; // Artist
    address private constant _otterCommunity = 0xe137a63ba60fB1714Ff9fC8181489C4B8c47808f; // Community/Project

    uint256 private constant _totalShares = 10000;

    string private _baseUri = "ipfs://QmNXeAoaG8FcAcY9CohWn9sndwtfCeEgnDtwPE1q1rmyEz";

    address private _signerAddress = 0xD8CC6fb6fda6d052045c4066f7320584Bb1eA082;

    bool private _adminsSet = false;
    uint256 private _qtyReserved = 0;

    address[4] private _shareholders = [_otterJef, _otterPico, _otterSpencer, _otterCommunity];
    ...
    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        ...
        _shares[_otterJef] = 3750;
        _shares[_otterPico] = 1000;
        _shares[_otterSpencer] = 3000;
        _shares[_otterCommunity] = 2250;
    }
    ...
    function setPublicSaleActive(bool active) external onlyOwnerOrAdmin {
        if (active) {
            ...
            require(bytes(Provenance).length > 0, "Provenance has not been set");
        }
    ...
    /*     
    * Set the provenance hash, once it's calculated
    */
