...
contract TaperToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Taper Token";
    string private constant _symbol = "TAPER";
    ...
    address payable private _marketingAddress = payable(0x37960723329d6E1d03d03D9fA3653DEa03152D88);
    address payable private _devAddress = payable(0xc670aEE59062974d32eF98c6500407cfd03f01c0);
