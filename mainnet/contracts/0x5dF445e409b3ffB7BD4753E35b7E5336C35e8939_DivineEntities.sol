...
contract DivineEntities is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVmRsguGspBmHcByfxXRkJBxFF5r3AdZiZ1LNxa9NCxc1";
    ...
    constructor(
    ) ERC721A("Divine Entities", "Divine", 100, maxSupply) {
    }
