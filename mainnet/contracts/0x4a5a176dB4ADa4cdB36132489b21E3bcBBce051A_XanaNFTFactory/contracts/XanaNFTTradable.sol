...
/**
 * @title XanaNFTTradable
 * XanaNFTTradable - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract XanaNFTTradable is ERC721, Ownable {
