...
contract ApeBig is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ape Big";//
    ...
    address payable private _developmentAddress = payable(0x39cCa1C2885b9f47cd48809DE07E68DF31D3dB22);//
    address payable private _marketingAddress = payable(0x9Da787Af1C18C8D0459837c86C18fE4F57E61b42);//
