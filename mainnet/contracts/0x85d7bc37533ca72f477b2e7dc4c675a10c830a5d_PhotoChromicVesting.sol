...
contract PhotoChromicVesting {
    ...
    /**
     * Time Zone: UTC
     * Start Date: 2022-01-10 AM 10:00:00
     * Last Date:  2022-12-10 AM 10:00:00
     */
    uint[12] public LockedDateList = [
        1641808800, 1644487200, 1646906400, 1649584800,
        1652176800, 1654855200, 1657447200, 1660125600,
        1662804000, 1665396000, 1668074400, 1670666400
    ];

    uint256 public totalLockedToken;
    address public unlockAddress = 0x1EB89AcDE42514b4bA49232C58036E124f9F2A89;

    uint256 public currentUnlockToken;
    uint256 public lastUnlockTime;
    uint256 public maxUnlockingTimes = 12;
    uint256 public beforeUnlockingTimes = 1;
    uint256 public beforeUnlockingToken;
    uint256 public afterUnlockingTimes = 11;
    ...
    constructor(address _token) public {
        ...
        totalLockedToken = (10 ** _decimals).mul(225_000_000); // total 225,000,000 PHCR Tokens
        beforeUnlockingToken = totalLockedToken.mul(1000).div(10000); // 10% token, 1 m
        afterUnlockingToken  = totalLockedToken.mul(818).div(10000); //  8.18% token, 11 m
    }
