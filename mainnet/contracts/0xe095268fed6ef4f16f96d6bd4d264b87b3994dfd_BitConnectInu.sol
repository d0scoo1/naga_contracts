...
contract BitConnectInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "BitConnect Inu";
    string private constant _symbol = "BCCINU";
    ...
    address payable public marketingWallet = payable(0xF985d32391F9d6892dCFB7B48816776AAD59EbC6);
    address payable public treasury = payable(0xd8e99449a29b71e22D4Cb912e757335a8BF870cd);
