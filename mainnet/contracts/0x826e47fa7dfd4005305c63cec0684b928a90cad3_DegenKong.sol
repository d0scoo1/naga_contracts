...
DegenKong is exclusively on DegenSwap to take advantage of the new router system!

This means the contract won’t sell tokens EVER!
Which will provide VERY healthy an EVER growing liquidity pool!

🌐 Web: https://degenkong.com/
🐥 Tw: https://twitter.com/DegenKongErc
🚪 Portal: https://t.me/DegenKongPortal
...
contract DegenKong is Context, IERC20, Ownable {
    ...
    string private _name = "DegenKong";
    string private _symbol = "DEGENKONG";
    ...
    constructor () {
        ...
        _approve(_msgSender(), degenSwapPair, _tTotal);
