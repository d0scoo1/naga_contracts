...
contract wazzzup_mf is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Wazzzup MF", "WUMF_NFT") {
    setHiddenMetadataUri("ipfs://QmSwn3YFmxTgmA4cubLoLd41SLdsPYak6vojSZBFD95Dgb/hidden.json");
  }
