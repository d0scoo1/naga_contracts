...
contract StonerZebra is ERC721A, ReentrancyGuard, Ownable {  
  ...
  uint256 private private_price = 0.05 ether;
  ...
  address[4] public fundRecipients = [
    0x941D67d10a0d581a4De32af22d4Ab8452C474BA3,
    0x020F2ce4a627186c8eC1AAd5A32210175C59F0dC,
    0xA7c8EF131344639F8C4aC295fb6F08695721198b, //acf
    0xc37Da9811b67eE0e0227aB564Bae104d9e76D043 //com
  ];
  uint256[] public receivePercentagePt = [35, 35, 20, 10];   //distribution in basis points

  constructor(string memory _baseURI) ERC721A("StonerZebra", "STZ", MAX_MINT) {
