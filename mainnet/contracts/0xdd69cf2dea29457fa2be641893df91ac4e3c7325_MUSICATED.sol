...
contract MUSICATED is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmYCdqAYDJJvLbrNmWbGiazRU3dBgvjevU7GPxR3c6b7Se";
    ...
    constructor(
    ) ERC721A("MUSICATED", "CUR3", 100, maxSupply) {
    }
