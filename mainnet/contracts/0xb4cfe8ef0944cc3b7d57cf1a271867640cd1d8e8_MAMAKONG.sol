/*
Mama Kong ($MAMAK)
All apes needed a mama. Forget the usual utilities. Mama is here to change the perspective on crypto.
...
contract MAMAKONG is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mama Kong";
    ...
    address payable private _developmentAddress = payable(0xa0B019026Ec78b885A520a96fd3DCEDb3d869933);
    address payable private _marketingAddress = payable(0xa0B019026Ec78b885A520a96fd3DCEDb3d869933);
