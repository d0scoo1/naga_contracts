...
// File: contracts/celestialtown.sol
...
// File contracts/ERC721A.sol
    ...
    contract celestialtown is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    string public uriPrefix = "ipfs://QmStFsHNr6Z6Yo2npnsCaKkLeWrB7zADHetPdGoK7R1KK8/"; string public uriSuffix = ".json"; string public hiddenMetadataUri;
    ...
    constructor() ERC721A("celestialtown", "CELESTIAL") {setHiddenMetadataUri("ipfs:///hidden.json");}
