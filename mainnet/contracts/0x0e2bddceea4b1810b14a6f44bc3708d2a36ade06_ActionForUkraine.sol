...
// File: contracts/Action 4 Ukraine.sol
...
contract ActionForUkraine is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Action For Ukraine", "A4U") {
    setHiddenMetadataUri("ipfs://Qmagh3eduEQ5qkdRxhneWCSDYG7bdZHVbCJjBzJhEvVJsE/Hidden.json");
  }
