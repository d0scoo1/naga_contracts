...
contract Adamisnotsilly is ERC2981, ERC721A, Ownable {
    using Address for address payable;
    using ECDSA for bytes32;
    using Strings for uint256;

    uint256 public immutable _mintPrice = 0.0069 ether;
    ...
    string public _metadataURI = "https://bucketains.s3.us-east-2.amazonaws.com/json/";

    constructor() ERC721A("adamisnotsilly", "AINS") {
