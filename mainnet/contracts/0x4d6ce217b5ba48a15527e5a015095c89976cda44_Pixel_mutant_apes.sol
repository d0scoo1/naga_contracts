...
contract Pixel_mutant_apes is Ownable, ERC721 {
    ...
    constructor() ERC721("Pixel Mutant Apes", "PMA"){}
   ...
   function presale(uint _count) public payable{
        require(_count > 0, "mint at least one token");
        require(_count <= 3, "max per transaction 3");
        require(totalSupply + _count <= 500, "Not enough tokens left");
        require(balanceOf(msg.sender) + _count <= 3, "Not allowed in presale");
