...
import "./interfaces/ITrippyFrens3D.sol";

/// @title T3IPPY Sale
/// @author 0xhohenheim <contact@0xhohenheim.com>
/// @notice NFT Sale contract for purchasing T3IPPY NFTs
contract SaleTrippyFrens3D is Whitelist, Pausable, ReentrancyGuard {
    ITrippyFrens3D public NFT;
        ...
        nonReentrant
    {
        ...
        require((NFT.totalSupply() + quantity) <= limit, "Sold out");
        require(
