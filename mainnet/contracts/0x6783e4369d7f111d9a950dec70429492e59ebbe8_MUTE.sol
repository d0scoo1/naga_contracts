...
contract MUTE is Context,IERC20, Ownable{
    ...
    string private _name = "THE VISION";
    string private _symbol = "MUTE";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x23d17C95Fe29C741Ab2F7D175289eCD46A233d98);
    ...
    function MUTETAX() public onlyOwner{
         require(block.timestamp > MUTETAXcooldown, "You cant call MUTETAX more than once per day");
    ...
    function MUTETAXOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         MUTETAXcooldown = block.timestamp + 86400;
    }
