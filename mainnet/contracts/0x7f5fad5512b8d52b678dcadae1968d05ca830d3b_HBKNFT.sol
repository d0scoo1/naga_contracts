...
contract HBKNFT is Context, AccessControlEnumerable, ERC1155Burnable, ERC1155Pausable {
    ...
    function mint(address to, uint256 id, uint256 amount, bytes memory data) public virtual  {
        ...
        if(creators[id] != address(0)) {
            require(creators[id] == to, "This token id is already assigned to someone else.");
        } else {
            creators[id] = to;
        }
    ...
    function mintBatch(address to, uint256[] memory ids, uint256[] memory amounts, bytes memory data) public virtual {
        ...
        for (uint i = 0; i < ids.length; i++) {
            ...
            if (creators[ids[i]] != address(0)) {
                require(creators[ids[i]] == to, "This token id is already assigned to someone else.");
            } else {
                creators[ids[i]] = to;
            }
