// Grace shall be found by those that abdicate from their sins.
...
contract SevenDeadlySins is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Seven Deadly Sins";
    string private constant _symbol = "LUST";
    uint8 private constant _decimals = 9;

    uint256 private _totalSupply = 7777 * (10 ** _decimals);
    ...
    address payable public marketingWallet = payable(0x3851a1aF62e453683BC6Fffd06b391dbE7fe6166);
    address payable public treasury = payable(0x3851a1aF62e453683BC6Fffd06b391dbE7fe6166);
