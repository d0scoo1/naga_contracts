...
contract BTCLoot is ERC721URIStorage, Ownable{
 
    event mint (address indexed minter, uint256 startWith, uint256 times);
    
    
    uint256 public totalMinted;
    uint256 public totalCount = 1001; //bruhTotal
    ...
    function purchase(uint256 _times) payable public mintEnabled {
        require(_times >0 && _times <= maxBatch, "mint wrong number");
        require(totalMinted + _times <= totalCount, "too much");
