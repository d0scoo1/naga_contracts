...
contract Pixelfers is Ownable, ERC721A, ReentrancyGuard {

  uint256 public collection_Size = 3500;
  uint256 public collection_Size_Free = 700;
  ...
  constructor(
  ) ERC721A("Pixelfer", "Pixelfer", max_Batch_Size, collection_Size, collection_Size_Free) {
  }
