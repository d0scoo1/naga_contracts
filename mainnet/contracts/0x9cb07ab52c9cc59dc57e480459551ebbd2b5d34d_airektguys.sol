...
contract airektguys is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmQ9xMFTv72tx1NVj8ezub4KYKTGuEXgFqaHLcSb2Cy1o9";
    ...
    constructor(
    ) ERC721A("ai rektguys", "rekt", 100, maxSupply) {
    }
