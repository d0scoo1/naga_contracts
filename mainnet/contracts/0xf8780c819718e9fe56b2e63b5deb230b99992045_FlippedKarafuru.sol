...
// File: contracts/FlippedKarafuru.sol
...
contract FlippedKarafuru is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcrZqLAArV1YCj3pUi3a41QRpkwDZH55e4Xh1gm2upvkm";
    ...
    constructor(
    ) ERC721A("FlippedKarafuru", "KARA", 100, maxSupply) {
    }
