// DiamondHandsElon (DHElon) a community driven ERC20 token.
 ...
 */
contract DHElon is Context, IERC20 {
    ...
    string private _name = 'Diamond Hands Elon';
    string private _symbol = 'DHElon';
