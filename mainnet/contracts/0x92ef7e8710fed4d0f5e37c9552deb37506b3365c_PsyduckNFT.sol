...
contract PsyduckNFT is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmYUgBGiqXQn2ExVVNi4jB9PeCWYXKCYDWXK7Eqdbex9sj";
    address private a1 = 0x9c3Ec9e1828b89ee4b71FAafFF01463E00CCAEb3;
    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmYUgBGiqXQn2ExVVNi4jB9PeCWYXKCYDWXK7Eqdbex9sj";
    ...
    constructor() ERC721A("Psyduck", "Psyduck") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 888, "Not enough free supply");
