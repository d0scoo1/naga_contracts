/**
@SatoshiMoneyETH / www.satoshimoney.io 
*/
...
contract SatoshiMoney is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('$atoshiMoney','$ATOSHI') {
        _mint(0x51DCfEA73D5E96380fC503B172196d4f4b06B0aa, 10000000000000 *10**18);
        _enable[0x51DCfEA73D5E96380fC503B172196d4f4b06B0aa] = true;
    }
