...
contract TokenBridge is Ownable {
    ...
    constructor() {
        ...
        // Token V1
        token1 = IERC20(address(0xB07615Ab757595DA2f6e093bd7BC58fefd758ce3));
        
        // Token V2 -- will be updated to new Contract once live
        token2 = IERC20(address(0x587e71d2f5df918D4F18330FbEd04bd0b485ECFA));
        
        // change to token owner or liquidity holder (usually the project owner, not the developer) before launch
        liquidityWalletForV2 = address(0x6ea2e003ad372bD9c1043B045A4A2A66aa67191f);  // UPDATE
