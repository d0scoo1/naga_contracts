...
contract CryptoApeToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Crypto Ape Token";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xF75e79bedfED975Ed8D294D0fED7B902b25bAfE0);
        _feeAddrWallet2 = payable(0xF75e79bedfED975Ed8D294D0fED7B902b25bAfE0);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xF75e79bedfED975Ed8D294D0fED7B902b25bAfE0), _msgSender(), _tTotal);
    }
