...
contract QOMAPE is Context, IERC20, Ownable {
    ...
    string private constant _name = "QOMAPE";
    string private constant _symbol = "QOMAPE";
    ...
    constructor () {
        _feeAddress = payable(0xc953e3CdE2f3759b5bCB25F7DCfCf87135E9c68F);
        _buyTax = 3;
        _sellTax = 3;
