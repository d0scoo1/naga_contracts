...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  abstract contract Allowlist is Ownable {
        ...
        , Allowlist
    {
        ...
        string private IPFSTokenURI = "ipfs://QmTweyQFMfDqzE91wwWs1Xu3XZfpaAYogmiFiXoaYj7Zma/";
        ...
        constructor(
            ...
            payableAddresses.push(0x416e61747862b0Ce660Ba84A22D7303C72540b22);
    ...
    // File: contracts/dinoDoodsContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract DinoDoodsContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Dino Doods", "DDOOD", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/ElwCWQh4c9DSrAreTLTW/contract-metadata";
        }
    }