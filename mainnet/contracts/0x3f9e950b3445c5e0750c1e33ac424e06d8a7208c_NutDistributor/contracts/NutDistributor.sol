...
contract NutDistributor is Governable, INutDistributor {
    ...
    function initialize(address nutAddr, address _governor, address oracleAddr, uint blocksPerEpoch) external initializer {
    ...
    function collect() external  {
        ...
        if (totalAmount > 0) {
            ...
            IERC20Upgradeable(nut).safeApprove(address(this), totalAmount);
            IERC20Upgradeable(nut).safeTransferFrom(address(this), lender, totalAmount);
        }
    }
