 ...
 */
contract FRCKTeamSale is Ownable {
    ...
    constructor(address _FRCKCollectionAddress, uint _maxVipSupply, uint _maxSupply){
     ...
     */
    function mint(uint amount) external validOrder(amount) onlyOwner() {
