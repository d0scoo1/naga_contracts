...
contract HelloKittie is IERC20, Auth {
    using SafeMath for uint256;

    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "HelloKittie";
    string constant _symbol = "HEKI";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0x4279413a0FD202899ABF3B610Ecc70D0472eae2A);
	    teamFeeReceiver = address(0x6C99d42C2b15A24dfdCf939b85b6B2393EC58B09);
