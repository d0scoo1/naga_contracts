...
contract DoodleXApes is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmZJ5uSSmv7nrdnDBEkRm7kwxLJu9JBZSALLisxDnqschY";
  ...
  ) ERC721A("Doodle x Apes", "Doodle x Apes") {
