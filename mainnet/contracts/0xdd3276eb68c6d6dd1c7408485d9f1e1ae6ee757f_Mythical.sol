...
contract Mythical is ERC721A, Ownable, ReentrancyGuard{
    ...
    /***** BREEDING ****/
    IERC721 godNft = IERC721(0x8572286096E14d040B09F3C56d9D60b41AA941f1);
    IERC721 goddessNft = IERC721(0x28C4Fd77b7459B29136B4b82b1B24d8aa6378D1b);

    uint immutable public SEED_GOD = 2;
    uint immutable public SEED_GODDESS = 1;
    uint256 public BREEDING_TIME = 5*60;
    uint256 public GOD_WAITING_TIME = 10*60;
