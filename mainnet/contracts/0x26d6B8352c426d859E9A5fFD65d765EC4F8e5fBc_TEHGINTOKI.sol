...
contract TEHGINTOKI is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TEH GINTOKI";
    string private _symbol = "TEH GINTOKI";
    uint8 private _decimals = 18;
    uint256 private _totalSupply = 10000000 * 10**_decimals;     

    uint256 private minimumTokensBeforeSwap = 5000000 * 10**_decimals;
    uint256 public _totalDistributionShares = 24;
    address payable public marketingwallet = payable(0x1c6AAB72076cC0d151348D5758A16190E52965E7);
    ...
    uint256 public _maxTxAmount = 400000 * 10**_decimals;  // max buy 4% 
