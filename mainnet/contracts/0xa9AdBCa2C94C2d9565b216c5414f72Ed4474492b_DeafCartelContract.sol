...
abstract contract TimedDrop is Ownable {
  ...
  uint256 public publicDropTime = 1654563600;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x5468141Aa8e5ea79e994Ab3442d96EDE6Edec93b,0xb954135A8b9d4F4A67348e6838B55b3DBCaf88E6];
  uint256[] public payableFees = [5,40,55];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmYMNoHTbTPy9hVShx9amFoUxcL8bMzduF6J9EBBKMEJLE/";
...
// File: contracts/DeafCartelContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DeafCartelContract is RamppERC721A {
    constructor() RamppERC721A("Deaf Cartel", "DEAF"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/sr6xKsoDMolk6ODizlPv/contract-metadata";
    }
}
