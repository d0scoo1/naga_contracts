...
contract FDJZ is ERC721A, Ownable, ReentrancyGuard {
    string public baseURI = "https://gateway.pinata.cloud/ipfs/QmVcAuv77vh4GGyfkM4LTqt4kbXatM3EHmgNDiGUzgfEB3";
    ...
    constructor() ERC721A("FUDSTER DEGENSNAKE JAZZ CLUB", "SpaceSnakeSsS"){}
    ...
    function mint(uint256 count) external payable {
        ...
        require(msg.value >= count * cost, "Please send exact amount");
        require(totalSupply() + count <= maxSupply, "None left");
