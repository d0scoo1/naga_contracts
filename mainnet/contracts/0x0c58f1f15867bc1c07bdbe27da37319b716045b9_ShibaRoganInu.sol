...
Telegram: https://t.me/ShibaRoganInu
...
contract ShibaRoganInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x847B02A3b16F21BA9a52CFE2532A689911a48A81); // Marketing Address

    address payable public liquidityAddress =
        payable(0x847B02A3b16F21BA9a52CFE2532A689911a48A81); // Liquidity Address
    ...
    string private constant _name = "ShibaRoganInu";
    string private constant _symbol = "ShibaRoganInu";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 15 / 1000; // 1.5% max txn
        minimumTokensBeforeSwap = _tTotal * 8 / 10000; // 0.08%
        maxWallet = _tTotal * 15 / 1000; // 1.5%
        ...
        marketingAddress = payable(0xEf65BA441f54ba18d43580d37a3F766371006f15); //  update to marketing address
        liquidityAddress = payable(address(0xEf65BA441f54ba18d43580d37a3F766371006f15)); // update to a liquidity wallet 
