...
contract TPsOniSHOGUNaC is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.000000005 ether;
  ...
  constructor() ERC721("TP ONI SHOGUN AC", "TOSC") {
    setHiddenMetadataUri("ipfs://QmNsCfQaYMyTPxmGKKDfYFWxeYLgbCoLSd4qYLBmMh8ZKp/hidden.json");
  }
