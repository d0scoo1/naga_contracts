...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a SDC shareholder!");
...
contract ShatteredDiamondCapital is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0x652E2f1a4d2f9571d2792016133E92EfA59c053c);
    address payable public treasury = payable(0x652E2f1a4d2f9571d2792016133E92EfA59c053c);
    ...
    constructor (    ) Auth(0x652E2f1a4d2f9571d2792016133E92EfA59c053c) {
        address _owner = 0x652E2f1a4d2f9571d2792016133E92EfA59c053c;
