...
//*********************************************************************//
//
//    ________.__                    __             .___   ________      ___.           
//   /  _____/|  |__   ____  _______/  |_  ____   __| _/  /  _____/  ____\_ |__   ______
//  /   \  ___|  |  \ /  _ \/  ___/\   __\/ __ \ / __ |  /   \  ___ /  _ \| __ \ /  ___/
//  \    \_\  \   Y  (  <_> )___ \  |  | \  ___// /_/ |  \    \_\  (  <_> ) \_\ \\___ \ 
//   \______  /___|  /\____/____  > |__|  \___  >____ |   \______  /\____/|___  /____  >
//          \/     \/           \/            \/     \/          \/           \/     \/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8D593C1c34Fb37C68399464F322b463f788a4406];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://Qmd5PS3sv4QCp1FtCrvUonXjR8tRL83sB7w1qbw3J85r7j/";
...
// File: contracts/GhostedGoblinsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GhostedGoblinsContract is RamppERC721A {
    constructor() RamppERC721A("Ghosted Goblins", "GOBB"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IRdwnfZAz16vqcVGb08g/contract-metadata";
    }
}
