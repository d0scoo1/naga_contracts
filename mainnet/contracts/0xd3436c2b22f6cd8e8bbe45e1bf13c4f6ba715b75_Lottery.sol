...
contract Lottery is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmT9giUDN6k5kmKN7DcxBM7nktTQFHh8qcoKex9ssZwaqG";
    ...
    constructor(
    ) ERC721A("Ether Lottery", "Lottery", 100, maxSupply) {
    }
