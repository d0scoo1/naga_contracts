/*
    ...
    Telegram :  https://t.me/WarmCapital         
...
contract WARM is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Warm Capital";//
    string private constant _symbol = "WARM";//
    ...
    address payable private _developmentAddress = payable(0xe5B67ed07fdb11c9861d3B90AD3E1557A14FBC2c);//
    address payable private _marketingAddress = payable(0xe5B67ed07fdb11c9861d3B90AD3E1557A14FBC2c);//
    ...
    uint256 public _maxTxAmount = 30000000 * 10**9; // 0.3% of total supply
    uint256 public _maxWalletSize = 100000000 * 10**9; // 1.00% of total supply
    uint256 public _swapTokensAtAmount = 10000000 * 10**9; // 0.1% of total supply
