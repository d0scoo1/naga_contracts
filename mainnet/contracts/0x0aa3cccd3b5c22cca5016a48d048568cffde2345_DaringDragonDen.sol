...
// File: contracts/DaringDragonDen.sol
...
contract DaringDragonDen is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("Daring Dragon Den", "DDD") {
        transferOwnership(0x0b0bed31F64af1f4A17A2F9659b58C430034526f);
    }

    function _baseURI() internal view virtual override returns (string memory) {
        return "https://api.daringdragonden.com/";
    }
   ...
   function mint(uint256 amountToMint) public payable {
        ...
        require(DRAGONS_PRICE * amountToMint == msg.value, "Incorrect Ether value.");
