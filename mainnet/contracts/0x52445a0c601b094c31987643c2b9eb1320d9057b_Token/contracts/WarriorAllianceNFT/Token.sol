...
contract Token is ERC20Upgradeable, OwnableUpgradeable {
    ...
    function _blacklist(address account, bool isBlacklisted) private onlyOwner {
    ...
    function _buyAndBurnHati(uint256 amount) public {
        ...
        path[0] = address(this);
        path[1] = uniswapV2Router.WETH();
        path[2] = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; // USDC token
        path[3] = 0x251457b7c5d85251Ca1aB384361c821330bE2520; // HATI token
