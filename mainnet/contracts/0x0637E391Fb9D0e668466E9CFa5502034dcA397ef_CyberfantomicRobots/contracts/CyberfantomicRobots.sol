...
contract CyberfantomicRobots is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmeuSSeHygUi7vz8AS4JDd4PrUkTBM79SnVSew494hPu3d";
  ...
  ) ERC721A("Cyberfantomic Robots", "Cyberfantomic Robots") {
