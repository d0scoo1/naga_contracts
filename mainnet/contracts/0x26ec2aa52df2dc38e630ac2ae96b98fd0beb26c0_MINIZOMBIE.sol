...
Without a well prepared platoon of organized veteran fighters. There simply is no way for survivors to defeat this MiniZombie army. With the enormous number of MiniZombie, there is no guarantee you're not surrounded, thus your only option is to JOIN the Minizombie army!
MiniZombie token is dedicated to present you a deflationary experience! This token is designed with a deflationary mechanism, 5% of our token will be automatically burned to ensure the stability and prospect of the token. We believe that this token will grow exponentially like how zombies grow rapidly. 

MiniZombie is going to be the deadliest and viral token you have ever seen!
...
contract MINIZOMBIE is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "MINI ZOMBIE INU";
    string private constant _symbol = "MINIZOMBIE";
    ...
    address payable private _marketingAddress = payable(0x6f8954F7c7Fdd97e2900C7c5A5Cd05c22E4cd59A);
    ...
    uint256 public _swapTokensAtAmount = 1002 * 10**9;
