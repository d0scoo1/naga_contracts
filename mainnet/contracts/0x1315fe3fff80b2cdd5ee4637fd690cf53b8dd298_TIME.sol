...
Teh ever growing Ponzi, or you get paid. Every buy re-triggers the timer, if the timer runs out, last buyer wins.
Website
https://tehgiftoftime.net

Telegram
https://t.me/GiftofTime
...
contract TIME is ERC20, Ownable {
    ...
    uint256 public maxTxLimit = _tTotal.mul(175).div(10000);         // 1.75% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(250).div(10000);    // 2.50% of total supply
    ...
    constructor(address _dev) public ERC20("Teh Gift of Time", "TIME") {
