...
contract FameLadySquadPowerPass is AMPowerPassCore{
  string public name = "Fame Lady Squad: Power-Pass Plus";
  string public symbol = "AM: FLS";
  ...
  constructor()
    ...
    setToken( 0,
      "Fame Lady Squad: Power-Pass Plus",
      "https://herodev.mypinata.cloud/ipfs/QmctGRRtUnyh9ogZgCjgw4mG2v58RSuJJMFqNzw4jfB7Y1/fame-lady-squad.json",
      false, 0,
      false, 0.05 ether,
      10000 );
    ...
    setAccessCollection( IBalance(0xf3E6DbBE461C6fa492CeA7Cb1f5C5eA660EB1B47) );
  }
}
