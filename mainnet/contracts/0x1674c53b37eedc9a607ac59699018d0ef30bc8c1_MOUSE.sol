...
$MOUSE - Meet the CHEDDA Killer

www.mousetoken.net
t.me/mousetoken
twitter.com/mousetokenerc

MOUSE has unique flexible tokenomics. Meaning, the dev team will adjust the tokenomics to accustom the needs of the token and its community.

The initial taxes (9%) will go to marketing. Later on, taxes will be utilized for liquidity, reflections and development as well.
...
contract MOUSE is Context, IERC20, Ownable {
    ...
    //
    string private _name = "Mouse Token";                                           // name
    string private _symbol = "MOUSE";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xCBc3fD5067cED6F9839F3bF9dCd3e0C67c29C2e1);
