...
contract ProfitDistribution is Ownable {
    ...
    Payee public reserve; 
    Payee public platform; 
    Payee[] public distributors;
    Payee[] public persons;

    Distributor[] public distributorInfo;
    Order[] public orders;

    mapping(address => Distributor[]) affiliated; 
    ...
    function splitAccount(uint256 _orderId, uint256 _amount, address payable _distributorAddress) public {
        ...
        uint256 _distributorAmount = _amount * (share.distributor * 100) / 10000; 
