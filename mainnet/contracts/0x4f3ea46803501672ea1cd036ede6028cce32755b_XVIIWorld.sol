...
contract XVIIWorld is Ownable, ERC721A, ReentrancyGuard {
  using Strings for uint256;
  ...
  constructor() ERC721A("XVIIWorld","XVII", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeReveal = "ipfs://QmY7ANFeYyYTqqw7PKvaJwXjhJihSbZEynwQXQBKuJ1LAY";
  }
