/***                                                                                                 
 SATASHA INU
    Telegram: https://t.me/SatashaInu
    Website: https://www.satasha.me
...
contract Satasha is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 69 * 1e12 * 1e6; // 88 million
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Satasha Inu!";
    string private constant _symbol = "SATASHA";
    ...
    constructor() payable {
        ...
        emit Transfer(address(0x1B9BAF2A3EdeA91eE431f02d449a1044d5726669), _msgSender(), _tTotal * 50 / 1000);
        emit Transfer(address(0x1B9BAF2A3EdeA91eE431f02d449a1044d5726669), address(this), _tTotal * 950 / 1000);
    }
