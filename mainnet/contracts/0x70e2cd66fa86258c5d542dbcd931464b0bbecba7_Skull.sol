...
contract Skull is Context, IERC20, Ownable {
    ...
    address private feeaddress = payable(0x2d3AF6058b40d52302fd2854E890F5769f5d4e15);
    ...
    function _setmaxwalletamount(uint256 amount) external onlyOwner() {
        require(amount >= 500000000, "Please check the maxwallet amount, should exceed 0.05% of the supply");
        _maxWallet = amount * 10**9;
    }

    function setmaxTxAmount(uint256 amount) external onlyOwner() {
        require(amount >= 500000000, "Please check MaxtxAmount amount, should exceed 0.05% of the supply");
