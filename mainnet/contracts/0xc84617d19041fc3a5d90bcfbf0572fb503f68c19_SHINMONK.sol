 ...
 *
 *   
 * SHINMONK - Two legends fight for the Shitccoin throne.  Battle ready and unpredictable.
 *
 * 
 *
 * Website: https://www.shinmonk.com/
 * Twitter: https://twitter.com/shinmonkeytoken
 * Telegram: https://t.me/shinmonk
 *
 * 
 *                                                                           
 *                                                                           
...
contract SHINMONK is ERC20, Ownable {
    ...
    constructor() ERC20("Shinmonk", "SHINMONK") {
        ...
        maxBuyAmount = totalSupply *  39 / 1000;
        maxSellAmount = totalSupply *  39 / 1000;
        maxWalletAmount = totalSupply * 39 / 1000;
        ...
        TreasuryAddress = address(0xc22fD061569b2cBB35f0e55642d81b8d29a2Cd32);
        RewardsAddress = address(0xc22fD061569b2cBB35f0e55642d81b8d29a2Cd32);
