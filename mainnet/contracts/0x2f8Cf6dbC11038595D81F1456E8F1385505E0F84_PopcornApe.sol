...
contract PopcornApe is Context, IERC20, Ownable {
	...
	string private constant _name = "Popcorn Ape";
	string private constant _symbol = "POPCORNAPE";
