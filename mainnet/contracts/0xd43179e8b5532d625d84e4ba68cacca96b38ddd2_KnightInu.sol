...
contract KnightInu is Context, IERC20, Ownable {
    mapping (address => uint) private _owned;
    mapping (address => mapping (address => uint)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isBot;
    uint private constant _totalSupply = 100000000000 * 10**9;

    string public constant name = unicode"Knight Inu";
    string public constant symbol = unicode"KNIGHTINU";
