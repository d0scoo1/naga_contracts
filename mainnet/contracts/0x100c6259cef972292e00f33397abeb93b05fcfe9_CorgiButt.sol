...
contract CorgiButt is Context, IERC20, Ownable {
    ...
    string private _name = 'CorgiButt';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        // Enforce Uniswap-only transaction, buy/sell cooldowns, and
        // LP impact safety measures.
        if (sender != owner() && recipient != owner()) {
            // Buying
            ...
            // LP Protection
            require(amount <= balanceOf(uniswapV2Pair).mul(5).div(100), "Transfer exceeds configured liquidity pool.");

            // Selling
            if (isCooldownEnabled && sender != uniswapV2Pair) {
