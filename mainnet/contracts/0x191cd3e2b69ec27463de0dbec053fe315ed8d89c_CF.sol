...
contract CF is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTaqS52BF6ZnNCXhVB8hMCZgrEUwKhw8DZ5LEubFUioTR";
    ...
    constructor(
    ) ERC721A("Chain Fighter", "CF", 100, maxSupply) {
    }
