...
📘 Information:
#mShiba - The MetaVerse of Shiba Inu 🔥

Built on the Ethereum Chain, $mShiba is an ERC20 token with numbers of impressive features. 
Firstly, there is a Black Hole design that exponentially cuts the total supply in circulation by massive amounts. 
Secondly, $mShiba combines this with an innovative Auto-Liquidity feature that increases liquidity of the token rapidly. 
And finally, $mShiba holders will receive more $mShiba tokens just by simply holding the token in their wallet.


🔥 Social links:
Website: https://metaverseofshiba.io/
TG Announcements: https://t.me/metaverseofshiba_ann
TG Chat: https://t.me/metaverseofshiba
...
contract ERC20 is Context, IERC20, IERC20Metadata , mShibaEth{
...
contract mShiba is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 100000000 * 10 ** 18;

    constructor () ERC20('Metaverse of Shiba', unicode'mShiba') {
