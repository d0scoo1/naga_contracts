...
contract HeatherMorganInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Heather Morgan Inu";//
    string private constant _symbol = "HMI";//
    ...
    address payable private _developmentAddress = payable(0x6D87BdA4DE99270d980C78052B71e1428462F6e9);//
    address payable private _marketingAddress = payable(0x2e0F1912C3bACb60e873B84c2AF374A0f3D08BfA);//
