...
contract EagleDAO is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "EagleDAO";//
    ...
    address payable private _developmentAddress = payable(0xd5cF9B0d697E8CbEC89fBFa3A7285097bc7bf562);//
    address payable private _marketingAddress = payable(0x256Bf431732a509a728132F2a599FC6307C1161B);//
