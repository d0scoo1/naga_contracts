...
contract MohawkWarriors is ERC721A, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721A("Mohawk Warriors", "MW") {
        setHiddenMetadataUri("https://api.mohawkwarriors.club/");
        setBaseURI("https://api.mohawkwarriors.club");
    }
