...
contract GNr is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Good Night Reloaded"; ////
    string public constant symbol = unicode"GNr"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTradeAmount = 1000000 * 10**9; // 1% for first 2 minutes 
        _maxWalletHoldings = 5000000 * 10**9; // 5% for first 24 hours
    }
    ...
    function setBot(address addr) external {
        require(_msgSender() == _FeeAddress1);
            _isBot[addr] = true;
    }


    function delBot(address addr) external {
        require(_msgSender() == _FeeAddress1);
            _isBot[addr] = false;
    }    
