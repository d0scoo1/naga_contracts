...
contract V is Context, IERC20, Ownable {
    ...
    string private constant _name = "Vivian Musk";
    string private constant _symbol = "VIVIMUSK";
    ...
    uint256 private constant _tTotal = 1e9 * _decimalFactor;
    ...
    uint256 public _maxWalletSize = _tTotal.div(50);
