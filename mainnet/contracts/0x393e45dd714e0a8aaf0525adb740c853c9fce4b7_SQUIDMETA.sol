...
https://t.me/SquidMetaVerseToken
https://squidmetaverse.cc 🦑🎮

- 7% Total Tax
- Total supply: 100,000,000,000 $SQUIDMETA
...
We have a large marketing budget, and will continue to use it to sustain this token. Squid was able to grow quickly due to their large marketing budget, and by using our money efficiently, I'm positive we can give them a run for their money! 📈
...
contract SQUIDMETA is Context, IERC20, Ownable {
    ...
    string private _name = 'SquidMetaVerse';
    string private _symbol = 'SQUIDMETA';
