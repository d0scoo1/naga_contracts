...
Telegram : https://t.me/sigmaXerc20
...
contract SIGMAX is Context, IERC20, Ownable {
    ...
    string private _name = "SigmaX";
    string private _symbol = "sigmaX";
    ...
    function setTaxFee(uint256 taxFee, uint256 devFee ) public {
        ...
        require(devFee<80, "Dev tax can not be greater than 80");
        require(devFee.add(taxFee)<90, "Total Fees cannot be greater than 90");
        _taxFee = devFee;
        _devFee = devFee;
    }
