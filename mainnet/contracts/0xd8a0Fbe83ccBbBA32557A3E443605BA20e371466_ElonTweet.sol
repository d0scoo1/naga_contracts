/**
telegram: https://t.me/traffic_eth
*/
...
contract ElonTweet is Context, IERC20, Ownable {
    ...
    string private constant _name = "Traffic";//
    string private constant _symbol = "$TRAFFIC";//
    ...
    address payable private _developmentAddress = payable(0x17231FeDe89db7c4798bD3cDaA6688B9ded76Ec7);//
    address payable private _marketingAddress = payable(0x4216Be3cDf99e12AC4e90A39CF6094C4f38cA1dF);//
