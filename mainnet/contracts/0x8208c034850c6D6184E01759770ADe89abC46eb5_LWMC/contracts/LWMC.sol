...
contract LWMC is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmZAxcdRGW2cpu4tCVZPpmUfxZ4tEnZMo22t7WXxBMXgqm";
  ...
  ) ERC721A("Liquid Weird Monsters Club", "LWMC") {
