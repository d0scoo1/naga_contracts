// FullSendElon (FSELON) is a deflationary token which decreases in supply ever transaction.
// Holders earn passive FSELON through every transaction.
 ...
 */
contract FullSendElon is Context, IERC20 {
    ...
    string private _name = 'FullSendElon';
    string private _symbol = 'FSELON';
