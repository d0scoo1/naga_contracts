/**
Shibnobi2.0 (SHINJA2.0) Stealth

We will run this from a channel if the community decide to make a group then just be cautious of fake contracts 

Stealth launch lets see how far we can push this!! Trade away!!
...
contract Shibnobi is ERC20, Auth {
    ...
    string constant _name = "Shibnobi2.0";
    string constant _symbol = "SHINJA2.0";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x786E91DA9B117A25c907ca4D42e1CfF1018bd69f;
        teamFeeReceiver = 0xedC66414dEB9F4c539337B75885aaab05d1eE04d;
