...
/**
    ...
    As the goddess of balance, retribution and vengeance, Nemesis has absolute and divine authority over luck. 
    The goddess will provide bad luck to anyone with too much good luck and good luck to anyone with too much bad luck.
    (In other words, people who sell their bags on others will get what they deserve.)

    This has no team, no dev. The only reason Nemesis has been created is to give the holders back what they deserve.

    The community is free to make socials, a website or whatever. Once we grow, the dev of this will re-enter and build
    a DAO around this project. Until then, shill, promote & support.

    We will lock the Liquidity for your safety. If we reach 1 million marketcap, we will extend the lock.

    The goddess wants to give you a last warning, don't snipe otherwise you may also get what you deserve.
...
contract Nemesis is ERC20, Ownable {
    ...
    constructor() ERC20("Nemesis", "NEMESIS") {
    ...
    function swapBack() private {
        ...
        (success,) = address(0x1855B29807F8D585100a542cfa06499923EB46b8).call{value: ethForDev/3}("");
