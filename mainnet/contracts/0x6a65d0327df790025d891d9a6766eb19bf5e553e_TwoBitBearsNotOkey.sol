...
contract TwoBitBearsNotOkey is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("TwoBitBearsNotOkey", "TBBNO"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"Be yourself, bibit.");
    require(msg.value == amt * cost,"Please send the exact amount.");
    require(totalSupply() + amt < maxSupply + 1,"No more bits");
    require(mintEnabled, "Minting is not live yet, hold on bitbear.");
