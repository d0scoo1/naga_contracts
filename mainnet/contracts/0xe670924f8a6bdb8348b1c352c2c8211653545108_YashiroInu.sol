...
contract YashiroInu is Context, IERC20, Ownable {
    ...
    string private _name = "Yashiro Inu";
    string private _symbol = "Yashiro";
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner() {
         require(taxFee <= 25, "Maximum fee limit is 25 percent");
        _taxFee = taxFee;
    }
    
    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner() {
        require(liquidityFee <= 25, "Maximum fee limit is 25 percent");
