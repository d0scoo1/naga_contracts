/*
                        Aethera et Terra
                         ...
                         Origo doloris:
                Deceptio, Ira, Luctus, mendacium
        Vindicta, Luxuria, Rixae, Oblivionis, Desidiae, Timoris.

        Hoc tempus inexplicabile, immortale auxilium, genuit

            Aut chasma magnum, vastum huc atque illuc;

    nullus infra se modus, nullus ignobilis, nullus locus ad componendum
...
contract AETHER is Context, IERC20, Ownable {
    ...
    string private constant _name = "Aether";
