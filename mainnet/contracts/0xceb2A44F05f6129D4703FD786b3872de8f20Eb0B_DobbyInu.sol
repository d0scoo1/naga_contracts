/**
 ...
 | |  | |/ _ \| '_ \| '_ \| | | |   | | | '_ \| | | |
 | |__| | (_) | |_) | |_) | |_| |  _| |_| | | | |_| |
 |_____/ \___/|_.__/|_.__/ \__, | |_____|_| |_|\__,_|
                            __/ |                    
                           |___/                     
                           
Welcome to Dobby Inu, your favorite house elf token !
...
contract DobbyInu is Context, IERC20, Ownable, Pausable {
  ...
  string private _symbol = "Dobby Inu";
  string private _name = "DOBBY";
