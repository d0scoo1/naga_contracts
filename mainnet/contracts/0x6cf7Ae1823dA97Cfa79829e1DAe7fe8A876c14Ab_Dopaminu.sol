...
Telegram: https://t.me/Dopaminu

Website: http://www.dopaminu.com
 * */
 ...
 contract Dopaminu is Context, IERC20, Ownable {
     ...
     string private constant _name = "Dopaminu";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x882AB1268690728DE08cFe7773Bf4886b74a3693);
         _feeAddrWallet2 = payable(0x882AB1268690728DE08cFe7773Bf4886b74a3693);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x882AB1268690728DE08cFe7773Bf4886b74a3693), _msgSender(), _tTotal);
     }
