...
| $$    $$| $$_____/| $$      | $$_____/| $$  | $$| $$      | $$  | $$| $$ | $$ | $$      | $$  | $$| $$  | $$| $$  | $$
|  $$$$$$/|  $$$$$$$| $$      |  $$$$$$$| $$$$$$$/| $$      |  $$$$$$/| $$ | $$ | $$      | $$$$$$$/| $$  | $$|  $$$$$$/
 \______/  \_______/|__/       \_______/|_______/ |__/       \______/ |__/ |__/ |__/      |_______/ |__/  |__/ \______/ 
                                                                                                                        
                                                                                                                        
                                                                                                                                                                                                                                                                                                                                                                         
🧠Welcome to Cerebrum DAO ($CEREBRUM)!🧠
World First DeFi Multi-chain Farming Deflationary Token with passive income generation in ETH! 📈
Cerebrum DAO it's a community-run ERC-20 token with unique tokenomics to ensure long term sustainability!🔥

Telegram:
https://t.me/CerebrumDAO
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a CEREBRUM shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract CerebrumDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Cerebrum DAO";
    string private constant _symbol = "CEREBRUM";
    ...
    address payable public marketingWallet = payable(0xF8FB38ce590e4E78586226A9E43C5E2Cb032225D);
    address payable public treasury = payable(0x5e2044F984C8121A94427e8D14301f28bb481aDB);
