...
contract boredlife is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmTtVjHMhvxeW7fMSyVKworEo1DYV9mGHaE6W1vJwHGVVN";

  uint256 private maxSupply = 4444;
  uint256 public  MAX_MINTS_PER_TX = 10;
  uint256 public  FREE_MINTS_PER_TX = 2;
  uint256 public  PUBLIC_SALE_PRICE = 0.004 ether;
  uint256 public  TOTAL_FREE_MINTS = 444;
  bool public isPublicSaleActive = true;

  constructor(

  ) ERC721A("boredlife.wtf", "boredlife.wtf") {
