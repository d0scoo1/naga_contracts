...
// File: contracts/ApeApes.sol

// These will not reveal. The art is in your hearts.
...
contract ApeApes is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
...
uint256 public freeMaxSupply = 500;
...
constructor() ERC721A("Ape Apes", "ApeApes") {setHiddenMetadataUri("ipfs://tyfkrz37dg4uvi7haswz5icpxlx4fi3dnyxdge5ty5qe3mltuinli0ioevm");}
