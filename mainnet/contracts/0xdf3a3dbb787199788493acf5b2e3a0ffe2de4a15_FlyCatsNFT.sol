...
contract FlyCatsNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Fly Cats NFT", "FCN") {
    setHiddenMetadataUri("ipfs://QmWafyE2HpM9NwFdHVFnmAzGXJmzTcGPAbDctuv5dPm5Za/hidden.json");
  }
