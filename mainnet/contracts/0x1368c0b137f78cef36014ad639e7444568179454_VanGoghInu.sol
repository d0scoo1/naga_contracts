/** 
 * https://vangoghinu.com/
 * https://t.me/vangoghinu
 * 
...
contract VanGoghInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "VanGogh Inu";
    string private constant _symbol = "VGI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x361E18d64ae7D9aB2Ad22e0133A68C994218140E);
        ...
        emit Transfer(address(0x361E18d64ae7D9aB2Ad22e0133A68C994218140E), _msgSender(), _tTotal);
    }
