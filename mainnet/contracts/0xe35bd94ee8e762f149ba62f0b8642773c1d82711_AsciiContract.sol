...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPG3MDFxoeTTQ5sXZmzScuphvFSJ9dvsN391wmAaXXeLH/";
...
// File: contracts/AsciiContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AsciiContract is RamppERC721A {
    constructor() RamppERC721A("ASCII", "ASCII"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/iX7zFy6wojdEm5xIhAuk/contract-metadata";
    }
}
