...
// File: contracts/babyRabbits.sol
...
contract BabyRabbits is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Baby Rabbits", "BR") {
    setHiddenMetadataUri("ipfs://QmZSsjwk1199WGjEwoXWw1PaBWnYXRRu6DVrN3JEKsKtvL/hidden.json");
  }
