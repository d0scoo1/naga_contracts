...
Fees: 0% on buy & 10% on sell, Some of the funds will be used for marketing.
*/
...
contract DeclineCrypto is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "DeclineCrypto";//
    string private constant _symbol = "DECLINE";//
