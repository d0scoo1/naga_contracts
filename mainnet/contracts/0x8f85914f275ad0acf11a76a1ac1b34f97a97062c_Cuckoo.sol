...
contract Cuckoo is ERC20, Ownable {
    ...
    constructor() ERC20("Cuckoo", "CUCK") payable {
        ...
        buyDevFee = 2;
        buyMarketingFee = 4;
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyDevFee + buyMarketingFee;

        sellOperationsFee = 2;
        sellLiquidityFee = 2;
        sellDevFee = 2;
        sellMarketingFee = 4;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevFee + sellMarketingFee;

        operationsAddress = address(0x56577b4E605B0C1074033c6Befbd66C6272be5E1);
        DevAddress = address(0x210Bf63c7CA60a40DCAcD4BaF1e63d6979aB5247);
        MarketingAddress = address(0x028040557b9994487982a402711f474fE450D672);
        futureOwnerAddress = address(0xDa32beF0F8C04894dEdE38AFF1f8a86C428e0DF2);
    ...
    function getPrivateSaleMaxSell() public view returns (uint256){
        ...
        return amounts[1] + (amounts[1] * (sellDevFee + sellMarketingFee + sellOperationsFee + sellLiquidityFee))/100;
    }
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _DevFee, uint256 _MarketingFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _DevFee, uint256 _MarketingFee) external onlyOwner {
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        dexRouter.addLiquidityETH{value: ethAmount}(
            ...
            0, // slippage is unavoidable
            address(0xDa32beF0F8C04894dEdE38AFF1f8a86C428e0DF2),
            block.timestamp
        );
    }
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForDev + tokensForMarketing;
        ...
        ethForLiquidity -= ethForOperations + ethForDev + ethForMarketing;
