...
contract degentoonbirdz is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSSBkAVD24oCZ6AzM4eGRMkY5wnMJkPEdJwzCUkYhdzQY";
    ...
    constructor(
    ) ERC721A("degentoonbirdz", "degen", 100, maxSupply) {
    }
