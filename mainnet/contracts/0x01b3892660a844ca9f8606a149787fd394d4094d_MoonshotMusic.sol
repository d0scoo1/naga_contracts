...
contract MoonshotMusic is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmcfM43Q24sygM2yLrVytU59n2QLvHGcPwSEKzWLB6R9Qd";
    ...
    constructor(
    ) ERC721A("MOONSHOT MUSIC", "MOONSHOT", 100, maxSupply) {
    }
