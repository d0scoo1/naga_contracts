...
/*
 ...
 Social Experiment, As You Know, Community is all on a project, we don't need only Paid Call & Call to make Pump & Dump.

 Community will make the TG for TTC, I will found it for sure as I'm on all chat and Crypto Gems Founder.

 Shill the project, Spread The Words, and let's pump it.

 LP will be locked, on team.finance.

 Ownership will be renounced at launch too.

 Max buy : 2%
 Max Wallet : 4%

 Trust the process, trust the community and let's shill it everywhere and make money together. We will act as simply holders.

 This Is A Community Driver Project, Make A TG, Make A Twitter, be ready to take-off.

 Let's shill this organically and moon this.
...
contract TrustTheCommunity is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"TrustTheCommunity"; ////
    string public constant symbol = unicode"TTC"; ////
