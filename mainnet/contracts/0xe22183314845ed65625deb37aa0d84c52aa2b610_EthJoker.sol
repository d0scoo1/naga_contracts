...
contract EthJoker is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"EthJoker"; ////
    string public constant symbol = unicode"EthJoker"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 1000000 * 10**9; // 3%
        _maxHeldTokens = 1000000 * 10**9; // 3%
    }
