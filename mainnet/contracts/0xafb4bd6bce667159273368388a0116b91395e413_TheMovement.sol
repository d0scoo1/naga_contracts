...
Idea behind movement is that community acts as decision makers and team.
With contract renounced and liquidity locked $MVNT is a safe investment for everyone.
$MVNT features a 5% liquidity tax on buys and sells.

There is no team tax/team wallets.

All you need to do is buy a bag and forward the info about the token to the next person.

Official Telegram : https://t.me/MVNTTOKEN
*/
...
contract TheMovement is Context, IERC20, Ownable {
    ...
    string private _name = "The Movement";
    string private _symbol = "MVNT";
    ...
    uint256 public _maxWalletSize = 840000000000 * 10**9;
