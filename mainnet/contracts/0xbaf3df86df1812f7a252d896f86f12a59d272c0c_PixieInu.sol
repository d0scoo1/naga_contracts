...
contract PixieInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "PixieInu";                                           // name
    string private _symbol = "PixieInu";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xece120aF1FE2Fc169d0e08282A3a01b09DBE3ec4);
