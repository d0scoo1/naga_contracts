// File: contracts/DisaTok (Final)/utils/Context.sol
...
// File: contracts/DisaTok (Final)/contracts/Ownable.sol
...
// File: contracts/DisaTok (Final)/IERC20.sol
...
// File: contracts/DisaTok (Final)/extensions/IERC20Metadata.sol
...
// File: contracts/DisaTok (Final)/DISATOK.sol
...
contract DisaTokDemo is Ownable, IERC20, IERC20Metadata {
    ...
    //tuleva accounts
    //address private _accountFee = 0xE8B93F214Ca6B00447f9d5965e0509CB4Ca482e7; //0x7554CEA927C9D9b0329470d73aD4D03533Ce9538
    //address private _accountSales = 0x897177F83A5fd2C5291468D9f912c1115f74917f; //0xA267ffeAD14B0F302e6AA10f156Ad41D17d2278D
...
*/
    ...
    function _transfer(
        ...
        if(noFee){
            ...
            uint fee = calculateTaxFee(amount);
