// Defi Dodo Good is a DApp that you can collect, trade, and build your Demi army. Mint rare Gamefi NFT’s with different attributes like weapons, amulets and more.
// Designed to revolutionize the traditional NFT space. Stake your tokens or earn a passive reward from holding your NFT.
...
// 
// ⚔️ WHY Defi Dodo Good? ⚔️
// •   Bringing the future to Defi with 3D designed characters with uniquely attributed NFT classes.
// •   NFT’s will have a limited minting supply for each class growing more in value as more people fuse and collect the NFT’s.
// •   Each Demi will have its on unique attributes specific to its class. Like amulets, armor and aura’s
// •   Use your character in a strategic battle simulator and prove your NFT’s true strength in the Arena!
// 
// ✔️ True developments
// ✔️ Devs Have Long Term Plans
// ✔️ Project Has Roadmap & Whitepaper
// ✔️ Experienced Dev Team
// ✔️ Vested Development Wallet
// ✔️ Rug proof
// ✔️ Gamefied NFT's

// 💠 Main links:
// Telegram: https://t.me/DefiDodoGod
// Website: https://defidodogood.com
...
contract DefiDodoGod is Context, IERC20, Ownable {
    ...
    string private _name = 'Defi Dodo God';
