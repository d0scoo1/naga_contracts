...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x4a3aabF9B3B3199CA6a785F00d2497A23e1701d3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWuHqVD8pE6pTgnSbQHh1iMvoeZWko4DTStTPpzqaNxmW/";
...
// File: contracts/BoredApeSwagClubContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract BoredApeSwagClubContract is RamppERC721A {
    constructor() RamppERC721A("Bored Ape Swag Club", "BASC"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YmNHm3S6PTeBQDSyKfvm/contract-metadata";
    }
}
