//Website - https://azukid.io
//Opensea - https://opensea.io/collection/azukid-dao
//Twitter - https://twitter.com/AzukidNFT
//Discord - https://discord.gg/jpntXxUecT
//$AZK
...
contract AzukidDao is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "Azukid DAO";
    string private _symbol = "AZK";
    ...
    address payable public marketingWallet = payable(0x819E51c611C5d0701748e57204c67F5F63809dFC);
