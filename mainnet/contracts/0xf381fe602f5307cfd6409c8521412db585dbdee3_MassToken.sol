...
contract MassToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    
    string private _name = "Mass Token";
    string private _symbol = "M";
    uint8 private _decimals = 18;

    address payable public marketingWalletAddress = payable(0x33066D4C96cBcEb7be3667d51A40279707D2C668);
    ...
    uint256 public _maxTxAmount =   _totalSupply.mul(1).div(1e3);  //1%
