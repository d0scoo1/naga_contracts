...
contract DOGGOS is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGGOS";
    string private constant _symbol = "DOGGOS";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        require(!_isBot[from], "Please contact Doggos team on Telegram.");
    ...
    function LaunchDoggos(address payable feeAddress) external onlyOwner() {
