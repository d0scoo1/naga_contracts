/**
We are Memebank. We are not your average bank.
...
Website: https://memebanktoken.com/

Telegram: https://t.me/memebankERC
...
contract Memebank is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "MemeBank";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x2944a74173c8C53403AB69e267295E2e695d3260);
        _feeAddrWallet2 = payable(0x2944a74173c8C53403AB69e267295E2e695d3260);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xd2bb41124A9754dbd6349d0b672891fd74e7F0b3), _msgSender(), _tTotal);
    }
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = 300000000000000 * 10 ** 9;
        tradingOpen = true;
