...
Live by the ETH die by the ETH. We used mixers to preserve our anonymity in this blockchain for eternity. This is the atmosphere
we thrive in. 

We live here and intend to die here, with nothing but our legacy left behind for future generations to prosper with.
...
contract LifeOfETH is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "Live by the ETH die by the ETH";//////////////////////////
    ...
    address payable private _developmentAddress = payable(0x65752dF4D7498096D48Db395Fb30A449283DF9a8);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x65752dF4D7498096D48Db395Fb30A449283DF9a8);///////////////////////////////////////////////////
