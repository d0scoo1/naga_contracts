...
The Shiba predator is back, with a new vision for mankind... 

Tokenomics remain the same: 0% tax 
94% of the supply will be added to liquidity.
The remaining 6% will be divided between the team. 

Note: remember to use low slippage 
...
contract ShibaPredator2 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Shiba Predator 2.0";
    ...
    address payable private _marketingAddress = payable(0x8eB9b231523c41d63045bef12EA38820600BF22d);
