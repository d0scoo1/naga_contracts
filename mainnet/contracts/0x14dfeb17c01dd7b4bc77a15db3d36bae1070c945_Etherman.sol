...
contract Etherman is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa1052dd4F3Dd989Bd2337f24CAF285c4A9093e78); // Marketing Address
    ...
    string private _name = "The Etherman";
    string private _symbol = "E$hield";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xa1052dd4F3Dd989Bd2337f24CAF285c4A9093e78);
    }
