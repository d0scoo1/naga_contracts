...
contract DubaiBitchGoblin is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 6969;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmUmWFVnRb8xCgMGrsEteEG7GqCMSCauQa8q39QwK33XTU/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("DubaiBitchGoblin", "DGB", MAX_MINTS, MAX_SUPPLY) {  
    }
    

    function MintFreeBitch(uint256 numTokens) public payable {
