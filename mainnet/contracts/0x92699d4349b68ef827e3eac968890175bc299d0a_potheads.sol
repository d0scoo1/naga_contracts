...
/**
POTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
GET HIGH WITH POTHEADS 420!

Roll ‘em up and light ‘em good!  It’s 4/20 Day, and you know what that means!  New event and new hype for the ETH community!  Come join us as we celebrate this notorious but very much fun occasion where every minute is an All Time High!
...
No Max Tx & Wallet - ape as much POT as u like !!!

TG: http://t.me/potheads420erc

HEADSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
*/
...
contract potheads is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 420 * 10**_decimals;
    ...
    string private constant _name = "Potheads 420";
