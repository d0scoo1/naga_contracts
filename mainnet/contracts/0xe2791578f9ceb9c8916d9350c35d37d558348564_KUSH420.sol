...
contract KUSH420 is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0x8AF0366D57dd904d5d788D1588672f783234F2eb);
    address payable private _marketingAddress = payable(0x87df5bEA88dcb38E523AB74E9Ee21BcD19E6E7A2);
    
    string private constant _name = "KUSH420";
    string private constant _symbol = "KUSH420";
