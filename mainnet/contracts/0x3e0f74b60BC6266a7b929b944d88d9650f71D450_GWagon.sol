...
contract GWagon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100 * 100000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "GWagon";
    string private _symbol = "GWGN";
    ...
    address public immutable burnAddress = 0x7eE0733688824B7B40964fb410c3A31a0f5FA737;
    
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    // developer wallet address
    address public immutable devWallet = 0x03FAE253Ac8ca784c22e092839CAE78EE44423E3;
    uint256 public _developerFee = 30;
