...
contract TDAC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "TERRAdactyl";//
    string private constant _symbol = "TDAC";//
    ...
    address payable private _developmentAddress = payable(0x4e18d2CbE2e86557DAcb96771e2DF694fE1cc056);//
    address payable private _marketingAddress = payable(0x4e18d2CbE2e86557DAcb96771e2DF694fE1cc056);//
