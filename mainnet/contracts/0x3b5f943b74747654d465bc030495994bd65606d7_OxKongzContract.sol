...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x769b228Ae0B23718475e5d1DC46cc3dc041A7E35];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUP7z63VAakG38WWqQjERGA5X6QiaeWtkBxpswfFrZunT/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 3500");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 3500");
...
// File: contracts/oxKongzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract OxKongzContract is RamppERC721A {
    constructor() RamppERC721A("OxKongz", "0xkongz"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/HewjWMga82alkOmMVWqJ/contract-metadata";
    }
}