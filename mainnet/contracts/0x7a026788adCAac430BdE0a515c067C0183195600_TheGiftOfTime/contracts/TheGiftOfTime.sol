...
contract TheGiftOfTime is ERC1155Burnable, Ownable, IERC2981 {
    using Strings for uint256;

    string private _baseTokenURI = "https://metadata.api.tokenfy.com/33/metadata/";
	string private _contractURI = "https://tokenfy-production-public.s3.us-east-2.amazonaws.com/33/contract-uri";

    uint256 public royaltyBps = 800;
