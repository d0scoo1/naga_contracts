...
contract SodaLimitedEdition is ERC721Enumerable, Ownable {

  string private _baseTokenURI;

  // SHA-256 hash for a given NFT
  mapping (uint => string) public provenanceHash;

  constructor() ERC721("SODA Limited Edition", "SODA LE") {
    _setBaseURI("https://soda.blob.core.windows.net/metadata-le/");
  }
  ...
  function mint(string memory _provenanceHash) public onlyOwner {
    uint index = totalSupply();

    provenanceHash[index] = _provenanceHash;
