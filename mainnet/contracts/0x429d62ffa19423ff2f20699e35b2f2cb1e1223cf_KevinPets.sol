...
// File: contracts/KevinApes.sol


pragma solidity ^0.8.4;

contract KevinPets is ERC721A, Ownable {

    uint256 constant public maxSupply = 555;
    uint256 public freeSupply = 0;
    uint256 constant public mintPrice = 0.0 ether;
    uint256 constant public maxMint = 5;

    bool public isSaleLive = true;
    string public baseURI = "ipfs://QmNjsw3cb3ZwzydudWW66tsPRBCPbGfF5arfiXvsVwa6r9/";

    constructor() ERC721A("KevinPets", "KPS") {}
