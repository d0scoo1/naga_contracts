...
We are not here to take part, we are here to takeover.

Harambe Inu will be building the next gen Metaverse.
...
contract HINU is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x68C8Ce14EBb9876467E4234bf4C67090D2a1c4e4);
    ...
    uint256 public _maxWalletSize = 5000000000000 * 10**9; //5.0
