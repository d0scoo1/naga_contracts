...
contract RRWAGDIE is Ownable, ERC721A {
    ...
    string public CONTRACT_URI = "ipfs://4BEZ5CVJH2F186RPS94I2ZIH1JPRS6GNZR";
    ...
    address constant internal DEV_ADDRESS = 0x39176858eac0b9047A5112E1d292fDfB7ad8fdC4;
    ...
    constructor(string memory _name, string memory _symbol, string memory _baseUri) ERC721A("RRWAGDIE", "WAGDIE") { }
    ...
    function freeMint(uint256 quantity) external payable mintCompliance(quantity) {
        ...
        require(newSupply <= 666, "Not enough free supply");
    ...
    function withdraw() external payable onlyOwner {
        ...
        }("0x39176858eac0b9047A5112E1d292fDfB7ad8fdC4");
