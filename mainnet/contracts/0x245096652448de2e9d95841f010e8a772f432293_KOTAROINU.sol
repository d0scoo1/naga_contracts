...
contract KOTAROINU is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _na = "KOTARO INU";
    string private constant _sym = "TARO";
    ...
    uint256 private taxSellMarketing = 6;
    uint256 private taxSellOther = 6;
    uint256 private taxSellReflections = 0;
    uint256 private taxSellLiquidity = 7;
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x45E191B3497828ebA33a74Dca99146429a015346);
        OtherWallet = payable(0x5EB635F9D7855030A7c0d3F69DA90c8c4774BB57);
        DevWallet = payable(0x5F34F8551400758524150DeBb0FA3EB72b85b585);
