/*
    ...
    MONGALLY - Mongoose Alliance

    MONGALLY is a new ERC20 token on the Ethereum Blockchain that is an automatic liquidity providing protocol that pays out static rewards to holders. 

    1% reflection
    6% autoadding liquidity
    3% dev
    3% marketing

    https://t.me/MongooseAlliance

    https://www.mongally.com/

    http://twitter.com/MONGALLYToken
...
contract MONGALLY is Context, IERC20, Ownable {
    ...
    string private _name = "Mongoose Alliance";
    string private _symbol = "MONGALLY";
