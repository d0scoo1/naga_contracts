...
contract MintableToken is Ownable, IERC721, IERC721Metadata, ERC721Burnable, ERC721Base {
    ...
    function mint(uint256 tokenId, uint8 v, bytes32 r, bytes32 s, Fee[] memory _fees, string memory tokenURI, address userWallet) public {
        require(owner() == StringLibrary.getAddress(abi.encodePacked(this, tokenId, userWallet), v, r, s), "owner should sign tokenId");
