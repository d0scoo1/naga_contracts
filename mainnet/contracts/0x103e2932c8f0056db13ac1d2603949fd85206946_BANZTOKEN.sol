/**
The "Z" first drew attention when it was painted on the sides of thousands of tanks and other military vehicles along the Russian border with Ukraine. Then the letter began popping up across Russia.

BANZ TOKEN:BAN "Z"

https://t.me/BanZToken
*/
...
contract BANZTOKEN is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Ban Z Token";
    string private constant _symbol = "BANZ";
    ...
    uint256 _totalSupply = 20220309 * 10**9;
    ...
    address payable private _marketingAddress = payable(0xC6df1e6375895e7d9c6c4DB5654beeb7658cc691);
    ...
    uint256 public _maxTxAmount = 202203 * 10**9;
    uint256 public _maxWalletSize = 606609 * 10**9; 
    uint256 public _swapTokensAtAmount = 101102 * 10**9; 
