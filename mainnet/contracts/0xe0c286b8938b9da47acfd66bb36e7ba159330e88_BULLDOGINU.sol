...
contract BULLDOGINU is Context, IERC20, Ownable, dAPPRewards {
    ...
    string private _name = "Smoker Bulldog Inu";
    string private _symbol = "SMBU";
