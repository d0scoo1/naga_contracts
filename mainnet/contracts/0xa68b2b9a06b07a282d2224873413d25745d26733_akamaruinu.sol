...
contract akamaruinu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Akamaru Inu";                                           // name
    string private _symbol = "$AKAMARU";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x9376Cdb9Ab7672b6E2C33976C6c82499ced47c31);
