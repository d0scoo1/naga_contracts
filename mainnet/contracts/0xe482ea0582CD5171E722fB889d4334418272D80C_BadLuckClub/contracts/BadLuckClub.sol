...
contract BadLuckClub is AdminControl, ICreatorExtensionTokenURI, ILazyDelivery, ILazyDeliveryMetadata {
    ...
    /*
     * Used to mint a single 1155 token into the admin's wallet.
     */
    ...
    /*
     * Used to setup the marketplace listing for lazy minting tokens upon sale.
     */
    ...
    /*
     * Used to lazily deliver (aka mint) an 1155 token to the purchaser.
     * Limit of one mint per wallet address.
     */
