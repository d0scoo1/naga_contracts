...
//*********************************************************************//
//
//  _       __        _       ___ ____   ___    ____   ____  _    
// | |     / /__     | |     / (_) / /  /   |  / / /  / __ \(_)__ 
// | | /| / / _ \    | | /| / / / / /  / /| | / / /  / / / / / _ \
// | |/ |/ /  __/    | |/ |/ / / / /  / ___ |/ / /  / /_/ / /  __/
// |__/|__/\___/     |__/|__/_/_/_/  /_/  |_/_/_/  /_____/_/\___/ 
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x8a53550d34FE41c1540E4b775D5834A3121893aC];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmP5H6ttk28bp6USXViRuyFnnBB1XCSE9YrCCCU28WtqjJ/";
...
// File: contracts/WeWillAllDieContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeWillAllDieContract is RamppERC721A {
    constructor() RamppERC721A("We Will All Die", "WWAD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/niPimxBI4ndGaFUphx4t/contract-metadata";
    }
}
