...
// File: contracts/FightingMfers.sol


pragma solidity ^0.8.0;


contract FightingMfers is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public publicSaleWalletLimit = 50;
  ...
  constructor() ERC721("FightingMfers", "FightingMfers") {
