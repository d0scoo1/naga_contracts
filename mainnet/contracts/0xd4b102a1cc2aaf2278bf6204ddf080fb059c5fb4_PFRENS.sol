...
contract PFRENS is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 4369;
	uint256 public GIVEAWAY_NFT = 75;
	...
	uint256 public PRESALE_PRICE = 0.022 ether;
	uint256 public SALE_PRICE = 0.033 ether;
    ...
    constructor() ERC721P('Pickle Frens', 'PFRENS') {}
