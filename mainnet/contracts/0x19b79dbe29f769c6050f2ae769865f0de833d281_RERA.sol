...
contract RERA is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVKWMGMH2xPw7JYusEuAeoMx2gA9cfpTssqR4YoPWYvfm";
    ...
    constructor(
    ) ERC721A("Robot Era", "RERA", 100, maxSupply) {
    }
