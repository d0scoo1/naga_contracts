/*
                    d8888b. d888888b d8b   db db    db 
                    88  `8D   `88'   888o  88 88    88 
                    88oooY'    88    88V8o 88 88    88 
                    88~~~b.    88    88 V8o88 88    88 
                    88   8D   .88.   88  V888 88b  d88 
                    Y8888P' Y888888P VP   V8P ~Y8888P' 
  
                    EARNING BALANCER REWARDS ON UNISWAP
  
               BAL: 0xba100000625a3754423978a60c9317c58a424e3D
  
               BINU/BAL POOL WILL BE CREATED 7 DAYS FROM LAUNCH
                        UPDATES PROVIDED ON-CHAIN
*/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  constructor(){
      ...
      rewardTokens.push(address(0xba100000625a3754423978a60c9317c58a424e3D)); // BAL - 0xba100000625a3754423978a60c9317c58a424e3D
...
contract BalancerInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Balancer Inu", "BINU") {
