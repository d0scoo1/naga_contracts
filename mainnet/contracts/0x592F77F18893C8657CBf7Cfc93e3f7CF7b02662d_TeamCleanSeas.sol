...
Team Clean Seas Socials:
Telegram: https://t.me/TeamCleanSeas
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x700dDf8CF9e92aaEff6836D54D6Ca8Ba91c65571), 5000);
        m_DidDeploy = true;
    }
...
contract TeamCleanSeas is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Team Clean Seas";
    string private m_Symbol = "TCS";
