/*
    2022 wild gooses appeared and are ready to dominate ETH! Stay tuned for the first eth printer of the year 
...
contract TwentyTwoGooses is Context, IERC20, Ownable {
    ...
    string private _name = "2022 Gooses";
