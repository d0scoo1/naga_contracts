...
/// @title SignedAllowance with claimedBitMap & extra data
...
contract SignedAllowanceWithData is Context {
    ...
    /// @param data any additional data as bytes
    ...
    function _validateSignature(
        ...
        // verifies that the sha3(address(this), account, index, data) has been signed by signer
