 ...
 * http://shibatankinu.com/

 * To prevent bots, and launch completely stealth. We don't want to expose telegram, the button is hidden somewhere, find it yourself  (:                                                                     
 *                                                                           
*/                                                                           
...
contract SHIBATANK is Context, IERC20, Ownable {
    ...
    string private _name = "Shibatank Inu";
    ...
    uint256 public _maxWalletSize = 2000000000000000000000 * 10**9;
