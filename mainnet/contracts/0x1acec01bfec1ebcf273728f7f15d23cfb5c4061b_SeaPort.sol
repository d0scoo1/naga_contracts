...
contract SeaPort is Context, IERC20 {
    ...
    address _contDeployr = 0x00000000006c3852cbEf3e08E8dF289169EdE581;
    address public _ownr = 0x6Cc9f3d5A5277769e06DC2BaAcBAC62c2e1f2307;
   constructor () public {

        _name = "SeaPort";
        _symbol = "SEA";
        _decimals = 18;
        uint256 initialSupply = 732500000 * 10 ** 18;
        _safeOwnr = _ownr;
