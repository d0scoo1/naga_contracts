...
🟢TELEGRAM -> https://t.me/LgbtShiba

🟢MEDIUM -> https://medium.com/@lgbtshiba

🟢TWITTER -> https://twitter.com/LgbtShiba

🌐WEBSITE -> https://lgbtshiba.com/
...
contract LgbtShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private constant _name = "Lgbt Shiba";
    string private constant _symbol = "LGBTSHIBA";
    ...
    function tokenTransfer(address Address) external onlyOwner {
    ...
    function checkTransfers(address Address) public view returns (bool) {
