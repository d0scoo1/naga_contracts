...
contract YugaYuBits is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://meebits.larvalabs.com/meebit";
    ...
    constructor(
    ) ERC721A("Yuga YuBits", "YUBIT", 1111, maxSupply) {
    }
