...
contract Flixu is ERC1155, Ownable, ERC1155Supply, ReentrancyGuard, PaymentSplitter {
    ...
    //add initial sets of 5 NFTs
    function addSupply(uint256 _count) external onlyOwner {
        for (uint256 i=0; i<_count; i++) {
            createArt("Afro American NFT", 10, 100000, 10, 10, 10, firstPayees, firstShares);
            createArt("Afro American NFT", 25, 50000, 10, 10, 10, firstPayees, firstShares);
            createArt("Afro American NFT", 100, 10000, 10, 10, 10, firstPayees, firstShares);
            createArt("Afro American NFT", 500, 10000, 10, 10, 10, firstPayees, firstShares);
            createArt("Afro American NFT", 1000, 10000, 10, 10, 10, firstPayees, firstShares);
        }
    }
