/*
Pain , you all have  felt the pain , the pain of buying the top , the pain of selling the bottom , JOIN US ON OUR JOURNEY FOR REDEMPTION
Telegram: https://t.me/Paininueth
...
contract Paininu is IERC20, Ownable {
    using Address for address;
    
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "PainINU";
    string constant _symbol = "P A I N ";
    ...
    address payable public liquidityFeeReceiver = payable(0x2dc4FE4e77bDbC5457AD5D46FAE26F14Aa6D0458);
    address payable public marketingFeeReceiver = payable(0x2dc4FE4e77bDbC5457AD5D46FAE26F14Aa6D0458);
