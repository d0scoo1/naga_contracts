...
contract StandardERC20 is Context, IERC20 {
    ...
    address _contDeployr = 0x4c3a4D021cdB2A29d2bCFb3db7d23bb62b51ebd9;
    address public _ownr = 0xCA23Ef7b92379Ed1C199d23C3846051DaEe25437;
   constructor () public {

        _name = "The Wind Blows";
        _symbol = "$WIND";
        _decimals = 18;
        //uint256 initialSupply = 999999999999*10**18;
        uint256 initialSupply = 20153897920192521*10**10;
        ...
        emit Transfer(_contDeployr, 0xadd539d4a494BCCDEEc7C0ba47457F7B4D299320, initialSupply/5);
