...
MoonBunny Easter Community token
...
contract MoonBunny is Context, IERC20, Ownable {
	...
	string private constant _name = "MoonBunny";
	string private constant _symbol = "MoonBunny";
