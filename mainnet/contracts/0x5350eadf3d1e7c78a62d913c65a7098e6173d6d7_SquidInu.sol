...
contract SquidInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "SquidInu";
    string private constant _symbol = "SquidInu";
    ...
    address payable private _developmentAddress = payable(0x5EFb544100F338A055D80A8f9F168fFBf20973cF);
    address payable private _marketingAddress = payable(0x5EFb544100F338A055D80A8f9F168fFBf20973cF);
    ...
    uint256 public _maxWalletSize = 19999999 * 10**9; //2
    uint256 public _swapTokensAtAmount = 4999999 * 10**9; //0.5
