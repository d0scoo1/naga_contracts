...
// File: contracts/LoopiesLowerGas.sol
...
contract Loopies is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Loopy Llamas", "LL") {
    setHiddenMetadataUri("ipfs://QmPtKemuVZePnNDH4LZ5DFuP6Bfz34e1kbNJ2GjTXCQkMi/hidden.json");
  }
  ...
  modifier mintCompliance(uint256 _mintAmount) {
    ...
    if (whiteListed && whitelistedAddresses.length > 0) {
