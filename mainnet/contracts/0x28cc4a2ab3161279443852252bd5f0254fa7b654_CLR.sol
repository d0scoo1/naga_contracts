...
contract CLR is ERC721Enumerable, Ownable {
    using Strings for uint256;
    
    uint256 public constant MAX_TOKENS = 8000;
    uint256 public constant MAX_MINT = 20;
    uint256 public constant GIFT_CLAIM_LIMIT = 40;
    address public constant devAddress = 0x366CF5cA723433d716FdF835eaB1174707CbD5c3;
    
    string public baseURI;
    string public baseExtension = '.json';
    uint256 public price = 0.02 ether;
    uint256 public giftClaimCount = 0;
    ...
    constructor(string memory _name, 
        ...
        giftClaim(devAddress, 20);
        giftClaim(msg.sender, 20);
    }
    ...
    function giftClaim(address _to, uint256 _amount) public onlyOwner {
        uint256 supply = totalSupply();
        require(_amount + giftClaimCount <= GIFT_CLAIM_LIMIT, "Exceeds gift claim limit");
        require(supply + _amount <= MAX_TOKENS, "Exceeds total supply");
