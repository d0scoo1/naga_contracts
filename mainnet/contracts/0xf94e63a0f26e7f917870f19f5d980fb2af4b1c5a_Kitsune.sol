...
contract Kitsune is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 0.08 ether; //0.06 during pre-sale & 0.08 during public-sale
  ...
  constructor() ERC721A("Kitsune","Kitsune", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmZgty13wwbLieqSFzJsuNzJ3nrrjpeXHWVwSvfJiLQ32u/";
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmPkK1ne5PAn5FeVwQPqNbh82Xeiqhky7hHhGMiv5U32L6/";
  }
