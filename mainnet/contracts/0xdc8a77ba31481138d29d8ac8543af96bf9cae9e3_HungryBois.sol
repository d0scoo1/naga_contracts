...
contract HungryBois is ERC721A, Ownable, ReentrancyGuard {
    ...
    constructor() ERC721A("Hungry Bois", "HB") {
    }

    function mint(uint256 _mintAmount) external payable {

        require(msg.value >= _mintAmount * price, "Not enough ETH.");
