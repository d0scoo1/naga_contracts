// https://twitter.com/RedRightHandETH
...
contract RedRightHand is Context, IERC20, Ownable {
    ...
    string private _name = "RedRightHand";
    string private _symbol = "RRH";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 200000, "Max Tx Amount cannot be less than 20 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 200000, "Swap Threshold Amount cannot be less than 20 Million");
    ...
    function allowtrading(bool onOff)external onlyOwner() {
        canTrade = onOff;
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        // swap tokens for ETH
        swapTokensForEth(half); // <- this breaks the ETH -> RRH swap when swap+liquify is triggered
