/*
Dracula
t.me/Draculatokeneth

Vincent's open source contract - forked by a fan

Total Supply: 1,000,000
The max wallet is: 2,000 (2%) - starts smaller and autoincrements to the cap
...
Will initially be locked for a week and will extend at higher marketcaps discussed in chat. Will remove liquidity thereafter if the token ceases to hold activity.

Will create new tokens with a clear link to this funding address.
