...
contract Uhtred is Context, IERC20, Ownable {
    ...
    string private _name = "UHTRED";
    string private _symbol = "UHTRED";
    ...
    uint256 public _maxBuyAmount = 2700000000000 * 10**9;
    uint256 public _maxWalletAmount = 3600000000000 * 10**9;
    uint256 public ethPriceToSwap = 200000000000000000; //.2 ETH
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public marketingWallet = 0x404f3C17aFbFD9F8bc275A419DDd7C7eF365672F;
    address public devWallet = 0x465f360d919D032A3127161a06d4787541D52301;
