...
contract marvatars is ERC721Enumerable, Ownable{
    using SafeMath for uint256;
    using Address for address;
    using Strings for uint256;
    
    uint256 public NFT_PRICE = 80000000000000000; 
    uint256 public MAX_SUPPLY = 2520;
    uint public MAX_NFT_PURCHASE = 5;
    bool public saleIsActive = false;
    
    function setMAX_SUPPLY(uint256 _supply) public onlyOwner {
        MAX_SUPPLY = _supply;
    }
    
    function setNFT_PRICE(uint256 _price) public onlyOwner {
        NFT_PRICE = _price;
    }
    ...
    constructor() ERC721("marvatars.com","MARV"){}
