...
contract HunnysPowerPass is AMPowerPassCore{
  string public name = "Hunnys: Power-Pass Plus";
  string public symbol = "AM: H";
  ...
  constructor()
    ...
    setToken( 0,
      "Hunnys: Power-Pass Plus",
      "https://herodev.mypinata.cloud/ipfs/QmctGRRtUnyh9ogZgCjgw4mG2v58RSuJJMFqNzw4jfB7Y1/hunnys.json",
      false, 0,
      false, 0.05 ether,
      10000 );

    address[] memory _payees = new address[](11);
