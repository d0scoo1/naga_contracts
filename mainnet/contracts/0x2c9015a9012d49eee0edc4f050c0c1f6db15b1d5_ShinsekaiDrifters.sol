...
contract ShinsekaiDrifters is ERC721A, Ownable {
    ...
    constructor() ERC721A("Shinsekai Drifters", "DRIFT") {
        // must set hidden uri.
        setHiddenMetadataUri("ipfs://QmcEJ4XRXG2DD7qoyYMzVZRqXwrSwqczwKBq2sgRe7k4Nh/");

        // placeholder for public launch time. will update to prevent botting
        setPublicSaleStartTime(1647586800);

        /* hold back total 100 txn mint for giveaway, collab, and team. 
           hold back 5 on contract initialization to also test. 
           rest of mints held back will occur spread out to ensure all community members can join 
        */
