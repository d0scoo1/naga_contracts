...
contract  JAILKWON is Context, IBEP20, Ownable {
    using SafeMath for uint256;

    string constant _NAME = "JAILKWON ";
    string constant _SYMBOL = "$JKWON";
    ...
    uint8 public referralReward = 5;

    uint8 public liquidityFeeOnBuy = 1;
    uint8 public marketingFeeOnBuy = 3;
    uint8 public EtrondistributionFeeOnBuy = 1;
    

    uint8 public liquidityFeeOnWhiteListedBuy = 1;
    uint8 public marketingFeeOnBuyWhiteListed = 3;
    uint8 public EtrondistributionFeeOnBuyWhiteListed = 1;

    uint8 public liquidityFeeOnSell = 1;
    uint8 public marketingFeeOnSell = 3;
    uint8 public EtrondistributionFeeOnSell = 1;

    uint8 public liquidityFeeOnWhiteListedSell = 1;
    uint8 public marketingFeeOnWhiteListedSell = 3;
    uint8 public EtrondistributionFeeOnWhiteListedSell = 1;
    ...
    IPancakeswapV2Router02 public pcsV2Router;
    ...
    uint256 public amountOfTokensToAddToLiquidityThreshold = 10*10*18; // 
    ...
    event ChangeFeesForNormalBuy(uint8 liquidityFeeOnBuy, uint8 marketingFeeOnBuy, uint8 EtrondistributionFeeOnBuy);
    event ChangeFeesForWhiteListedBuy(uint8 liquidityFeeOnBuy, uint8 marketingFeeOnBuy, uint8 EtrondistributionFeeOnBuy);
    event ChangeFeesForNormalSell(uint8 liquidityFeeOnSell, uint8 marketingFeeOnSell, uint8 EtrondistributionFeeOnSell);
    event ChangeFeesForWhitelistedSell(uint8 liquidityFeeOnSell, uint8 marketingFeeOnSell, uint8 EtrondistributionFeeOnSell);
    event ChangeReferralReward(uint8 referralReward);
    event UpdatereserveWallet(address reserveWallet);
    ...
    constructor() {
        ...
        pcsV2Pair = IPancakeswapV2Factory(_pancakeswapV2Router.factory()).createPair(address(this), _pancakeswapV2Router.WETH());
        pcsV2Router = _pancakeswapV2Router;
        _allowances[address(this)][address(pcsV2Router)] = _MAX;

        rewardDistributor = IRewardDistributor(0xD9B8Fa41e2b7E4414631Ff722Ec9C7Ef24251453);
        _allowances[address(this)][address(rewardDistributor)] = _MAX;
        _allowances[address(rewardDistributor)][address(pcsV2Router)] = _MAX;

        reserveWallet = 0xb280d1372d06D42c6d40F328E3AfaFAbFec950e9;
        ...
        _excludeFromReflection(reserveWallet);
    ...
    function changeFeesForNormalBuy(uint8 _liquidityFeeOnBuy, uint8 _marketingFeeOnBuy, uint8 _EtrondistributionFeeOnBuy) external onlyOwner {
        liquidityFeeOnBuy = _liquidityFeeOnBuy;
        marketingFeeOnBuy = _marketingFeeOnBuy;
        EtrondistributionFeeOnBuy = _EtrondistributionFeeOnBuy;
        emit ChangeFeesForNormalBuy(_liquidityFeeOnBuy, _marketingFeeOnBuy, _EtrondistributionFeeOnBuy);
    }

    function changeFeesForWhiteListedBuy(uint8 _liquidityFeeOnBuy, uint8 _marketingFeeOnBuy, uint8 _EtrondistributionFeeOnBuy) external onlyOwner {
        liquidityFeeOnWhiteListedBuy = _liquidityFeeOnBuy;
        marketingFeeOnBuyWhiteListed = _marketingFeeOnBuy;
        EtrondistributionFeeOnBuyWhiteListed = _EtrondistributionFeeOnBuy;
        emit ChangeFeesForWhiteListedBuy(_liquidityFeeOnBuy, _marketingFeeOnBuy, _EtrondistributionFeeOnBuy);
    }

    function changeFeesForNormalSell(uint8 _liquidityFeeOnSell, uint8 _marketingFeeOnSell, uint8 _EtrondistributionFeeOnSell) external onlyOwner {
        liquidityFeeOnSell = _liquidityFeeOnSell;
        marketingFeeOnSell = _marketingFeeOnSell;
        EtrondistributionFeeOnSell = _EtrondistributionFeeOnSell;
        emit ChangeFeesForNormalSell(_liquidityFeeOnSell, _marketingFeeOnSell, _EtrondistributionFeeOnSell);
    }

    function changeFeesForWhitelistedSell(uint8 _liquidityFeeOnSell, uint8 _marketingFeeOnSell, uint8 _EtrondistributionFeeOnSell) external onlyOwner {
        liquidityFeeOnWhiteListedSell = _liquidityFeeOnSell;
        marketingFeeOnWhiteListedSell = _marketingFeeOnSell;
        EtrondistributionFeeOnWhiteListedSell = _EtrondistributionFeeOnSell;
        emit ChangeFeesForWhitelistedSell(_liquidityFeeOnSell, _marketingFeeOnSell, _EtrondistributionFeeOnSell);
    }
    ...
    function updatereserveWallet(address _reserveWallet) external onlyOwner {
        require(_reserveWallet != address(0), "Zero address not allowed!");
        reserveWallet = _reserveWallet;
        emit UpdatereserveWallet(_reserveWallet);
    }
    ...
    function updatePancakeSwapRouter(address _pcsV2Router) external onlyOwner {
        ...
        pcsV2Router = IPancakeswapV2Router02(_pcsV2Router);
        pcsV2Pair = IPancakeswapV2Factory(pcsV2Router.factory()).createPair(address(this), pcsV2Router.WETH());
        _allowances[address(this)][address(pcsV2Router)] = _MAX;
        _allowances[address(rewardDistributor)][address(pcsV2Router)] = _MAX;
    ...
    function _normalBuy(address sender, address recipient, uint256 amount) private {
        ...
        uint256 rEtrondistributionFee = amount.div(100).mul(EtrondistributionFeeOnBuy).mul(currentRate);
        uint256 rMarketingFee = amount.div(100).mul(marketingFeeOnBuy).mul(currentRate);
        uint256 rTransferAmount = rAmount.sub(rLiquidityFee).sub(rEtrondistributionFee).sub(rMarketingFee);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        ...
        _sendToreserveWallet(sender, rMarketingFee.div(currentRate), rMarketingFee);
        _reflectFee(rEtrondistributionFee, rEtrondistributionFee.div(currentRate));
    }
    ...
    function _whitelistedBuy(address sender, address recipient, uint256 amount) private {
        ...
        uint256 rEtrondistributionFee = amount.div(100).mul(EtrondistributionFeeOnBuyWhiteListed).mul(currentRate);
        uint256 rMarketingFee = amount.div(100).mul(marketingFeeOnBuyWhiteListed).mul(currentRate);
        uint256 rTransferAmount = rAmount.sub(rReferralRewardAmount).sub(rLiquidityFee).sub(rEtrondistributionFee).sub(rMarketingFee);
        _rOwned[sender] = _rOwned[sender].sub(rAmount);
        _rOwned[recipient] = _rOwned[recipient].add(rTransferAmount);
        _rOwned[address(this)] = _rOwned[address(this)].add(rLiquidityFee);
    ...
    function _normalSell(address sender, address recipient, uint256 amount) private {
        ...
        uint256 rEtrondistributionFee = amount.div(100).mul(EtrondistributionFeeOnSell).mul(currentRate);
    ...
    function _whitelistedSell(address sender, address recipient, uint256 amount) private {
        ...
        uint256 rEtrondistributionFee = amount.div(100).mul(EtrondistributionFeeOnWhiteListedSell).mul(currentRate);
    ...
    function _sendToreserveWallet(address sender, uint256 tMarketingFee, uint256 rMarketingFee) private {
        _rOwned[reserveWallet] = _rOwned[reserveWallet].add(rMarketingFee);
        if (_isExcluded[reserveWallet]) _tOwned[reserveWallet] = _tOwned[reserveWallet].add(tMarketingFee);
        emit Transfer(sender, reserveWallet, tMarketingFee);
    }
