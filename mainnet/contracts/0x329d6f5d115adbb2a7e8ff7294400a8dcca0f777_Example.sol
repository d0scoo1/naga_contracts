...
contract Example is Ownable, ERC721A {
    ...
    uint256 public maxPublicMint = 100;
    uint256 public maxMintPerAccount = 200;
    ...
    constructor(
        uint256 _publicTime
    ) ERC721A("GassFee", "GassFee", supply) {
    ...
    function mint(uint256 amount) payable public {
        ...
        {
          require(amount <= maxMintPerAccount,"Max 10 Amount");
    ...
    function devMint(
        ...
        for (uint256 i = 0; i < numToMint / 5; i++) {
            _safeMint(to, 5);
        }
    }
