...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 895 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmTDPq5qRqNKHhwUQCSY28SbqepczzJ75Mvs5JtyV6MXJN/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 895");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 895");
...
// File: contracts/NftVinnyVultureContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract NftVinnyVultureContract is RamppERC721A {
    constructor() RamppERC721A("NFTVinnyVulture", "NFTVV"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/QvdRowcKSt1GcQHEykNX/contract-metadata";
    }
}
