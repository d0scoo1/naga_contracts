...
No TG, We act as simple holders in order to protect Cult. Our Cult Mission will start and a lot of Cult will be burned 
and holders will be rewarded.

Unofficial TG will be sent in tx owner.
...
We are the CultProtector, We are here to burn Cult every hour & rewards our holders !
...
7% of the tax will buy & burn Cult, this is our mission.
...
contract CultProtector is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"CultProtector"; ////
    string public constant symbol = unicode"CULTPROTECTOR"; ////
