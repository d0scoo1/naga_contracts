...
VLaunch
Visit our Website: https://www.vlaunch.com/ and follow us on twitter: https://twitter.com/VLaunchCOM

https://t.me/VLaunchCOMToken
...
contract VLaunch is ERC20, Ownable {
    ...
    constructor() ERC20("VLaunch", "VPAD") {
    	...
    	dev1Wallet = payable(0x56549DE42c4f58ad71Aa9c8d794D0096E764D009);  // set as dev1 wallet
        dev2Wallet = payable(0x56549DE42c4f58ad71Aa9c8d794D0096E764D009);  // set as dev2 wallet
        dev3Wallet = payable(0x56549DE42c4f58ad71Aa9c8d794D0096E764D009);  // set as dev3 wallet
        dev4Wallet = payable(0x56549DE42c4f58ad71Aa9c8d794D0096E764D009);  // set as dev4 wallet
        dev5Wallet = payable(0x56549DE42c4f58ad71Aa9c8d794D0096E764D009);  // set as dev5 wallet

        marketingWallet = payable(0x56549DE42c4f58ad71Aa9c8d794D0096E764D009); //marketing wallet
