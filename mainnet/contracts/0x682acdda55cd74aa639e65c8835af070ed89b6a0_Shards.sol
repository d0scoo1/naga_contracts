...
contract Shards is ERC721, IMXMethods {
    string public baseTokenURI = "https://api.legendsofthemetaverse.com/shards/";
    uint256 public Max_Mint = 1500;
    address _imx = 0x5FDCCA53617f4d2b9134B29090C87D01058e27e9;
    mapping(uint256 => bytes) public metadata;

    constructor() ERC721("Legends Of The Metaverse Shards", "LOTM") IMXMethods(_imx) {}
