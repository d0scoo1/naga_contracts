...
abstract contract Ramppable {
  address public RAMPPADDRESS = 0xe9A36d2d6820539ec2F3b4ddC68Fd337BF8Ce293;
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [0xe9A36d2d6820539ec2F3b4ddC68Fd337BF8Ce293];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSkHBrNV7ZUVAPMz8WKNKdZH95pp6hhsMuKsdErveUaGw/";
...
// File: contracts/KodaTownContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KodaTownContract is RamppERC721A {
    constructor() RamppERC721A("kodatown.wtf", "KT"){}

    function contractURI() public pure returns (string memory) {
      return "ipfs://Qmc2a43CUD8LJRpVWeAtXYY8WYHHqh3fkD1wWSrua4JHhE/metadata.json";
    }
}
...
//*********************************************************************//  
//
//         This smart contract was created with the help of rampp.xyz.
//    used ramp but only their generated code to fork - I want to credit them so leaving this in
//            Rampp allows creators like you to launch 
//             large scale NFT communities without code! (actually..)
//
//*********************************************************************//                                                     
//*********************************************************************//