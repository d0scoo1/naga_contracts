...
/*
    ...
    - Buy one token (M) to earn yield generated from multiple other aggregator projects.

    Tokenomics:
    10% of each buy goes to existing holders (reflection).
    10% of each sell is divided into:
        4% Marketing Wallet: For marketing, growth and promotion of M.
        4% Treasury Wallet: Invests in multi-chain farming projects to redirect yield into buy backs of M.
        2% Auto-Adds Liquidity: Automatically adds liquidity to M.

    Website: MoneyCapital.org 
    

    Telegram: https://t.me/MoneyCapitalOfficial
...
contract M is Context, IERC20, Ownable {
    ...
    address payable public _MWalletAddress = 0x48A67fc45d5224690eB418c7d88f90d68a44482d;
    address payable public _marketingWalletAddress = 0x3ca6a576e8A9aCdeAA916E07D62827Bc18f146cF;
    ...
    function sendETHToCapitalFund(uint256 amount) private { 
        ...
        _MWalletAddress.transfer(address(this).balance); 
    }
    ...
    function sendETHToTeam(uint256 amount) private {
        _MWalletAddress.transfer(amount.div(2));
