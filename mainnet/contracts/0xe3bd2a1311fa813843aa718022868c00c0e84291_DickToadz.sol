...
// File: contracts/dicktoadz.sol

pragma solidity ^0.8.0;

contract DickToadz is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  uint256 public maxSupply = 5200;
  uint public constant pricePerToken = 0.069 ether;
  ...
  constructor() ERC721A("DickToadz", "DICKTOADZ") {}
  ...
  function tierOneMint(bytes32[] calldata _merkleProof, uint256 quantity) external payable {
    ...
    require(addressMinted[msg.sender] + quantity <= maxMintAmountPerWallet, "Can only mint 10 per wallet.");
    require(quantity <= maxMintAmountPerWallet, "Can only mint 10 per wallet.");
    require(pricePerToken * quantity <= msg.value, "It is 0.069 per token.");
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    Address.sendValue(payable(0x011B63A4ccBc5bD55F9Fb9fbEDA3525cA6707451), total * 2090/10000);
    Address.sendValue(payable(0x099dd85261862A729A58d67649e8056B3df9904f), total * 2090/10000);
    Address.sendValue(payable(0x2255374629CA8EA9f862d5867124521AA3a90151), total * 1254/10000);
    Address.sendValue(payable(0x31C1b03EC94EC958DD6E53351f1760f8FF72946B), total * 1115/10000);
    Address.sendValue(payable(0xE209B86Fab947e6716aEF53C00CEAC7a2bF3C586), total * 1115/10000);
    Address.sendValue(payable(0xc8FA8f3589dD37488433CB78f8E9160e81AcF6Cf), total * 1115/10000);
    Address.sendValue(payable(0xF14d484b29A8aC040FEb489aFADB4b972422B4E9), total * 557/10000);
    Address.sendValue(payable(0x7e9656C4B7F56FA280Ba20D1667c8CDd923fe9Bd), total * 557/10000);
    Address.sendValue(payable(0xc9F972796C4e2494044BcaB703482AE5df6f3438), total * 107/10000);
  }
