...
contract stayPositive is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Stay Positive";
    ...
    address payable private _developmentAddress = payable(0x9A4660c9cd5656d9cd9BFd5fB5Ab616E111fA73C);
    address payable private _marketingAddress = payable(0x9A4660c9cd5656d9cd9BFd5fB5Ab616E111fA73C);
    ...
    constructor() {
        _developmentAddress = payable(0x9A4660c9cd5656d9cd9BFd5fB5Ab616E111fA73C);
        _marketingAddress = payable(0x9A4660c9cd5656d9cd9BFd5fB5Ab616E111fA73C);
