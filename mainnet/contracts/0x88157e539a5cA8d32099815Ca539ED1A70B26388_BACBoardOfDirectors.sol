...
contract BACBoardOfDirectors is ERC721Enumerable, Ownable {
    ...
    constructor()
        ERC721("BAC: Board Of Directors", "BACBOD")
    {
    ...
    function _baseURI(uint256 _tokenID) internal view virtual override returns (string memory) {
