...
#SWEAT fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes SWEAT!
...
contract SWEAT is Context, IERC20, Ownable {
    ...
    string private _name = 'SWEAT Economy';
