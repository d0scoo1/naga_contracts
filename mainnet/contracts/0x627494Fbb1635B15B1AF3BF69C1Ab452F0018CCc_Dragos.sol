...
contract Dragos is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    uint256 mintPrice = 85000000000000000; // 0.085 ETH
    uint256 whitelistMintPrice = 79000000000000000; // 0.079 ETH
    uint256 creationTime;
    uint256 public MAX_TOKEN_SUPPLY = 3702;
    uint256 maxWhitelistMints = 3;
    uint256 maxMintsPerTxn = 5;
    uint256 maxSpecialDragons = 15;
    uint256 specialDragonsMinted = 4;
    ...
    function setMintPrice(uint256 _cost) external onlyOwner {
      mintPrice = _cost;
    }

    function setWhitelistPrice(uint256 _cost) external onlyOwner {
      whitelistMintPrice = _cost;
    }
    ...
    function changeName(uint256 tokenId, string memory _name) external {
        ...
        _dragosNameByTokenId[tokenId] = _name;
    }
    ...
    function _mintLoop(uint256 amount, string[] memory names) internal {
      uint256 tokenId = totalSupply() + startingTokenId;
    ...
    function ownerMint(uint256 amount, string[] memory names) external onlyOwner {
       require(totalSupply().add(amount) <= MAX_TOKEN_SUPPLY, "Purchase would exceed max supply");
    ...
    constructor() ERC721("Dragos Part Two", "DRAGOS") Ownable() {
        ...
        startingTokenId = 2298;
        prerevealURI = "https://dragos.mypinata.cloud/ipfs/QmZdZhygDZTsG6KC71zk9XMohScmFKZryFpeGZ939oLzX9";
        addToWhitelistRootHash(0x972a3d988e5a774c47487f46826f2d67ea0645449d1ccf115ae2db344f8b4c38);
        addToWhitelistRootHash(0x14303410f0c20a8b5afba45bedaa5b1836da426f85fba541eba585ca22ae85f5);
        addToWhitelistRootHash(0x21a034bb82e9b0692d1d34eccf9caa39f866040ac26aafcde3697e3f026c3994);
    }
