...
contract SquigglesByDamers is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPG8pQDHUpwbb4DME4Mof6rLuvGDRVUA4TQiXSJWckcmc";
    ...
    constructor(
    ) ERC721A("Squiggles By Damers", "DAMERS", 100, maxSupply) {
    }
