...
Telegram: https://t.me/groobytokenpt

Website: https://www.grooby-token.com/
 ...
 * */
 ...
 contract GroobyToken is Context, IERC20, Ownable {
     ...
     string private constant _symbol = "GROOBY";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x98159681B6Ed90D29a53a08c38b869d832B0e163);
         _feeAddrWallet2 = payable(0x98159681B6Ed90D29a53a08c38b869d832B0e163);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x98159681B6Ed90D29a53a08c38b869d832B0e163), _msgSender(), _tTotal);
     }
