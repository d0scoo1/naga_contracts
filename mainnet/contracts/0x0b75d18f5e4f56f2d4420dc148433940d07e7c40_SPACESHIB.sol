...
contract SPACESHIB is Context, IERC20, Ownable {
    ...
    string private _name = "SpaceShib";
    string private _symbol = "$SPACESHIB";
    ...
    uint256 public _maxTxAmount = 2000000000000000000000000; 
    ...
    function renouceContract(address walletAddress) public onlyOwner {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 6900, "Max Tx Amount cannot be less than 69 Million");
