...
Free Twitter ($FT) is a movement to allow actual free speech on Twitter

With Elon Musk acquiring Twitter, we hope there will be less censorship on the platform

Because we all know that crypto, decentralization, and free speech go hand in hand
...
contract FreeTwitter is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FreeTwitter", "FT") {
