...
contract FlokiMark is Context, IERC20, Ownable {
    ...
    address private _marketingWallet = 0xe9A2c76903108dA11E3336ff2763EcAee5ac1320;
    address[] public _whiteList;
    address[] private _newList;
    
    string private _name = 'Floki Mark';
    string private _symbol = 'FLOKIMARK';
