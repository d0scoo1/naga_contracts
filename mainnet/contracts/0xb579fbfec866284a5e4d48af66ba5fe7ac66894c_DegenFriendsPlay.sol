...
contract DegenFriendsPlay is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbpWm8bLEvVcgD66PNjqTs4sCEYDtiAnRXR6Xmp5SeRbJ/1.json";
    ...
    constructor(
    ) ERC721A("Degen Friends Play", "DFP", 100, maxSupply) {
    }
