...
// website (https://mint.etherelves.xyz)
// 0.7.6

pragma solidity ^0.7.0;
pragma abicoder v2;

contract EtherElves is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant maxPurchase = 20;
    uint public reserve = 50; // for events and giveaways
    uint256 public price = 55000000000000000; // 0.055 ETH
    uint256 public constant MAX_SUPPLY = 5555;
    bool public saleIsActive = false;
    
    
    address private devAddr = 0x43DcBc41ba6fdbc5d6B04dcBf6959F0503cEDEF8;
    address private ownerAddr = 0x87c56882216A3Ae8d2A1530b1A413dA144a721C1;
    
    constructor() ERC721("Ether Elves", "ELVES") {
    }
    ...
    function mintEtherElves(uint numberOfTokens) public payable {
        require(saleIsActive, "Sale must be active to mint etherElves");
        require(numberOfTokens > 0 && numberOfTokens <= maxPurchase, "Can only mint 20 tokens at a time");
        require(totalSupply().add(numberOfTokens) <= MAX_SUPPLY, "Purchase would exceed max supply of etherElves");
