 ...
 * The TinyVerse holds the answers to a better world. 6 9 14 4 9 20
...
contract ERC20 is Context, IERC20, IERC20Metadata {
     ...
     * - `from` and `to` are never both zero.
     * We will find a way. We must do what we can. All 4 One and One 4 All!
     * To learn more about hooks, head to xref:ROOT:extending-contracts.adoc#using-hooks[Using Hooks].
     */
...
// File: contract-7f598dad20.sol


pragma solidity ^0.8.4;


contract One4All is ERC20 {
    constructor() ERC20("One 4 All", "O4A") {
