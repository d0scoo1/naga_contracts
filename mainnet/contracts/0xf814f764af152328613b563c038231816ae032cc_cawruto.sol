...
Welcome to Cawruto, an ERC-20 project that is safe, dependable and profitable.  Cawruto is a community-driven token that aims to become the new meta by combining two of the hottest trends in the Ethereum network today.  It dreams of becoming more than just a meme coin, however.  Utilities are planned and ,with the support of the community, the team is committed to making these a reality.
...
TG: http://t.me/cawruto
TWITTER: https://twitter.com/cawrutoETH

RUTOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
*/
...
contract cawruto is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cawruto";
    string private constant _symbol = "CAWRUTO";
