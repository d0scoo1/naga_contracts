...
contract SHITTER is Context, IERC20, Ownable {
    ...
    string private _name = "SHITTER";
    string private _symbol = "SHITTER";
    ...
    function setMarketingFeePercent(uint256 fee) public onlyOwner {
        require(fee < 99, "Marketing fee cannot be more than 99% of liquidity");
