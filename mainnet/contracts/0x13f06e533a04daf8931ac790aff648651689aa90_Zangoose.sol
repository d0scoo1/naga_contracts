...
//Zangoose usually moves on all fours
//but when he is angry
//he stands up on his hind feet and can avoid Sherman's attack with swift action.

//https://twitter.com/Zangoose_token
//https://t.me/zangoosetoken
//https://www.zangoose.org/
...
contract Zangoose is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("Zangoose", "Zangoose") {
