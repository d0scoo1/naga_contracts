...
contract FUCKOP is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmaSDmzEZ3ZaRaZDKEq7998u28whUGh2tLne4o4Rvx5A9Q";
    ...
    constructor(
    ) ERC721A("RR/FUCKOPENSEA", "FUCKOPENSEA", 100, maxSupply) {
    }
    ...
    function FUCKOPENSEA(uint256 _numfreemints)
        external
        onlyOwner
    {
