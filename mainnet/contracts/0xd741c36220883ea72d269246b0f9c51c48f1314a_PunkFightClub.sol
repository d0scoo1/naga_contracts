...
// File: contracts/PhoenixContract.sol

pragma solidity ^0.8.0;



contract PunkFightClub is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public preSaleMaxSupply = 1029;
    uint256 public nftPerAddressLimitPresale = 20;
    uint256 public maxMintAmountPresale = 20;
    
    uint256 public cost = 0.07 ether;
    uint256 public maxSupply = 1029;
    
    uint256 public maxMintAmount = 10;
    uint256 public nftPerAddressLimit = 100;
    
    uint256 public preSaleDate = 1650211200;
    uint256 public preSaleEndDate = 1650297600;
    uint256 public publicSaleDate = 1650297600;
    ...
    constructor() ERC721("Punk Fight Club", "PFC") {
        setNotRevealedURI("");
    }
