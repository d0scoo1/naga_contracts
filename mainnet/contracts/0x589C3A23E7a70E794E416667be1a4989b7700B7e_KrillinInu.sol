...
//📱 Telegram : https://t.me/KrillinToken
//💻 Website: http://Krillin.info/
...
contract KrillinInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 555555555555 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;
    address public contractMaker;
    string private _name = "Krillin Inu";
    string private _symbol = "KRINU";
    ...
    uint256 public numTokensSellToAddToLiquidity = 555555555555 * 10**9;
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 555555555555 * 10**9;
    }

    function DoubleUpMaxTxAmount() external onlyOwner() {
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 5555555555, "Swap Threshold Amount cannot be less than 5555555555");
    ...
    function addBot(address botter) external onlyOwner() {
        botWallets[botter] = true;
    }
    

    function removeBot(address botter) external onlyOwner() {
        botWallets[botter] = false;
    }
    ...
    function removeFeePermanently() external onlyOwner() {
        _previousTaxFee = 0;
