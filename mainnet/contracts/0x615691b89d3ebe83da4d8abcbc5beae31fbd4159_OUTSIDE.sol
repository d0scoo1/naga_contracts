/*
    ...
    Welcome to the Outside.io, an outdoor creator community on a mission to promote wellness, diversity, and sustainability in the outdoors. 
    Be part of this community with the world’s first NFT Marketplace dedicated to the outdoors. 
    We’ll be minting with the world’s renowned athletes, brands and non-profits - all designed for less screen time and more outside time.

    https://www.outside.io/
    https://twitter.com/outsideio
    https://www.instagram.com/outsideio/
...
contract OUTSIDE is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Outside Coin";
    string public _symbol= "OUTSIDE";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x075cdA3FA8c7F995ebF2B9e794fF7aBd2f8AC077);
