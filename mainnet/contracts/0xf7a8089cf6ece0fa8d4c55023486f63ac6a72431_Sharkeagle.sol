/*
 * 🦈 🦅 🎎 🎁 
 * https://sharkeagle.com
 * Sharkeagle as wedding anniversary gift for my wife
 * My honey used to draw all the Sharkeagles and asked me to help her publish as NFT to OpenSea, so totally 2266 unique Sharkeagles, as wedding anniversary gift for my wife, were free to mint in 2022.6.6. Our story: we met in the beauti city Sydney in 2016 and got married in 2020.6.6.
 * -- chis.eth
 */
...
// File contracts/Sharkeagle.sol


pragma solidity ^0.8.0;

contract Sharkeagle is NFT {
    uint16 public freeMints = 0;

    constructor() NFT("Sharkeagle as wedding anniversary gift for my wife", "Sharkeagle", 10, 2266) {
        BASE_URI = "ipfs://Qma9FXn2huRET6mGieSQnw7eFC4N2xkUdEfMLa8UZz7VEZ/";
        price = 0.066 ether;
        startTime = 1654473600; // 2022-6-6 00:00 UTC
        freeMints = 1000;
    }
