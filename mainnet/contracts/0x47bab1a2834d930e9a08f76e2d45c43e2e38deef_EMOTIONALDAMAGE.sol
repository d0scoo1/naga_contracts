...
contract EMOTIONALDAMAGE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmVLEebZDy3oYvuN1PBKosbgz3CwpTFvGn8c2GT1Cr2pWL";
    ...
    constructor(
    ) ERC721A("EMOTIONAL DAMAGE", "DOWNBAD", 100, maxSupply) {
    }
