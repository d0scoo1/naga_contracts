...
contract SpacedHeadz is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("Spaced Headz","SpacedHeadz", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "ipfs://QmZYLeDfzFj86bLz4orWhWbiqkFG3fy57w2HKz2wRkxsq1";
  }
