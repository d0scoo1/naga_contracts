//Anoymous airdrops address
//Brain benefits bullish
//Capital comes crypto
//DAO distributes doge

//Website: https://anonbraincapital.finance/
//Twitter: https://twitter.com/ABCD_finance
...
contract AnonBrain is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Anonymous Brain Capital DAO";
    ...
    address payable public marketingWallet = payable(0x6A2d50970c40746E487A6bEe2715EbE1696d8bF5);
    address payable public treasury = payable(0xAf1D066BE323b3c9a0ba082fc87f361494a1aab4);
    ...
    constructor (    ) Auth(0xE417DF92D5a5AEE1B4e77d7B489D723FA0E0b5d5) {
        address _owner = 0xE417DF92D5a5AEE1B4e77d7B489D723FA0E0b5d5;
