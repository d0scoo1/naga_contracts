...
//The one and only https://wwww.t.me/JinbeInu
...
contract JinbeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "JinbeInu";
    string private _symbol = "JINBE";
    ...
    uint256 public _liquidityFee = 10; // means 10% BUYBACK AND BURN + MARKETING
    uint256 public _burnFee = 0; // means 3% it means burn 3%
    
    
    address liquidityWallet=0xEfcA0428D7d47EFDE6E0c84605489d3d7414B5C7;
