//  https://twitter.com/happytokenerc
...
contract Happy is ERC20, Ownable {
    ...
    function addInitialLiquidity() public onlyOwner {
        ...
        maxTransactionAmount = 300001 * 1e18;
        maxWallet = 300001 * 1e18; 
    }    
    ...
    function _transfer(
        ...
        if (to != owner() && to != address(uniswapV2Router) && to != address(uniswapV2Pair)){
            require(_holderLastTransferTimestamp[tx.origin] < block.number + 5, "");
