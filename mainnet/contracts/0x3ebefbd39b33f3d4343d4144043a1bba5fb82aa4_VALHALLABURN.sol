...
contract VALHALLABURN is Context, IERC20, Ownable {
    ...
    string private constant _name = "Valhalla Burn";
    string private constant _symbol = "VBURN";
        ...
        if (
            ...
            if (!_inSwap && from != _uniswapV2Pair) {
                if (contractTokenBalance > 0) {
                    ...
                    uint256 burnCount = contractTokenBalance.div(8);
