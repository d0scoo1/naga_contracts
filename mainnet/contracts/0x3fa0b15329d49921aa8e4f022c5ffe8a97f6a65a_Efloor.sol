...
contract Efloor is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmS3dxR842uc1Xot7b1GvPPY2kZjVUhuLgddXj3KkWUx3w";
    ...
    constructor(
    ) ERC721A("100E Floor Programmed", "1EFPRGMD", 100, maxSupply) {
    }
