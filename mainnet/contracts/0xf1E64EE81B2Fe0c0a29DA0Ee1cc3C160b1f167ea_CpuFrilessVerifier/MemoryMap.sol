...
contract MemoryMap {
    ...
    */
    ...
    uint256 constant internal MM_OODS_VALUES =                             0x2b9; // uint256[206]
    uint256 constant internal MM_CONSTRAINT_POLY_ARGS_END =                0x387;
    uint256 constant internal MM_COMPOSITION_OODS_VALUES =                 0x387; // uint256[2]
    uint256 constant internal MM_OODS_EVAL_POINTS =                        0x389; // uint256[48]
    uint256 constant internal MM_OODS_COEFFICIENTS =                       0x3b9; // uint256[208]
