...
contract Mandelviews is ERC721Tradable {
    string baseURI;
    uint256 public MAX_SUPPLY = 111;
    uint256 public basePrice = 1618033988749894848;
    bool public paused;
    
    constructor()
        ERC721Tradable("Mandelviews", "MANDELS", address(0))
    {
        baseURI = "https://www.mandelviews.com/json/";
