...
contract goblintownpunk is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;


  uint256 public MAX_PER_Transaction = 7; // maximam amount that user can mint/Transaction
  uint256 public MAX_PER_WALLET = 7; // maximam amount that user can mint/Wallet
  ...
  uint256 private constant MaxMintPerBatch_ = 7; //max mint per transaction
  ...
  constructor() ERC721A("goblintownpunk","GTP") {
