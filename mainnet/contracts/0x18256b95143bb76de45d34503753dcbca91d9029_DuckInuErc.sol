...
contract DuckInuErc is Context, IERC20, Ownable {
    ...
    string private constant _name = "DuckInuErc";
    string private constant _symbol = "DuckInuErc";
