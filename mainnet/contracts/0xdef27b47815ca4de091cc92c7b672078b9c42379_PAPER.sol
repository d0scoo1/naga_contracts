...
contract PAPER is ERC721A, Ownable {

    string public baseURI = "https://api.samot.club/token/samotclub/";
    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;

    uint256 public constant MAX_PER_TX = 7;
    uint256 public constant FREE_MAX_SUPPLY = 1111;
    uint256 public MAX_SUPPLY = 2222;
    uint256 public price = 0.004 ether;

    bool public paused = false;

    constructor() ERC721A("Paper Adventure", "Stay") {}
