...
contract RRBAYCExpansion is ERC721A, Ownable {

    string public baseURI = "https://ipfs.io/ipfs/QmbtrXf5jZ1ujLZoUW8bWRApGDRJv3tUqeMGrUB6FS7WVZ";
    bool public paused;

    uint256 constant public MAX_MINT = 5600;
    uint256 constant public MAX_MINT_PER_TX = 10;
    uint256 public cost = 0.004 ether;
    uint256 public freemint = 500;

    constructor() ERC721A("RR/BAYC", "RR/BAYCEXPANSION") {}

    function mintRRBAKE(uint256 quantity) external payable {
