...
https://t.me/LiquidityStacker

Liquidity Stacker will be a nano cap token upon launch. 

Our sole mission is to provide investors with an opportunity to invest in a nano cap token that Stacks Liquidity. 

We will stack liquidity using taxes to contently add liquidity to our pool. 

The only taxes ever charged here will 100% go to building our liquidity (unless otherwise voted on by our community), providing stability along the way. 

As we grow, our Liquidity grows. 

4% Max Wallet
13% Tax - ALL to Liquidity
No supply burn - 100% of tokens sent to UniSwap, in true Nano fashion
*/                                                                           
...
contract LiquidityStacker is Context, IERC20, Ownable {
    ...
    string private _name = "LiquidityStacker";
    string private _symbol = "LPStack";
    ...
    uint256 public _maxTxAmount = 2760000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 350000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 2760000000000000000000 * 10**9;
