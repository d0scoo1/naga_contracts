...
// Traumatized individuals pay more attention to cues of threat than other experiences, and they interpret ambiguous stimuli and situations as threatening, leading to more fear-driven decisions. 

// If you are traumatized; terrified. Don’t join. If you think you are brave enough, you are welcome to our new world; our valhalla.
...
contract DZero is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "D0";
    string private constant _symbol = unicode"(O.O)";
