...
contract moonsadcat is Ownable, ERC721A, ReentrancyGuard{
    ...
    constructor() ERC721A("Moonsadcat", "MOONCAT") {
        _safeMint(msg.sender, 1);
    }

    modifier mintCompliance() {
        require(saleIsActive, "Sale is not active!");
        require(tx.origin == msg.sender, "No contract mint please!");
        _;
    }
    ...
    function freeMint(uint256 _quantity) external mintCompliance() {
        ...
        require(
            _freeMintedAmount + _quantity <= maxFreePerWallet,
