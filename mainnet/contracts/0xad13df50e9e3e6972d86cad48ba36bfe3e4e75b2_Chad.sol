/*
Introducing ONLYCHADS, the Token of Indifference, Camaraderie, and Excellence
 
The aim of $ONLYCHADS is to make sure our entire community ascends from permavirgins into a higher plane of existence. 
We look out for our brothers.
 
$ONLYCHADS will start as a fun shitcoin, a community builder, and develop into something more. Our tokenomics will allow us 
to sponsor people who are key players within the community, as well as promote ourselves to new heights.
 
Tokenomics:
5% Tax per Transaction
  - Absolutely No Burn of Tokens
- 3% Redistribution (Chad is always looking out for his loyal bros)
- 2% Marketing (Chad is a social butterfly, and always wants to get the word out)
 
Total supply of 100,000,000,000 ONLYCHADS tokens

NO PRESALE

The Developer of ONLYCHADS will be in the chat on a consistent basis, never leaving our bros hanging. This is key to maintaining the crew.
JOIN THE CHAD SQUAD HERE @onlychadscommunity
*/
library SafeMath {
...
contract Chad is ERC20{
    ...
    constructor () ERC20('OnlyChads',unicode'[̲̅O][̲̅N][̲̅L][̲̅Y] [̲̅C][̲̅H][̲̅A][̲̅D][̲̅S]') {
