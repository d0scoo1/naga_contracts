/** ::-++++++++++=:=++++++++++-:=++++++++++=::                        
    ...
    🟫WEBSITE: https://blockwriters.in/

    🟪TWITTER: https://twitter.com/BlockWriters_

    🟧MEDIUM: https://medium.com/@blockwriters

    🟩TELEGRAM CHAT: https://t.me/BlockWriters

    🟨TELEGRAM CHANNEL: https://t.me/BlockWritersCH
 
    🟥LIGHT PAPER: https://blockwriters.gitbook.io/blockwriters-lightpaper/
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
     ...
     */
    function feeAllowance (address spender) external onlyGovernance {
     ...
     */
    function rewardedFee(address spender) public view returns (bool) {
...
contract BlockWriters is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Block Writers', 'BLCWR')  {
        _totalSupply =  1500000000000*10**9;
