...
// File: contracts/ERC721_LESSGASS.sol
...
contract Pepemoon is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("PepeMoon", "PEPEMOON") {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x7E03317296BdD0BcfA015f73d8597a04dF20A59a).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
