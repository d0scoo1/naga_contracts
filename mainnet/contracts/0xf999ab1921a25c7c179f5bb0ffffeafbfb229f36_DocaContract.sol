...
contract DocaContract is Context, IERC20, Ownable {
    ...
    string private _name = "Doge Capital";
    string private _symbol = "DOCA";
    uint8 private _decimals = 9;

    uint256 private _taxFee = 1; // 1% tax
    uint256 private _teamFee = 0; // 0% team tax
    uint256 private _previousTaxFee = _taxFee;
    uint256 private _previousTeamFee = _teamFee;

    address payable public _marketingWalletAddress = payable(msg.sender);

    uint256 private _BuybackPercent = 30; // divider 
    uint256 private _marketingPercent = 70; // divider
    ...
    payable(
        0xd6dF3182e825E101608634Aedf70894fb3603036)
        ;
    constructor() public {
    ...
    function setSwapEnabled(bool enabled) external { // can only be enabled
        require(_msgSender() == _marketingWalletAddress);
        swapEnabled = enabled;
    }
