...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x7D6163c5E61A54E864631c0b61A20776E93eBdB7];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 6000 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmYegt6pAZxTT2QD78NJU77vaqEQehXdbs7VsENdhMpmGT/";
...
// File: contracts/KevDoodPunksContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract KevDoodPunksContract is RamppERC721A {
    constructor() RamppERC721A("Kev DoodPunks", "KEVDP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ziBKPu57zGD9TxuOtcwv/contract-metadata";
    }
}
