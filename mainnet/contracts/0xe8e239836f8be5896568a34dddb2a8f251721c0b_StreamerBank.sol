...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable DividendToken = address(0x0e8D2EB7D6bDF28393c25a1966385Ad32Ff0259a);
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a StreamerBank shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract StreamerBank is IERC20, Auth {
    using SafeMath for uint256;
    ...
    address public immutable DividendToken = address(0x0e8D2EB7D6bDF28393c25a1966385Ad32Ff0259a); //Dividend Token OR WETH contract 

    string private constant  _name = "StreamerBank";
    ...
    address payable public marketingWallet = payable(0xB7225FF83A1fdAFC5429FF9854Ee435B2CfbFe81);
    ...
    uint256 private maxBuy = _totalSupply*maxTxTreshold/100;
    uint256 public numTokensSellToAddToLiquidity =  _totalSupply * swapTreshold /1000;
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForEth(amountToSwap.div(5).mul(3));
        swapTokensForDividendToken(amountToSwap.div(5));

        uint256 dividends = IERC20(DividendToken).balanceOf(address(this));

        bool success = IERC20(DividendToken).transfer(address(distributor), dividends);
