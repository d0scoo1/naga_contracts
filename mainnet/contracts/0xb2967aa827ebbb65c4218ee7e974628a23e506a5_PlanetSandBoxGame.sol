...
📇Name: PlanetSandBox Game
💮Symbol: PSB
🌳Decimals: 18
🗃Max Supply: 1,000,000,000


PSB is the ultimate physics-powered sandbox shooting game. 
Build and own arenas to fight other players in different game modes using your own NFT weapons and accessories. 
Powered by the $PSB and $PULV token, PSB is the new Metaverse's world with P2E !

As a sandbox owner, you can customise your land with limitless building items, design game modes for others to join and play. 
The land will become a business where you sell or earn passive income through the renting system. T
he land system provides creators with various possibilities to build on diverse sceneries and landscapes such as Grass, Desert (with oasis), Mountain, Toxic Wasteland, Arctic, … etc. 
We will updat another environments in space like Moon, Mars - suggested by the name “Planet Sandbox”! 

_

🪐 PLANETSANDBOX 🪐 - 
LET’S BUILD, PLAY, EARN
**/
...
contract PlanetSandBox is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , PlanetSandBox{
...
contract PlanetSandBoxGame is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000 * 10 ** 18;

    constructor () ERC20('PlanetSandBox | t.me/planetsandbox_eth', unicode'PSB') {
