...
// File contracts/comics/ACDrop2.sol
...
contract ACDrop2 is Ownable {

  /**
   * @dev Time when the WL drop starts
   */
  uint256 public WLdropStart;
  /**
    ...
    payable
  {
    ...
    require(block.timestamp >= WLdropStart, "Drop not yet available.");
    require(
      block.timestamp >= dropStart || whitelisted[msg.sender], 
      "Only WL addresses allowed."
    );
