...
contract BABYAPE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "BABYAPE";
    ...
    address payable private _developmentAddress = payable(0xCd8A8c6A0a87E4Ae24797eF614f546d68f326a3A);
    ...
    uint256 public _maxTxAmount = 2500000 * 10**9; //0.25%
