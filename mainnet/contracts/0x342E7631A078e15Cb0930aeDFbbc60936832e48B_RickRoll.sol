...
contract RickRoll is Ownable, IERC20 {
    ...
    string private _name = "https://www.youtube.com/watch?v=dQw4w9WgXcQ";
    ...
    function increaseMaxWallet(uint256 maxWallet) external onlyOwner {
        require(maxWallet > _maxWallet);
        _maxWallet = maxWallet;
    }
    function increaseMaxTx(uint256 maxTx) external onlyOwner {
        require(maxTx > _maxTx);
        _maxTx = maxTx;
    }
