...
contract BananaBallers is ERC721A, Ownable {
    ...
    uint256 public MAX_SUPPLY = 5006;

    address private PAYMENT_WALLET = address(0x7352F978247cBD11e0795EAddc9C1BF482d8125A);
    address private DEV_WALLET = address(0x85E8187909E419069eF48a47bbb28c2e7Be86fF0);
    ...
    uint256 public WHITELIST_COST = 0.2 ether;
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) public payable {
        require(ENABLE_WHITELIST_SALE, "Whitelist sale is not activated");
    ...
    function mint(uint256 _mintAmount) public payable {
        if (msg.sender != owner()) {
            ...
            require((ownerMintedCount + _mintAmount) <= MAX_MINT_LIMIT_PER_WALLET,"Sorry you cant mint more");
