...
contract NonFungibleChuckECheese is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmWQzYCxFMnZtegVJqt8MMuzmEhLUmDphsgcR9aEbERrTZ";
    ...
    uint256 public NUM_FREE_MINTS = 116;
    ...
    constructor(
    ) ERC721A("Non Fungible Chuck E. Cheese", "Chuck E. Cheese", 100, maxSupply) {
    }
