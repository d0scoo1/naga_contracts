...
contract NOMOREFUCKINGGOBLINS is ERC721A, Ownable {
    ...
    constructor() ERC721A("NO MORE FUCKING GOBLINS", "NMFG", MAX_MINTS, MAX_SUPPLY) { 
    ...
    function setMAX_MINTS(uint256 newMax) public onlyOwner {
        MAX_MINTS = newMax;
    }
