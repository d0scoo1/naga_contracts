...
contract Realism is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUYTURHvW9By4bbBqD3L2feEJ1PZc3TWrFSpicNJ5X2Lv";
    ...
    constructor(
    ) ERC721A("Realism", "Realism", 100, maxSupply) {
    }
