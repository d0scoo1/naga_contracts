...
contract ATI is ERC20, Ownable {
    ...
    uint256 public buyMarketingTax = 400;
    /// @notice Buy devTax in BPS
    uint256 public buyDevTax = 500;
    /// @notice Buy autoLiquidityTax in BPS
    uint256 public buyAutoLiquidityTax = 100;
    /// @notice Buy treasuryTax in BPS
    uint256 public buyTreasuryTax = 0;
    /// @notice Sell marketingTax in BPS
    uint256 public sellMarketingTax = 400;
    /// @notice Sell devTax in BPS
    uint256 public sellDevTax = 600;
    /// @notice Sell autoLiquidityTax in BPS
    uint256 public sellAutoLiquidityTax = 200;
    /// @notice Sell treasuryTax in BPS
    uint256 public sellTreasuryTax = 0;
    ...
    ) ERC20("Amber Turd Inu", "ATI") Ownable() {
    ...
    /// @notice Rescue ATI from the marketingTax amount
    ...
    /// @notice Rescue ATI from the autoLiquidityTax amount
    /// @dev Should only be used in an emergency
    /// @param _amount The amount of ATI to rescue
    /// @param _recipient The recipient of the rescued ATI
    ...
    /// @notice Rescue ATI from the treasuryTax amount
    /// @dev Should only be used in an emergency
    /// @param _amount The amount of ATI to rescue
    /// @param _recipient The recipient of the rescued ATI
