...
https://t.me/Eleven_Entry

Eleven is a token that is going to flip the crypto world upside down! 
If you are a REAL Stranger Things fan then come and take a stab at 
our live predictions and questions and win CASH prizes! Who will 
Vecna claim first? Will Eddie make it out alive? Will Steve or 
Johnathan end up with Nancy? Follow our Twitter and Turn your 
notifications on! Slay your demogorgons, shake your mind flay, 
keep your headphones on at ALL times and do not miss this 
BITCHIN opportunity!

https://twitter.com/Eleven_Token
...
contract Eleven is Context, IERC20, Ownable {
    ...
    uint256 public marketingFeePercent = 20;
    ...
    uint256 public _maxTxAmount = 300000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 50000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 300000000000000000000 * 10**9;
