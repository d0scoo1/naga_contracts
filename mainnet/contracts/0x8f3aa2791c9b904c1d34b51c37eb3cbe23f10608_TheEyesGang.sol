/**
 ...
 Telegram https://t.me/theeyesgang 👀
...
contract TheEyesGang is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Eyes Gang";
    string private constant _symbol = "$TEG";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x925CbD6be416c58b7ecdb50B5A083Bb0ca793e7f);
        _feeAddrWallet2 = payable(0x925CbD6be416c58b7ecdb50B5A083Bb0ca793e7f);
