/**
 * 
    Jack Sparroge is a legendary pirate dog of the Seven Dog Breeds and the irreverent trickster of the Caribbean Chain.

    He fought a constant and losing battle with Jeets, Fud and his own best tendencies.

    Now he is putting together a good crew to glide on the Black Ethereum Pearl with and to assume the whole Chain!

    TG : https://t.me/jacksparroge
...
contract jacksparroge is Context, IERC20, Ownable {
    ...
    string private _name = 'jack sparroge';
