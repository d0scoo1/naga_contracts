...
contract SADAHARUTOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("Sadaharu Token", "SADAHARU") {
        ...
        maxWallet = totalSupply * 1 / 150; // 1.5%
        swapTokensAtAmount = totalSupply * 15 / 10000;

        _marketingBuyFee = 25; // 2.5%
        _liquidityBuyFee = 50; // 5%
        _devBuyFee = 25; // 2.5%

        _marketingSellFee = 25; // 2.5%
        _liquiditySellFee = 50; // 5%
        _devSellFee = 25; // 2.5%

        _marketingEarlySellFee = 50; // 5%
        _liquidityEarlySellFee = 100; // 10%
        _devEarlySellFee = 50; // 5%       
        ...
        marketingWallet = address(0xe98A40478Bb5E7293d4503CdD68357dC1de99f7F); 
        devWallet = address(0xAB4eC703bec1fe7D7b1bF546BeC5fadE7039e3CF); 
    ...
    function enableTrading() external onlyOwner {
        ...
        earlyselltax = block.number + 6283; // average number of blocks in a 24 hour period
        tradingActive = true;
    }
