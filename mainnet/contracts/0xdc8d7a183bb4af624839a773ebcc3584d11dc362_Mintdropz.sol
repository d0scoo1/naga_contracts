...
contract Mintdropz is ERC721, Ownable {
    ...
    uint256 public constant bananaPrice = 30000000000000000; // each token price is 0.09 ETH

    uint public constant maxBananaPurchase = 20;

    uint256 public constant MAX_BANANAS = 9600;
    ...
    constructor() ERC721("MISFITZ by Sunny Leone", "MISFITZ") { }
