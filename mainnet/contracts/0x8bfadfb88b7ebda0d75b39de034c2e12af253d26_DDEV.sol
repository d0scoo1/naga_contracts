...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20VotesComp.sol@v4.4.1
...
// File contracts/DDEV/DDEV.sol



contract DDEV is ERC20VotesComp {
    constructor()
    ERC20Permit("DDEV")
    ERC20("DDEV", "DDEV")
    {
        // There are total 100 million DDEV, of which 50 million DDEV
        // goes to 0x13D0aACF9b7F02AaA8C12C4D3FFB98A888046Cb4 and the rest
        // 50 million goes to 0xA456b6C338D66204416ee300dc5874D3640cf283.
        _mint(
            0x045C8c95eC4321AD47363d6C9fA5901471BCB402,
            50_000_000 * 10 ** decimals()
        );
        _mint(
            0xA456b6C338D66204416ee300dc5874D3640cf283,
            50_000_000 * 10 ** decimals()
        );
    }
}