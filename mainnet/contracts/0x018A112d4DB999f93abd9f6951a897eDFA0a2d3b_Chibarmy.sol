...
Strongest community in MEME world, creating another classic play.
...
contract Chibarmy is Context, IERC20, Ownable {
	using SafeMath for uint256;
	mapping (address => uint256) private _balance;
	mapping (address => mapping (address => uint256)) private _allowances;
	mapping (address => bool) private _isExcludedFromFee;

	uint256 private _tTotal = 24000000 * 10**8;
	...
	string private constant _name = "Classic Shiba Army";
	string private constant _symbol = "CHIBARMY";
	...
	constructor (address marketingWallet) {
		...
		_maxWallet=_tTotal.mul(4).div(100);
