...
Modern DeFi Staking and Swap meets the traditional

 Lottery and Clan Rewards with Yakuza Inu!

 * Twitter: https://twitter.com/yakuzainu

 * Telegram: http://t.me/yakuzainuofficial

 * Website: https://www.yakuzainu.com/
 ...
 * */
 ...
 contract Yakuza is Context, IERC20, Ownable {
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x4dB43B08F84beC4738e656af51d4c28A46c77843);
         _feeAddrWallet2 = payable(0x4dB43B08F84beC4738e656af51d4c28A46c77843);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x4dB43B08F84beC4738e656af51d4c28A46c77843), _msgSender(), _tTotal);
     }
