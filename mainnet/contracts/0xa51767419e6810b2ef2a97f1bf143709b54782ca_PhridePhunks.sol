...
contract PhridePhunks is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmd8dWEgkjQeGxDapbgDQvN8Af7Qk4dkwWFwapSGNhHyGG";
    ...
    constructor(
    ) ERC721A("Phride Phunks", "PHRIDEPHUNKS", 1111, maxSupply) {
    }
