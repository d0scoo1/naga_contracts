...
contract PUB is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmaX5qpwtYwpy9MB41PFbgc3AcaynNZoSPuCqbj18QQRSQ";
  ...
  ) ERC721A("Poor Unlucky Bears", "PUB") {
