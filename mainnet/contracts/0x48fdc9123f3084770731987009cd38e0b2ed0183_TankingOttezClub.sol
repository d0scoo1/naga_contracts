...
contract TankingOttezClub is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "http://app.ottz.world";
    address private openSeaProxyRegistryAddress = 0x7a3b5671f6c67b2C56f4605b474C44AfB207f824;
    bool private isOpenSeaProxyActive = true;
    mapping(address => uint256) public walletMintCount;

    uint256 public constant MAX_MINTS_PER_TX = 10;
    uint256 public maxMintAmountfreePerTx = 1;
    uint256 public maxMintAmountfreePerWallet = 2;
...
//   }
    ...
    constructor(
    ) ERC721A("Tanking Ottez Club", "Tanking Ottez Club", 100, maxSupply) {
    }
