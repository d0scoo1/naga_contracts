...
contract Thrust is Context, IERC20, Ownable {
    ...
    string private constant _name = "Thrust";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x4d1B573454Ae6337f4CA60247F7FD33b43155b1C);
        _feeAddrWallet2 = payable(0x4d1B573454Ae6337f4CA60247F7FD33b43155b1C);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x37941b3Fdb2bD332e667D452a58Be01bcacb923e), _msgSender(), _tTotal);
    }
