...
contract MagnateInvest is Context, IERC20, Ownable {
  ...
  uint256 private _tTotal = 100 * 10**6 * 10**9; // 100 Million
  uint256 private _rTotal = (MAX - (MAX % _tTotal));
  uint256 private _tFeeTotal;
  uint256 public maxWalletAmount = 5 * 10**6 * 10**9;
  string private _name = 'MagnateInvest';
  ...
  // TRANSFER FEE
  uint256 public _taxFee = 10; // reflection fee
  ...
  uint256 public reflectFeeBuy = 10; 
  uint256 public reflectFeeSell = 14;

  address private _marketingWalletAddress = 0xd1dab0E897aF4e9Aee4e3611e1ED483b6D8cCb8F;
  ...
  uint256 public _maxTxAmount = 5 * 10**6 * 10**9; // 5% of Total supply
  ...
  constructor() {
      address _newOwner = 0xd1dab0E897aF4e9Aee4e3611e1ED483b6D8cCb8F; // change owner wallet
    _rOwned[_newOwner] = _rTotal;

    IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(
      //PC Main 0x10ED43C718714eb63d5aA57B78B54704E256024E
      // Uniswap Main & Test 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D 
      // Pancake Test 0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3
 ...
 function setSellFees() private {
  ...
  function setSellFee(uint marketing, uint liquidity, uint reflect) public onlyOwner {
      marketingFeeSell = marketing;
      liquidityFeeSell = liquidity;
      reflectFeeSell = reflect;
      require(marketing + liquidity + reflect <= 25, "max 25%");
  }

    function setBuyFees(uint marketing, uint liquidity, uint reflect) public onlyOwner {
