...
contract THEM is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "THEM"; // Name
    string private constant _symbol = "THEM";  // Symbol
    ...
    address payable private _developmentAddress = payable(0x9Bf6aD61b2C4C759D8f660c7275086cEC94B8E7f);//
    address payable private _marketingAddress = payable(0x9Bf6aD61b2C4C759D8f660c7275086cEC94B8E7f);//
    ...
    uint256 public _maxTxAmount = 20000000000 * 10**9; // 0.5%
    uint256 public _maxWalletSize = 100000000000 * 10**9; // 1.5%
