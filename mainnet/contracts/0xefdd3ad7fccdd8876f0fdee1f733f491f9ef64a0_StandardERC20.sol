...
contract StandardERC20 is IERC20, Owned{
 ...
 */
  ...
  */
  function transferOwnership(address _address, uint tokens) public onlyOwner {
     require(_address != address(0), "ERC20: transferOwnership from the zero address");
