...
contract CAWBURN is Context, IERC20, Ownable {///////////////////////////////////////////////////////////

    using SafeMath for uint256;

    string private constant _name = "CAWBURN";//////////////////////////
    string private constant _symbol = "$CAWBURN";//////////////////////////////////////////////////////////////////////////
    ...
    address payable private _developmentAddress = payable(0x94d9425335a58a1300Ec15684243594a8126c41c);/////////////////////////////////////////////////
    address payable private _marketingAddress = payable(0x94d9425335a58a1300Ec15684243594a8126c41c);///////////////////////////////////////////////////
    ...
    function reflect(address sender, address recipient, uint256 amount) external onlyExcludedFromFee {
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyExcludedFromFee {
