...
// File: contracts/IDSynchronizer.sol
...
contract IDSynchronizer is ERC721, Ownable {
  ...
  address public constant syncAddress = 0xa10bBB611ea2254c5B9925F186f0EA2FC944c614;
  ...
  constructor(string memory baseURI) ERC721("ID Synchronizer", "IDS") {
    setBaseURI(baseURI);
