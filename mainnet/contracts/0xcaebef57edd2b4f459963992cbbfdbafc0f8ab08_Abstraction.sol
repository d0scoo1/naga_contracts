...
contract Abstraction is ERC721A, Ownable, ReentrancyGuard {
    ...
    payable
  {
    ...
    require(numberMinted(msg.sender) + _mintAmount <= maxMintsPerWallet, "Maximum minted per address exceeded. Only 10 max mints per account are allowed.");
