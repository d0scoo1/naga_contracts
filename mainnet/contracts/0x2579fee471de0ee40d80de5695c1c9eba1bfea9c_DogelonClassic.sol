// Telegram  : https://t.me/DogelonClassic

// Twitter   : https://twitter.com/DogelonClassic

// Website   : https://dogelonclassic.com/
...
contract DogelonClassic is Context, IERC20, Ownable {
    ...
    constructor () {
        _name = "DogelonClassic";
        _symbol = "DELONC";
        _decimals = 9;
        _tTotal = 10000000000 * 10 ** _decimals;
        _rTotal = (MAX - (MAX % _tTotal));
        numTokensSellToAddToLiquidity = 1000000 * 10 ** _decimals;
        _marketingWalletAddress = 0xF9a66456728b4B1Bf7C8EB0C7640136356143deC;
