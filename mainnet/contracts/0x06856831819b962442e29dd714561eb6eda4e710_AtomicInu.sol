...
"Atomic Inu": $ATOMU
The #1 Decentralised News reporting dAPP on Ethereum

Dev is Doxxed.

Telegram: t.me/AtomicInuETH
Website: atomicinu.com
Twitter: twitter.com/AtomicInuETH
...
contract dAPPRewards is Ownable {
  ...
  function LockToken() onlyOwner ifdAPPRewardsOff public {
    special = true;
    emit dAPPRewardsOn();
  }
...
contract AtomicInu is Context, IERC20, Ownable, dAPPRewards {
