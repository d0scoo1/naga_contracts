...
// Telegram : https://t.me/nexxtgeneration
...
contract NEXXTGENERATION is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public _tTotal = 100000000 * 10**9;                         
    uint256 public swapAtAmount = _tTotal.mul(10).div(10000);       
    uint256 public maxTxLimit = _tTotal.mul(150).div(10000);         
    ...
    constructor(address _dev) public ERC20("Nexxt Generation", "TWO") {
