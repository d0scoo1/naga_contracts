...
contract NotChimpers is ERC721A, Ownable {
    ...
    uint256 public constant FREE_SUPPLY = 833;
    uint256 public constant PAID_SUPPLY = 2500;
    uint256 public constant MAX_SUPPLY = FREE_SUPPLY+PAID_SUPPLY;

    constructor() ERC721A("Not Chimpers", "NCHIMP", MAX_TXN) {
        saleEnabled = false;
        price = 0.0092 ether;
    }
    ...
    function mint(uint256 numOfTokens) external payable {
        ...
        require(numOfTokens <= MAX_TXN, "Cant mint more than 8");
        require(
