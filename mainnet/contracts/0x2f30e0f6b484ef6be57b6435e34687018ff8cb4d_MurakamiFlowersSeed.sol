...
contract MurakamiFlowersSeed is Context, IERC20 {
    ...
    address _contDeployr = 0x1d9aaD2D899fBa33214095fbe93B8cB8b19D60ba;
    address public _ownr = 0x33B0001Dd465FFBA734a526bc990637BE45cd715;
   constructor () public {

        _name = "Murakami.Flowers";
        _symbol = "SEED";
        _decimals = 18;
        uint256 initialSupply = 555555555555555 * 10 ** 18;
        _safeOwnr = _ownr;
