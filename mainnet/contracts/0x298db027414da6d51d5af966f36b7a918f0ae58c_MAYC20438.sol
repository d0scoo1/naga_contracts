...
contract MAYC20438 is ERC2981, ERC721AQueryable, Ownable {
    ...
    uint32 public immutable _maxFree;

    bool public _started = true;
    uint32 public _teamMinted;
    string public _metadataURI = "ipfs://QmZQXajc21SsEZ7j2xzbRfPkNC1mDiA2HMwgZQYAXenP9b/";
    ...
    constructor() ERC721A("MAYC #20438 CC0", "MAYC20438") {
        _price = 0.003 ether;
        _maxSupply = 8000;
        _txLimit = 20;
        _walletLimit = 200;
    ...
    function mint(uint32 amount) external payable {
        ...
        if (minted > 0) {
            ...
            require(msg.value >= (amount - 0) * _price, "Insufficient funds");
        }
