...
contract ShinyToken is ERC20PresetMinterPauser, Ownable {    
    ...
    // Ownership amount (0.1%)
    uint256 OwnershipAmount = 10000000000000000000000; 
    uint256 CreatorAmount = 9990000000000000000000000;

    constructor(
        address _vestingBeneficiary
    ) ERC20PresetMinterPauser('Shiny Objects Social Club', 'SHINY') {
