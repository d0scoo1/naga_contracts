...
contract AIShitBeast is ERC721A, Ownable, Pausable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721A("AIShitBeast", "AISB") {
        setBaseURI("");
    ...
    function mintFree(uint256 _mintAmount) public payable nonReentrant{
        ...
        require(addressFreeMintedCount + _mintAmount <= maxperAddressFreeLimit, "Max AIShitBeast per address exceeded");
		require(_mintAmount > 0, "Cant mint 0 AIShitBeast" );
		require(s + _mintAmount <= maxFree, "Cant exceed AIShitBeasts supply" );
    ...
    function mint(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0 AIShitBeast");
        require(_mintAmount <= maxperAddressPublicMint, "Cant mint more AIShitBeast" );
        require(s + _mintAmount <= maxSupply, "Cant exceed AIShitBeastS supply");
