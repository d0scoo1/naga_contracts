...
// File: contracts/DystopiaNoize.sol
...
contract DystopiaNoize is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  Counters.Counter private supply;

  string public uriPrefix = "ipfs://QmVJrCx26fYWrFHpuV7FpuMVM4aFAAA61nomkD6UAEiWUj/";
  ...
  constructor() ERC721("DystopiaNoize", "DSTNZ") {
    setHiddenMetadataUri("ipfs://QmV9YZmctAxwhh7zP7Z6xPFeYp94WWQDMPjCKsK7qq3PH6/hidden.json");
  }
