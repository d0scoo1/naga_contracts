...
contract DreamCats is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant maxSupply = 998;
    uint256 public constant freeMints = 1;
