...
// | | |_ |/ _` | '_ ` _ \| '_ \| | | | __|
// | |__| | (_| | | | | | | |_) | |_| | |_ 
//  \_____|\__,_|_| |_| |_|_.__/ \__, |\__|
//                                __/ |    
//                               |___/     

contract Gambyt is ERC721A, Ownable {
  // general
  ...
  constructor() payable ERC721A('Gambyt', 'GAMBYT') {
    maxSupply = 160;
    maxPerTxnAllowlist = 2;
    maxPerWalletAllowlist = 2;
    maxPerTxnPublic = 10;
    maxPerWalletPublic = 40;
    mainWallet = payable(address(0x59F1eaA05F59371e6A5EcB2e7b2A206a135d4D7D));
  }
