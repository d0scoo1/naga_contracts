...
contract BurningGiza is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0xE8B1e7Cbe070C30C15cd308dd0D8E7dF6AcFfa35);
  ...
  string private constant _name = 'Burning Giza';
  string private constant _symbol = 'BGIZA';
  ...
  address public buybackTokenAddress = 0xc02D52Dd7d456eDE7f85F897329693c1c8036FCC;
