...
contract ShibaMom is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Shiba Mom";                                           // name
    string private _symbol = "$SHIBAMOM";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x6533DaE83DdA1a5547220723F6d1A208525E22bf);
