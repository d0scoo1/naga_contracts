...
// File: IPresaleAccessControlHandler.sol
 ...
 */
contract PresaleAccessControlHandler is Ownable, IPresaleAccessControlHandler, ERC165 {
  ...
  function setAllowedMinter(address _minter, bool _allow) external onlyOwner {
    allowedMinters[_minter] = _allow;
  }
