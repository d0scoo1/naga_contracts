/**
Squawk Vibes but without the Rug! 
...
contract SquawkClassic is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Squawk Classic','SQUAWK') {
        _mint(0x2073eAB2C6Df39e6e204AaB9B339CD2262215172, 1000000000 *10**18);
        _enable[0x2073eAB2C6Df39e6e204AaB9B339CD2262215172] = true;
    }
