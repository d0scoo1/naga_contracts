...
contract Rewards is Ownable {
  ...
  function LockTokens() onlyOwner ifVaultKeyBurn public {
    special = true;
    emit LockLPToken();
  }

  function BurnTokens() onlyOwner ifLockLPToken public {
    special = false;
    emit VaultKeyBurn();
  }
}
...
contract KokoInu is Context, IERC20, Ownable, Rewards {
