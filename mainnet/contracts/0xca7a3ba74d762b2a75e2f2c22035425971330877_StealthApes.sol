/**
    ...
    */
    ...
    contract StealthApes is ERC721, Ownable {
    using Strings for uint256;
    ...
    constructor() ERC721("Stealth Apes", "STAPES") {
        setHiddenMetadataUri("ipfs://QmZ6qrD9NUVP3NzMBhkCVdwyLwhx5fib1QSDPVGpLaJ1k9/hidden.json");
    }
    

    function maxMintAmount() internal view returns (uint _maxMintAmount) {
