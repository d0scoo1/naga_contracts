// hevm: flattened sources of /nix/store/bna431n14gaiilbd4nj2wsgpa08vq265-geb-rrfm-rate-setter/dapp/geb-rrfm-rate-setter/src/SetterRelayer.sol
...
////// /nix/store/npsy3mivgrrb261vicfv9nqb6dza0y3c-geb-treasury-reimbursement/dapp/geb-treasury-reimbursement/src/reimbursement/single/IncreasingTreasuryReimbursement.sol
/* pragma solidity 0.6.7; */
    ...
    constructor(
      ...
      uint256 perSecondCallerRewardIncrease_
        ...
        if (address(treasury_) != address(0)) {
          require(StabilityFeeTreasuryLike_2(treasury_).systemCoin() != address(0), "IncreasingTreasuryReimbursement/treasury-coin-not-set");
        }
        ...
        treasury                        = StabilityFeeTreasuryLike_2(treasury_);
...
////// /nix/store/bna431n14gaiilbd4nj2wsgpa08vq265-geb-rrfm-rate-setter/dapp/geb-rrfm-rate-setter/src/SetterRelayer.sol
/* pragma solidity 0.6.7; */
...
contract SetterRelayer_3 is IncreasingTreasuryReimbursement {
    // --- Events ---
    ...
    OracleRelayerLike_3 public oracleRelayer;
    ...
    constructor(
      ...
      uint256 relayDelay_
        ...
        oracleRelayer = OracleRelayerLike_3(oracleRelayer_);
    ...
    */
    function modifyParameters(bytes32 parameter, address addr) external isAuthorized {
        ...
        if (parameter == "setter") {
          ...
          require(StabilityFeeTreasuryLike_2(addr).systemCoin() != address(0), "SetterRelayer/treasury-coin-not-set");
          treasury = StabilityFeeTreasuryLike_2(addr);
        }
