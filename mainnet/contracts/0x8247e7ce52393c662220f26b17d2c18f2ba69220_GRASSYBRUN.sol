...
//https://t.me/GrassyBurn
//https://www.grassyburn.com/
//MaxBuy 2% to start BurnParty!!!
...
contract GRASSYBRUN is Context, IERC20, Ownable {
    mapping (address => uint) private _owned;
    mapping (address => mapping (address => uint)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => bool) private _isBot;
    uint private constant _totalSupply = 420000000 * 10**9;

    string public constant name = unicode"GrassyBurn";
    string public constant symbol = unicode"GRASSYBRUN";
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyTokens = 8400000 * 10**9; 
        _maxHeldTokens = 16800000 * 10**9; 
