...
// Elon Musk is tweeting every day about taxes, so we decided to create a funny, meme token about his situation!
// Come on the group, have fun with us and let's reach Elon

// ON TELEGRAM: @ElonPayTaxes
// HURRY UP !! WE ARE ABOUT TO STEALTH LAUNCH THIS 
...
contract ElonPayTaxes is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xB47768e805686B047679E9446706532C496893fa);
    ...
    string private _name = "ElonPayTaxes";
    string private _symbol = "$EPTAX";
