...
/// @title Breadsticks for NFOG owners!
/// @author Will Papper <https://twitter.com/WillPapper>
/// @notice This contract mints Breadsticks for Franchise owners and maybe other things
...
contract Breadsticks is Context, Ownable, ERC20 {
    ...
    /// @param tokenId The tokenId of the NFOG NFT
    ...
    /// @notice Allows the DAO to mint new tokens for use within the Olive Garden
    /// Cinematic Universe
    ...
    /// @notice Allows the DAO to set a new contract address for Franchises. This is
    /// relevant in the event that NFOG migrates to a new contract.
    /// @param oliveGardenContractAddress_ The new contract address for NFOG
    ...
    /// @dev This is relevant in case a future NFOG contract has a different
    ...
    /// @notice Allows the DAO to set a season for new breadsticks claims
    /// @param season_ The season to use for claiming Breadsticks
    ...
    /// @param breadsticksDisplayValue The amount of Breadsticks a user can claim.
    ...
    /// @notice Allows the DAO to set the season and Breadsticks per token ID
