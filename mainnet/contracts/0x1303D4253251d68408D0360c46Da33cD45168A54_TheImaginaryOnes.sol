...
/// @custom:security-contact info@theimaginaryones.net
contract TheImaginaryOnes is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("TheImaginaryOnes", "TIO") {}
