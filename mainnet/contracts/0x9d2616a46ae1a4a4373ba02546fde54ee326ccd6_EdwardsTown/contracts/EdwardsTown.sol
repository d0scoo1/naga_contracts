...
contract EdwardsTown is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint256 public freeMintAmount = 1111;
    uint256 private paidMintAmount = 2222;
    uint256 public mintCount;
    bool public isMintEnabled;
    string internal baseTokenUri = "ipfs://QmZHZBmFSjHKJ3V3DKN4ZiBcoyhMn4Pf9ivFh2EovT9Eoz/";
  ...
  function _baseTokenUri() internal view returns (string memory) {
    ...
    function mint(uint256 quantity_) public payable returns(uint256) {
        require(isMintEnabled, "Minting not enabled yet");
        
        if(mintCount <= paidMintAmount) {
            require(msg.value != 0, "Mint Now @0.007 ETH To Qualify For Free Minting");
