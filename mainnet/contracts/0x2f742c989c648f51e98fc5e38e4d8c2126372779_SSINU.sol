...
Sesshomaru Inu $SSINU(Japanese: せっしょうまる Sesshōmaru,
 Kanji: 殺生丸 Slayer) is a great dog that loves power and terrorizes the feudal world with the title of Lord of
  Western Japan. He is Inuyasha's half-brother and the successor of General Dog Demon, his father. This is the next #Anime coin project that we hope to explode today.
————————————————
Telegram: https://t.me/Sesshomaru_Inu

Twitter: https://twitter.com/Seshomaru_Inu
...
contract SSINU is Context, IERC20, Ownable {
    ...
    string private _name = 'Sesshomaru Inu';
    string private _symbol = 'SSINU';
