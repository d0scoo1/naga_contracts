...
abstract contract PToken is PTokenInterface, Exponential, TokenErrorReporter {
    ...
    function getBorrowSnapshot(address borrower) external view returns (uint, uint) {
        return (accountBorrows[borrower].principal, accountBorrows[borrower].interestIndex);
    }
