...
contract OnChainMonkeyKarma  is ERC721A, Ownable {

    string public baseURI = "https://nftservices.s3.amazonaws.com/karmamonkey/";

    uint256 public tokenPrice = 500000000000000000; //0.005 ETH
    ...
    constructor() ERC721A(" Karma", "Karma", 100, MAX_TOKENS) {
    }
