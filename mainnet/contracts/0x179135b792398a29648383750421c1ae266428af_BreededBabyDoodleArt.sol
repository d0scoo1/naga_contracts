...
contract BreededBabyDoodleArt is ERC1155, Ownable {
    string public constant name = "Breeded Baby D Art";
    string public constant symbol = "BBDART";
    ...
    IERC1155 public babydoodleart=IERC1155(0x4e82D0dBdd5A3E0a17bAE15A74A5B496728245D5);
    /*
    ...
    */
        ...
        public 
    {
        ...
        require(idFirst!=idSecond,"Cannot breed with himself");
        require(babydoodleart.balanceOf(msg.sender,idFirst)==1,"You don't own idFirst Baby D Art");
        require(babydoodleart.balanceOf(msg.sender,idSecond)==1,"You don't own idSecond Baby D Art");
        require(!hasBreed[idFirst],"First Baby D Art already breeded");
        require(!hasBreed[idSecond],"First Baby D Art already breeded");
        mint(msg.sender,1);
        hasBreed[idFirst]=true;
