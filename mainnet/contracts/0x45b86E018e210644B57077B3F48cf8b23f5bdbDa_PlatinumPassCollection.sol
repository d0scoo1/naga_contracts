...
contract PlatinumPassCollection is EIP712, Ownable, ERC721A {
    string private constant SIGNING_DOMAIN = "WEB3CLUB";
    string private constant SIGNATURE_VERSION = "1";

    uint256 public adoptionLimit = 5;
    uint256 public adoptionLimitWL = 5;
    ...
    constructor() ERC721A("Platinum Pass", "PP") EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION){}
   ...
   function sendGiftsToWallet(address _wallet, uint256 _num) external onlyOwner{
    ...
    function setAdoptionlimits(uint256 _adoptionLimit, uint256 _adoptionLimitWL) public onlyOwner() {
