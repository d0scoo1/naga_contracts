...
*
* Telegram: https://t.me/ShirahoshiInu
*/
...
contract ShirahoshiInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Shirahoshi Inu";                                           // name
    string private _symbol = "SHIRA";                                            // symbol
    ...
    // % to swap & send to team wallet
    uint256 public defaultTeamFee = 6;
    uint256 public _teamFee = defaultTeamFee;
    uint256 private _previousTeamFee = _teamFee;

    uint256 public _teamFee4Sellers = 6;

    bool public feesOnSellersAndBuyers = true;

    uint256 public _maxTxAmount = _tTotal.div(1).div(100);
    uint256 public numTokensToExchangeForTeam = _tTotal.div(100).div(100);
    address payable public teamWallet = payable(0xc0C16390a5A25B98Bae871FF7DdcB45050420bD5);
    ...
    function _transfer(
        ...
        bool overMinTokenBalance = contractTokenBalance >= numTokensToExchangeForTeam;
    ...
    function setFees(address recipient) private {
        ...
        _teamFee = defaultTeamFee;
        if (recipient == uniswapV2Pair) { // sell
            _teamFee = _teamFee4Sellers;
        }
    }
    ...
    function setDefaultTeamFee(uint256 teamFee) external onlyOwner() {
        defaultTeamFee = teamFee;
    }

    function setTeamFee4Sellers(uint256 teamFee4Sellers) external onlyOwner() {
        _teamFee4Sellers = teamFee4Sellers;
    }
    ...
    function setnumTokensToExchangeForTeam(uint256 _numTokensToExchangeForTeam) public onlyOwner() {
        numTokensToExchangeForTeam = _numTokensToExchangeForTeam;
    }

    function _setTeamWallet(address payable wallet) external onlyOwner() {
        teamWallet = wallet;
    }
