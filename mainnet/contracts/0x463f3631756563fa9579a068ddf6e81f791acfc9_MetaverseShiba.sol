/**
Metaverse Shiba is going to to be a real life game based on virtual reality meme
tokens where you can buy 3d nft meme characters. You can buy lands and develop
it’s utilities to invite other memes and organize social and business meetings. 

JOIN US - https://t.me/MetaverseShiba 
              https://twitter.com/_MetaverseShiba  
                   https://metaverseshiba.net/
...
contract MetaverseShiba is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Metaverse Shiba', 'METASHIBA')  {
