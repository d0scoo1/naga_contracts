// Today we are celebrating Fathers Day and
// especially how well Elon tends to his lovely doge.
// Let’s celebrate all together until we reached the moon and even more!
// HAPPY DOGE FATHERS DAY 

// 2% buy and sell 2% 

// Telegram : https://t.me/DogeFathersdayETH
...
contract DogeFathersday is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "DogeFathersday";
    string private constant _symbol = "DFATHER";
    ...
    address payable private _marketingAddress = payable(0x741462935a52fF1583C9db989181701DC8311dD8);
