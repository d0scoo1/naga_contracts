...
-- World Of Crypto NFT Game -- Beta anticipated in Q4 with NFT creation and graphic design courtesy of former 
...
contract WorldOfCrypto is Context {
...
contract ERC20 is Context, IERC20, IERC20Metadata , WorldOfCrypto{
...
contract WorldOfCryptoNFT is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 800000000 * 10 ** 18;

    constructor () ERC20('World Of Crypto | NFT GAME', unicode'☄WOC') {
