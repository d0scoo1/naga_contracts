// Bolt= Baby Volt
// Bolt rewards its Users with Volt token.
// Manual claim.
// initial tax 14%
// Tax will be reduced 2% after a period of time.
// Period 1 - first 2 hours (14%)
// Period 2 - next 4 Hours (12%)
// period 3 - Next 6 hours (10%)
// Period 4 - Next 8 hours (8%)

// TG - https://t.me/BoltToken
...
contract DividendDistributor is IDividendDistributor {
    ...
    address public immutable VOLT = address(0x7db5af2B9624e1b3B4Bb69D6DeBd9aD1016A58Ac); //UNI
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            shares[shareholder].totalExcluded = getCumulativeDividends(shares[shareholder].amount);
            IERC20(VOLT).transfer(shareholder, amount);
        }
    }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a VOLTBANK shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract BabyVolt is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Baby Volt";
    ...
    address payable public marketingWallet = payable(0x6eDAFf2857b872745aa8BC4270943CFF384B4149);
    ...
    uint256 private maxBuy = 15000000001 * (10 ** _decimals);
    ...
    function swapBack() internal swapping {
        ...
        swapTokensForVOLT(amountToSwap.div(2));

        uint256 dividends = IERC20(VOLT).balanceOf(address(this));

        bool success = IERC20(VOLT).transfer(address(distributor), dividends);
    ...
    function swapTokensForVOLT(uint256 tokenAmount) private {
