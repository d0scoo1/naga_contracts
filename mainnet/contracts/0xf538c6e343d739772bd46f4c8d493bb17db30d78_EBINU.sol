...
🐰Max buy/sell:   10,000,000🐰
🐰Max wallet:     40,000,000 🐰
🐰token will be locked🐰
🐰Contract will be renounced🐰
🐰htpps://t.me/EBINU_ETH🐰
🐰https://twitter.com/EBINU_ETH🐰
*/
...
contract EBINU is Context, IERC20, Ownable { 
    mapping (address => uint) private _owned;
    mapping (address => mapping (address => uint)) private _allowances;
    mapping (address => bool) private _isExcludedFromFee;
    mapping (address => User) private cooldown;
    uint private constant _totalSupply = 1_000_000_000 * 10**decimals;

    string public constant name = unicode"Easter Bunny Inu"; 
    string public constant symbol = unicode"🐰EBINU🐰"; 
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 10_000_001 * 10**9;
        _maxHeldTokens = 40_000_004 * 10**9;
    }
