...
contract LunaBet is Initializable {
  ...
  uint public constant betStartTimestamp = 1647243834;
  ...
  Side public winner; // The bet winner.
  uint public winningMultiplier; // in 1e18.

  /// @notice Contract upgradeable for safety measures.
