...
abstract contract Ownable is Context {
    ...
    address payable internal  dev = payable(0xf4EF28C2C736B7dc0E2B0eADCabd5A06F9c4dfc9);
    address payable internal  iv = payable(0x9e2101c558c0EB062FE5A5a79dD558e55aD2280D);
...
contract OBOT is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("O-Bot Game", "OBGame")  {
        setBaseURI(baseURI);
    }
