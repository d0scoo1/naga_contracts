...
contract SNOGE is ERC20, Ownable {
    ...
    uint256 public maxSellTransactionAmount = 1000000 * (10**8);
    uint256 public maxBuyTransactionAmount = 10000 * (10**8);
    uint256 public swapTokensAtAmount = 5000 * (10**8);
    uint256 public maxWalletToken = 10000 * (10**8);
    ...
    constructor() ERC20("Snake Doge", "SNOGE") {
        ...
        */
        _createInitialSupply(owner(), 1000000 * (10**8));
    }
