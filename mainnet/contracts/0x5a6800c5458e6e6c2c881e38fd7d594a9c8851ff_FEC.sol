...
contract FEC is IERC721, Ownable, Functional {
    ...
    address Dev = 0x2496286BDB820d40C402802F828ae265b244188A;
    address Art = 0x0860ECFF3F7FE9bE68b0ac2161726DACd3Aaa586;
     ...
     */
    constructor() {
        _name = "Freedom Eagle Club";
        _symbol = "FEC";
        _baseURI = "https://freedomeagle.club/metadata/";
        _hideTokens = true;
        
        totalTokens = 2225;
        price = 30 * (10 ** 15); // Replace leading value with price in finney
        maxPerWallet = 20;
        
        // Instant Mint 
        uint256 numToMint = 20;
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override returns (bool) {
        return  interfaceId == type(IERC721).interfaceId ||
                ...
                interfaceId == FEC.onERC721Received.selector;
    }
    
    // Standard Withdraw function for the owner to pull the contract
    function withdraw() external onlyOwner reentryLock {
        ...
        payout = ((10 * sendAmount) / 100);
        (success, ) = Dev.call{value: payout}("");
        require(success, "Transaction Unsuccessful"); 
        
        payout = ((20 * sendAmount) / 100);
        (success, ) = Art.call{value: payout}("");
        require(success, "Transaction Unsuccessful");   
        
        payout = ((70 * sendAmount) / 100);
    ...
    */
    ...
    function mint(uint256 qty) external payable reentryLock {
        ...
        require(_msgSender() == owner() || ((_balances[_msgSender()] + qty) <= maxPerWallet), "Mint: Max tokens per wallet exceeded");
        
        // extends minting availability for approved wallets during pre-sale
        require(mintActive, "Mint not open for business");
