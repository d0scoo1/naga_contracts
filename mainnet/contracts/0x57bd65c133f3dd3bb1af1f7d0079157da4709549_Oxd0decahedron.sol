...
contract Oxd0decahedron is ERC721Burnable, Ownable {
    
    string public OxD0DECAHEDRON_PROVENANCE = "";

    uint256 private Ox0_REQUIRED = 500 *10**18;
    uint256 private OxCUBE_REQUIRED = 5;
    ...
    constructor()ERC721("0xd0decahedron", "0xD0DECAHEDRON") {
    }
    ...
    */
    function setProvenanceHash(string memory provenanceHash) external onlyOwner {
        OxD0DECAHEDRON_PROVENANCE = provenanceHash;
    }
    ...
    function forge0xd0decahedron(uint256 numberOfTokens) external {
