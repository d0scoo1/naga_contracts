...
The Church of Ethereum welcomes a new congregation, one inspired by faith on the sound of a feathered creature and the dreams of a visionary.  Trust us.  Join us.  Let us ascend together and claim what is rightfully ours.
...
1.5% max TRX, 1.5% max wallet (At Launch)

3% max BUY / 1.5% max sell / 3% max wallet (after 10 mins)

TG: http://t.me/cawcultofficial
TWITTER:https://twitter.com/cawcultETH
Website : https://cawcult.mobirisesite.com

CULTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
*/
...
contract cawcult is Context, IERC20, Ownable {
    ...
    string private constant _name = "Caw Cult";
    string private constant _symbol = "CAWCULT";
