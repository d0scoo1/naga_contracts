/*
You must have heard of QOM,   a successful project on the ETH.
And recently you also see a very popular Classic trend, such as Shib Classic and Floki Classic, which have multiplied more than 100 times.
QOM Classic is a project that combines QOM and Classic trend.
*/
...
contract QOMC is ERC20, Auth {
    ...
    string public constant name = "Shiba Predator Classic";
    string public constant symbol = "QOMC";
    ...
    uint256 public constant totalFee = 4;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0B25469d2e340b165bd8712f6f836D376A194293;
