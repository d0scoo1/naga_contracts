...
https://t.me/LunaETHClipse_Portal
...
contract LUNAETHCLIPSE is Context,IERC20, Ownable{
    using Address for address;

    string private _name = "LunaETHClipse";
    ...
    address _owner;
    address payable public marketingAddress = payable(0x3B4176B9DdB13Ec3D9D8eE432A37D27c17438e21);
    ...
    function LECCoinDay() public onlyOwner{
         require(block.timestamp > LECCoinDaycooldown, "You cant call LECCoinDay more than once a day");
    ...
    function LECCoinDayOver() public onlyOwner{
         buyliqFee = buyprevLiqFee;
         buymktFee = buyPrevmktFee;
         LECCoinDaycooldown = block.timestamp + 86400;
    }
