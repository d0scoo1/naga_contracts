...
contract NFT_Contract is ERC721A, Ownable {
    ...
    string public UnrevealedURI = "ipfs://Qmcof3Wyaj2Sd2g7QADpFYQ8h7aVcXgJmUGjFXj6zWwqW7/";
    bool public revealed = false;
    bool public paused = true;
    bytes32 public merkleRoot;
    uint256 public maxWhitelist = 20;
    uint256 public maxPublic = 20;
    uint256 public maxSupply = 11111;
    address wallet = 0xe9933b9cd16717D48F183165B05f3A60defcA047;
    uint256 precentage = 10;

    uint256 public available4Mint = 494;
        ...
        payable
    {
        ...
        require(supply + quantity <= available4Mint, "Round Limit Reached");
    ...
    function setRoundTokens(uint256 _roundTokens) public onlyOwner {
        available4Mint = _roundTokens;
    }
    ...
    function withdraw() public onlyOwner {
        ...
        (bool os, ) = payable(wallet).call{value: address(this).balance/precentage}("");
        require(os);
