    ...
    fallback() external {
        ...
        assembly {
            ...
            for {} lt(friQueue, friQueueEnd) {friQueue := add(friQueue, 0x60)} {
                ...
                // res += c_108*(f_7(x) - f_7(g^32751 * z)) / (x - g^32751 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^32751 * z)^(-1)*/ mload(add(denominatorsPtr, 0x960)),
    ...
    */
    function oodsPrepareInverses(
        ...
        assembly {
            ...
            // expmodsAndPoints.expmods[18] = traceGenerator^391.
            ...
            let oodsPoint := /*oods_point*/ mload(add(context, 0x2b40))
            {
              ...
              // point *= g^32.
              point := mulmod(point, /*traceGenerator^32*/ mload(add(expmodsAndPoints, 0x1a0)), PRIME)
              // expmods_and_points.points[75] = -(g^32751 * z).
              ...
              // point *= g^391.
              point := mulmod(point, /*traceGenerator^391*/ mload(add(expmodsAndPoints, 0x240)), PRIME)
