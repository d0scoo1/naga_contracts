...
// File: contracts/Technohead_def.sol
...
contract TechnoheadMusicClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.0303 ether;
  ...
  constructor() ERC721("Technohead Music Club", "TMC") {
    setHiddenMetadataUri("ipfs://bafybeiamib6cwjqr4erw25l7zo3peb23h4yheqcsvqi7ch6syuqsuf6p6q/hidden.json");
  }
