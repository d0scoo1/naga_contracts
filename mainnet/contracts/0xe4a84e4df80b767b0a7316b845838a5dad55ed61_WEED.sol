...
For too long anyone that smokes weed has been seen as lazy and unreliable.
Today this changes. Today we show them a multi million dollar marketcap. 
- Mr. Weed 
...
contract WEED is Context, IERC20, Ownable, Pausable {
    ...
    address payable public marketingWallet = payable(0xC964e2C94eA16DF81683aED5e13224C664F49c9A);
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000000000 * 10**9; //0.1%
    uint256 public _maxTxAmount = 300000000000 * 10**9;
    uint256 public maxBuyTransactionAmount = 50000000000 * 10**9;  //0.5%
    uint256 public maxWalletToken = 100000000000 * 10**9; //1%
