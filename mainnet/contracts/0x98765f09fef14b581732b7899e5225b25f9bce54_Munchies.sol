...
contract Munchies is ERC721, Ownable {
  ...
  function withdraw() public onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x8618F71c5Ca43c7A5EF355A0171F70D2E9A18F98).call{value: address(this).balance * 40 / 100}("");
    require(hs);
    ...
    require(ms);
    (bool js, ) = payable(0xB2fEde6896dD63F4cFf37dC193BCc99f2b69Eda0).call{value: address(this).balance * 33 / 100}("");
    require(js);
