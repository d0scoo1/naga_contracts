...
Mother of the popular Shiba Inu. 

I am the mother you would like to invest in! (MYLI)
*/
...
contract DONNAINU is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Donna Inu";
    ...
    uint256 public _maxWalletSize = 3e9 * 10**9;
