...
contract UPYOERC721Collection is ERC721Base {
    ...
    function lazyMint(
        ...
        uint buyingBrokerage = (_brokerage.buyer * price) / (100 * decimalPrecision);
        ...
        uint sellingBrokerage = (_brokerage.seller * price) / (100 * decimalPrecision);
        uint sellerFund = price - sellingBrokerage;
