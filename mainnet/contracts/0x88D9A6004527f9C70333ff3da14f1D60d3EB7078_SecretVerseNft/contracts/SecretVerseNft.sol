...
contract SecretVerseNft is ERC721Enumerable, AccessControl, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    string _baseTokenURI = "https://api.secretverse.io/token/";
    ...
    constructor() ERC721("SecretVerse", "SV_NFT") {
