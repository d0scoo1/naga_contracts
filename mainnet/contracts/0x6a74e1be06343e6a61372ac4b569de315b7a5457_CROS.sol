...
contract CROS is
    ...
    Freezable
{
    string constant private _name = "ONTACT Protocol";
    string constant private _symbol = "ONTP";
    uint8 constant private _decimals = 18;
    uint256 constant private _initial_supply = 1_900_000_000;
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "ONTP/transfer : Should not send to zero address"
        );
