...
contract Shibvolt is IERC20, Context, ERC20Ownable {
    ...
    string private constant _name = "ShibVolt";
    string private constant _tick = "SHIBVOLT";
    ...
    constructor() {
        ...
        feeWallet = payable(0x8DAbAbC6b4cC56b6e9F85CDF2e9dC6025a9fC890);
