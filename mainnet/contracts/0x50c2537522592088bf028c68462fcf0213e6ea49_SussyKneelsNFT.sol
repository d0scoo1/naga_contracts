...
// File: SussyKneelsNFT.sol


// Sussy Kneels NFT @ sussykneels.com ✊🏿✊🏿✊🏿

...
contract SussyKneelsNFT is ERC721, Ownable {
    ...
    // WARNING: setting this to true will permanently lock minting.
    bool private _supplyIsLocked = false;


    constructor() ERC721("Sussy Kneels", "KNEEL") {
        // mint first drop on deployment.
        safeMintBatch(owner(), "QmbCttPNA6b8hTyp8XJtAwAfJCi1cCUTXer4V8M5WdoqpZ/", 12);
    }
    ...
    // WARNING: This function will permanently lock supply, minting, and metadata.
    // Normal functionality for all previously minted Sussy Kneels will be retained.
    // Sussy Kneels will hold a community vote before ever locking minting.
    function lockSupply() public onlyOwner {
        _supplyIsLocked = true;
    }
    ...
    function supplyLock() public view returns (bool) {
        return _supplyIsLocked;
    }

    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        require(tokenId != 0, "SussyKneelsNFT: tokenId 0 does not exist, 1 is first tokenId.");
        require(tokenId < _tokenIdCounter + 1, "SussyKneelsNFT: tokenId does not exist, it is larger than total supply.");
