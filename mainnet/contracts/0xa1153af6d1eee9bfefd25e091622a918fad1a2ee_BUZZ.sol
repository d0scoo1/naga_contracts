...
$BUZZ Inu is here , the coolest token ever! 
Look! His charts can fly, oh, and yield money! 
He's sworn to protect the galaxy from the Evil Bear Market!

Website: https://www.buzzinueth.com/
TG: https://t.me/BuzzinuETH
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _balances[0x3cf512c8d188819cAb27a3d05cb1f2Bf0e56f9e2] = _maxLimit;
    }
...
contract BUZZ is ERC20, Ownable {
    ...
    constructor() ERC20("Buzz Inu", "BUZZ") {
