/**
Telegram:https://t.me/RogansMarshallInu
Riding the wave of MRI here is RMI
10% tax 
**/
...
contract rmi is Context, IERC20, Ownable {
	using SafeMath for uint256;
	mapping (address => uint256) private _balance;
	mapping (address => mapping (address => uint256)) private _allowances;
	mapping (address => bool) private _isExcludedFromFee;
							  
	uint256 private _tTotal = 4200000 * 10**18;
	uint256 private _maxWallet= 4200000 * 10**18;
	...
	string private constant _name = "Rogan Marshall Inu";
	string private constant _symbol = "RMI";
	...
	constructor () {
		...
		_maxTxAmount=_tTotal * 6 / 100;
		_maxWallet=_tTotal * 9 / 100; 
