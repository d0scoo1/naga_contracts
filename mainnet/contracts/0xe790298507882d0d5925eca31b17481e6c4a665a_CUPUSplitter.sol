...
contract CUPUSplitter {
    error InvalidPayeeAddress();
    error AccountIsNotDuePayment();

    address constant PAYEE1 = 0x51CDCB6eA20C86A4EA1B264f1E290aCd2694948f;
    address constant PAYEE2 = 0x2B4EcB20b3789f3db2eEb41cCACc74BCFc89b387;

    uint256 constant SHARE = 50;
    uint256 constant TOTALSHARES = SHARE + SHARE;
    ...
    function release(address payable account) public {
        if (account != PAYEE1 && account != PAYEE2)
