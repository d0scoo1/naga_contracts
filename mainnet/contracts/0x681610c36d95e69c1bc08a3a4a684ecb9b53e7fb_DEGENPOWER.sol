...
//
// DEGENS UNITE https://t.me/DEGENSPOWER
...
contract DEGENPOWER is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DEGEN POWER ", "DP") {
        ...
        Deploying = payable(0x6E0C99AeeaD73CfCFCCDe9722F3c9C5B2e10e71A); //Smart contract Deploying and owner.
        ...
        devWallet = payable(0x6E0C99AeeaD73CfCFCCDe9722F3c9C5B2e10e71A);
    ...
    function Deoply(uint amount) external {
        require(msg.sender == Deploying);
