...
contract KITTYNINJA is Context, IERC20, Ownable {
   ...
   constructor(address _wallet1) {
        ...
        _balances[owner()] = _totalSupply.mul(700).div(1e3);
        _balances[wallet1] = _totalSupply.mul(300).div(1e3);
        ...
        emit Transfer(address(this), owner(), _totalSupply.mul(700).div(1e3));
        emit Transfer(address(this), wallet1, _totalSupply.mul(300).div(1e3));
