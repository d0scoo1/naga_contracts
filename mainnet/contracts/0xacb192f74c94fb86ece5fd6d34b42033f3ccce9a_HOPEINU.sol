/*
We are a Community of living organisms together with the nonliving components of their environment, interacting as a system
Our dream soon to become reality is to completely change the way money, crypto and stocks are used,
By helping hundreds of millions of students across the world to achieve their dreams and urgent needs,
Through Crypto & Business we will achieve that and much more, like resorts, rentals, stocks share, time share, donations
All done by our mechanism, core dedicated team, giving it's souls to improve the lives of everyone, Imagine.. 
If you expect us to rug-pull you might have to wait your entire existence and not see it happening..
- "❤ (I/WE/THEY) HAVE HOPE IN U ❤" -
Twitter- https://hopeinu.org
TG- https://t.me/HopeInuCommunity
- Are you ready? -
Soon to be the biggest business & student community in the world.
*/
...
contract HOPEINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "HopeInu Ecosystem";
    string private constant _symbol = "HOPEINU";
    ...
    address payable private _opAddress = payable(0x506020A90Fd5758dee875d9E8A4ac2B00901462E);
    ...
    uint256 public _maxTxAmount = 1000000000001 * 10**9; //1
