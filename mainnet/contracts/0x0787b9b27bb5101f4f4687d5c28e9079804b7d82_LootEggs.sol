...
contract LootEggs is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function setAirdropList(address[] memory _AirdropList) public onlyOwner {
        for (uint256 i = 0; i < _AirdropList.length; i++) {
            AirdropList[_AirdropList[i]] = true;
        }
    }

    function removeAirdropList(address[] memory _AirdropList) public onlyOwner {
        for (uint256 i = 0; i < _AirdropList.length; i++) {
            AirdropList[_AirdropList[i]] = false;
        }
    }
    ...
    function getClaimAirdropNum(address _user) public view returns (uint256){
        ...
        if (num == 0 || canClaimAirdrop == false) {
            return 0;
        }
        uint256 num2 = 0;
    ...
    function claimAirdrop() public nonReentrant {
        ...
        require(num > 0, "k033");
        uint256 num2 = getClaimAirdropNum(msg.sender);
        require(num2 > 0, "k034");
        for (uint256 i = 0; i < num; i++) {
