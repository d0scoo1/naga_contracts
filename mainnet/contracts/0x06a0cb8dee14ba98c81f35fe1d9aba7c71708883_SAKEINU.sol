...
contract SAKEINU is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Sake Inu";                                           // name
    string private _symbol = "SAKE";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x92f50Ff900513758762be591A3d1343d0b31856f);
