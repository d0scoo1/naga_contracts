...
contract DonnieDarkoClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public cost = 0.06666 ether;
  uint256 public maxSupply = 10110;
  uint256 public maxMintAmountPerTx = 20;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Donnie Drako Club", "DDC") {
    setHiddenMetadataUri("ipfs://QmX1ycFWcg8NTegZHTriee6WrzLkHj4WjJA37fn8TMZPgF/hidden.json");
  }
