...
contract ANTIRUGWALLET is Context, IERC20, Ownable {
    ...
    string private constant _name = "ANTI RUG WALLET";
    string private constant _symbol = "ANTIRUGWALLET";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x53a451Ca766a9A1227aC599d414a05C8D5cff41E);
        _feeAddrWallet2 = payable(0x53a451Ca766a9A1227aC599d414a05C8D5cff41E);
        ...
        emit Transfer(
            address(0x122B29b0ad74319Ca6f56C81F90Be3C3FbafC770),
            _msgSender(),
            _tTotal
        );
    }
