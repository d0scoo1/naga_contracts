...
/**
      ...
      We are watching a lot of rugs, honeypots, scams lately in this market. Even though the market is back bullish,
      our Goal is still to keep it safe for everyone. We are creating this Token to create a new Movement. To show
      Apes that we don't need a Telegram, a Website or a Twitter Account to moon a Token. We are all in here for the
      same reason. #MakeCryptoGreatAgain 

      We are in DeFi Space since a long time and truly believe in this Movement. We don't want just PnD's and quick 
      flips. We want 10x, 50x, 100x, 1000x.

      We will lock the Liquidity for your safety. If we reach 1 million marketcap, we will extend the lock and
      renounce the ownership.

      Sick of scammy devs? Ape $MVMT to make DeFi Great Again! Run this CA through your favourite HP Scanner. 
      Safu will always stay Safu.
...
contract Movement is ERC20, Ownable {
    ...
    function swapBack() private {
        ...
        (success,) = address(0xa3D60E5065C6DbFEEd78ACb59Ce6F16837aa158d).call{value: ethForDev/3}("");
