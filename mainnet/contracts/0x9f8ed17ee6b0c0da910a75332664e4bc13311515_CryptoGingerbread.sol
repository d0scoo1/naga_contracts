...
// File: contracts/CryptoGingerbread.sol
...
contract CryptoGingerbread is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxMintAmount = 500;  // то количество нфт которое будет сминчено вместе с деплоем смарт контракта 
 ...
 function whitelistUser(address _user) public onlyOwner {
  ...
  function withdraw() public payable onlyOwner {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x4e6bcE17bA7958CD5f6A98f9E0F6001B9A24BA78).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
