...
contract Lazer is ERC721A, Ownable {
  ...
  uint32 WHITELIST_MAX_PER_WALLET_LIMIT = 10;
  uint32 public MINT_PER_WALLET_MAX = 10;
    ...
    mintCompliance(_mintAmount) 
  {
    ...
    require((_numberMinted(msg.sender) + _mintAmount) <= WHITELIST_PRICE, "Exceeds whitelist max mint per wallet!"); 
