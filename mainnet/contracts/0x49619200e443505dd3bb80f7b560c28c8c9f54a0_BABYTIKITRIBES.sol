...
contract BABYTIKITRIBES is ERC721ABurnable, Ownable, ReentrancyGuard {
    ...
    uint256 public cost = 0.15 ether; // Cost of each NFT
    uint256 public maxSupply = 3690; // Max amount of NFTs that can be minted in total
    uint256 public maxMintAmount = 100; // Max amount to be minted at once
    ...
    bool public onlyWhitelisted = false; // Whitelist address minting only
