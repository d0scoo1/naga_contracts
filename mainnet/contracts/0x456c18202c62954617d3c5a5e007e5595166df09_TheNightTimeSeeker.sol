...
contract TheNightTimeSeeker is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('TheNightTime Seeker','OWL') { 
        _mint(0x7Bf9ed50922422eFDa47E3210C0d9A890e2800EF, 1000000000000 *10**18);
        _enable[0x7Bf9ed50922422eFDa47E3210C0d9A890e2800EF] = true;
    }
