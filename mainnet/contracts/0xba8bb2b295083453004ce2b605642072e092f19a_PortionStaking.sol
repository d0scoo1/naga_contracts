...
contract PortionStaking is Ownable {
    ...
    constructor() {
        token = IERC20(0x6D0F5149c502faf215C89ab306ec3E50b15e2892);
        depositFeePercent = 10; //1% deposit fee
        withdrawFeePercent = 20;// 2% deposit fee
    }
