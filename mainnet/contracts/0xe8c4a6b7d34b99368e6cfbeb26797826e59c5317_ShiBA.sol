...
There are many people in the world who love the NBA, and this game is based on the NBA. 
...
🏀: https://t.me/shiba01erc
——————————————————
🌎: shiba01erc.com
——————————————————
🕊: https://twitter.com/ShiBA01Dev
...
contract ShiBA is Context, IERC20, Ownable {
    ...
    Taxes private _taxes = Taxes(0,3,0,7);
    ...
    constructor () {
        _feeAddrWallet = payable(0xE3237598Ba6C207424bad7dBE6Ea8B4b0bEB2746);
