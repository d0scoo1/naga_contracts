...
contract ToiletVees is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmSWhTsBniumMJ7svxeaNXUdExPLVqLvyytEGWtrpdUCkD";
    ...
    constructor(
    ) ERC721A("Toilet Vees", "TV", 100, maxSupply) {
    }
