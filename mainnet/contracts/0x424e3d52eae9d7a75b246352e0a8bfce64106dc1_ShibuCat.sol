/**
        ...
        Tg: https://t.me/shibucat
        Web: https://shibucateth.com
...
contract ShibuCat is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x8fd8Bd2A27E5ffa2b7f23779B7BCEC0E33B42EA9); // Marketing Address
    ...
    string private constant _name = "ShibuCat";
    ...
    uint256 public _reflectionsFee = 9;
    ...
    constructor() {
        ...
        marketingAddress = payable(0x8fd8Bd2A27E5ffa2b7f23779B7BCEC0E33B42EA9); //  update to marketing address
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_isExcludedFromFee[to]) {
            ...
            // Sell
                ...
                _taxFee = _sellTaxFee;
                _liquidityFee = _reflectionsFee + _sellMarketingFee;
                if(_liquidityFee > 0){
    ...
    function _takeLiquidity(uint256 tLiquidity) private {
        if(buyOrSellSwitch == BUY){
            ...
            _liquidityTokensToSwap += tLiquidity * _reflectionsFee / _liquidityFee;
    ...
    function setSellFee(uint256 sellTaxFee, uint256 reflectionsFee, uint256 sellMarketingFee)
        external
        onlyOwner
    {
        ...
        require(_sellTaxFee + _reflectionsFee + _sellMarketingFee <= 30, "Must keep taxes below 30%");
    }
