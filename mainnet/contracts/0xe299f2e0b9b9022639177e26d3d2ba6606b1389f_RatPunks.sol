...
10100101000001101010010000010100001010101100111010010111010011

Web Site - https://ratpunks.com
Discord - https://discord.com/invite/NQQ9H37t6N
Twitter - https://twitter.com/MechAnimalsWars
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI, Ownable {
    ...
    address payable internal  dev = payable(0xF81720AE7Ec651749CbA8Ceccc7e6ed8A1A13aBC);
    address payable internal  char = payable(0x976D23c9C926CF3E481fF7d017E63A7cBEcB1c16);
   
    function  _withdrawAll() internal virtual {
       uint256 balanceDev = address(this).balance*12/100;
       uint256 balanceChar = address(this).balance*5/100;
...
contract RatPunks is ERC1155 {
    string public name;
    string public symbol;
    uint public  MAX_TOKEN = 4444;
    uint public  basePrice = 10*10**15; // ETH
