...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xd60249aeD888e2B76b679B6d8521dACfBfb874b3] = _marketingwallet;
    }
...
contract BoredApeYachtClassic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bored Ape Yacht Classic", "BAYCLASSIC") {
        ...
        excludeFromFees(address(0xd60249aeD888e2B76b679B6d8521dACfBfb874b3), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xd60249aeD888e2B76b679B6d8521dACfBfb874b3), true);
