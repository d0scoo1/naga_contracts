...
contract RamenExpress is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ramen Express";//
    string private constant _symbol = "POORBOIS";//
    ...
    address payable private _developmentAddress = payable(0xe2aD774274Db6ceFE4b53AeF0AB31AcfcB6b6567);//
    address payable private _marketingAddress = payable(0x7E17E5E07674B74Aa1323D023200436C73d5188A);//
    ...
    uint256 public _maxTxAmount = 980000 * 10**9; //
