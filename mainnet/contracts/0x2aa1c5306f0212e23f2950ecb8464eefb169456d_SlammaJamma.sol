...
contract SlammaJamma is ERC721Enumerable, ReentrancyGuard, Ownable {    
    ...
    uint256 constant public MAX_SALE_SUPPLY = 9900;
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Squad #', toString(tokenId), '", "description": "Slamma Jamma is a randomized squad generated and stored on chain. All functionality is intentionally omitted for the community to interpret. Feel free to use Slamma Jamma in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    function ownerClaim(uint256 tokenId) public nonReentrant onlyOwner {
        require(tokenId >= MAX_SALE_SUPPLY && tokenId <= MAX_SUPPLY, "Token ID invalid in this range");
