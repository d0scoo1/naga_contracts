//https://t.me/WhiteRoosterPortal
//https://twitter.com/WhiteRoosterErc
...
contract GoblinPredator is Context, IERC20, Ownable {
    ...
    string private constant _name = "Goblin Predator";
    string private constant _symbol = "WhiteRooster";
    uint256 private _maxTxAmount = _tTotal.mul(50).div(1000);
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0xd1d9906B8189Ec0907cb243A3099dC1410bA2856);
        _feeAddrWallet3 = payable(0xFFB21eF9721ff0ef67671b9B644e63D59dEC1919);
        _tOwned[address(this)] = _tTotal.div(100).mul(100);
        _tOwned[address(0x63715B649192644cf27fc8d081d7E2352190984c)] = _tTotal.div(100).mul(1);
        _tOwned[address(0x3E025019E0725E564Fa236C4038FF4b4EfD0b078)] = _tTotal.div(100).mul(1);
