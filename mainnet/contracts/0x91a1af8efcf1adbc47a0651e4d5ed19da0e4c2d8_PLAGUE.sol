 ...
 */
 /**
    Telegram: https://t.me/plaguedoctortoken 
    
                        TEH EYES TO SEE... AND THE EARS TO HEAR.
...
contract PLAGUE is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PLAGUE";
    ...
    uint256 private _maxTxAmount = 60_000_000_000 * 10**9;
    uint256 private _maxWalletAmount = 120_000_000_000 * 10**9;
