...
contract Narutaki is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Narutaki", "Narutaki") {
     ...
     uint256 totalSupply = 1 * 10 ** 9 * 10 ** decimals();
        ...
        maxTransactionAmount = 10 * 10 ** 6 * 10 ** decimals(); // 0.7% maxTransactionAmountTxn
        maxWallet = 20 * 10 ** 6 * 10 ** decimals(); // 1.4% maxWallet
