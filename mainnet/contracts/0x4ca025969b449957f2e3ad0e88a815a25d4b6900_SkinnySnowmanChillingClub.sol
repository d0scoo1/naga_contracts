...
// File: contracts/SkinnySnowmanChillingClub.sol
...
contract SkinnySnowmanChillingClub is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
    ...
    maxPerAddressDuringMint = maxPerWallet_;
  ...
  function FreeMint(uint256 quantity)
    ...
    callerIsUser
  {
    require(quantity <= maxPerTxn, "reached max per txn");
    ...
    callerIsUser
  {
    ...
    require(msg.value == upgradeCost, "Amound not correct");
    level[tokenId]++;
  }
