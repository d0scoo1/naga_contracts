...
contract pterodactylus is Context, IERC20, Ownable {
    ...
    string private _name = "pterodactylus";
    string private _symbol = "TERO";
    ...
    uint256 public _maxBuyAmount = 5000000000000 * 10**9;
    uint256 public _maxWalletAmount = 15000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 200000000000 * 10**9;
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public marketingWallet = 0x249002cf6A8769f6d18bbfF5E5a4895C8a6281fe ; 
    address public devWallet = 0xD09BeC9A668111bDcB7c445319BbAC526EDfF076 ;
