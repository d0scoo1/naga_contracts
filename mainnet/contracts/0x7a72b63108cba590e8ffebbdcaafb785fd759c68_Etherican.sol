/*
Welcome to the Bank of Etherica.

THIS PROJECT IS IN BETA.

• Stake/earn passive income by earning ETH Dividends that are paid our regularly!
• We are a community-based token - decisions are made by our community as long as you are a holder - we will have a voting governance system released within the week.
• In addition, liquidity is locked to give it the true meaning.
• Bank-for-Free - There are no fees! Marketing wallet will hold 1% of total supply and this wallet will be governed by the community. We already have some Twitter/Telegram shills planned so keep your eyes peeled 👀

What are you waiting for? Come bank with us today!

Website: https://etherican.com/
TG: @Etherican
*/
...
contract Etherican is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000000 * 10 ** 18;

    constructor () ERC20('BankOfEtherica', unicode'Etherican') {
