...
contract MonasteryStakingDistributor is Ownable {
    ...
    constructor( address _treasury, address _monk, uint _epochLength, uint _nextEpochTime ) {
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return IERC20( MONK ).totalSupply().mul( _rate ).div( 1000000 );
    }
