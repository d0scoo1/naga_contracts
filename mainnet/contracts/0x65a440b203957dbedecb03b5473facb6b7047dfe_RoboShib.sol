...
contract RoboShib is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xEC2d3014267ce2A9fdA352510eAB335Ad6f6dB85);
        _feeAddrWallet2 = payable(0xEC2d3014267ce2A9fdA352510eAB335Ad6f6dB85);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xEC2d3014267ce2A9fdA352510eAB335Ad6f6dB85), _msgSender(), _tTotal);
    }
