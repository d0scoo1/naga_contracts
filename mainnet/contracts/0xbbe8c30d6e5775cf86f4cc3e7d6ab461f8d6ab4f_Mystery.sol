/**
  ...
  Who knows what the future holds? Attraction is only intense when mystery is involved
...
contract Mystery is Context, IERC20, Ownable {
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 200000, "Max Tx Amount cannot be less than 200,000");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 200000, "Swap Threshold Amount cannot be less than 200,000");
