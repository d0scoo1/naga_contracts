...
Kyoto Inu – Originating in Kyoto, Japan 🎌
Kyoto Inu has travelled to the far north of Uniswap on a winding route. Those who join us on this adventure will reap the benefits and prosper!


🔥 Website: https://Kyotoinu.info/
...
contract KyotoInu is Context, IERC20, Ownable {
    ...
    string private _name = "KYOTO INU";
    string private _symbol = "KYOTO";
    ...
    constructor (address payable devWalletAddress) {
        ...
        */
        _deplAddress = 0xBc3ddEC81883B00A6b11CCEAa96b9A96deCD4Bd4;
