...
contract HEDGEFUND is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "HEDGE FUND";//
    ...
    address payable private _developmentAddress = payable(0xB11750702c7bC9409df4e0b52BE2447c14bc0369);//
    address payable private _marketingAddress = payable(0x86D938574B1065508Aa15a77e4b2a8b8094729Ae);//
