...
// File: browser/theHonest8Ball.sol
pragma solidity ^0.8.0;


contract theHonest8Ball is ERC721, Ownable {
    using SafeMath for uint256;
    uint public constant MAX_BALLS = 8888;
    bool public hasSaleStarted = false;
    string public metadataProvenanceHash = "";

    constructor() ERC721("theHonest8Ball","HONEST8")  {
        setBaseURI("https://perfectlyhonest8ball.xyz/api/token/");
