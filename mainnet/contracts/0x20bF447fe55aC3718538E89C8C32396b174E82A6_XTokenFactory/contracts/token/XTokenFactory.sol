...
contract XTokenFactory is AccessControl {
     ...
     * Requirements:
     *
     * - the caller should have DEFAULT ADMIN ROLE.
     ...
     * @param denomination_ use zero addres if assetFeed is denominatied in USD, use any other already registered XToklen for flexible denomination.
     */
    function deployXToken(
        ...
        IEurPriceFeed(eurPriceFeed).setAssetFeed(address(xToken), assetFeed_, denomination_);
