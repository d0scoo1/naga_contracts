...
/**
    DogeZilla - The one and only Zilla, DogeZilla - 0 Taxes
*/
...
contract DogeZilla is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _na = "DogeZilla";
    string private constant _sym = "DogeZilla";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0xd8EBDF94588583d73F84984bCc2E0cD7E542CcB7);
        OtherWallet = payable(0xd8EBDF94588583d73F84984bCc2E0cD7E542CcB7);
        DevWallet = payable(0xd8EBDF94588583d73F84984bCc2E0cD7E542CcB7);
