...
//*********************************************************************//
//
//     ____  _           ______        __    __    _                    __            ____  _ _____                _ 
//    / __ \(_)  _____  / / __ )__  __/ /_  / /_  (_)__  _____   ____ _/ /______ _   / __ )(_) / (_)__  _____   _ | |
//   / /_/ / / |/_/ _ \/ / __  / / / / __ \/ __ \/ / _ \/ ___/  / __ `/ //_/ __ `/  / __  / / / / / _ \/ ___/  (_)/ /
//  / ____/ />  </  __/ / /_/ / /_/ / /_/ / /_/ / /  __(__  )  / /_/ / ,< / /_/ /  / /_/ / / / / /  __(__  )  _  / / 
// /_/   /_/_/|_|\___/_/_____/\__,_/_.___/_.___/_/\___/____/   \__,_/_/|_|\__,_/  /_____/_/_/_/_/\___/____/  (_)/_/  
//                                                                                                            /_/    
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC548AB914865c730647a1a044C65DF7C0758a07e];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 22222 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmSARWPw2tAoVwZMqBLjxSh2qKCZ8qBimxZccTkWnNBggh/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 22222");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 22222");
...
// File: contracts/PixelBubbiesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract PixelBubbiesContract is RamppERC721A {
    constructor() RamppERC721A("PixelBubbies", "pixbubs"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ccDTcRpgLIWaJvctmSCs/contract-metadata";
    }
}
