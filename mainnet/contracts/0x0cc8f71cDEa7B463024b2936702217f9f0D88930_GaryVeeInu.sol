...
contract GaryVeeInu is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xE5D0071C67b8ECc176a02B5a975f3573eBFAC443);
    address payable private _marketingAddress = payable(0xE54A687F96cdb1aa02C0daF92BEAb144e37D1aeF);
    
    string private constant _name = "Gary Vee Inu";
    string private constant _symbol = "GaryVeeInu";
