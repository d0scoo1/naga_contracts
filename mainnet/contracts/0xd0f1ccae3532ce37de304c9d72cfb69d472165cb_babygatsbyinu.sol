...
contract babygatsbyinu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Baby Gatsby Inu";                                           // name
    string private _symbol = "$BGATSBY";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x2cF8934B1D3337E51d7d202272f2B740615254Dc);
