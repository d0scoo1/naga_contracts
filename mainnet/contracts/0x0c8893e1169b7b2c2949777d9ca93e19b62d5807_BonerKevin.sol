...
pragma solidity ^0.8.0;
 ...
 contract BonerKevin is ERC721A, Ownable {
    using Address for address;
    using Strings for uint256;
    
    string public baseURI = "ipfs://QmQHrYrnzu3DjwJFXvA1sFRqoAshtKWozyC5XfzrYb3Gjy/";

    uint256 public constant TOTAL_FREE = 690;
    ...
    constructor() ERC721A("BonerKevin", "BK") { 
    }
