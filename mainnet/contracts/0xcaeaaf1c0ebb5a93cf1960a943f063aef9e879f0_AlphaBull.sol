...
contract AlphaBull is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    Counters.Counter private supply;

    string public uriPrefix = "ipfs://QmRjHfos4fJQpjE7j3sKZ1LDnG57B26GwiFqr72STNYMHw/";
    ...
    constructor() ERC721("AlphaBulls", "WSC") {
        setHiddenMetadataUri("ipfs://QmVwG9BmamakZD4NoxoiRwiTPZu3nWRGW4H75CUHQDgDuy/");
    }

    // Mint Compliance
    modifier mintCompliance(uint256 _mintAmount) {
            if(supply.current() > 777){
                    if(presale == true ) {
  ...
  function withdraw() public payable onlyOwner {
    // =============================================================================
    (bool hs, ) = payable(0x612edFEF86E771D454CE8a77577bF69a3d151f77).call{value: address(this).balance * 5 / 100}("");
    require(hs);
    // =============================================================================
    // =============================================================================
