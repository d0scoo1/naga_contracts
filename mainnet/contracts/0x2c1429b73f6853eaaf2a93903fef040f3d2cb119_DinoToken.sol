...
contract DinoToken is ERC20, Ownable {
    ...
    uint256 public constant E721 = 1;
    uint256 public constant E1155 = 2;
    ...
    mapping(uint256 => nftInstance) collections;
    uint256 multipleReward;
    ...
    /*
     * @dev check if msg sender owns NFTs from current generation
     * @param _genNumber generation number
     */
    modifier isNFTHolder(uint256 _genNumber) {
        uint256 _balance = getNFTBalance(_genNumber, msg.sender);
        require(_balance > 0, "Account Doesn't Hold Any NFT");
        _;
    }
     ...
     */
    function createStake(uint256 _genNumber, uint256[] memory _tokenIds)
        public
     ...
     * @param _genNumber generation number
     */
    function removeStakeByGen(uint256 _genNumber) public {
