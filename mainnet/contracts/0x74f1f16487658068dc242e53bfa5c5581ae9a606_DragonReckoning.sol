...
|_____/|__| |___._|___  |_____|__|__|    |___|__||_____|____||__|__|_____|__|__||__||__|__|___  ||__|    
        _______   |_____|                 __             ____                             |_____|        
       |     __|.-----.-----.-----.-----.|__|.-----.    |_   |                                           
       |    |  ||  -__|     |  -__|__ --||  ||__ --|     _|  |_                                          
       |_______||_____|__|__|_____|_____||__||_____|    |______|                                         
...
*/
contract DragonReckoning is ERC721A, Ownable {
    using ECDSA for bytes32;
    using Strings for uint256;

    address private constant TEAM_ADDRESS = 0xb8386e589B0Bc2f9cBe2727Fd8F49479CEaF56FF;

    uint256 public constant TOTAL_MAX_SUPPLY = 984;
    uint256 public constant MAX_FREE_MINT_PER_WALLET = 1; 
    uint256 public constant MAX_PUBLIC_MINT_PER_WALLET = 10;
    uint256 public constant TEAM_CLAIM_AMOUNT = 10;
    ...
    constructor(string memory baseURI) ERC721A("Dragon Reckoning", "D") {
    ...
    function setTotalFreeMintNum(uint256 _num) external onlyOwner {
        total_free_mints = _num;
    }
