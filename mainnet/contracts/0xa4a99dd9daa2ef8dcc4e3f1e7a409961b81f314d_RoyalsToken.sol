...
contract RoyalsToken is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Royals Token";
    string private constant _symbol = "ROYALS";
    ...
    address payable private _developmentAddress = payable(0xFb9Fbc4C527C303bee0fB07fE07760B17d2e0F7C);
    address payable private _marketingAddress = payable(0xFb9Fbc4C527C303bee0fB07fE07760B17d2e0F7C);
