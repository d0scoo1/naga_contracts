/**
    ...
    88      a8P                           88                d8'            88888888ba,                         88  
    88    ,88'                            ""               d8'             88      `"8b                        88  
    88  ,88"                                              ""               88        `8b                       88  
    88,d88'       ,adPPYba,  8b       d8  88  8b,dPPYba,    ,adPPYba,      88         88  ,adPPYYba,   ,adPPYb,88  
    8888"88,     a8P_____88  `8b     d8'  88  88P'   `"8a   I8[    ""      88         88  ""     `Y8  a8"    `Y88  
    88P   Y8b    8PP"""""""   `8b   d8'   88  88       88    `"Y8ba,       88         8P  ,adPPPPP88  8b       88  
    88     "88,  "8b,   ,aa    `8b,d8'    88  88       88   aa    ]8I      88      .a8P   88,    ,88  "8a,   ,d88  
    88       Y8b  `"Ybbd8"'      "8"      88  88       88   `"YbbdP"'      88888888Y"'    `"8bbdP"Y8   `"8bbdP"Y8  

    Telegram : https://t.me/kevindad_eth

    Website : https://www.kevindad.com/
...
contract KevinDad is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Kevin Dad";
    string private constant _symbol = "KEVINDAD";
    ...
    address payable private _opAddress = payable(0x97c70fE8b32de3Cf882876E1b9Ee54cfCB1C3Bc6);
