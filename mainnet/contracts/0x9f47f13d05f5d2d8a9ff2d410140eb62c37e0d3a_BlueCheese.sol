...
contract BlueCheese is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BlueCheese";//
    string private constant _symbol = "BlueCheese";//
    ...
    address payable private _developmentAddress = payable(0x7e33C705d9f4Cd157A626c1eb5D307c9Cb53B494);//
    address payable private _marketingAddress = payable(0x7e33C705d9f4Cd157A626c1eb5D307c9Cb53B494);//
