...
contract InvisiblePhrens is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable, Ownable {
    ...
    string public _baseURIPath = 'ipfs://QmPVPCkJ6NzQmpGY62LyX24mpMXLEWbHzYanX4A7ih8kr3/';
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = InvisiblePhrens.ownerOf(tokenId);
