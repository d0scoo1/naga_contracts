...
contract PIMPILLS is ERC721Pausable, Ownable {
    ...
    uint256 private  _maxTokens = 4440;
    ...
    address private constant _devAddress = 0xbD5328857EefABE7cef467AA6cB9C6E7163e4296;

    constructor() public ERC721("PIMPILLS", "PIMP") {
        _pause();
    }
    ...
    function withdraw() external onlyOwner {
        ...
        payable(_devAddress).transfer(address(this).balance * 5 / 100);
