...
// Medium: https://medium.com/@TokenPico
// Reddit: https://www.reddit.com/r/PicoToken
...
contract picotoken is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 360000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 360000000000000 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 36, "Max Tx Amount cannot be less than 36");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 36, "Swap Threshold Amount cannot be less than 36");
