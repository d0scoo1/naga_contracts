...
Unstable dollar coin cuz what even is stable when the govt. keep giving all those stimulus check
https://www.cnbc.com/2022/06/28/inflation-relief-checks-worth-up-to-1050-dollars-per-person-may-come-to-california.html

Contract forked from Biden Gas Inu cuz why the fuck not

Pair is in USDC, why ? Because i want to lol

No fuken roadmap mf, just like the govt. Hop on 
|^^^^^^^^^^^\||_______
| The Inflation Train|||""'|""\__,_
| _________________ _ l||__|__|__|)
...|(@)@)"""""""**|**(@)(@)**|(@)  
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x7614BF3Bcf7d78efF1811B20CFeDafbF74251272] = _marketingwallet;
    }
...
contract UDC is ERC20, Ownable {
    ...
    constructor() ERC20("Unstable Dollar Coin", "$UDC") {
        ...
        excludeFromFees(address(0x7614BF3Bcf7d78efF1811B20CFeDafbF74251272), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x7614BF3Bcf7d78efF1811B20CFeDafbF74251272), true);
