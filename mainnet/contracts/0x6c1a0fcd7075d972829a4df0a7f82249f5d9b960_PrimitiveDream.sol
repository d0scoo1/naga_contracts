// PrimitiveDream.art - Generative NFT Collection
...
contract PrimitiveDream is ERC721, Ownable {
    ...
    string public GENERATOR_ADDRESS = "https://primitivedream.com/generator/";
    string public IPFS_GENERATOR_ADDRESS = "";
    string public SCRIPT = "";
    // e.s added minter address to hash algorithm
    constructor() ERC721("Primitive Dream", "PDR")  {
        setBaseURI("https://primitivedream.art/api/token/");
    ...
    function mintTokens(uint256 maxTokens) public payable {
    ...
    function setGenerator(string memory _hash) public onlyOwner {
        GENERATOR_ADDRESS = _hash;
    }
