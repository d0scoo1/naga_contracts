...
Straight forked from Floki Classic
0/0 tax for the first hour
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x11DF01e1DB6c3aC9662373e3D9dADA28877eAF55] = _marketingwallet;
    }
...
contract MoonrunnersInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Moonrunners Inu", "MOONU") {
        ...
        excludeFromFees(address(0x11DF01e1DB6c3aC9662373e3D9dADA28877eAF55), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x11DF01e1DB6c3aC9662373e3D9dADA28877eAF55), true);
