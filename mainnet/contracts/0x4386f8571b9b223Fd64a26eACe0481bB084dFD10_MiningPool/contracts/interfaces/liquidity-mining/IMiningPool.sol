...
interface IMiningPool is IOwnable, IERC165, IERC223Recipient, IERC677Recipient, IERC1363Receiver {
    ...
    function setLockAndRedeemWaitPeriod(uint64 newLockPeriod, uint64 newRedeemWaitPeriod) external;

    function allowStaking() external view returns (bool);

    function setStakingAllowance(bool isAllow) external;
