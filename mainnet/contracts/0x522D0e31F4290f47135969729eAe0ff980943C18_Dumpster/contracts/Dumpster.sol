...
contract Dumpster is StakingWrapper, Pausable, AccessControl {
    ...
    uint256 public maxStake = 8200 * 1e17;
    uint256 public dumpsterDive = 82000 * 1e17;
    ...
    function setDumpsterDive(uint256 _dumpsterDive)
        public
        onlyRole(DEFAULT_ADMIN_ROLE)
    {
    ...
    function addTreasure(
        ...
        tokenId = nftToken.initializeToken(_maxIssuance, _tokenURI);
