    ...
    IHistoryMoments
{
    ...
    function pause() public virtual {
        require(
            ...
            "HistoryMoments: must have pauser role to pause"
        );
        _pause();
    }
    ...
    function unpause() public virtual {
        require(
            hasRole(PAUSER_ROLE, _msgSender()),
            "HistoryMoments: must have pauser role to unpause"
        );
        _unpause();
    }
    ...
    function mint(address to) public override {
        require(
            ...
            "HistoryMoments: must have minter role to mint"
        );
        ...
        external
    {
        require(
            ...
            "HistoryMoments: must have admin role"
        );
