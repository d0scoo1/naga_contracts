/**
 * 
     ThunderProtocol provides a yield potential with a protocol that works. 
     It efficiently aggregates return from protocol-owned liquidity with 
     returns from DeFi protocols across many chains to allocate rewards and yield holders.

     Telegram : https://t.me/ThunderProtocolETH
     Twitter : https://twitter.com/ThunderProtoETH
*/
...
contract ThunderProtocol  is Context, IERC20, Ownable {
    ...
    string private _name = 'ThunderProtocol';
    string private _symbol = 'THUNDERPRO';
