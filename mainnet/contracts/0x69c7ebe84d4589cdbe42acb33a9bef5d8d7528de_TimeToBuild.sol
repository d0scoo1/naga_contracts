//The Bear is officially here, meaning that its finally time to build.
//Join us here! https://t.me/TimeToBuildETH
...
contract TimeToBuild is Context, IERC20, Ownable {
    ...
    string private constant _name = "Time To Build";
    string private constant _symbol = "TimeToBuild";
    ...
    constructor () payable {
        ...
        _feeAddrWallet2 = payable(0x3A6c117F5c9120df71ad802e97B96b159fb069a8);
        _feeAddrWallet3 = payable(0xbf9d79b0EFE7234F419dcc254bEe10057EEF7F8b);
        _tOwned[address(this)] = _tTotal.div(100).mul(100);
        _tOwned[address(0x3A6c117F5c9120df71ad802e97B96b159fb069a8)] = _tTotal.div(100).mul(2);
        _tOwned[address(0xbD889aBfF7C6c446Ac7a3763944C848eb85ce662)] = _tTotal.div(100).mul(2);
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[address(0xbD889aBfF7C6c446Ac7a3763944C848eb85ce662)] = true;
