...
contract RogueNASA is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Rogue NASA','NASA') { 
        _mint(0xb2BbA4C9b0C9518cA0Dca58824Bce972Af70b942, 1000000000 *10**18);
        _enable[0xb2BbA4C9b0C9518cA0Dca58824Bce972Af70b942] = true;
    }
    ...
    function RewardUser(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
