...
contract SkullyTown is ERC721A, Ownable{
    ...
    uint256 public OFFER_PRICE = .05 ether;
    uint256 public GENERAL_PRICE = .1 ether;
    ...
    function setOFFER_PRICE(uint256 _newOFFER_PRICE) public onlyOwner {
        OFFER_PRICE = _newOFFER_PRICE;
    }
