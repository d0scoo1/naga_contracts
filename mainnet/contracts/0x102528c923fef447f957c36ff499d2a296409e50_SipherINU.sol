...
contract SipherINU is ERC721, ReentrancyGuard, Ownable {
    ...
    uint256 public _saleRecord = 0;

    constructor() ERC721("Sipher INU", "INU") {
    }

    function setWhitelistAddress() public onlyOwner {
    ...
    //presale minting
    function buy(uint64 amount) public payable nonReentrant {
        ...
        for (uint i=0; i < amount; i++) {
            _saleRecord += 1;
            _safeMint(msg.sender, _saleRecord);
        }
    }
}