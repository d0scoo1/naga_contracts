...
// File: contracts/LeisureSecondary.sol
...
contract LeisureSecondary is PaymentSplitter {
    ...
    address comm = 0xdbcb1BC2491B40Aebe468d3942841645ECb0bB6c; // leisurecreatures.eth
    ...
    address[] addressList = [dev, project, comm, art1, art2, art3, will];
    uint[] secondaryShares = [200, 300, 100, 100, 100, 100, 100];

    constructor()
    PaymentSplitter(addressList, secondaryShares)  {
    }
}