...
https://t.me/DragonDaoPortal

🐲Welcome to Dragon DAO🐲
$DRAGON  is the native token of Dragon DAO a decentralized and frictionless passive 
income generating protocol on Ethereum chain that combines a revolutionize BuyBack 
strategy with ETH rewards to its holders generated from the profits of farming rewards
 across multiple chain and DragonBrain future protocols.

1️⃣You buy on Ethereum. 
2️⃣We farm and stake on multiple chains and return the profits in ETH to you automatically in your wallet.
3️⃣More DeFi and real world products are gonna be developed that will generate an income.

All the income generated from the DragonBrain Protocols
will be used to boost rewards and DragonBrain BuyBacks!!

🐲Tokenomics:🐲

- ✅Buy Tax / 🚫Sell Tax: 8%
- 4% of each tx goes to marketing and development funds
- 4% of each tx goes to treasury wallet that powers the multichain farming

Distributution:
50% liquidity
50% burned 
NO TEAM TOKENS
LIQUIDITY WILL INITIALLY BE LOCKED 6 MONTHS !!
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a DRAGON shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract DragonDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0x7A696aB1E59320C81FbE8F41Ad1bFf3a6eBeaA01);
    address payable public treasury = payable(0x7A696aB1E59320C81FbE8F41Ad1bFf3a6eBeaA01);
