/*
    Thunder Shib Inu ($THSHIB)

    Description:
        Thunder Shib INU is a revolutionary token to incentivize community building and holding by rewarding the community with reflections, major networking,
        advertising as well as the community is the top priority to create an ecosystem that is built to expand beyond Defi.

    https://t.me/ThunderShibInu
    https://twitter.com/ThunderShibInu
    https://thundershibinu.com
...
contract ThunderShibInu is Context, IERC20, Ownable {
    ...
    string private _name = "Thunder Shib Inu";
    string private _symbol = "THSHIB";
