// Daddy Elon (DELON) a DeFi meme token which serves to idolize Elon Musk
//
 ...
 */
contract DELON is Context, IERC20 {
    ...
    string private _name = 'DaddyElon';
    string private _symbol = 'DELON';
