...
// File: contracts/leavehimalone.sol
...
// File contracts/ERC721A.sol
    ...
    contract LeaveHimAlone is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
    string public uriPrefix = "ipfs://QmcphE15jXmKCHhzazymqBihfnhysec5mpFHLLsEiTspR7/"; string public uriSuffix = ".json"; string public hiddenMetadataUri;
    ...
    constructor() ERC721A("LeaveHimAlone", "BOYZ") {setHiddenMetadataUri("ipfs:///hidden.json");}
