...
contract Aidicraft1155 is Initializable,ERC1155Upgradeable, OwnableUpgradeable, ERC1155BurnableUpgradeable {
   ...
   event Approve(
    ...
    function initialize() public initializer {
        ERC1155Upgradeable.__ERC1155_init("", "Aidicraft1155", "Aidicraft1155");
        __Ownable_init();
        _tid = 1;
  ...
  function saleToken(
    ...
    function _saleToken(
        ...
        if (
            ...
            IERC20Upgradeable t = IERC20Upgradeable(Tokendetail[bidtoken].tokenAddress);
            ...
            require(
                ...
                "Approved value mismatch in Admin Value"
            );
    ...
    function acceptBId(
     ...
     function _acceptBId(
        ...
        uint256 val = pERCent(amount, dyntokfee).add(amount);
        IERC20Upgradeable t = IERC20Upgradeable(Tokendetail[tokenAss].tokenAddress);
        uint256 approveValue = t.allowance(from, address(this));
        require(approveValue >= val, "Insufficient Balance");
        require(
            _balances[tokenId][msg.sender] > 0,
