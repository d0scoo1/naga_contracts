...
contract Vector35 is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Binary Ninja";
    string private constant _symbol = "BINJA";
    ...
    uint256 _totalSupply = 1010101010 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x8697E86f5c18c67291515f06F398d3B3A181Be2D);
    ...
    uint256 public _maxTxAmount = 10101010 * 10**9;
    uint256 public _maxWalletSize = 30303030 * 10**9; 
