...
contract Queentama is Context, IERC20, Ownable {
    ...
    address private marketingWallet = payable(0xcEEE125Bc71b85Ca276fE3CEBC6cFC1d64c1d4C5);
    uint256 public antidumpthreshold;

    string private _name = "Queentama";
    string private _symbol = "QUEENTAMA";
