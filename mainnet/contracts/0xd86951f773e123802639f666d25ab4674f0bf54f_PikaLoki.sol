/*
    PikaLoki - Pikachu & Loki combined forces merging to become the unbeatable supergod PikaLoki
...
contract PikaLoki is Context, IERC20, Ownable {
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 100000, "Swap Threshold Amount cannot be less than 100 Thousand");
