  ...
  *@%:   =@%%@@=  .+++=   *+  .%   -.  .   %%  =%@#--#@@@%--+@@@%=-==-=%@@%--*@@@@@+-=@@. 
  ...
  +@*: :==:   ==  :@@@+   %+  .#   @@@@+   %%  :@@#=-*%#+--+@@#--#@*=#+-=@%--+#####=-=@@. 
   ...
   DAILY PRESS                 https://medium.com/@shindao/shindao-introduction-2489b7227a19 
   ELON`S PLAYGROUND           https://twitter.com/_SHINDAO
   LET`S TALK ABOUT IT         https://t.me/SHINDAO) 
   LOTS OF INFO                https://shindao.gitbook.io/shindao
   OUR PIECE AROUND THE WORLD  https://shindao.net/
*/
...
contract ShinDAO is Ownable, IERC20, IERC20Metadata {
