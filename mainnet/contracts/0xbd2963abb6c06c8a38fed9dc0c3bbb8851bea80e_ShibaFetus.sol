// ShibaFetus
// Website: https://shibafetus.com
// Twitter: https://twitter.com/shibafetus
// TG: https://t.me/shibafetus
// Medium: https://medium.com/@shibafetus
...
contract ShibaFetus is Context, IERC20, Ownable {
    ...
    string private _name = "ShibaFetus";
    ...
    uint256 public _maxTxAmount = 4200000000000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 4200000000000000000000 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 42000000000, "Max Tx Amount cannot be less than 42 Billion");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 42000000000, "Swap Threshold Amount cannot be less than 42 Billion");
