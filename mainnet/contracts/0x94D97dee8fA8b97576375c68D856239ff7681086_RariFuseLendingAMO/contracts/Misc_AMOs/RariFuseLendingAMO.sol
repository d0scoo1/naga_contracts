...
contract RariFuseLendingAMO is Owned {
    ...
    function enterMarkets(address comptroller_address, address pool_address) public onlyByOwnerOrGovernanceOrCustodian {
        address[] memory cTokens = new address[](1);
    ...
    // E18
    function lendToPool(address pool_address, uint256 mint_amount) public onlyByOwnerOrGovernanceOrCustodian {
        uint256 pool_idx = poolAddrToIdx(pool_address);
    ...
    // E18
    function redeemFromPool(address pool_address, uint256 redeem_amount) public onlyByOwnerOrGovernanceOrCustodian {
        uint256 pool_idx = poolAddrToIdx(pool_address);
