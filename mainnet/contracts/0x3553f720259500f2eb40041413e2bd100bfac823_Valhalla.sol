...
contract Valhalla is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xa189c0a832bB977c3BBF6083f2A1D84D497Ac7bd);
        _feeAddrWallet2 = payable(0xa189c0a832bB977c3BBF6083f2A1D84D497Ac7bd);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xb3bba1a7dbd73D3a955a119063ca435659787fD5), _msgSender(), _tTotal);
    }
