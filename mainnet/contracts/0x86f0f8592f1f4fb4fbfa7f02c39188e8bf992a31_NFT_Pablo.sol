...
contract NFT_Pablo is ERC721, Ownable {
    ...
    function withdraw() public payable onlyOwner {
        address a1 = 0xc7Aef4fD9deC1488f7Aa81cC7ae781BB55e053C8;
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        require(_mintAmount <= maxMintAmount, "Must mint less than max amount");
        require(
            _tokenSupply.current() + _mintAmount <= maxSupply,
            "Must mint within supply"
        );
    ...
    function mintForAddress(uint256 _mintAmount, address _receiver)
        ...
        onlyOwner
    {
        _mintLoop(_receiver, _mintAmount, _tokenSupply.current());
    }
