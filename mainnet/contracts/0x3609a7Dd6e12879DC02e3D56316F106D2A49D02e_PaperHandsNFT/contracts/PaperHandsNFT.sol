...
contract PaperHandsNFT is Initializable, ERC721AUpgradeable, OwnableUpgradeable {
    ...
    uint256 public constant QUANTITY_MAX = 10;
    ...
    function batchTransferFrom(
        ...
        for (uint256 i; i < _tokenIds.length; i++) {
            super.transferFrom(_from, _to, _tokenIds[i]);
        }
    }
