...
Taxes
4% liquidity Fee on buying and selling

Griffin will be a community led token. No socials will created.
...
contract GRIFFIN is Context, IERC20, Ownable {
    ...
    string private _name = "GRIFFIN";
    string private _symbol = "GRIFFIN";
