/*
    Hatsune Miku is a  MMORPG (massively-multiplayer online role-playing game) that also offers a free-to-play mode ideal for those looking for games with a low entry barrier.

    Hold $HATSUNE tokens to earn rewards and redeem them for ETH. 

    https://HatsuneMiku.one

    https://t.me/HatsuneToken
...
contract HatsuneMiku is Context, IERC20, Ownable {
    ...
    string private _name = "Hatsune Miku";
    string private _symbol = "HATSUNE";
