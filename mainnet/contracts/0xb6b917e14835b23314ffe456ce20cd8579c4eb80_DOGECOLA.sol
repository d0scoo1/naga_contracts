...
contract DOGECOLA is Context, IERC20, Ownable {
    ...
    string private constant _name = "DOGECOLA";
    string private constant _symbol = "DOGECOLA";
    ...
    uint256 private _taxFeeOnSell = 5; // 5% tax on sales
    ...
    address payable private _developmentAddress = payable(0xe628a02A6996cC96026F9d517fd18B3A76350a42);
    address payable private _marketingAddress = payable(0xe628a02A6996cC96026F9d517fd18B3A76350a42);
