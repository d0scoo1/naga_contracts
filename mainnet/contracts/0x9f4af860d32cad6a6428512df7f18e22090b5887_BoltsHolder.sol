...
contract BoltsHolder is IERC721Receiver, Ownable {
    using EnumerableSet for EnumerableSet.UintSet;

    address public BOLTS;
   ...
   function setboltsAddress(address boltsAddress) public onlyOwner {
        BOLTS = boltsAddress;
   }
   
    function setERC721ContractAddress(address contractAddress) public onlyOwner {
    ...
    function claimRewards(uint256[] calldata tokenIds) public {
        ...
        if (reward > 0) {
            try IERC20(BOLTS).transfer(msg.sender, reward) returns (bool v) {
