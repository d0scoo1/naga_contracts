...
abstract contract ZapBaseV2_2 is Ownable {
    ...
    /**
    @notice Set true for Zaps to bypass fees when calling this contract
    @param zapAddress The Zap caller which is allowed to bypass fees
    * if they exist
    ...
    /** 
    @notice Set sthe percentage to split the goodwill by to distribute to
    ...
    @param _affiliate The  affiliat's address
    @param _status The affiliates approval status
     */
