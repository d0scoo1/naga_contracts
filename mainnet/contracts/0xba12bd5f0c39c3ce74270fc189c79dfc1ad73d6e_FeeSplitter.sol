...
contract FeeSplitter is Ownable {
    ...
    function distributeTokens(IERC20 _token) external {
        ...
        for (uint256 i; i < length; ++i) {
            ...
            _token.safeTransfer(recipient.account, balance * recipient.share / shares);
        }
    }
    ...
    function changeRecipientShare(uint256 _idx, uint256 _newShares) external onlyOwner {
        uint256 length = recipients.length;
        require(_idx < length, "INVALID_IDX");
