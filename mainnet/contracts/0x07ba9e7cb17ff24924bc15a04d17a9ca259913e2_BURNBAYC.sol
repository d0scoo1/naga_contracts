// https://t.me/burnbayc
// Buytax: 6% sell tax: 9%
// Tax goal is to buy a BAYC and burn it
...
contract BURNBAYC is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "BURNBAYC";
    string private constant _symbol = "BURNBAYC";
    ...
    address payable private _developmentAddress = payable(0x472A25025d659079598f0Dc64B987C2a78f8857a); 
    address payable private _marketingAddress = payable(0x472A25025d659079598f0Dc64B987C2a78f8857a);
