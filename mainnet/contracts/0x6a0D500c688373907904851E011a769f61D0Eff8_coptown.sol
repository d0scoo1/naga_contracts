...
contract coptown is ERC721A, Ownable, ReentrancyGuard {
  ...
  uint public          maxfreeSupply     = 10000;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled;

  constructor() ERC721A("coptown.wtf", "COP"){}

  function mint(uint256 amt) external payable
  {
    uint cost = price;
    require(msg.sender == tx.origin,"Be yourself, COP.");
