...
contract ApesofRock is Ownable, ERC721 {
    ...
    constructor() ERC721("Apes of Rock", "AOR"){}
   ...
   function buy_presale(uint _count) public payable{ 
        ...
        require(_count > 0, "mint at least one token");
        require(_count <= maxPerTransaction, "max per transaction 20");
        require(totalSupply + _count<= phase, "Not enough tokens allowed in current phase");
        require(totalSupply + _count<= maxSupply, "Not enough tokens left");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 50 / 100);
        payable(0xaca8E67190Ca5e513601ef60315D360D28a2C4f5).transfer(_balance * 50 / 100);
    }
