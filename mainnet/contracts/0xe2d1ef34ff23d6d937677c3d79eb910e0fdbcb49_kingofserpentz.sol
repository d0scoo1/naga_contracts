...
contract kingofserpentz is ERC721Enumerable, Ownable{
    ...
    string public _contractURI = "ipfs://QmV2Qs8NCp6uAGVRU973NSNvQvHDsMvcFznMsQJ7BZkNNh";
    ...
    constructor (string memory _URI, uint256 _preSaleTime, uint256 _publicSaleTime, address _owner) ERC721("kingofserpentz", "KOS"){
    ...
    function changeStartTime(uint256 _preSaleTime, uint256 _publicSaleTime) public onlyOwner {
