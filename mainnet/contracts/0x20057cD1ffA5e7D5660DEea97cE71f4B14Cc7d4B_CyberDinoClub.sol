...
// File: contracts/CyberDinoClub.sol
    ...
    contract CyberDinoClub is ERC721, Ownable, ERC721Enumerable {
      ...
      uint256 public devReserve = 6;
    
      event DinoMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("CyberDinoClub", "CDC") {}
      ...
      function mintDino(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmWt5o6JAqjLTr8D9iuWrEfasV2R9yd4KHRkgZBsEo3X34/hidden.json.json";
        }
