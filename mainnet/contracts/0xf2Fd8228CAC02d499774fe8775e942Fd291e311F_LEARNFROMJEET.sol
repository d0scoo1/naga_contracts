...
contract LEARNFROMJEET is Context, IERC20, Ownable {
    ...
    string private _name = "LEARN FROM JEET";
    ...
    address payable public marketingaddress = payable(0xc5e62Db4b8FE3B096d34a624C4d2E671EA929Ad2);
