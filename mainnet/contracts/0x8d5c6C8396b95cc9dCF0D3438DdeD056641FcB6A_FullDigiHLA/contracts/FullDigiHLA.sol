...
contract FullDigiHLA is Ownable, ERC721A, MerkleWhitelist, ReentrancyGuard {
    ...
    uint256 public DA_AMOUNT = 10;
    uint256 public MAIN_AMOUNT = 10;
    uint256 public ALL_AMOUNT = 100;


    uint256 public WL_START_TIME = 1650565200;
    uint256 public WL_END_TIME = 1650738300;

    uint256 public DA_START_TIME = 1650479400;
    uint256 public DA_END_TIME = 1650738900;

    uint256 public MAIN_END_TIME;
    //uint256 public MAIN_LAST_TIME = 10800;
    uint256 public MAIN_LAST_TIME = 600;

    uint256 public EXTRA_START_TIME = 1650653400;
    ...
    function mainInfo(address user) public view returns (uint256,uint256,uint256,uint256,uint256,uint256) {
       return  (MAIN_AMOUNT,MAIN_MINTED,mainPrice(),0,MAIN_END_TIME,MAIN_WALLET_CAP[user]);
    }
