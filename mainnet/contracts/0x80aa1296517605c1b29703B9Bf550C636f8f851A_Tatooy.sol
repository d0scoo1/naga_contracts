...
/// @custom:security-contact tatooydeployer@gmail.com
contract Tatooy is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;

    constructor() ERC721("Tatooy", "TCO") {}

    function _baseURI() internal pure override returns (string memory) {
        return "https://tatooy.com";
    }
