...
contract nft is ERC721A, Ownable {
    ...
    uint private mintCost_ = 0.08 ether;
    ...
    address private dev = 0x318cBF186eB13C74533943b054959867eE44eFFE;
    ...
    constructor() ERC721A("Bluttles", "B", 3, 10000){
    ...
    */
    ...
    function presaleMint(uint256 number, uint8 _v, bytes32 _r, bytes32 _s) onlyValidAccess(_v,  _r, _s) public payable {
        ...
        require(mintsPerAddress[msg.sender] + number <= maxBatchSize, "Maximum 3 Mints per Address allowed!");
        require(msg.value >= mintCost() * number, "Not sufficient Ether to mint this amount of NFTs (Cost = 0.08 ether each NFT)");
    ...
    function retrieveFunds() public onlyOwner {
        ...
        _withdraw(payable(dev), (balance * 5) / 1000);
