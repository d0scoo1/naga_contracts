/*
    ...
    Valentine Mongoose - $VMG

    Telegram : https://t.me/valentinemongoose
...
contract ValentineMongoose is Context, IERC20, Ownable {
    ...
    string private _name = "Valentine Mongoose";
    string private _symbol = "VMG";
