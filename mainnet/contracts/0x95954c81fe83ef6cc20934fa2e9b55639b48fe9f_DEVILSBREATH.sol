...
contract DEVILSBREATH is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZ8ZHspL2ji3KB4gBJmfiXWgUavmVzkimpaAcvrHcXWsh//";
    address private openSeaProxyRegistryAddress = 0x3f956E031f8BbdaEa4514cEc193f59562bFD8d07;
    ...
    constructor(
    ) ERC721A("DEVILSBREATH", "DEV", 100, maxSupply) {
    }
