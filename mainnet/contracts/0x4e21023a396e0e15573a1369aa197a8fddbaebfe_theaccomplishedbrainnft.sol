...
contract theaccomplishedbrainnft is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 0.06 ether; //0.06 during sale 
  ...
  constructor() ERC721A("TheAccomplishedBrainNft","TheAccomplishedBrainNft", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmP6tyweGyweipc9DFtc6eCLqdG9P2iT12Dwmk41hDLaMd/";
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmU7dym53H81eMNHpXYFAkcUf8Z58BaQ53gWXA88oZidpp/";
  }
