...
contract LandsaleNFT_ESTATE is ERC721Enumerable, AccessControl {

    // CVIP_ESTATE (L2 / on ETH)
    // CVIP_PARCEL (L3 / on Polygon) 

    constructor() ERC721("CVIP_ESTATE", "CVIP_ESTATE")  {
    ...
    string _baseTokenURI = "https://api.cryptoverse.vip/metadata/";
