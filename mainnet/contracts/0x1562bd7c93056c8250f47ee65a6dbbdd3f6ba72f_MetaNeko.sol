...
contract MetaNeko is Context, IERC20, Ownable {
    ...
    string private _name = "Meta Neko";
    ...
    uint256 public _liquidityFee = 3; //(3% liquidityAddition)
    ...
    // @dev set Router
    function setRouter(address _newUniswapRouter) external onlyOwner {
        IUniswapRouter02 _uniswapRouter = IUniswapRouter02(_newUniswapRouter);
