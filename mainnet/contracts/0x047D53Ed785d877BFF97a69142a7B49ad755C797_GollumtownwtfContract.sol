...
//
//    __ _             _       _                      _                                               _         __  
//   / _` |   ___     | |     | |    _  _    _ __    | |_     ___   __ __ __ _ _            __ __ __ | |_      / _| 
//   \__, |  / _ \    | |     | |   | +| |  | '  \   |  _|   / _ \  \ V  V /| ' \      _    \ V  V / |  _|    |  _| 
//   |___/   \___/   _|_|_   _|_|_   \_,_|  |_|_|_|  _\__|   \___/   \_/\_/ |_||_|   _(_)_   \_/\_/  _\__|   _|_|_  
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF40EcCBdDD768830A1Fc8b4Bedf46C8b9EaA1402];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 6006 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmdDSrxtRd5jAQy14NLfxXQcndYkVfjH2oASgodko8WtHy/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 6006");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 6006");
...
// File: contracts/GollumtownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GollumtownwtfContract is RamppERC721A {
    constructor() RamppERC721A("gollumtownwtf", "GOLLUM"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/IRFLBNAORE7QP7T4Z1x5/contract-metadata";
    }
}
