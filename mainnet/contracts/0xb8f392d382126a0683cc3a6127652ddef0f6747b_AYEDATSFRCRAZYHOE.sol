...
contract AYEDATSFRCRAZYHOE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTqmoDfuQ3vBPGy4Fy6tkPEH3xP9gQefUSxHeYqRUKhBV";
    ...
    constructor(
    ) ERC721A("AYE DATS FR CRAZY HOE", "AYO", 100, maxSupply) {
    }
