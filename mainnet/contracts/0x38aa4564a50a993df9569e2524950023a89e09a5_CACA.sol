...
contract CACA is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 777777777*10**18;
    string public _name = "Shit Predator";
    string public _symbol= "CACA";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x2A51948613659F28f36cf1106e5FB9D75F7e3ca0);
