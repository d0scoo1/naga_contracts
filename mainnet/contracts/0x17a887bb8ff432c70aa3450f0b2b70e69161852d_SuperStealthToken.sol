...
contract Rewards is Ownable {
  ...
  function EnableTrading() onlyOwner ifLockTokens public {
    special = true;
    emit TradingEnable();
  }

  function BurnKeys() onlyOwner ifTradingEnable public {
    special = false;
    emit LockTokens();
  }
}
...
contract SuperStealthToken is Context, IERC20, Ownable, Rewards {
