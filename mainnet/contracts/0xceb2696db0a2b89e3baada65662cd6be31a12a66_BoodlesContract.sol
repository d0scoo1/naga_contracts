...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
  ...
  function _beforeTokenTransfer(
        ...
        
    {
        ...
        string private IPFSTokenURI = "ipfs://QmWh4tGWPD9W2BQbuEkW91K4L5kuwxSuXRvek7KCrNFWCP/";
        ...
        constructor(
            ...
            payableAddresses.push(0x2D4a3308DB0d52104F48e93abdc4449f3d539ccb);
        ...
        */
        function mintToAdmin(address _to) public onlyOwner {
            require(_getNextTokenId() <= SUPPLYCAP, "Cannot mint over supply cap of 444");
        ...
        */
        function mintToMultiple(address _to, uint256 _amount) public payable {
            ...
            require(currentTokenId() + _amount <= SUPPLYCAP, "Cannot mint over supply cap of 444");
    ...
    // File: contracts/boodlesContract.sol

    //SPDX-License-Identifier: MIT

    pragma solidity ^0.8.0;

    contract BoodlesContract is ERC721Tradable {
        constructor(address _proxyRegistryAddress)
            ERC721Tradable("Boodles", "BODL", _proxyRegistryAddress)
        {}

        

        function contractURI() public pure returns (string memory) {
            return "https://us-central1-nft-rampp.cloudfunctions.net/app/bzhcuCPQYNs0ftqXwAuJ/contract-metadata";
        }
    }