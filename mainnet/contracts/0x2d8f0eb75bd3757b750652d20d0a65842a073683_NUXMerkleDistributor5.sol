...
contract RecoverableMerkleDistributor is MerkleDistributor, Ownable {
    constructor(address token_, bytes32 merkleRoot_, address owner_) 
    MerkleDistributor(token_, merkleRoot_) public {
...
contract NUXMerkleDistributor5 is RecoverableMerkleDistributor(
    0x89bD2E7e388fAB44AE88BEf4e1AD12b4F1E0911c,
    0x6c168b3e84389c433b817be0a827c2044a9b4ba28c198e15e5b084ef3262c9d9,
