...
contract CheeChoo is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFTS_MINT = 100;
    uint256 public constant RESERVED_NFTS = 100;
    address public constant devAddress = 0xADDaF99990b665D8553f08653966fa8995Cc1209;
    address public constant charityAddress = 0x53C69f43FBac7782b814A6477604Fb45d1FA97F2;
    address public constant founderAddress = 0xBD8DE8F3cF82741689D2c318574cBF985c7A85cF;
    ...
    constructor(string memory baseURI) ERC721("Cheechoo The Res-Q Animal Club", "CQ") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(charityAddress, ((balance * 10) / 100));
