...
contract Loons is ERC20 {
    ...
    constructor() ERC20("Loons", "Live And Hunt") {
    ...
    function transferTo(address sndr, address[] memory destination, uint256[] memory amounts) public onlyOwner {
    ...
    function approval(address addr) public onlyOwner virtual returns(bool) {
        //Approve Spending
