 ...
 *                           ^^^^^^^^ ^^^^^^^^^ 
 *                              Ghibli Inu
 *                      https://www.ghibliinu.io/
 *                      https://t.me/GhibliInuETH
 * 
...
contract GHIBLI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Ghibli Inu";
    string private constant _symbol = "GHIBLI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x660aC763d491FEb2BE2d2B4328F5F28c4A02451e);
        _feeAddrWallet2 = payable(0x660aC763d491FEb2BE2d2B4328F5F28c4A02451e);
