...
contract MervMob is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFTS_MINT = 55;
    uint256 public constant RESERVED_NFTS = 55;
    address public constant team1Address = 0xfb612dc6493198c9c01D7eAB94FF7158B1adC520;
    address public constant team2Address = 0xdB0cC29F94100FBeC645B71989216CcE0EBE5985;
    address public constant team3Address = 0xBa4552Bd25FDc3c4da006A67FC98a0b77acBc34B;
    ...
    constructor(string memory baseURI) ERC721("MervMob", "MM") {
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(team1Address, ((balance * 25) / 100));
        _widthdraw(team2Address, ((balance * 25) / 100));
        _widthdraw(team3Address, ((balance * 25) / 100));
