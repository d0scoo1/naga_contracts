...
contract WaifuInterstellarGalaxy is ERC721A, Owneable {
    ...
    constructor() ERC721A("Waifu Interstellar Galaxy", "WIG") {}
    ...
    function mint(uint256 _amount) external payable {
        ...
        require(MAX_PER_TX >= _amount , "Excess max per paid tx");
            require(totalSupply() < 2000 ? _amount * 0 == msg.value : _amount * price == msg.value, "Invalid funds provided");
