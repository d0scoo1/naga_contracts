...
contract TakamoriInu is Context, IERC20, Ownable {
    ...
    string private _name = "TAKAMORI INU";
    string private _symbol = "TAKA";
    ...
    uint256 public _maxBuyAmount = 3000000000000 * 10**9;
    uint256 public _maxWalletAmount = 10000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 1000000000000 * 10**9;
    uint public ethSellAmount = 1000000000000000000;  //1 ETH
    address public marketingWallet = 0xE730bde85a4e5Baae7E1eE6a111355010C0E68a4;
    address public devWallet = 0xE730bde85a4e5Baae7E1eE6a111355010C0E68a4;
