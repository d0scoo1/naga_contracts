...
contract RYUKONG is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    string private constant _name = "RYUKONG";
    string private constant _ticker = "RYUKONG";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x1668580fCEb3F1aCA4157A3A69C2ca15c82472bA);
        DevWallet = payable(0x4875bD98fE00a8B32e5581FBd36cC745EcF90c94);
