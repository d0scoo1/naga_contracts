...
BartBonk - A fork of Dogebonk but on Eth
Hodl and earn 5% reflections.1% goes to the marketing wallet which we'll use to send this thing nuclear

 ✅ Fair Launch - No presale, no whitelist. Anti bot-contract
 ✅ Locked Liquidity - We'll lock liquidity for 12 months
 ✅ Renounced Ownership

🔥 50% of supply starts off burned

Join the telegram to view all relevant links:  https://t.me/BartBonkEth
...
contract  BartBonk is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply =  9000000000000 * 10 ** 18;


    constructor () ERC20('BARTBONK','BARTBONK') {
