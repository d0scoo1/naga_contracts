...
/*    
     TG: https://t.me/smokeshiba  

    Website: https://www.smokeshiba.com/

       🚬 🚬 🚬 
       So what we smoke weed 🌿🌿            - Contract will be renounced + Lp locked , Prelocking
       We're just having fun                         Supply: 420,420           Max Tx: 8408
...
contract SmokeShiba is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 420420 * 10**8;
	string private constant _name = "Smoke Shiba";
	string private constant _symbol = "SmokeShiba";
