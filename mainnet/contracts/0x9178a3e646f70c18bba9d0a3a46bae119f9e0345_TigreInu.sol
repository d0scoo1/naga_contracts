...
Website : http://Tigreinu.org/
TG : https://t.me/tigreinu
✅ WEBSITE LAUNCH
✅ LIQUIDITY LOCKED
✅ X100 POTENTIAL
✅ LOW MC 
...
contract TigreInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Tigre Inu";
    ...
    address payable private _developmentAddress = payable(0x2107FEe1ea9fB85Ee2a8F848Cb03e83e9105418f);
    address payable private _marketingAddress = payable(0x2107FEe1ea9fB85Ee2a8F848Cb03e83e9105418f);
    ...
    uint256 public _maxTxAmount = 40000000000001 * 10**9; //4
    uint256 public _maxWalletSize = 40000000000001 * 10**9; //4
