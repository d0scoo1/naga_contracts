...
contract Theseus is Context, IERC20, Ownable {
    ...
    string private constant _name = "Theseus Inu";
    string private constant _symbol = "THESEUS";
