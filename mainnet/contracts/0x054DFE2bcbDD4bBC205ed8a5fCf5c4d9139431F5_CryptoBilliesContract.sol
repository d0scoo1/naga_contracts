...
//   / ____/______  ______  / /_____     / __ )(_) / (_)__  _____
//  / /   / ___/ / / / __ \/ __/ __ \   / __  / / / / / _ \/ ___/
// / /___/ /  / /_/ / /_/ / /_/ /_/ /  / /_/ / / / / /  __(__  ) 
// \____/_/   \__, / .___/\__/\____/  /_____/_/_/_/_/\___/____/  
//           /____/_/                                            
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1AB8693930D7b99A0B66F3e7Df5219c7e98537FA,0x02599Df75c35Dface882a1b29ba3AC01847eb929,0x0Cb3Dd2D550737490c3628248184D0aDE4709381];
  uint256[] public payableFees = [5,25,35,35];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVRy4ec3keuA3Nh3PimTGTJNddiGGEftfqNvDUnxFayYh/";
...
// File: contracts/CryptoBilliesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CryptoBilliesContract is RamppERC721A {
    constructor() RamppERC721A("Crypto Billies", "BILLIES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/yfctE3tYKJH6d91fLRmo/contract-metadata";
    }
}
