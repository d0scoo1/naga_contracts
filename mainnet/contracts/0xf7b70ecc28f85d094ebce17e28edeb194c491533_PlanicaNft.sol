...
// File contracts/planica/PlanicaNft.sol
...
contract PlanicaNft is ERC721Enumerable, Ownable {
  ...
  /**
   * @dev Marks if minting new tokens for this contract is permanently disabled.
   */
  ...
  /**
   * @dev Creates new NFTs. NFTs are sent directly to te owners wallet.
    ...
    onlyOwner
  {
    ...
    for (uint8 i = 0; i < amount; i++) {
      _safeMint(owner(), totalSupply() + 1); // we start with id 1
    }
  }

  /**
   * @notice Irreversible action.
   * @dev Disables minting new nfts for this collection.
   */
