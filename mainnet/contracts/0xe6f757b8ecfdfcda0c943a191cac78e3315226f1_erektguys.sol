...
contract erektguys is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbAFxnxERUvCNz78zjALsaeXyAD6SLhTEvtiSvjfM2raaA";
    ...
    constructor(
    ) ERC721A("erektguys", "erekt", 100, maxSupply) {
    }
