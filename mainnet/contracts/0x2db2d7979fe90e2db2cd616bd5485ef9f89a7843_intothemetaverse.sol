...
contract intothemetaverse is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPaL42HMi2oFrY2X7AP9SAmYnwhgvJmPJkqF6XoHCZcKf";
    ...
    constructor(
    ) ERC721A("Into The Metaverse", "ITM", 100, maxSupply) {
    }
