...
contract TheLudus is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 0.05 ether;
    uint256 private whitelistCost = 0.0001 ether;
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmdT9pQZzCcNypQ2D9Co71zjKhU9Ukc93TDYFcRb6BH9iT/",
