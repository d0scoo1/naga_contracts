...
Telegram Channel: @classicmemeeth
...
contract ClassicMemeEth is Context, IERC20, Ownable {
    ...
    string private constant _name = "Classic Meme";
    string private constant _symbol = "CLASSICMEME";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (from != owner() && to != owner()) {
            ...
            if (from == uniswapV2Pair && to != address(uniswapV2Router) && ! _isExcludedFromFee[to] && tradingOpen) {
                // buy limit
