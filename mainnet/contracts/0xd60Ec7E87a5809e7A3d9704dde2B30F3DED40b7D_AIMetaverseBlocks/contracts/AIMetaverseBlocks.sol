...
contract AIMetaverseBlocks is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mintOLD(uint256 _mintAmount) public payable mintCompliance(_mintAmount) mintPriceCompliance(_mintAmount) {
