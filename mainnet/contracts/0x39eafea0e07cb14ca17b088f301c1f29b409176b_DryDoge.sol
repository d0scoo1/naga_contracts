...
| $$  | $$| $$      | $$  | $$      | $$  | $$| $$  | $$| $$  | $$| $$_____/      
| $$$$$$$/| $$      |  $$$$$$$      | $$$$$$$/|  $$$$$$/|  $$$$$$$|  $$$$$$$      
|_______/ |__/       \____  $$      |_______/  \______/  \____  $$ \_______/      
                     /$$  | $$                           /$$  \ $$                
                    |  $$$$$$/                          |  $$$$$$/                
                     \______/                            \______/                
                     
Welcome to the Dry Doge Metaverse

website - www.drydoge.com
telegram - https://t.me/drydoge
...
contract DryDoge is Context, IERC20, Ownable {
    ...
    //
    string private _name = "Dry Doge Metaverse";                                           // name
    string private _symbol = "DRYDOGE";                                            // symbol
    ...
    uint256 public _maxTxAmount = _tTotal.div(1).div(32);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x6EE0044Ac64685d788d66562c51020cf8ac24363);
