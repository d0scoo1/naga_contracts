/**
The time has come. There is a taste in the air.. do you taste it? We have been confined to the shadows for
too long, it is now our time. We are releasing something that will aid you in accomplishing everything you 
so deathly desire. We are the age of the new. ALL HAIL TAMA2
...
contract SAITAMA is ERC20, Ownable {
    ...
    constructor(address _dev) public ERC20("SAITAMA 2.0", "TAMA2") {
