/*
    Goat Cheese Token ($GOAT)
 
    https://t.me/GOATCheeseToken
    https://www.goattoken.co/


   $GOAT NFTs and Staking will be available shortly after launch. 
*/
...
contract GoatCheese is Context, IERC20, Ownable {
    ...
    string private _name = "Goat Cheese";
