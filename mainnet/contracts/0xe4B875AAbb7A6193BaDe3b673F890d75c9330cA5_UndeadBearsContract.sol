...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x92F1225F814CC4f4b41D3F60508f3535820f9DEc];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 20, 9990 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmcgjt2ELQUhqrSPerJATzd32US7YgiHYWu6dt3eTUitJX/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 9990");
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 9990");
...
// File: contracts/UndeadBearsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract UndeadBearsContract is RamppERC721A {
    constructor() RamppERC721A("Undead Bears", "UNDEADBEAR"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YXETnErfiqiPMkXyiIJK/contract-metadata";
    }
}
