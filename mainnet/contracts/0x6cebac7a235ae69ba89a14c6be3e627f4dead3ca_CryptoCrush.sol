...
contract CryptoCrush is ERC721A, Ownable {
    using Strings for uint256;
    ...
    bool public paused;
    uint256 mintRate = .01 ether;
    uint256 public maxPublic = 20;
    uint256 public maxSupply = 50000;
    uint256 public mintFree = 500;


    constructor(string memory _initBaseURI) ERC721A("Crypto Crush 2022", "CRCRUSH2022") {
