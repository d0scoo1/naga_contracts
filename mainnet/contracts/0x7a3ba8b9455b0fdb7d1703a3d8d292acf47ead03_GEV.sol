...
// ----------------------------------------------------------------------------
// 'Gotham Etherverse' contract
//
// Symbol      : GEV
// Name        : Gotham Etherverse
...
contract GEV is BurnableToken {

    string public constant name = "Gotham Etherverse";
    string public constant symbol = "GEV";
