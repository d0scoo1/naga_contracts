...
contract MrsClaus is Context, IERC20, Ownable {
    ...
    string private _name = "Mrs Claus";
    string private _symbol = "MRSCLAUS";
    ...
    address public charityWallet = 0xD74477f81234C8564c74a856426BAFbCbb7ca7ED;
    address public developmentWallet =
        0xBC5FC97ca7FFa244d1ef7B603a618a1dbB4b477E;
    address public marketingWallet = 0x025Df6DE44F581CD0b20786D5740813d64CDD92c;
    ...
    function _tokenTransfer(
        ...
        if (_isExcluded[sender] && !_isExcluded[recipient]) {
            _transferFromExcluded(
                sender,
                recipient,
                (amount.sub(burnAmt).sub(amtWalletS))
            );
