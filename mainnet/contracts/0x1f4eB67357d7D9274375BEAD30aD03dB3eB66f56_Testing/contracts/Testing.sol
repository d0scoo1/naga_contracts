...
contract Testing is Ownable, ERC721A, ERC2981, ReentrancyGuard,Pausable {
    ...
    constructor(address _royaltyReceiver) ERC721A("For The Tester", "Testing", 5, 1000) {
        maxMintPerUser = 5;
        _setDefaultRoyalty(_royaltyReceiver, 500);
    }

    function mintPublic(uint256 numTokens) external nonReentrant {
