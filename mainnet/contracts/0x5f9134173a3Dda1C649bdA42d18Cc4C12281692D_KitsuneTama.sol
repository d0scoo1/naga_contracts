...
contract KitsuneTama is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Kitsune Tama";
    string private constant _symbol = "KITAMA";
    ...
    uint256 private constant _tTotal = 48000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    mapping(address => bool) private _isSniper;
    uint256 public launchTime;

    uint256 private _redisFeeJeets = 10;
    ...
    uint256 public _maxTxAmount = 480000 * 10**9;
    uint256 public _maxWalletSize = 960000 * 10**9;
    uint256 public _swapTokensAtAmount = 1000 * 10**9;
    uint256 public _minimumBuyAmount = 480000 * 10**9 ;
