...
//*********************************************************************//
//
//     ______           __      _ __     ________          _     
//    / ____/_  _______/ /__   (_) /_   / ____/ /_  ____ _(_)____
//   / /_  / / / / ___/ //_/  / / __/  / /   / __ \/ __ `/ / ___/
//  / __/ / /_/ / /__/ ,<    / / /_   / /___/ / / / /_/ / / /    
// /_/    \__,_/\___/_/|_|  /_/\__/   \____/_/ /_/\__,_/_/_/  
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xe173f64346bE280c29C54b58b878032e61Af2Cf3];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUsb1FeMPUF9Kp3yJQkXeCjhhAhpPW7xoRE8p7ttrgbgG/";
...
// File: contracts/FuckitChairContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FuckitChairContract is RamppERC721A {
    constructor() RamppERC721A("Fuck it Chair", "Chair"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/fyBlYLFptzlj4VMiHF2R/contract-metadata";
    }
}
