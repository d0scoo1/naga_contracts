...
Elon Musk set to purchase Coca Cola to recreate the original cocaine containing formula
...
contract ELONSNORTSCOKE is Context, IERC20, Ownable {
  ...
  bool private initialAirdrop = false;
	...
	string private constant _name = "ELON BUYS COCA COLA";
	string private constant _symbol = "ELONBUYSCOKE";
  ...
  event SwapAndLiquify(
	...
	constructor () {
		 _elonWallet = payable(0xc0d03b908e0Ae3eF8f572634C30d2C9a35b794BA);

		_taxFee = _buyTaxMarketing + _autoLpFee;
		_uniswap = IUniswapV2Router02(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

		_isExcludedFromFee[address(this)] = true;
    	_maxTxAmount = _tTotal.mul(2).div(10**50);
	  	_maxWallet = _tTotal.mul(4).div(10**50);
    ...
    function setElonWallet(address newWallet) external onlyOwner() {
        _elonWallet = payable(newWallet);
    }
