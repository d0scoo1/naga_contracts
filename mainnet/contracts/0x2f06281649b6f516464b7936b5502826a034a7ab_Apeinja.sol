...
contract Apeinja is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Apeinja";
    string private constant _symbol = "APEINJA";
    ...
    address payable private _developmentAddress = payable(0x7483FE2Af25bAA88B6E5c820cab6012C908983bA); 
    address payable private _marketingAddress = payable(0x87d8AF3Cec1DcDbbB9a07F028d0171f414B97A09);
