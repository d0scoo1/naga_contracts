...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xb34Cf8F443352953EbA4EE92e3636A464339D9Fd];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmQoQ7nG38zTDYK6FJUaKiH131VMD1zNGQKWL5kzwjZVWT/";
...
// File: contracts/LittlegoblintownwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LittlegoblintownwtfContract is RamppERC721A {
    constructor() RamppERC721A("littlegoblintownwtf", "LGOBT"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/rTEzRLqaOCtH3fRAhakU/contract-metadata";
    }
}
