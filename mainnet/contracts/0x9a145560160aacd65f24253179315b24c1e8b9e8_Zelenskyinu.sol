...
/*
    ...
    President Zelensky is one of the most inspiration people in the world right now, and this meme coin is dedicated to him!

    On February 24, 2022, The Russian Federation invaded Ukraine. President Volodymyr Zelensky did not flee, instead showing bravery and courage by fighting with his military!

    Zelensky Inu $ZELINU is dedicated to showing support for Ukraine and its president.

    🇺🇦🐶 Roadmap:
    CG/CMC
    Coinalerts voting
    Website fresh design and release
    Dext Trending (with volume)
    Utility

    Tokenomics: 1% max buy 15% buy fee

     Telegram: https://t.me/ZelenskyInuERC
*/
...
contract Zelenskyinu is Context, IERC20, Ownable {
    ...
    string private _name = "Zelensky";
    string private _symbol = "Zelinu";
