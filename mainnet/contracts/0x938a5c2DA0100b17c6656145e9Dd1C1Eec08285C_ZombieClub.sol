...
contract ZombieClub is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    uint256 public maxBalance = 6666;
    uint256 public maxMint = 6666;
