// Telegram Group : https://t.me/okxzillaeth
// Website : https://okxzilla.com/
// Max Transaction : 2% of Supply & Max Wallet : 4% of Supply
...
contract OKXZilla is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "OKX Zilla";
    string private _symbol = "OKXZILLA";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x2720C5baBf72a7a831BdFeAAe96C31F17A5d6e48); // Marketing Address
    address payable public developmentWalletAddress = payable(0x910F02d2df9BF512321724f8a66da69Ad6D192dB); // Development Address
    ...
    uint256 public _buyDevelopmentFees = 6;
    uint256 public _sellLiquidityFees = 1;
    uint256 public _sellMarketingFees = 7;
    uint256 public _sellDevelopmentFees = 6;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount <= (20 * 10**6 * 10**9), "Max wallet should be less or euqal to 4% totalSupply");
