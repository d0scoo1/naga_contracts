...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x509560f51caF4da8F07AC47CcAae7Bc34f3E9f9f), 8000);
        m_DidDeploy = true;
    }
...
contract IdiotApes is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "Idiot Apes";
    string private m_Symbol = "iAPE";
    ...
    constructor () {
        ...
        ILO.init(2000000000000000000, 1000, 1000, 100000, m_ILOPublic);
        initTax();
