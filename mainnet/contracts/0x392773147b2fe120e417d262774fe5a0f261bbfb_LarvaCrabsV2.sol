...
// File contracts-source/ERC721B.sol
...
// File contracts-source/ERC721EnumerableLite.sol
...
// File @openzeppelin/contracts/finance/PaymentSplitter.sol@v4.4.1
...
// File contracts-source/LarvaCrabsV2.sol
...
contract LarvaCrabsV2 is ERC721EnumerableLite, Ownable, PaymentSplitter {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  bool public isPauseMode = true;
  uint256 public PriceNFT = 0.025 ether;
  uint256 public MaxCollection = 5001; //account for 0 based array
  uint256 public maxMintPerTrx = 10;
  bool public isProxied = true;

  address[] private addressList = [
    0x3Fc6C5047c28917FB27c79bF1D9B49419CFDc04B,
  ...
  constructor(string memory _initBaseURI)
    ERC721B("Larva Crabs", "LARVACRABS2") 
  ...
  function gift(uint[] calldata quantity, address[] calldata recipient) external onlyOwner{
    ...
    require( supply + totalQuantity <= MaxCollection, "Mint/order exceeds supply" );
