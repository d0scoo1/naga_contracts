/*
Putin you wanna BARK or INVADE Ukraine? 

PutinInu is a meme token to mock the inability and ruthlessness of Putin as well as showing solidarity with the Ukrainian. By combining the inu with the dictator Putin, we mock Putin is just a coward in comparison with those Ukrainians who vowed to defend their own country with bare hand. 
The purpose of the Putininu is actually far more greater than solely providing a meme, a utility designed to help the Ukrainian will be put into the Putininu. 

Most of the tax will be simply used to buy back and burn the token to push the price and the supply of the token.

Every community members could receive reward by simply holding $PUTININU but helping Ukrainian at the same time.

🚀4% Reward Pool to buy and burn $PUTININU token  
🚀3% Marketing Wallet 
🚀3% Development Wallet
🚀2% For Ukrainian humanitarian NGO

DAO governance
Community could suggest and vote what Ukrainian humanitarian NGO we should invest.

Telegram: https://t.me/putinutoken

Website: https://putininu.world/
...
contract PutinInu is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "PutinInu";
