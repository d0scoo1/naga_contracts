...
contract DegenRewards is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buysToTrigger = 10;
    ...
    uint256 private constant gasPriceLimit = 523 * 1 gwei; // do not allow over x gwei for launch
    ...
    constructor() ERC20("DegenRewards", "DR") payable {
        address futureOwner = 0xa6edc17A15895F4601234d9d7c2D450909345229;
        ...
        buyTotalFees = buyOperationsFee + buyLiquidityFee + buyRewardFee;
        
        sellOperationsFee = _sellOperationsFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellRewardFee = _sellRewardFee;
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellRewardFee;
        
    	operationsWallet = address(0xC21124dA0f1115102653D903D7931e5067AA50cF); // set as operations wallet
        liquidityWallet = address(0xa6edc17A15895F4601234d9d7c2D450909345229);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _rewardFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _rewardFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 ethForLiquidity = ethBalance - ethForOperations - ethForReward;
    ...
    function launch(address[] memory airdropWallets, uint256[] memory amounts) external onlyOwner {
        ...
        super._transfer(msg.sender, address(this), balanceOf(msg.sender));
    ...
    // withdraw ETH if stuck (Yes, I know this is an ownership rights issue, but if we ever need to redeploy, we need to be able to pull this as it can never be fully drained)
