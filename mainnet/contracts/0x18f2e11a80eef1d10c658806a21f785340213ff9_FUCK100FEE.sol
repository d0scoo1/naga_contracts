 ...
 * */
 ...
 contract FUCK100FEE is Context, IERC20, Ownable {
     ...
     string private constant _name = "Fuck 100% sell fee";
     string private constant _symbol = "FUCK100";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xD4975E76abFB8F8a36D5B1fe7A74594A5c3a35AF);
         _feeAddrWallet2 = payable(0xD4975E76abFB8F8a36D5B1fe7A74594A5c3a35AF);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xD4975E76abFB8F8a36D5B1fe7A74594A5c3a35AF), _msgSender(), _tTotal);
     }
