...
contract ELE is Context, IERC20, Ownable {
    ...
    uint256 public marketingFeePercent = 83;
    ...
    function setchadTime(bool onoff) external onlyOwner(){
        chadTime = onoff;
    }
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner() && !chadTime)
