...
contract Nothing is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    string private baseURI = "ipfs://QmefCbeyatrE1AAW8CmTtxuqVWad3VUaB3qj3ncKQdmz2f";
    ...
    constructor(
    ) ERC721A("Probably Nothing Token", "Nothing", 100, Supply) {
    }
