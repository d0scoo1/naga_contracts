...
contract LuckyApeTravelClub is Ownable, ERC721A  {

    using Strings for uint256;

    string private _baseTokenURI;

    uint256 public presaleCost = 0.777 ether;
    uint256 public publicSaleCost = 1 ether;
    uint256 public maxSupply = 10000;
    uint256 public maxMintAmountPerPublicAccount = 20;
    ...
    constructor() ERC721A("LuckyApeTravelClub", "LATC") {}
