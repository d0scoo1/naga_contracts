...
//            |_||_\___\__,_\__,_| \_, | |_|  |_| .__/\___|  |___/\___/\__||_\___| \__|\_, | 
//                                 |__/         |_|                                    |__/  
//                                                                                                                                                                                                      
//                                                                                                    
//                                 %@@@@@@\              &@@@                                        
...
abstract contract RandomlyAssigned is WithLimitedSupply {
    ...
    function nextToken() internal override ensureAvailability returns (uint256) {
        uint256 maxIndex = maxTokens() - tokenCount();
...
contract HeadyPipeSociety is ERC721, Ownable ,RandomlyAssigned {
  using Strings for uint256;
  using Counters for Counters.Counter;
  ...
  constructor() ERC721("HeadyPipeSociety", "HEADY") RandomlyAssigned(6000, 1){
    setHiddenMetadataUri("https://www.HeadyPipeSociety.com/reveal/hidden.json");
  }
