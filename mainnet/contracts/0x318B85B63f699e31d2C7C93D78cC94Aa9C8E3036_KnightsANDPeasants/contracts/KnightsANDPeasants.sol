...
contract KnightsANDPeasants is ERC721A, Ownable, ReentrancyGuard {


  string public baseURI = "https://api.knightsandpeasants.one/api/knight?id=";
  ...
  constructor() ERC721A("Knights & Peasants", "Knights & Peasants"){
