...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xDF29bF2468d6CF167bdB70101b506a38f0E69A9A;
...
contract H1 is Context, IERC20, Ownable {
    ...
    address private _developmentWalletAddress = 0xB0Be54faC517Ee9bB3503F195Df15b607917cB0f;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "H1";
    string private _symbol = "H1";
