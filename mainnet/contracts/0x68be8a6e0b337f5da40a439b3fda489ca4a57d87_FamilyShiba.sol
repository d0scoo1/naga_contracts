...
* With the auto-claim feature, simply hold $FAMILYSHIBA and you'll receive $DOGE automatically in your wallet.
* 
* Tokenomics
* 
* 🐶 5% Redistribution $DOGE coin on Each Transaction!
* 💸 2% Marketing & Buy-back on Each Transaction
* ♻️ 2% Liquidity pool for increase price floor
* 🤯 7-9% TAXES
* 
* Family Shiba ($FAMILYSHIBA)
* ✅ Manual Buy-back & $DOGE rewards
* 🔒 AUDIT COMING SOON
* 🦾 UNIQUE TOKENOMICS
* 📢 InitialCap $35K
* 📈 2% Marketing & Buy-back
* 📊 2% Liquidity
* 🦮 5% $DOGE REWARDS
* 💰 DEVS WITH BIG CONNECTIONS
* 
* Our community:
* 📲 Telegram: https://t.me/family_shiba
* 🌐 Website: https://familyshiba.com
*/
...
contract FamilyShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'Family Shiba';
    string private _symbol = 'FAMILYSHIBA';
