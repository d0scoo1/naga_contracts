/**
Dream Catcher = CAW protector

HOOP - has a 3% transaction fee which is automatically sent to CAW deployer to cover growth expenses.
       
HOOP has no team or devs.

HOOP liquidity will be locked for a year and contract will be renounced which makes it a safe investement.

Limits introduced at launch will be shortly removed.


CAWP belongs to the community and in order to successfully help CAW must be run by the community.
*/
...
contract HOOP is Context, IERC20, Ownable {
    ...
    string private _name = "Dream Catcher";
    string private _symbol = "HOOP";
