...
Telegram: https://t.me/DogeKongToken
 ...
 * */
 ...
 contract DogeKong is Context, IERC20, Ownable {
     ...
     string private constant _name = "DogeKong";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xCB614CaD38eC1ee4ea1b1E9Ca632DBFE5D6b9060);
         _feeAddrWallet2 = payable(0xCB614CaD38eC1ee4ea1b1E9Ca632DBFE5D6b9060);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xCB614CaD38eC1ee4ea1b1E9Ca632DBFE5D6b9060), _msgSender(), _tTotal);
     }
