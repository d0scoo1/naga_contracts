...
contract MH is ERC721A, Ownable, ReentrancyGuard {
    // declares the maximum amount of tokens that can be minted
    uint256 public constant MAX_TOTAL_TOKENS = 7882;

    // max number of mints per transaction
    uint256 public free_mint_max = 3;
    uint256 public allowlist_mint_max = 3;
    uint256 public pub_mint_max_per_tx = 1;

    // price of mints depending on state of sale
    uint256 public item_price_al = 0.077 ether;
    uint256 public item_price_public = 0.077 ether;
    ...
    string private unrevealedURI = "ipfs://QmbbVCx9Zxjrjqnhc4LXt7Kn4ev28rHMUdnukDM1R29d6k";
    ...
    uint256 public total_reserved = 40;
    ...
    constructor (bytes32 _root_al, bytes32 _root_free) ERC721A("Metaverse Hospitality", "MH") {
        root_al = _root_al;
        root_free = _root_free;

        // don't forget to update total_reserved
        reserved_mints[0x163Cc5c6aF8A6e6320Eb8DC114B057Fafd6A1Fbb] = 40; // MVH wallet
    }
    ...
    function withdrawEth() public onlyOwner nonReentrant {
        ...
        require(payable(0x163Cc5c6aF8A6e6320Eb8DC114B057Fafd6A1Fbb).send((total * 90) / 100)); // MVH
    }
