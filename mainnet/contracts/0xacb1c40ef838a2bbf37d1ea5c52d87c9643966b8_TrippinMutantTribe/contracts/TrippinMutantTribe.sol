...
contract TrippinMutantTribe is ERC721A, Ownable, ReentrancyGuard {
...
// ================== Constructor Start =======================
  ...
  constructor(
    string memory _uri
  ) ERC721A("TrippinMutantTribe", "TMT")  {
    seturi(_uri);
  }
