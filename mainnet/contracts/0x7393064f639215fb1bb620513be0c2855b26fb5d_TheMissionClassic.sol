/**
    ...
    5% liquidity Fee on buying and selling MSN

    There is no dev or marketing fee.

    MSNC is a social experiment style of token.
...
contract TheMissionClassic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Mission Classic", "MSNC") {
