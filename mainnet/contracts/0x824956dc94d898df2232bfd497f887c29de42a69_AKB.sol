...
contract AKB is StandardToken
{
	string public name = "AlkebulanCoin";
	string public symbol = "AKB";
	...
	{
                 _admin = msg.sender;
		totalSupply = 1000000000000 * DECIMALS_MULTIPLIER;
