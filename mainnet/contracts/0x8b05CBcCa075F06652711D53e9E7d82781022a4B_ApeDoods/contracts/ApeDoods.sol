    ...
    contract ApeDoods is ERC721, Ownable, ERC721Enumerable {
      ...
      string public baseURI = "ipfs://QmUvRMycr3YesvxEYicBe1PBCG3dTLZE2n1GnxBeCstTtP/"; // IPFS URI WILL BE SET AFTER ALL TOKENS SOLD OUT
      ...
      uint256 public devReserve = 156;
    
      event ApeMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("ApeDoods", "APED") {}
      ...
      function mintApe(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit ApeMinted(id, msg.sender);
          }
        }
      }
    
      function presaleApe(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmNedYo9WmqynA7ttWHy9Mzv66VZcxzoqkx2vBT2FJr3Bc/hidden.json";
        }
