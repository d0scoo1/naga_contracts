...
contract KODAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://Qmbfx1Wbqyp5LsywxAeMSyLDgYRvZ7zjKYTebqPeQJ4Zje/";
    ...
    constructor(
    ) ERC721A("KODA DAO", "KODAO", 100, maxSupply) {
    }
