...
/**
 * @title Crop Token
 * @dev Crop ERC20 Token
 */
contract CropToken is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Crop Finance", "CROP") {
     ...
     * Owner is assumed to be governance or Crop trusted party for helping users
