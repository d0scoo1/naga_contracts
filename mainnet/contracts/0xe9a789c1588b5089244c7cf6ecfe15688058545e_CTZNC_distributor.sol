...
contract CTZNC_distributor is Ownable {
    ...
    uint256 private _byteBurn = 20;

    bool public paused = true;

    mapping(address => uint16) public whitelistBurn;
    ...
    function setByteBurn(uint256 _newBurn) public onlyOwner() {
        _byteBurn = _newBurn;
    }
    ...
    function getRewardBalance() public view onlyOwner returns (uint256)  {
        return IERC20(0xCa593143355d8E9C3107248778d31E56Df9146dF).balanceOf(address(this));
    }
    ...
    function claim() external {
        require(!paused, "Smartcontract is paused");
        require(whitelist[msg.sender] > 0, "Address not on whitelist");

        IERC20 rewardToken = IERC20(address(0xCa593143355d8E9C3107248778d31E56Df9146dF));
        rewardToken.transfer(msg.sender, whitelist[msg.sender] * (10 ** 18));
    ...
    function claimBurn() external {
        ...
        IERC20 burnToken = IERC20(address(0x7d647b1A0dcD5525e9C6B3D14BE58f27674f8c95));
        burnToken.transferFrom(msg.sender, 0x0000000000000000000000000000000000000000, _byteBurn * (10 ** 18));

        IERC20 rewardToken = IERC20(address(0xCa593143355d8E9C3107248778d31E56Df9146dF));
        rewardToken.transfer(msg.sender, whitelistBurn[msg.sender] * (10 ** 18));
