...
pragma solidity ^0.8.2;
    ...
    contract FUCKOS is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable {
        ...
        address public beneficiary=0xFC68348fcCC958A633D367710a59865cB736F8E8;
        ...
        constructor() ERC721("FUCKOS", "FUCKOS") {
            nextId=1;
            _baseURIextended="ipfs://QmeUJGXYj6jXLqHyTUyeiyDDZwhgVFJPaSPLpqSxMavw6d";
            extension = ".json";
        }
        ...
        function mint() public payable{
            ...
            if(!publicMint||nextId<=555){
               require(isWhitelist(msg.sender),"You are not a whitelisted address");
            }
            require(mintCount[msg.sender]+1<=MAX_MINT, "Amount invalid");
            uint price1=getPrice(msg.sender);
            require(msg.value>=price1,"Amount invalid");
            uint tokenId=nextId;
        ...
        function getPrice(address player) public view returns(uint){
            if(!publicMint){
                if(mintCount[player]>=3){
                    return price;
                }else{
                    return 0;
                }
            }else{
                if(mintCount[player]>=1){
                    return price;
                }else{
                    return 0;
                }
