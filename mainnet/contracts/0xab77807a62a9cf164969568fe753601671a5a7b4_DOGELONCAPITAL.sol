/*
 From the DogElonMars team, we bring you our latest creation: DogElonMars Money (capital)
- https://t.me/DogelonMarsMoney
Steal Launch from your favorite dev team
*/
...
contract DOGELONCAPITAL is  Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    string private constant _name = "DOG ELON CAPITAL";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x352e3375Bfd0481880422FF402124791F5350B54);
        _feeAddrWallet2 = payable(0x352e3375Bfd0481880422FF402124791F5350B54);
        ...
        emit Transfer(address(0xaa9186B9953bA0153F276bf87381F2F6Ca0423F4), _msgSender(), _tTotal);
    }
