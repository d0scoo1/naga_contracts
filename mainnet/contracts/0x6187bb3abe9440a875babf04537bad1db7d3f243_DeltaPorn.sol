...
contract DeltaPorn is Context, IERC20, Ownable {
    ...
    string private _name = "Delta Porn";
    string private _symbol = "DPRN";
    ...
    {
        require(
            SwapThresholdAmount > 5000000,
            "Swap Threshold Amount cannot be less than 50 Million"
        );
