...
contract MoonFuckers is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 670000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'MoonFuckers';
    string private _symbol = 'MFKR';
    uint8 private _decimals = 18;
    
    uint256 private _taxFee = 5;
    uint256 private _burnFee = 4;
    uint256 private _maxTxAmount = 33500000 * 10**18;
