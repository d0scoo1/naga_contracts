...
contract skoufrens is Ownable, ERC721A {

    bool public publicSale = true;
    bool public revealed = false;
    uint256 public maxPerTx = 25;
    uint256 public maxPerAddress = 250;
    uint256 public maxToken = 10000;
    uint256 public price = 0.01 ether;
    string private _baseTokenURI = "ipfs://QmaGvPiM19UFD6uyyw2FcSoa1NXCtcx9TiJKypgq5aiE16/";
    string public notRevealedUri = "ipfs://QmaGvPiM19UFD6uyyw2FcSoa1NXCtcx9TiJKypgq5aiE16/";
    ...
    function mint(uint256 quantity) external payable callerIsUser {
        ...
        }else if(numberMinted(msg.sender) + quantity < 6){
             require(msg.value == 0, "INVALID_ETH");
        }else{
            require(msg.value == price * ( quantity - 5), "INVALID_ETH");
        }
