...
contract TheTheProcessV2 is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"TrustTheProcessV2"; ////
    string public constant symbol = unicode"TrustTheProcessV2"; ////
