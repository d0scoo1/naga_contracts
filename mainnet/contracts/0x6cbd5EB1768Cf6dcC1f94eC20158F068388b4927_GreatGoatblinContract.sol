...
//   / ____/_______  ____ _/ /_   / ____/___  ____ _/ /_/ /_  / (_)___ 
//  / / __/ ___/ _ \/ __ `/ __/  / / __/ __ \/ __ `/ __/ __ \/ / / __ \
// / /_/ / /  /  __/ /_/ / /_   / /_/ / /_/ / /_/ / /_/ /_/ / / / / / /
// \____/_/   \___/\__,_/\__/   \____/\____/\__,_/\__/_.___/_/_/_/ /_/ 
//                                                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xCC879Bc973A74d87375b385B804e7F44F6B38D89];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmdvArt2G2tbhY1Q52YfaSYF4SSENMT5sKNoPpwVQbKq9v/";
...
// File: contracts/GreatGoatblinContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GreatGoatblinContract is RamppERC721A {
    constructor() RamppERC721A("Great Goatblin", "GG"){}
}
