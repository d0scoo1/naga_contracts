...
contract BWERKS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUzUsjRADXQygGUJdUJDomiKUeRKvdmM2NrTCT2GhVtR1";
    ...
    constructor(
    ) ERC721A("BWERKS", "BWERKS (BLACK MEN TWERKING)", 100, maxSupply) {
    }
