...
contract $LEVY is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 300000000000 * 10**8;
	...
	string private constant _name = "Levy Iny";
	string private constant _symbol = "$LEVY";
