...
for the community, enjoy a safe trade .
...
contract BlackBird is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Black Bird";
    string private constant _symbol = "BLKBird";
    ...
    address payable private _taaxAddress = payable(0x2f7B1742fCD27Cf93120be70102341859f4fB4Ce); 
    address payable private _ttaxAddress = payable(0x2f7B1742fCD27Cf93120be70102341859f4fB4Ce);
