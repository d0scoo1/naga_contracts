...
/*
Floki's FAVOURITE HERO HAPPY BIRTHDAY ELON MUSK

From a self taught programmer to sending humans to Mars,this man made us believe that everyone can create wonders.
Wishing a very very Happy 50th Birthday to Elon Musk.
Similarly, Floki, the smartest, will be reloaded to go to Mars in a better shape, lively, classic and intelligent.
*/
...
contract FLOKIr is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Floki Reloaded", "FLOKIr") {
        ...
        maxWallet = 15 * 1e5 * 1e18; // Max Wallet 1.5%
		...
		marketingWallet = address(0x771d2Ab491F68eB48a0dCcaC4B6F44AeC3AD5d0b); // set as marketing wallet
         
        // exclude from paying fees or having max transaction amount
        _isExcludedFromFees[address(0x771d2Ab491F68eB48a0dCcaC4B6F44AeC3AD5d0b)] = true;
        _isExcludedFromFees[address(this)] = true;
        _isExcludedFromFees[address(0xdead)] = true;
      
        _isExcludedMaxBuyTransactionAmount[address(0x771d2Ab491F68eB48a0dCcaC4B6F44AeC3AD5d0b)] = true;
        _isExcludedMaxBuyTransactionAmount[address(this)] = true;
        _isExcludedMaxBuyTransactionAmount[address(0xdead)] = true;
   
        _isExcludedMaxSellTransactionAmount[address(0x771d2Ab491F68eB48a0dCcaC4B6F44AeC3AD5d0b)] = true;
