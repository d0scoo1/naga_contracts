...
Nephthys, or “Mistress of the House,” was the goddess of the air (since the sky is the “head” of the world) and the head of the family. 
Nephthys also sometimes represented Lower Egypt along with Ptah-Tanen. In Egyptian mythology, Nephthys was the daughter of Geb (Earth) and Nut (sky) and the 
sister of Isis.

5% buy
5% sell

1 month initial lock, will extend at 100k MC and 250k MC.
...
contract Nephthys is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Goddess of the Air", "Nephthys") {
