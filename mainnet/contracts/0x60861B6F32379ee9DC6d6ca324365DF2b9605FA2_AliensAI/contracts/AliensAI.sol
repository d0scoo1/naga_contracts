...
contract AliensAI is ERC721A, Ownable, ReentrancyGuard {


  string public baseURI = "ipfs://QmSd9zcwqh1bfvxVdXL8iB78XgbUcsJMScXqfpyYGkxXYi/";
  string public baseExtension = ".json";
  uint public          price             = 0.002 ether;
  uint public          maxPerTx          = 20;
  uint public          maxTxForFreeMints    = 3;
  uint public          totalFree         = 500;
  uint public          maxSupply         = 3000;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = true;

  constructor() ERC721A("AliensAI", "AliensAI"){
