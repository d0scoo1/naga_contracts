...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmVrkuuiEqksfztg6CAUdNVdZmwk91aQSPjkG2TH3HTd7y/";
...
// File: contracts/WeediesContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract WeediesContract is RamppERC721A {
    constructor() RamppERC721A("Weedies", "Weed"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/cvx6on6j7nEzniu7Q9Is/contract-metadata";
    }
}
