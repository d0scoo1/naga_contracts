...
contract Hunters is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("Hunters Of Evil", "HUNTERS"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more hunters");
    require(mintEnabled, "Minting is not live yet, hold on hunters.");
