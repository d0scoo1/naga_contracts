...
contract CoreVault is OwnableUpgradeSafe {
    ...
    function swapAllRLPForRLP() public onlyOwner {
        string [3] memory symbols = ["coreDAO/LP1", "coreDAO/LP2", "coreDAO/LP3"];
        string [3] memory names = ["coreDAO Voucher LP1", "coreDAO Voucher LP2", "coreDAO Voucher LP3"];
        // Migration steps 
        // - Create RLP tokens
        ...
        require(address(poolInfo[0].token) ==  0x32Ce7e48debdccbFE0CD037Cc89526E4382cb81b, "Already done"); // CORE-WETH UNI LP
