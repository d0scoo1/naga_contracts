...
Geass is a supernatural ability which certain people can bestow upon others. This power is usually called the Power of Kings.  According to an English edition of "Newtype", the power of Geass has something to do with the very existence of humankind, and it may be used to destroy, control, or transform just about anything. 

The power of Geass increases with use, and should the user lack the willpower, they may be consumed by it.
Lelouch states that the Geass is a form of wish. However, people who have Geass are not immune to the Geass effects of others. The Geass is represented by a glowing, bird-shaped symbol. 

https://codegeassinu.club/
https://t.me/codegeassinu
...
contract GEASS is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 2e10 * 10**9;
