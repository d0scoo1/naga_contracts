...
contract MonstersNFT is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public diamondSaleCost = 0.01 ether;
  ...
  uint256 public maxMintAmountPerDiamondAccount = 1;
  uint256 public maxSupply = 9999;

  bool public paused = true;
  bool public diamondSaleActive=true;
  bool public whitelistActive=false;


  bytes32 public merkleRoot= 0x0de6c9f4b501d88b442db96c4f3653e394ef2ce0c67fc9d33527d625663f633c;

  constructor() ERC721("Monsters NFT", "Monsters NFT") {}
  ...
  function mint(bytes32[] calldata _merkleProof, uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if(diamondSaleActive==true){
      require(msg.value >= diamondSaleCost * _mintAmount, "Insufficient funds!");
      require(balanceOf(msg.sender) + _mintAmount <= maxMintAmountPerDiamondAccount, "Mint limit exceeded." );
  ...
  function setDiamondSaleCost(uint256 _diamondSaleCost) public onlyOwner {
    diamondSaleCost = _diamondSaleCost;
  }


  function setMaxMintPerDiamondAccount(uint256 _maxMintAmountPerDiamondAccount) public onlyOwner {
    maxMintAmountPerDiamondAccount = _maxMintAmountPerDiamondAccount;
  }
  ...
  function endDiamondSale() public onlyOwner {
    diamondSaleActive = false;
    whitelistActive = true;
    paused=true;
  }

  function endWhitelist() public onlyOwner {
    require(diamondSaleActive==false);
