/*
    ...
    https://t.me/RagingRadishEth

    RR - Raging Radish

    Mean vegetables? That's cute. Raging radishes are here to dominate the vegetable game. Be mean all you want, nothing stops pure RAGE! 
*/
...
contract RagingRadish is Context, IERC20, Ownable {
    ...
    string private _name = "Raging Radish";
