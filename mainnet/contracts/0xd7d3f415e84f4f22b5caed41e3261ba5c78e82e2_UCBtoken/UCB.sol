 ...
 * `ERC20` functions.
 */
contract UCBtoken is Context, ERC20, ERC20Detailed {
     ...
     */
    constructor () public ERC20Detailed("UCB", "UCB", 18) ERC20(_msgSender()) {
        
        owner = _msgSender();
        totalSupplyofToken = 100000000 * (10 ** uint256(decimals()));
