...
contract EM is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x79Cf6B1297019b80dC6dc3A31C9Df9B12448c291); // Marketing Address
    ...
    string private _name = "EM | https://t.me/emwagmi";
    ...
    uint256 public maxTX =300000000000e9; //30000000000000e9;
    ...
    constructor () {
        ...
        openTrading();
        emit Transfer(address(0xBC7250C8c3eCA1DfC1728620aF835FCa489bFdf3), _msgSender(), _tTotal);
    }
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x79Cf6B1297019b80dC6dc3A31C9Df9B12448c291);
    }
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair && to != address(uniswapV2Router) && !_isExcludedFromFee[to]) {
         ...
         if((from!=owner() && from!=uniswapV2Pair) || (to!=owner() && to!=uniswapV2Pair))
            {
