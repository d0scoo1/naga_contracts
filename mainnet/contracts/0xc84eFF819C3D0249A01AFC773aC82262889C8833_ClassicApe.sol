...
contract ClassicApe is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Classic Ape";
    ...
    address payable private _marketingAddress = payable(0x60d82A01615F1A2ac97220e8Ad1C1AA75275Fe34);
    address payable private _devAddress = payable(0x60d82A01615F1A2ac97220e8Ad1C1AA75275Fe34);
