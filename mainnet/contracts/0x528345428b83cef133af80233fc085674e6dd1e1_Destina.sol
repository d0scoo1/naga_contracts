...
contract Destina is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Destina";//
    string private constant _symbol = "Destina";//
    ...
    address payable private _developmentAddress = payable(0x6F0443578c654007F81F66dc3fEFE215dD4cd4a9);  
    address payable private _marketingAddress = payable(0x6F0443578c654007F81F66dc3fEFE215dD4cd4a9); 
    ...
    function setFee(uint256 redisFeeOnBuy, uint256 redisFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(taxFeeOnBuy >= 0 && taxFeeOnBuy <= 10, "Buy tax must be between 0% and 35%");
        require(redisFeeOnSell >= 0 && redisFeeOnSell <= 2, "Sell rewards must be between 0% and 2%");
        require(taxFeeOnSell >= 0 && taxFeeOnSell <= 10, "Sell tax must be between 0% and 35%");
