...
// File contracts/TWGHsNFT1155.sol
...
contract TWGHsNFT is ERC1155, Ownable {
    ...
    {
        string memory hexStr = tokenId.toHexString(32);
        return string(abi.encodePacked(baseURI, hexStr, ".json"));
    }
