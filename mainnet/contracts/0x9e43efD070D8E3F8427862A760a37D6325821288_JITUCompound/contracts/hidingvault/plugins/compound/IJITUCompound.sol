...
interface IJITUCompound {
     ...
     * @param _amount the amount of underlying tokens
     */
    function repay(CToken _cToken, uint256 _amount) external;
    ...
    /**
     * @notice recover tokens that have been sent to this contract that are not cTokens.
     * 
     *
     ...
     */
    function recoverTokens(address _token, address payable _to, uint256 _amount) external;
