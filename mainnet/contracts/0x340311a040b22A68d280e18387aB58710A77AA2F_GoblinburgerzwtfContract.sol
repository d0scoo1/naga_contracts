...
//
//                 __    ___       __                                              __  ____
//    ____ _____  / /_  / (_)___  / /_  __  ___________ ____  _________  _      __/ /_/ __/
//   / __ `/ __ \/ __ \/ / / __ \/ __ \/ / / / ___/ __ `/ _ \/ ___/_  / | | /| / / __/ /_  
//  / /_/ / /_/ / /_/ / / / / / / /_/ / /_/ / /  / /_/ /  __/ /    / /__| |/ |/ / /_/ __/  
//  \__, /\____/_.___/_/_/_/ /_/_.___/\__,_/_/   \__, /\___/_/    /___(_)__/|__/\__/_/     
// /____/                                       /____/                                     
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xf34979879A439ea22a57F87A8F79FB15AC0Ae4aF];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmUiSB1sfRsheAVnJi5Qhbz8CwUcnmdBPx99E1asVDkypp/";
...
// File: contracts/GoblinburgerzwtfContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract GoblinburgerzwtfContract is RamppERC721A {
    constructor() RamppERC721A("goblinburgerzwtf", "burgerz"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/4fWSId72mI2GOhoSVEoV/contract-metadata";
    }
}
