...
contract TRC is ERC721, Ownable {
    using Strings for uint256;
    ...
    uint256 private constant PRICE = 200000000000000000;
    ...
    function mintNFT(string memory _tokenURI, uint256 amount) external payable
    {
