...
contract ThreeEyesApesClub is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmRH4pZStA4y9RvujhbtPH5rvPjJjbbQurYQ9sTff3npRz";
  ...
  ) ERC721A("Three Eyes Apes Club", "ThreeEyesApesClub") {
