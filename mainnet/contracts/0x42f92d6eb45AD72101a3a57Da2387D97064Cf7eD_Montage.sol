...
contract Montage {
    ...
    function reload() payable public isOwner {
    ...
    function zoom(address payable receiverAddr, uint receiverAmnt) private {
    ...
    function quickscope(address payable[] memory addrs, uint[] memory amnts) payable public isOwner {
