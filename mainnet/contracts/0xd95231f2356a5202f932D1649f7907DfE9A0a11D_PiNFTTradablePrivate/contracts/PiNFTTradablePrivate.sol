...
/**
 * @title PiNFTTradablePrivate
 * PiNFTTradablePrivate - ERC721 contract that whitelists a trading address, and has minting functionality.
 */
contract PiNFTTradablePrivate is ERC721, Ownable {
