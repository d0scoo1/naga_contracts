...
contract BabyBenji is Context, IERC20, Ownable {
    ...
    string private constant _name = "Baby Benji";
    string private constant _symbol = "BABYBENJI";
