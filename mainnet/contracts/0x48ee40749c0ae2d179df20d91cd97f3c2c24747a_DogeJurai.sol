...
contract DogeJurai is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x85d76D575D9A69E1F03f260F3cd8949960723024); // Marketing Address

    address payable public liquidityAddress =
        payable(0x2d92C6A2f36e5E81608E39348e9847531B09C0bc); // Liquidity Address
    ...
    string private constant _name = "DogeJurai";
    string private constant _symbol = "DOGEJURAI";
