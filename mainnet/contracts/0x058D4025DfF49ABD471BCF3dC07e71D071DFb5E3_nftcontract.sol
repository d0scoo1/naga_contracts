...
contract nftcontract is Ownable, ERC721A, ReentrancyGuard {
    uint256 public adoptionLimit = 50;
    ...
    address public partner_address = 0x7917bEeA24D86719017eC29fdcC35B8F4b734c94;
    ...
    function updatePartnerAddress(address _temp) public onlyOwner() {
        partner_address = _temp;
    }
    ...
    function withdraw() external onlyOwner {
        ...
        payable(partner_address).transfer(_balance * 25 / 100); //Partner
        payable(msg.sender).transfer(_balance * 75 / 100); //Owner
    }
