...
// Seed Club Token on a fixed supply.

contract SeedClubToken is ERC20PresetMinterPauser, Ownable {    
    // _amount = 10000000000000000000000000 (mints 10M tokens)
    // _vestingBeneficiary = 0x2dB60257E3c7ceFD0ff66EBbEDeFd7cD6c65f037
    // owner = 0x091B6cA0A91424498Ec9aC6803bcc8aA0eD88b9C

    constructor(
        address _vestingBeneficiary,
        uint256 _amount
    ) ERC20PresetMinterPauser('Seed Club', 'CLUB') {
