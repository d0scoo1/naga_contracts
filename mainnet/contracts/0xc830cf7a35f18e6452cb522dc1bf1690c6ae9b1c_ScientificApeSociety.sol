...
contract ScientificApeSociety is ERC721A, Ownable {
  using Strings for uint256;
  ...
  uint256 public totalPresaleTickets = 3500;
  ...
  constructor() ERC721A("ScientificApeSociety", "SAS", maxSupply, maxSupply) {
    setBaseURI("ipfs://.../");
