...
contract ShiBBQ is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"ShiBBQ"; ////
    string public constant symbol = unicode"SHIBBQ"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 15000000001 * 10**9; // .5%
