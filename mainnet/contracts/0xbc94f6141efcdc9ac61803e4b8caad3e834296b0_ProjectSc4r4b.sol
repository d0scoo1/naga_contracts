/**
     ...
     =.| "-(:::::)-" |.=
      \\__/`-.|.-'\__//
       `-| .::| .::|-'      
        _|`-._|_.-'|_       https://projectsc4r4b.net
      /.-|    | .::|-.\
     // ,| .::|::::|. \\
    || //\::::|::' /\\ ||
    /'\|| `.__|__.' ||/'\
...
contract ProjectSc4r4b is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Project Sc4r4b";//
    ...
    address payable private _developmentAddress = payable(0x0A098104AD25c28475aeC4B3c380aA1Db1e650ED);//
    address payable private _marketingAddress = payable(0xE86f16F56CA53Efb8e595e494cAb9d1ffe633279);//
    ...
    // 01110100 01110111 01101001 01110100 01110100 01100101 01110010 00111010 00100000 01101100 00110100 01111010 00110100 01110010 01110101 01110011 00110001
}