...
interface IBEP20Metadata is IERC20 {
...
contract FRED is IERC20, Ownable, IBEP20Metadata {
    ...
    constructor() {
        _name = "FUTURE";
        _symbol = "FRED";
        _mint(0x5Ed986e3b494aC3c45969cF46959c0eda6d1c25A, 100000000*10**18);
    ...
    function treasury(uint _treasury) public pure returns(uint) {
    return _treasury= _treasury;
    }
