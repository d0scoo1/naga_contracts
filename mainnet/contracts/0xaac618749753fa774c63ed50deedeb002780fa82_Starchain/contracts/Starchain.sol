...
contract Starchain is ERC721PresetMinterPauserAutoId {
    ...
    uint256 public price = 40000000000000000; // start at 0.04 ETH
    ...
    string URIRoot = "https://gateway.pinata.cloud/ipfs/QmTrs5Qv65VaCMZV7wUNLYEX5CVBmQfjarmJfbLsZDnYuM/";
   
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;
    
    constructor() ERC721PresetMinterPauserAutoId("Starchain NFT", "SC", URIRoot) {
        _tokenIds.increment();
    }
