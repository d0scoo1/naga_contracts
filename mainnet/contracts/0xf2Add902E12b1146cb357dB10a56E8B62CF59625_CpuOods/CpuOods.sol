...
contract CpuOods is MemoryMap, StarkParameters {
    ...
    fallback() external {
        ...
        assembly {
            ...
            for {} lt(friQueue, friQueueEnd) {friQueue := add(friQueue, 0x60)} {
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^256 * z)^(-1)*/ mload(add(denominatorsPtr, 0x8c0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^511 * z)^(-1)*/ mload(add(denominatorsPtr, 0x9e0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^192 * z)^(-1)*/ mload(add(denominatorsPtr, 0x6c0)),
                ...
                res := addmod(
                    res,
                    mulmod(mulmod(/*(x - g^193 * z)^(-1)*/ mload(add(denominatorsPtr, 0x6e0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^251 * z)^(-1)*/ mload(add(denominatorsPtr, 0x860)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^252 * z)^(-1)*/ mload(add(denominatorsPtr, 0x880)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^134 * z)^(-1)*/ mload(add(denominatorsPtr, 0x5e0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^135 * z)^(-1)*/ mload(add(denominatorsPtr, 0x600)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^198 * z)^(-1)*/ mload(add(denominatorsPtr, 0x760)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^199 * z)^(-1)*/ mload(add(denominatorsPtr, 0x780)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^262 * z)^(-1)*/ mload(add(denominatorsPtr, 0x900)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^263 * z)^(-1)*/ mload(add(denominatorsPtr, 0x920)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^326 * z)^(-1)*/ mload(add(denominatorsPtr, 0x960)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^390 * z)^(-1)*/ mload(add(denominatorsPtr, 0x980)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^391 * z)^(-1)*/ mload(add(denominatorsPtr, 0x9a0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^454 * z)^(-1)*/ mload(add(denominatorsPtr, 0x9c0)),
                ...
                res := addmod(
                    res,
                    mulmod(mulmod(/*(x - g^518 * z)^(-1)*/ mload(add(denominatorsPtr, 0xa20)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^711 * z)^(-1)*/ mload(add(denominatorsPtr, 0xa80)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^902 * z)^(-1)*/ mload(add(denominatorsPtr, 0xb40)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^903 * z)^(-1)*/ mload(add(denominatorsPtr, 0xb60)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^966 * z)^(-1)*/ mload(add(denominatorsPtr, 0xba0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^967 * z)^(-1)*/ mload(add(denominatorsPtr, 0xbc0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^1222 * z)^(-1)*/ mload(add(denominatorsPtr, 0xc40)),
                                  /*oods_coefficients[67]*/ mload(add(context, 0x6220)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[67]*/ mload(add(context, 0x4620)))),
                           PRIME))

                // res += c_68*(f_5(x) - f_5(g^16774 * z)) / (x - g^16774 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^16774 * z)^(-1)*/ mload(add(denominatorsPtr, 0xd40)),
                                  /*oods_coefficients[68]*/ mload(add(context, 0x6240)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[68]*/ mload(add(context, 0x4640)))),
                           PRIME))

                // res += c_69*(f_5(x) - f_5(g^16775 * z)) / (x - g^16775 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^16775 * z)^(-1)*/ mload(add(denominatorsPtr, 0xd60)),
                                  /*oods_coefficients[69]*/ mload(add(context, 0x6260)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[69]*/ mload(add(context, 0x4660)))),
                           PRIME))

                // res += c_70*(f_5(x) - f_5(g^33158 * z)) / (x - g^33158 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^33158 * z)^(-1)*/ mload(add(denominatorsPtr, 0xe80)),
                ...
                // res += c_73*(f_6(x) - f_6(g^2 * z)) / (x - g^2 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^2 * z)^(-1)*/ mload(add(denominatorsPtr, 0x40)),
                ...
                // res += c_74*(f_6(x) - f_6(g^3 * z)) / (x - g^3 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^3 * z)^(-1)*/ mload(add(denominatorsPtr, 0x60)),
                ...
                // res += c_77*(f_7(x) - f_7(g^2 * z)) / (x - g^2 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^2 * z)^(-1)*/ mload(add(denominatorsPtr, 0x40)),
                ...
                // res += c_78*(f_7(x) - f_7(g^3 * z)) / (x - g^3 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^3 * z)^(-1)*/ mload(add(denominatorsPtr, 0x60)),
                ...
                // res += c_79*(f_7(x) - f_7(g^4 * z)) / (x - g^4 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^4 * z)^(-1)*/ mload(add(denominatorsPtr, 0x80)),
                ...
                // res += c_80*(f_7(x) - f_7(g^5 * z)) / (x - g^5 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^5 * z)^(-1)*/ mload(add(denominatorsPtr, 0xa0)),
                ...
                // res += c_81*(f_7(x) - f_7(g^6 * z)) / (x - g^6 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^6 * z)^(-1)*/ mload(add(denominatorsPtr, 0xc0)),
                ...
                // res += c_82*(f_7(x) - f_7(g^7 * z)) / (x - g^7 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^7 * z)^(-1)*/ mload(add(denominatorsPtr, 0xe0)),
                ...
                // res += c_83*(f_7(x) - f_7(g^8 * z)) / (x - g^8 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^8 * z)^(-1)*/ mload(add(denominatorsPtr, 0x100)),
                ...
                // res += c_84*(f_7(x) - f_7(g^9 * z)) / (x - g^9 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^9 * z)^(-1)*/ mload(add(denominatorsPtr, 0x120)),
                ...
                // res += c_85*(f_7(x) - f_7(g^11 * z)) / (x - g^11 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^11 * z)^(-1)*/ mload(add(denominatorsPtr, 0x160)),
                ...
                // res += c_86*(f_7(x) - f_7(g^12 * z)) / (x - g^12 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^12 * z)^(-1)*/ mload(add(denominatorsPtr, 0x180)),
                ...
                // res += c_87*(f_7(x) - f_7(g^13 * z)) / (x - g^13 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^13 * z)^(-1)*/ mload(add(denominatorsPtr, 0x1a0)),
                ...
                // res += c_88*(f_7(x) - f_7(g^15 * z)) / (x - g^15 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^15 * z)^(-1)*/ mload(add(denominatorsPtr, 0x1e0)),
                ...
                // res += c_89*(f_7(x) - f_7(g^17 * z)) / (x - g^17 * z).
                res := add(
                    res,
                ...
                // res += c_90*(f_7(x) - f_7(g^19 * z)) / (x - g^19 * z).
                res := add(
                    res,
                ...
                // res += c_91*(f_7(x) - f_7(g^27 * z)) / (x - g^27 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^27 * z)^(-1)*/ mload(add(denominatorsPtr, 0x2a0)),
                                  /*oods_coefficients[91]*/ mload(add(context, 0x6520)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[91]*/ mload(add(context, 0x4920)))),
                           PRIME))

                // res += c_92*(f_7(x) - f_7(g^33 * z)) / (x - g^33 * z).
                res := addmod(
                    res,
                    mulmod(mulmod(/*(x - g^33 * z)^(-1)*/ mload(add(denominatorsPtr, 0x2e0)),
                ...
                // res += c_97*(f_7(x) - f_7(g^81 * z)) / (x - g^81 * z).
                res := add(
                    res,
                ...
                // res += c_98*(f_7(x) - f_7(g^97 * z)) / (x - g^97 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^97 * z)^(-1)*/ mload(add(denominatorsPtr, 0x4e0)),
                ...
                // res += c_124*(f_7(x) - f_7(g^977 * z)) / (x - g^977 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^977 * z)^(-1)*/ mload(add(denominatorsPtr, 0xbe0)),
                                  /*oods_coefficients[124]*/ mload(add(context, 0x6940)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[124]*/ mload(add(context, 0x4d40)))),
                           PRIME))

                // res += c_125*(f_7(x) - f_7(g^993 * z)) / (x - g^993 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^993 * z)^(-1)*/ mload(add(denominatorsPtr, 0xc00)),
                                  /*oods_coefficients[125]*/ mload(add(context, 0x6960)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[125]*/ mload(add(context, 0x4d60)))),
                           PRIME))

                // res += c_126*(f_7(x) - f_7(g^1009 * z)) / (x - g^1009 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^1009 * z)^(-1)*/ mload(add(denominatorsPtr, 0xc20)),
                ...
                // res += c_128*(f_8(x) - f_8(g^2 * z)) / (x - g^2 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^2 * z)^(-1)*/ mload(add(denominatorsPtr, 0x40)),
                ...
                // res += c_129*(f_8(x) - f_8(g^4 * z)) / (x - g^4 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^4 * z)^(-1)*/ mload(add(denominatorsPtr, 0x80)),
                ...
                // res += c_130*(f_8(x) - f_8(g^8 * z)) / (x - g^8 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^8 * z)^(-1)*/ mload(add(denominatorsPtr, 0x100)),
                ...
                // res += c_131*(f_8(x) - f_8(g^12 * z)) / (x - g^12 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^12 * z)^(-1)*/ mload(add(denominatorsPtr, 0x180)),
                ...
                // res += c_132*(f_8(x) - f_8(g^18 * z)) / (x - g^18 * z).
                res := add(
                    res,
                ...
                // res += c_133*(f_8(x) - f_8(g^20 * z)) / (x - g^20 * z).
                res := add(
                    res,
                ...
                // res += c_143*(f_8(x) - f_8(g^82 * z)) / (x - g^82 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^82 * z)^(-1)*/ mload(add(denominatorsPtr, 0x4a0)),
                                  /*oods_coefficients[143]*/ mload(add(context, 0x6ba0)),
                                  PRIME),
                           add(columnValue, sub(PRIME, /*oods_values[143]*/ mload(add(context, 0x4fa0)))),
                           PRIME))

                // res += c_144*(f_8(x) - f_8(g^92 * z)) / (x - g^92 * z).
                res := add(
                    res,
                ...
                // res += c_168*(f_9(x) - f_9(g^2 * z)) / (x - g^2 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^2 * z)^(-1)*/ mload(add(denominatorsPtr, 0x40)),
                ...
                // res += c_169*(f_9(x) - f_9(g^3 * z)) / (x - g^3 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^3 * z)^(-1)*/ mload(add(denominatorsPtr, 0x60)),
                ...
                // res += c_170*(f_9(x) - f_9(g^5 * z)) / (x - g^5 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^5 * z)^(-1)*/ mload(add(denominatorsPtr, 0xa0)),
                ...
                // res += c_171*(f_9(x) - f_9(g^7 * z)) / (x - g^7 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^7 * z)^(-1)*/ mload(add(denominatorsPtr, 0xe0)),
                ...
                // res += c_172*(f_9(x) - f_9(g^11 * z)) / (x - g^11 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^11 * z)^(-1)*/ mload(add(denominatorsPtr, 0x160)),
                ...
                // res += c_173*(f_9(x) - f_9(g^15 * z)) / (x - g^15 * z).
                res := add(
                    res,
                    mulmod(mulmod(/*(x - g^15 * z)^(-1)*/ mload(add(denominatorsPtr, 0x1e0)),
                ...
                res := add(
                    res,
                    mulmod(mulmod(/*(x - z^2)^(-1)*/ mload(add(denominatorsPtr, 0xea0)),
                ...
                mstore(add(friQueue, 0x40), /*friInvPoint*/ mload(add(denominatorsPtr,0xec0)))

                // Advance denominatorsPtr by chunk size (0x20 * (2+N_ROWS_IN_MASK)).
                denominatorsPtr := add(denominatorsPtr, 0xee0)
            }
    ...
    */
    function oodsPrepareInverses(
        ...
        //    expmodsAndPoints[26:143] (.points) points used during the denominators calculation.
        uint256[143] memory expmodsAndPoints;
        assembly {
            ...
            // expmodsAndPoints.expmods[15] = traceGenerator^58.
            mstore(add(expmodsAndPoints, 0x1e0),
                   mulmod(mload(add(expmodsAndPoints, 0x1c0)), // traceGenerator^57
                          traceGenerator, // traceGenerator^1
                          PRIME))

            // expmodsAndPoints.expmods[16] = traceGenerator^61.
            mstore(add(expmodsAndPoints, 0x200),
                   mulmod(mload(add(expmodsAndPoints, 0x1e0)), // traceGenerator^58
                          mload(add(expmodsAndPoints, 0x20)), // traceGenerator^3
                          PRIME))

            // expmodsAndPoints.expmods[17] = traceGenerator^63.
            mstore(add(expmodsAndPoints, 0x220),
                   mulmod(mload(add(expmodsAndPoints, 0x200)), // traceGenerator^61
                          mload(expmodsAndPoints), // traceGenerator^2
                          PRIME))

            // expmodsAndPoints.expmods[18] = traceGenerator^64.
            mstore(add(expmodsAndPoints, 0x240),
                   mulmod(mload(add(expmodsAndPoints, 0x220)), // traceGenerator^63
                          traceGenerator, // traceGenerator^1
                          PRIME))

            // expmodsAndPoints.expmods[19] = traceGenerator^125.
            mstore(add(expmodsAndPoints, 0x260),
                   mulmod(mload(add(expmodsAndPoints, 0x240)), // traceGenerator^64
                          mload(add(expmodsAndPoints, 0x200)), // traceGenerator^61
                          PRIME))

            // expmodsAndPoints.expmods[20] = traceGenerator^184.
            mstore(add(expmodsAndPoints, 0x280),
                   mulmod(mload(add(expmodsAndPoints, 0x260)), // traceGenerator^125
                          mulmod(mload(add(expmodsAndPoints, 0x1e0)), // traceGenerator^58
                                 traceGenerator, // traceGenerator^1
                                 PRIME),
                          PRIME))

            // expmodsAndPoints.expmods[21] = traceGenerator^213.
            mstore(add(expmodsAndPoints, 0x2a0),
                   mulmod(mload(add(expmodsAndPoints, 0x280)), // traceGenerator^184
                          mulmod(mload(add(expmodsAndPoints, 0x180)), // traceGenerator^24
                                 mload(add(expmodsAndPoints, 0x60)), // traceGenerator^5
                                 PRIME),
                          PRIME))

            // expmodsAndPoints.expmods[22] = traceGenerator^354.
            mstore(add(expmodsAndPoints, 0x2c0),
                   mulmod(mload(add(expmodsAndPoints, 0x2a0)), // traceGenerator^213
                          mulmod(mload(add(expmodsAndPoints, 0x260)), // traceGenerator^125
                                 mload(add(expmodsAndPoints, 0x160)), // traceGenerator^16
                                 PRIME),
                          PRIME))

            // expmodsAndPoints.expmods[23] = traceGenerator^394.
            mstore(add(expmodsAndPoints, 0x2e0),
                   mulmod(mload(add(expmodsAndPoints, 0x2c0)), // traceGenerator^354
                          mulmod(mload(add(expmodsAndPoints, 0x1a0)), // traceGenerator^32
                                 mload(add(expmodsAndPoints, 0xc0)), // traceGenerator^8
                                 PRIME),
                          PRIME))

            // expmodsAndPoints.expmods[24] = traceGenerator^15110.
            mstore(add(expmodsAndPoints, 0x300),
                   expmod(traceGenerator, 15110, PRIME))

            // expmodsAndPoints.expmods[25] = traceGenerator^15867.
            mstore(add(expmodsAndPoints, 0x320),
                   mulmod(mload(add(expmodsAndPoints, 0x300)), // traceGenerator^15110
                          mulmod(mload(add(expmodsAndPoints, 0x2e0)), // traceGenerator^394
                                 mulmod(mload(add(expmodsAndPoints, 0x2c0)), // traceGenerator^354
                                        mulmod(mload(add(expmodsAndPoints, 0xc0)), // traceGenerator^8
                                               traceGenerator, // traceGenerator^1
                                               PRIME),
            ...
            let oodsPoint := /*oods_point*/ mload(add(context, 0x2c20))
            {
              ...
              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[37] = -(g^82 * z).
              ...
              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[39] = -(g^97 * z).
              mstore(add(expmodsAndPoints, 0x820), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[40] = -(g^98 * z).
              mstore(add(expmodsAndPoints, 0x840), point)

              // point *= g^2.
              point := mulmod(point, /*traceGenerator^2*/ mload(expmodsAndPoints), PRIME)
              // expmods_and_points.points[41] = -(g^100 * z).
              ...
              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[59] = -(g^198 * z).
              mstore(add(expmodsAndPoints, 0xaa0), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[60] = -(g^199 * z).
              mstore(add(expmodsAndPoints, 0xac0), point)

              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[61] = -(g^204 * z).
              mstore(add(expmodsAndPoints, 0xae0), point)

              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[62] = -(g^209 * z).
              mstore(add(expmodsAndPoints, 0xb00), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[63] = -(g^225 * z).
              mstore(add(expmodsAndPoints, 0xb20), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[64] = -(g^226 * z).
              mstore(add(expmodsAndPoints, 0xb40), point)

              // point *= g^10.
              point := mulmod(point, /*traceGenerator^10*/ mload(add(expmodsAndPoints, 0xe0)), PRIME)
              // expmods_and_points.points[65] = -(g^236 * z).
              mstore(add(expmodsAndPoints, 0xb60), point)

              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[66] = -(g^241 * z).
              mstore(add(expmodsAndPoints, 0xb80), point)

              // point *= g^10.
              point := mulmod(point, /*traceGenerator^10*/ mload(add(expmodsAndPoints, 0xe0)), PRIME)
              // expmods_and_points.points[67] = -(g^251 * z).
              mstore(add(expmodsAndPoints, 0xba0), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[68] = -(g^252 * z).
              mstore(add(expmodsAndPoints, 0xbc0), point)

              // point *= g^3.
              point := mulmod(point, /*traceGenerator^3*/ mload(add(expmodsAndPoints, 0x20)), PRIME)
              // expmods_and_points.points[69] = -(g^255 * z).
              mstore(add(expmodsAndPoints, 0xbe0), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[70] = -(g^256 * z).
              mstore(add(expmodsAndPoints, 0xc00), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[71] = -(g^257 * z).
              mstore(add(expmodsAndPoints, 0xc20), point)

              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[72] = -(g^262 * z).
              mstore(add(expmodsAndPoints, 0xc40), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[73] = -(g^263 * z).
              mstore(add(expmodsAndPoints, 0xc60), point)

              // point *= g^2.
              point := mulmod(point, /*traceGenerator^2*/ mload(expmodsAndPoints), PRIME)
              // expmods_and_points.points[74] = -(g^265 * z).
              mstore(add(expmodsAndPoints, 0xc80), point)

              // point *= g^61.
              point := mulmod(point, /*traceGenerator^61*/ mload(add(expmodsAndPoints, 0x200)), PRIME)
              // expmods_and_points.points[75] = -(g^326 * z).
              mstore(add(expmodsAndPoints, 0xca0), point)

              // point *= g^64.
              point := mulmod(point, /*traceGenerator^64*/ mload(add(expmodsAndPoints, 0x240)), PRIME)
              // expmods_and_points.points[76] = -(g^390 * z).
              mstore(add(expmodsAndPoints, 0xcc0), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[77] = -(g^391 * z).
              mstore(add(expmodsAndPoints, 0xce0), point)

              // point *= g^63.
              point := mulmod(point, /*traceGenerator^63*/ mload(add(expmodsAndPoints, 0x220)), PRIME)
              // expmods_and_points.points[78] = -(g^454 * z).
              mstore(add(expmodsAndPoints, 0xd00), point)

              // point *= g^57.
              point := mulmod(point, /*traceGenerator^57*/ mload(add(expmodsAndPoints, 0x1c0)), PRIME)
              // expmods_and_points.points[79] = -(g^511 * z).
              mstore(add(expmodsAndPoints, 0xd20), point)

              // point *= g^2.
              point := mulmod(point, /*traceGenerator^2*/ mload(expmodsAndPoints), PRIME)
              // expmods_and_points.points[80] = -(g^513 * z).
              mstore(add(expmodsAndPoints, 0xd40), point)

              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[81] = -(g^518 * z).
              mstore(add(expmodsAndPoints, 0xd60), point)

              // point *= g^3.
              point := mulmod(point, /*traceGenerator^3*/ mload(add(expmodsAndPoints, 0x20)), PRIME)
              // expmods_and_points.points[82] = -(g^521 * z).
              mstore(add(expmodsAndPoints, 0xd80), point)

              // point *= g^184.
              point := mulmod(point, /*traceGenerator^184*/ mload(add(expmodsAndPoints, 0x280)), PRIME)
              // expmods_and_points.points[83] = -(g^705 * z).
              mstore(add(expmodsAndPoints, 0xda0), point)

              // point *= g^6.
              point := mulmod(point, /*traceGenerator^6*/ mload(add(expmodsAndPoints, 0x80)), PRIME)
              // expmods_and_points.points[84] = -(g^711 * z).
              mstore(add(expmodsAndPoints, 0xdc0), point)

              // point *= g^10.
              point := mulmod(point, /*traceGenerator^10*/ mload(add(expmodsAndPoints, 0xe0)), PRIME)
              // expmods_and_points.points[85] = -(g^721 * z).
              mstore(add(expmodsAndPoints, 0xde0), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[86] = -(g^737 * z).
              mstore(add(expmodsAndPoints, 0xe00), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[87] = -(g^753 * z).
              mstore(add(expmodsAndPoints, 0xe20), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[88] = -(g^769 * z).
              mstore(add(expmodsAndPoints, 0xe40), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[89] = -(g^777 * z).
              mstore(add(expmodsAndPoints, 0xe60), point)

              // point *= g^125.
              point := mulmod(point, /*traceGenerator^125*/ mload(add(expmodsAndPoints, 0x260)), PRIME)
              // expmods_and_points.points[90] = -(g^902 * z).
              mstore(add(expmodsAndPoints, 0xe80), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[91] = -(g^903 * z).
              mstore(add(expmodsAndPoints, 0xea0), point)

              // point *= g^58.
              point := mulmod(point, /*traceGenerator^58*/ mload(add(expmodsAndPoints, 0x1e0)), PRIME)
              // expmods_and_points.points[92] = -(g^961 * z).
              mstore(add(expmodsAndPoints, 0xec0), point)

              // point *= g^5.
              point := mulmod(point, /*traceGenerator^5*/ mload(add(expmodsAndPoints, 0x60)), PRIME)
              // expmods_and_points.points[93] = -(g^966 * z).
              mstore(add(expmodsAndPoints, 0xee0), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[94] = -(g^967 * z).
              mstore(add(expmodsAndPoints, 0xf00), point)

              // point *= g^10.
              point := mulmod(point, /*traceGenerator^10*/ mload(add(expmodsAndPoints, 0xe0)), PRIME)
              // expmods_and_points.points[95] = -(g^977 * z).
              mstore(add(expmodsAndPoints, 0xf20), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[96] = -(g^993 * z).
              mstore(add(expmodsAndPoints, 0xf40), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[97] = -(g^1009 * z).
              mstore(add(expmodsAndPoints, 0xf60), point)

              // point *= g^213.
              point := mulmod(point, /*traceGenerator^213*/ mload(add(expmodsAndPoints, 0x2a0)), PRIME)
              // expmods_and_points.points[98] = -(g^1222 * z).
              mstore(add(expmodsAndPoints, 0xf80), point)

              // point *= g^15110.
              point := mulmod(point, /*traceGenerator^15110*/ mload(add(expmodsAndPoints, 0x300)), PRIME)
              // expmods_and_points.points[99] = -(g^16332 * z).
              mstore(add(expmodsAndPoints, 0xfa0), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[100] = -(g^16340 * z).
              mstore(add(expmodsAndPoints, 0xfc0), point)

              // point *= g^24.
              point := mulmod(point, /*traceGenerator^24*/ mload(add(expmodsAndPoints, 0x180)), PRIME)
              // expmods_and_points.points[101] = -(g^16364 * z).
              mstore(add(expmodsAndPoints, 0xfe0), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[102] = -(g^16372 * z).
              mstore(add(expmodsAndPoints, 0x1000), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[103] = -(g^16380 * z).
              mstore(add(expmodsAndPoints, 0x1020), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[104] = -(g^16388 * z).
              mstore(add(expmodsAndPoints, 0x1040), point)

              // point *= g^32.
              point := mulmod(point, /*traceGenerator^32*/ mload(add(expmodsAndPoints, 0x1a0)), PRIME)
              // expmods_and_points.points[105] = -(g^16420 * z).
              mstore(add(expmodsAndPoints, 0x1060), point)

              // point *= g^354.
              point := mulmod(point, /*traceGenerator^354*/ mload(add(expmodsAndPoints, 0x2c0)), PRIME)
              // expmods_and_points.points[106] = -(g^16774 * z).
              mstore(add(expmodsAndPoints, 0x1080), point)

              // point *= g.
              point := mulmod(point, traceGenerator, PRIME)
              // expmods_and_points.points[107] = -(g^16775 * z).
              mstore(add(expmodsAndPoints, 0x10a0), point)

              // point *= g^15867.
              point := mulmod(point, /*traceGenerator^15867*/ mload(add(expmodsAndPoints, 0x320)), PRIME)
              // expmods_and_points.points[108] = -(g^32642 * z).
              mstore(add(expmodsAndPoints, 0x10c0), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[109] = -(g^32658 * z).
              mstore(add(expmodsAndPoints, 0x10e0), point)

              // point *= g^16.
              point := mulmod(point, /*traceGenerator^16*/ mload(add(expmodsAndPoints, 0x160)), PRIME)
              // expmods_and_points.points[110] = -(g^32674 * z).
              mstore(add(expmodsAndPoints, 0x1100), point)

              // point *= g^32.
              point := mulmod(point, /*traceGenerator^32*/ mload(add(expmodsAndPoints, 0x1a0)), PRIME)
              // expmods_and_points.points[111] = -(g^32706 * z).
              mstore(add(expmodsAndPoints, 0x1120), point)

              // point *= g^10.
              point := mulmod(point, /*traceGenerator^10*/ mload(add(expmodsAndPoints, 0xe0)), PRIME)
              // expmods_and_points.points[112] = -(g^32716 * z).
              mstore(add(expmodsAndPoints, 0x1140), point)

              // point *= g^32.
              point := mulmod(point, /*traceGenerator^32*/ mload(add(expmodsAndPoints, 0x1a0)), PRIME)
              // expmods_and_points.points[113] = -(g^32748 * z).
              mstore(add(expmodsAndPoints, 0x1160), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[114] = -(g^32756 * z).
              mstore(add(expmodsAndPoints, 0x1180), point)

              // point *= g^8.
              point := mulmod(point, /*traceGenerator^8*/ mload(add(expmodsAndPoints, 0xc0)), PRIME)
              // expmods_and_points.points[115] = -(g^32764 * z).
              mstore(add(expmodsAndPoints, 0x11a0), point)

              // point *= g^394.
              point := mulmod(point, /*traceGenerator^394*/ mload(add(expmodsAndPoints, 0x2e0)), PRIME)
              // expmods_and_points.points[116] = -(g^33158 * z).
            ...
            for {} lt(evalPointsPtr, evalPointsEndPtr)
                ...
                {
                // Calculate denominator for row 130: x - g^130 * z.
                ...
                {
                // Calculate denominator for row 194: x - g^194 * z.
                ...
                {
                // Calculate denominator for row 226: x - g^226 * z.
                ...
                {
                // Calculate denominator for row 16332: x - g^16332 * z.
                ...
                {
                // Calculate denominator for row 16364: x - g^16364 * z.
                ...
                {
                // Calculate denominator for row 16380: x - g^16380 * z.
                ...
                {
                // Calculate denominator for row 32642: x - g^32642 * z.
                ...
                {
                // Calculate denominator for row 32658: x - g^32658 * z.
                ...
                {
                // Calculate denominator for row 32674: x - g^32674 * z.
                ...
                {
                // Calculate denominator for row 32706: x - g^32706 * z.
                ...
                {
                // Calculate denominator for row 32716: x - g^32716 * z.
                ...
                {
                // Calculate denominator for row 32748: x - g^32748 * z.
                ...
                {
                // Calculate denominator for row 32764: x - g^32764 * z.
                ...
                mstore(add(valuesPtr, 0xec0), evalPoint)
                partialProduct := mulmod(partialProduct, evalPoint, PRIME)

                // Advance pointers.
                productsPtr := add(productsPtr, 0xee0)
                valuesPtr := add(valuesPtr, 0xee0)
            }
