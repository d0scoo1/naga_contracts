 ...
 * */
 ...
 contract TrumpTama is Context, IERC20, Ownable {
     ...
     string private constant _name = "TRUMP TAMA";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xAb16ECd1F047c3D9fB1d42a2594342951e512475);
         _feeAddrWallet2 = payable(0xAb16ECd1F047c3D9fB1d42a2594342951e512475);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xAb16ECd1F047c3D9fB1d42a2594342951e512475), _msgSender(), _tTotal);
     }
