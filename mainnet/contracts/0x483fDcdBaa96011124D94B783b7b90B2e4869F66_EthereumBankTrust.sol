/**
    ...
    “𝘛𝘩𝘦 𝘥𝘦𝘴𝘪𝘳𝘦 𝘰𝘧 𝘨𝘰𝘭𝘥 𝘪𝘴 𝘯𝘰𝘵 𝘧𝘰𝘳 𝘨𝘰𝘭𝘥. 𝘐𝘵 𝘪𝘴 𝘧𝘰𝘳 𝘵𝘩𝘦 𝘮𝘦𝘢𝘯𝘴 𝘰𝘧 𝘧𝘳𝘦𝘦𝘥𝘰𝘮 𝘢𝘯𝘥 𝘣𝘦𝘯𝘦𝘧𝘪𝘵.”
...
contract EthereumBankTrust is IERC20, Auth {
    using SafeMath for uint256;
 
    address WETH = 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2;
    string constant _name = "Ethereum Bank Trust";
    ...
    constructor () Auth(msg.sender) {
	    ...
	    marketingFeeReceiver = address(0xBEF85ad8B351aeE6618F6A64465e1c12D619BDFB);
	    teamFeeReceiver = address(0xBEF85ad8B351aeE6618F6A64465e1c12D619BDFB);
    ...
    function launchMode() internal view returns(bool) {
        return launchedAt !=0 && launchedAt + 2 < block.number && launchedTime + 1 minutes >= block.timestamp ;
    }
