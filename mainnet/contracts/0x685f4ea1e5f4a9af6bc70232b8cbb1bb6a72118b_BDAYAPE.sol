...
//BDAYAPE is means Bigday and Birthday. Today we are announced BDAYAPE is a community-focused decentralized cryptocurrency, we are here to celebrate today’s special.
...
contract BDAYAPE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "BDAYAPE";
    string private constant _symbol = "BDAYAPE";
