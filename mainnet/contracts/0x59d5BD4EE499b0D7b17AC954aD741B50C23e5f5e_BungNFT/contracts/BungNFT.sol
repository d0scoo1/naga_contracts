...
contract BungNFT is ERC721A, Ownable {
    using Strings for uint256;

    uint256 public constant WHITELIST_MAX = 4400; // placeholder
    uint256 public constant RESERVE_MAX = 88; // placeholder
    uint256 public constant TOTAL_MAX = 8888; // placeholder
    uint256 public constant MAX_SALE_QUANTITY = 3; // placeholder
    uint256 public whitelistPrice = 0.0185 ether; // placeholder
    ...
    address private paymentAddress = 0x942592D557DF4648Fe84C9086226BbF799Ca126F; // placeholder
    address private royaltyAddress = 0x942592D557DF4648Fe84C9086226BbF799Ca126F; // placeholder
    uint96 private royaltyBasisPoints = 750; // placeholder
    bytes4 private constant _INTERFACE_ID_ERC2981 = 0x2a55205a;

    constructor() ERC721A("BungNFT", "BNFT") {}
    ...
    function buy(uint256 _quantity) external payable {
        ...
        require(
            (totalSupply() - (whitelistCount + reserveCount)) + _quantity <=
                TOTAL_MAX - RESERVE_MAX - whitelistCount,
            "SALE_MAXED"
        );
        uint256 mintCost;
