/*
    ...
    Website: https://shibsun.com

    Twitter: https://twitter.com/ShibSunToken

    Telegram: https://t.me/ShibSunToken

    ShibSun is the star at the center of the Meme System. It is a nearly perfect ball of hot plasma, heated to incandescence by nuclear fusion reactions in its core.

    Features:

    🔥 After each transaction, LP tokens are bought back and burned. (5%)

    🔥 Reflection pays every investor with 2% lifetime earnings.
...
contract SHIBSUN is Context, IERC20, Ownable {
    ...
    string private _name = "ShibSun";
    string private _symbol = "SHIBSUN";
