...
Tired of being fu*king scammed? Then join the new revolution 
in The Wild West of Crypto as a COMMUNITY-RUN token.

Crypto is like The Wild West, join the newest Community-Run 
token with No Devs, No Scams, Just one hell of a ride!

>> t.me/wildwesttoken

Smart contract: Bot protection | Buy limit | Anti-dump protection.
...
contract WildWest is Context, IERC20, Ownable {
    ...
    string private constant _name = "The Wild West Token";
    string private constant _symbol = "WildWest";
    ...
    constructor () {
        _feeAddrWallet = payable(0x65Dae9F608bFFFA328094dA838bfAEa1424E0dbE);
