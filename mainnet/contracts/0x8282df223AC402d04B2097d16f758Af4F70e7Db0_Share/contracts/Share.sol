...
contract Share is ERC20Burnable, Operator, ReentrancyGuard {
    ...
    constructor(address _governance) public ERC20('YFLink Synthetic', 'sYFL') 
    {
        governance = _governance;
        
        _mint(msg.sender, 1500 * 10**18);
        _mint(governance, 2500000 * 10**18);
    }

    /**
     * @notice Operator mints YFLink Synthetic to a recipient
     * @param recipient_ The address of recipient
     * @param amount_ The amount of YFLink Synthetic to mint to
     */
