...
We are helping the under-valued great athletes and fitness fans with financing competitions and supplements on their way to greatness.

Website: www.jaycutlerinu.com
Telegram: https://t.me/+IygxfwDTo4MyYjlh
*/
...
contract JayCutlerInu is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1e8 * 10**8;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    string private constant _name = unicode"Jay Cutler Inu";
    string private constant _symbol = unicode"JCI";
    ...
    address payable private _DeveloperFeeAddress;
    ...
    modifier lockTheSwap {
        ...
        constructor (address payable DeveloperFeeAddress, address payable MarketingWalletAddress) {
        _DeveloperFeeAddress = DeveloperFeeAddress;
    ...
    function sendETHToFee(uint256 amount) private {
        _DeveloperFeeAddress.transfer(amount.div(2));
    ...
    function openTrading() external onlyOwner() {
        ...
        tradingOpen = true;
        walletLimitDuration = block.timestamp + (5 minutes);
    }
    
    function setMarketingWallet (address payable MarketingWalletAddress) external {
        require(_msgSender() == _DeveloperFeeAddress);
