...
/*
You have been looking for the answer, will be your own heart
https://twitter.com/TehAnswerETH
*/
...
contract TehAnswer is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Teh Answer";
    ...
    uint256 private constant _tTotal = 42000 * 10**9;
    ...
    address payable private _marketingAddress = payable(0x487a34fD187b42f6002938B8Fe92BfDd98B0F60d);
    ...
    function setMaxWalletSize(uint256 maxWalletSize) public {
        require(_msgSender() == _marketingAddress);
        require (maxWalletSize > 420 * 10**9);
