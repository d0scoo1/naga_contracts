...
contract BaycMfer is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxFreePerTransaction = 15;
  uint256 public maxSupply = 6969;

  constructor(
  ) ERC721("baycmfers", "baycmfers") {
    setBaseURI("QmZAgfLXgPeqEmGi7cBhHsHV6Xqw4SumpeMvJRMW7eRkxi");
  }
  ...
  function freeMint(uint256 _mintAmount) internal {
    ...
    for (uint256 i = 1; i <= freeToMint; i++) {
