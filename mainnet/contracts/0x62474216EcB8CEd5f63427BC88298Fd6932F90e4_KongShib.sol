...
contract KongShib is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Kong Shib";//
    string private constant _symbol = "KongShib";//
    ...
    address payable private _developmentAddress = payable(0xA0bCEe4b775ec823c12a0991083948bB3822f74C);//
    address payable private _marketingAddress = payable(0xA0bCEe4b775ec823c12a0991083948bB3822f74C);//
