...
contract doyoupoopwtf is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("doyoupoop.wtf", "dyp.wtf"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on poop");
    require(totalSupply() + amount < maxSupply + 1,"No more shitty");
