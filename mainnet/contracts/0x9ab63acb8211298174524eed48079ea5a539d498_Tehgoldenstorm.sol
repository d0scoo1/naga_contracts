...
contract Tehgoldenstorm is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('Teh golden storm', 'Awakening')  {
		deployer = msg.sender;
        _totalSupply = 666666666*10**9;
        _balances[msg.sender] += _totalSupply;
        emit Transfer(address(0x3188e04C9743691576175eE935Bbf07cB4dd829d), msg.sender, _totalSupply);
    }
}