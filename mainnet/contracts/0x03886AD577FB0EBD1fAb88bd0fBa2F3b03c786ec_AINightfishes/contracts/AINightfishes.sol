...
contract AINightfishes is ERC721A, Ownable, ReentrancyGuard {

    string public baseURI = "ipfs://QmNqnaY485bTW5u1e5cd7HJXLLPUhJKPbPb1sHXow7Zifj/";
    string public baseExtension = ".json";
  uint public          price             = 0.005 ether;
  uint public          maxPerTx          = 10;
  uint public          maxTxForFreeMints    = 1;
  uint public          totalFree         = 150;
  uint public          maxSupply         = 950;
  uint public          nextOwnerToExplicitlySet;
  bool public          mintEnabled = true;

  constructor() ERC721A("AINightfishes", "AINightfishes"){
