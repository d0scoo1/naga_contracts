...
contract NounsDescriptor is INounsDescriptor, Ownable {
    ...
    function dataURI(uint256 tokenId, INounsSeeder.Seed memory seed) public view override returns (string memory) {
        string memory tingId = tokenId.toString();
        string memory name = string(abi.encodePacked('Ting ', tingId));
        string memory description = string(abi.encodePacked('Ting ', tingId, ' is a member of the Tings DAO'));
