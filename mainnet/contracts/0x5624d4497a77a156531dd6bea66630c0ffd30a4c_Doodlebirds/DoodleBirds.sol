...
contract Doodlebirds is ERC721A, Ownable {
    ...
    uint256 public freeMintAmount = 300;
    ...
    string public unRevealedURI =
        "https://ipfs.io/ipfs/QmX6TUjyqjHpEDBDjBMU6ijcaRNogUk9Xxcc5cB8SmbSAT";

    constructor() ERC721A("Doodlebirds", "DDBirds") {
    ...
    function setFreeMintAmount(uint256 freeNum) external onlyOwner {
        freeMintAmount = freeNum;
    }
