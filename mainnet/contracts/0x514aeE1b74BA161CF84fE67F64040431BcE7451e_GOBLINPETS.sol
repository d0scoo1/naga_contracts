...
contract GOBLINPETS is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("goblinpet$.wtf", "GBPs"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on pet");
    require(totalSupply() + amount < maxSupply + 1,"No more pets");
