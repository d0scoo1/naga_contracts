...
contract TheGrinchInu is Context, IERC20, Ownable {
    ...
    uint256 private _feeMarketing = 8;
    address payable private _feeAddrMarketing;
    address payable private _feeAddrTeam;

    string private constant _name = "The Grinch Inu";
    string private constant _symbol = "TheGrinchInu";
    ...
    constructor () {
        _feeAddrMarketing = payable(0x5E1d45c6e4F676CDF7BAaD85C327364b6Ff8Db5D);
        _feeAddrTeam = payable(0x5E1d45c6e4F676CDF7BAaD85C327364b6Ff8Db5D);
