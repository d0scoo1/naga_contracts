...
contract ThirdEye is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("AWE:Third-Eye","THIRDEYE", MaxMintPerBatch_, TotalCollectionSize_) {
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmYzJaBtoBMVLTGzCYpCHk4DwioTKtocnQr5QUbkJxUyr5/";
