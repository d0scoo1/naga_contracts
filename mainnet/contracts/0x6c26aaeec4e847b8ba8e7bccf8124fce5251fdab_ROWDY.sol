...
contract ROWDY is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;
    string private constant _name = "CAT BURGLAR";
    string private constant _symbol = "ROWDY";
    ...
    uint private _marTax = 9; // tax for marketing
    ...
    uint private _sellMarTax = 11;
    uint private _preSellMarTax = _sellMarTax;
    uint private _sellLiqTax = 2;
    ...
    constructor() {
        ...
        marketingAddress = payable(0xdBad832e9fAE8E1A77bA1E9567b23a5550FE48b2);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
            require(amount <= 1665000000000000 * 10**9, "Limits are in place, please lower buying amount");
        }
        if(_initLaunch == true) {
