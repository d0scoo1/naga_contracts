...
interface voter {
    function migrateMinter(address) external;
...
contract Minter is Auth {
    ...
    //for guarded launch
    function tokenMigrateMinter(address newMinter_) external requiresAuth {
        _token.setMinter(newMinter_);
    }
    //for guarded launch
    function voterMigrateMinter(address newMinter_) external requiresAuth {
        _voter.migrateMinter(newMinter_);
    }

    //for guarded launch
    function ve_distMigrateDepositor(address newMinter_) external requiresAuth {
