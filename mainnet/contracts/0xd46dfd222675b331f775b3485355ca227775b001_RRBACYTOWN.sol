...
contract RRBACYTOWN is ERC721A, Ownable, ReentrancyGuard {
  ...
  string public uriPrefix = 'https://apetown.mypinata.cloud/ipfs/Qmddbq4sCE6UgdC327MFg22ToGRQ6Jw1Msg91QGp2T2o2A/';
  
  string public uriSuffix = '.json';
  
  constructor() ERC721A("RRBACYTOWN", "RBT") {
  }
  ...
  function mintT(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
