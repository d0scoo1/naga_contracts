...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a REFLECT shareholder!");
...
contract REFLECT is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0x60D773bb8Fd9C4306F743B71E26C04EE4931F1a5);
    address payable public treasury = payable(0x69965c18AABa033Aa80a4D5B3aF99d2847e46e1f);
    ...
    uint256 private maxBuy = 30000000000 * (10 ** _decimals);
