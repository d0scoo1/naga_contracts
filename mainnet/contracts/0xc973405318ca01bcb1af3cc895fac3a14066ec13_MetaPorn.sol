...
contract MetaPorn is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "MetaPorn";//
    ...
    address payable private _developmentAddress = payable(0x7c2f459b8637b35C849Ca3264E8a98402Fbd4c6A);//
    address payable private _marketingAddress = payable(0xf2F0686f7c0b5B4A6cc68cDb8909C31F5448ab82);//
    ...
    uint256 public _maxWalletSize = 7000000000 * 10**9; //
