...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata, IERC721Enumerable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        return string(abi.encodePacked(base, folder,"/",tokenId.toString(),".png"));
    }
...
// File: contracts/SketchApeYachtClub.sol
...
/**
 * @title SketchApeYachtClub contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract SketchApeYachtClub is ERC721, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public constant apePrice = 89000000000000000; //0.08 ETH
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        SAYC_PROVENANCE = provenanceHash;
    }
