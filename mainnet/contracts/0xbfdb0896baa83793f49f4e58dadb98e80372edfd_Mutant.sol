 ...
 */
contract Mutant is Ownable, ERC721Pausable {
    using SafeMath for uint256;
    using Strings for uint256;
    ...
    uint256 public constant MAX_BY_OWNER = 10;
    ...
    constructor(string memory baseURI) ERC721("Mutant Ether Babies", "MEB") {
        _setBaseURI(baseURI);
    }
    ...
    */
    ...
    function mintPack(string[] memory tokenURI, uint256[] memory mintedImg) public payable saleIsOpen returns (uint256) {
        ...
        emit MintPack(msg.sender, _tokenIds.current());
    }
