...
contract MATF is TimeLockToken, FreezableToken, PausableToken, BurnableToken {
    string public constant name = "MATF";
    string public constant symbol = "MTC";
    uint public constant decimals = 18;

    uint public constant INITIAL_SUPPLY = 1500000000 * (10 ** decimals);
