/**
 *
 * Yogi Bear Inu $YOGI a  deflationary token generating a 2% passive yield with a price stabilizer feature.
 * Website: http://www.yogibearinu.com
 * Telegram: https://t.me/YogiBearInu
 * Twitter: https://www.twitter.com/YogiBearInu
 * 
*/
...
contract YogiBearInu is Context, IERC20, Ownable {
    ...
    string private _name = "YogiBearInu";
    ...
    function addBotWallet(address[] memory botwallet) public onlyOwner {
