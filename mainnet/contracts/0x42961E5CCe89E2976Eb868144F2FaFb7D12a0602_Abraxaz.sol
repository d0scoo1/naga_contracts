...
contract Abraxaz is EIP712, Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor()  ERC721A("Abraxaz", "ABZ", 1000, maxToken) EIP712(SIGNING_DOMAIN, SIGNATURE_VERSION)
    {}
    ...
    function mint_presale(uint256 quantity, uint256 id, bytes memory signature) public payable {
        require(privateSale, "SALE_HAS_NOT_STARTED_YET");
