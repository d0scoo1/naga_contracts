...
contract GardenGnomes is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmTe7waCRmEhqDMNP2tGE9UxdFrhDgd61gJpuP947Fu7cQ";
    ...
    constructor(
    ) ERC721A("Garden Gnomes", "GG", 100, maxSupply) {
    }

    // ============ PUBLIC FUNCTIONS FOR MINTING ============

    function mintGnome(uint256 numberOfTokens)
        external
        payable
        nonReentrant
