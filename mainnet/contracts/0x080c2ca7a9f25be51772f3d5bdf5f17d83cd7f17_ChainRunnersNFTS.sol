...
/**
ChainRunnersNFTS ($RUNNERS)
Site: https://www.chainrunners.xyz/
Total Supply: 1 billion
This token is what will be accepted in our upcoming NFT store
*/
...
contract ChainRunnersNFTS is Context, IERC20, Ownable {
    ...
    string private constant _name = "ChainRunnersNFTS";
    string private constant _symbol = "$RUNNERS";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x66922E5288a7a5901665D638d7864E1DE5d00Fb3);
        _feeAddrWallet2 = payable(0x66922E5288a7a5901665D638d7864E1DE5d00Fb3);
