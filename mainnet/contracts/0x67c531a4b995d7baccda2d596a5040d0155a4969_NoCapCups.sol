...
contract NoCapCups is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 2222;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmNaT1Bfop2nWfaXHHRbzb8PTSqbBAyvKmChtaVUMt62XX/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("NoCapCups", "NCC", MAX_MINTS, MAX_SUPPLY) {  
    }
