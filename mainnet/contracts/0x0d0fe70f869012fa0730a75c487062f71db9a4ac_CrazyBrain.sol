//1337
//Please be aware, the fake $CBCD launched!!!

//Hats off to those crazy geeks: 
//over the past 12 years of bitcoin, generations of geeks have driven a massive progress and development of blockchain. 
//Now, bitcoin's market cap goes beyond Apple's is just the first step. 
//Time will tell and we will see!!!!

//There is a crazy thing we're about to do!!!

//$CBCD is a project that planned by four geeks. 
//We are gonna do a secret launch because we are afraid of our fans will be cheated by fake $CBCD.
//Calls and promotions will come only after official launch.

//In addition, if you can recognize us by the clues we left, surely you can buy $CBCD before liquidity locks.
//Because this means you are not only getting a lower price, you will also be crazily rewarded!!!
//We will airdrop NFT for top 1000 holders, in order to the memory those big events of block chain in the past twelve years.
//The earlier you buy, the better quality of NFT you will get.

//40% burning, 60% adding to liquidity, 13:37 UTC Launch on time,
//we will lock liquidity for 3 months within 2 minutes after launch!

//Additional notes: There are five levels of NFT, please check out our Twitter!
//Telegraph group link? Website links? We won't tell you, you have to find it out yourself, that's the geek mentality!

//Twitter: https://twitter.com/CBCD TOKEN
...
contract CrazyBrain is IBEP20, Auth {
    ...
    address payable public marketingWallet = payable(0x8Ab3D8F3969E01A4701688210E4BedfA5357Da1b);
    address payable public treasury = payable(0x9644eDa7ABE3EA2eaf3635D236783AB6E61a7Cd6);
    ...
    constructor (    ) Auth(0xF2163900A4475466aCdBB65643267A94d699aD2D) {
        address _owner = 0xF2163900A4475466aCdBB65643267A94d699aD2D;
