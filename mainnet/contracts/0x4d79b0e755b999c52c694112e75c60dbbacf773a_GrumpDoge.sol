// GrumpyDoge (GrumpDoge)
// Deflationary, frictionless yielding ERC20 Community run meme token.
 ...
 */
contract GrumpDoge is Context, IERC20 {
    ...
    string private _name = 'GrumpyDoge';
    string private _symbol = 'GrumpDoge';
