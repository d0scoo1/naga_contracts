...
Liquidity will be locked 1month after launched 🔐
...
contract ELONLGBTQ is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elon LGBTQ";
    string private constant _symbol = "ELONLGBTQ";
