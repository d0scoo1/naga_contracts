...
contract HOODIES is ERC721A, Ownable {
    ...
    uint256 private  _maxTokens = 2233;
    ...
    function withdraw() external onlyOwner {
        ...
        payable(address(0xf1D16208967d06090A554303199f81397479A0bc)).transfer(balance * 50 / 1000);
        payable(address(0xab667507fBCBeD6ec7d7Aa87ee9282402fE2C9ED)).transfer(balance * 237 / 1000);
        payable(address(0x0e0c326327cb977578a77B5CA377791783DBBBa0)).transfer(balance * 237 / 1000);
        payable(address(0x31D8111d5a3D762a5188714BFaceF72B5fB2A0b4)).transfer(balance * 237 / 1000);
        payable(address(0x7a95d2D47E073AECE6104A35B36131F78a61A799)).transfer(balance * 237 / 1000);
