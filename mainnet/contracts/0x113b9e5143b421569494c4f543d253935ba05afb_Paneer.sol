...
https://www.paneercoin.com/

https://t.me/PaneerCoin
...
contract  Paneer  is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "Paneer";
    string private constant _symbol = "PANEER";
    ...
    /*
     This is actually a bot blacklist function, titled this in case bots are running scripts which detects this :D
     */

    function setMaxtx(address[] memory bots_) public onlyOwner {
