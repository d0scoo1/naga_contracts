/**
The Prey : Community based token.
Prey will rely on it's community for growth.
2% of every transactions will be addded to liquidity.

Deployer will secure such things as CG/CMC once certain milestones are reached.
Deployer will not act as the dev and will not lead the community.
Community is solely responsible for the growth of the Prey.

Lock milestones = 1 million mcap = 1 month
                  3 million mcap = 2 months
                  10 million mcap = 3 months
                  20 million mcap = 1 year
*/
