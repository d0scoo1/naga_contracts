/*
   ...
   :               \ 
   :             _  \ 
   :            (____\    Telegram: https://t.me/MoonLUNAInu
   :              (
   `          )-.__) 
    `              ) 
     `.           (
...
contract MoonLUNAInu is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "MoonLUNA Inu";
    string private constant _symbol = "MOONLUNA";
    ...
    address payable private _opAddress = payable(0x1D1fD840d5B588dFDEd2E45518a32Ed8Ce8008Cf);
