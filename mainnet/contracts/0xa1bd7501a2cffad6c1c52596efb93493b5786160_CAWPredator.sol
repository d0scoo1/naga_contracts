/*
	...
	We’re Qoming for you!
	
	https://twitter.com/cawpredator
...
contract CAWPredator is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "CAW Predator";
    ...
    uint256 public _maxWalletSize = 3 * 1e10 * 1e9 + 1 * 1e9;
    uint256 public _swapTokensAtAmount = 1 * 1e9 * 1e9;
    ...
    constructor() {
        marketingAddress = address(0xb7da8BBA1E8E9AB16f3626295b24307fAeC6Bb83);
