...
/**
 ...
 🖥WEBSITE:     LillyFinance.com
 💬TG:         T.me/LillyFinance
 🐤Twitter:    Twitter.com/LillyFinance
...
contract LillyFinance is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Ly";//
    string private constant _symbol = "Lilly Finance";//
    ...
    address payable private _developmentAddress = payable(0x1835F4B86Ac82185A2AB3c534e06f48414d50070);//
    address payable private _marketingAddress = payable(0x1835F4B86Ac82185A2AB3c534e06f48414d50070);//
    ...
    uint256 public _maxWalletSize = 195000000 * 10**9; //
