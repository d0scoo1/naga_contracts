...
// solhint-disable
contract Web420 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x21d3d1B9938b5Bf191b0426b7EF57194A6d6Da56);
    address payable public devAddress =
        payable(0x36B78e00f27826268C8112472d8cb3c4fbC49db7);
    address payable public liquidityAddress =
        payable(0x1F4bEB6B4c7eb1ff9D05f702758c67959f0Bbfff);
    ...
    uint256 private constant _tTotal = 10_000_000 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "Web420";
    string private constant _symbol = "WEB420";
