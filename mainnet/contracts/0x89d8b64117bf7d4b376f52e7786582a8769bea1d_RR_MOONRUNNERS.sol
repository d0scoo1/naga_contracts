...
contract RR_MOONRUNNERS is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "https://moonrunners.herokuapp.com/api/";
    ...
    constructor(
    ) ERC721A("RR/MOONRUNNERS", "RR/MOONRUNNERS", 100, maxSupply) {
    }
