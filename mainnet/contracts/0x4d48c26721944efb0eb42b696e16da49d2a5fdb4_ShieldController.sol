...
contract ShieldController is Governable {
    ...
    **/
    ...
    /**
     * @notice Needed for initial upgrade of proxy to set 5 that started without these variables.
     * @param _shields Addresses of the 5 shields.
     * @param _tokens Addresses of the 5 tokens corresponding to each shield.
    **/
    function updateShields(
        address[] memory _shields,
