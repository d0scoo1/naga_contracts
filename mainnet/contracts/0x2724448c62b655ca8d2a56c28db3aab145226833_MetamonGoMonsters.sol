...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract MetamonGoMonsters  is ERC721Enumerable,  Ownable {
    using Strings for uint256;


  string private uriPrefix = "";
  string private uriSuffix = ".json";
  string public hiddenURL = "ipfs://QmPMkYTh6nMik7jDBz1C85JpmKaS13fpTeh9t8ktUabsk3";
  ...
  constructor() ERC721("Metamon Go Monsters ", "Mtmn") {
