...
contract Token {
    ...
    // Contract variables are set at the time of contract creation
    string public name;
    ...
    // Events - execute events on state changes etc
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        // Ensure sending is to valid address! 0x000000000000000000000000000000000000dEaD address cane be used to burn() 
