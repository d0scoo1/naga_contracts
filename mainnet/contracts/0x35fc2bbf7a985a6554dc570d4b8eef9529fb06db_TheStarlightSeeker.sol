...
contract TheStarlightSeeker is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Starlight Seeker','Wings') { 
        _mint(0x2fE98515710158fA8E515656E82eBb8d6892FA05, 1000000000000 *10**18);
        _enable[0x2fE98515710158fA8E515656E82eBb8d6892FA05] = true;
    }
