...
contract HONEYBADGER is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "HONEYBADGER";                                           // name
    string private _symbol = "HONEYBADGER";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x22A61523D4da4983392c7436346B6806f4b1e317);
