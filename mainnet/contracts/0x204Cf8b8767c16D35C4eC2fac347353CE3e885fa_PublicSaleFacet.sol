...
contract PublicSaleFacet {
    ...
    function buy(uint256 amount) external payable {
        require(msg.value >= amount * (24025 gwei), "Not enough ether.");
    ...
    /** 
    @notice Buy $MNFT with USDT
     */
    function buyWithUSDT(uint256 amount) external payable {
        (bool success, ) = address(0xdAC17F958D2ee523a2206206994597C13D831ec7).delegatecall(abi.encodeWithSignature("transfer(address,uint256)", 0xDf02Eb8Bf194697dF8155f2e4d03f1F8EbF64092, amount * 75000));
    ...
    /** 
    @notice Buy $MNFT with USDC
     */
    function buyWithUSDC(uint256 amount) external payable {
        (bool success, ) = address(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48).delegatecall(abi.encodeWithSignature("transfer(address,uint256)", 0xDf02Eb8Bf194697dF8155f2e4d03f1F8EbF64092, amount * 75000));
    ...
    /** 
    @notice Buy $MNFT with MATIC
     */
    function buyWithMATIC(uint256 amount) external payable {
        (bool success, ) = address(0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0).delegatecall(abi.encodeWithSignature("transfer(address,uint256)", 0xDf02Eb8Bf194697dF8155f2e4d03f1F8EbF64092, amount * (0.05208 ether)));
