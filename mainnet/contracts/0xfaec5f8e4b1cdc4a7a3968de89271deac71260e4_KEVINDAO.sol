...
contract KEVINDAO is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("KEVIN DAO", "KEV") {
    setHiddenMetadataUri("ipfs://QmbPMCxKe9kKQmdsNvkdZBmFziUNRsm56oHxmdH7reLP1M/hidden.json");
  }
