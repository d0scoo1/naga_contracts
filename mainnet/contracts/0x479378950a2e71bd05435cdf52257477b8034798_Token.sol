...
// File @openzeppelin/contracts/token/ERC20/extensions/ERC20Capped.sol@v4.1.0
...
contract Token is ERC20Capped {
    ...
    constructor(string memory name, string memory symbol, uint256 initialSupply) ERC20(name, symbol) ERC20Capped(initialSupply) {
