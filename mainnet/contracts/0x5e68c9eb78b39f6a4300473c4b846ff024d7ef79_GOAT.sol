...
/**
    ($GOAT) is a soft fork of Reflect (RFI) that incorporates adjustable
    yield rates (so early buyers can continue to earn reasonable yields as
    more holders enter the ecosystem). ($GOAT) also has a deflationary supply
    and fair-launch mechanisms to ensure a healthy distribution of tokens.
    
  
    -Telegram: https://t.me/Goat_token
    -Website: https://goat-token.netlify.app/
    -Medium: https://goat12311252.medium.com/introduction-to-goat-b64043c1fe72
    -Twitter: https://twitter.com/goat_finance?s=09
...
contract GOAT is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 128000000000e8;
