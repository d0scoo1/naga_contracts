//Pumpametti's IRL artwork titles as NFT trading cards.
//Every physical Pumpametti artwork will come with one of these bad boys.
//Plz make sure to transfer the Metti physical art along with the title NFT trading card.
//Plz do not buy/trade Metti physical art if it does not have the title NFT trading card. 
//Read about Pumpametti art here: https://www.pumpametti.com/art-review-pumpametti
...
// File: contracts/PumpamettiIRLArtTitles.sol
...
contract PumpamettiIRLArtTitles is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Enumerable, Ownable, Royalties {  
    ...
    uint256 private _MAX_UniqueWork = 1000000000;
    
    //Here you can set smart contract name and token symbol

    constructor() ERC721("PumpamettiIRLArtTitles", "PUMPAIRLTITLE") {}
