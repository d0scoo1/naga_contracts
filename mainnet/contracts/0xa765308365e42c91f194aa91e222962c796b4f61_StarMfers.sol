...
contract StarMfers is ERC721A, Ownable {
  constructor() ERC721A("Star Mfers", "SMFR") {}
  using Address for address;
  using Strings for uint;

  uint64  public  immutable _maxSupply = 5555;
  uint64  private immutable _maxMintAmountPerTx = 10;
  string  public  _baseTokenURI = "ipfs://QmZ3R6HdALs9xWSEDufDK2SVsPV5MLVLVtiVnRG19YDPHd/";
