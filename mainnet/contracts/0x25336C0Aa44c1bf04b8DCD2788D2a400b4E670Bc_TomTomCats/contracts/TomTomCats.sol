...
contract TomTomCats is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmWvoYeFwa1T8touP84fxiNfc9m8SoPgB5XB6t6WBwBXHA";
  ...
  ) ERC721A("Tom Tom Cats", "TomTomCats") {
