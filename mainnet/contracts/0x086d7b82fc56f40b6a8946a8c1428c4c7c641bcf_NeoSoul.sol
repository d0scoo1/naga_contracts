...
contract NeoSoul is ERC721A, Ownable, ReentrancyGuard{
    uint256 public constant maxSupply = 6000;
    uint public _price = 0.04 ether;
    uint256 public maxBuyPerTx = 3;
    bool public paused;
    

    constructor() ERC721A("NeoSoul", "NS") {
        paused = true;
    }
    // Read the price
