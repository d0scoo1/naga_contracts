/**
領域展開 Ryōiki Tenkai, or Domain Expansion, is a technique from the popular anime, Jujutsu Kaisen.

The anime is one of the most popular series globally which is available in multiple streaming services. The first season of the anime has been well received and people are willfully anticipating the release of the second season.

With this, we introduce you to Ryoiki Tenkai; it is an advanced barrier technique that manifests the user's Innate Domain and traps their target inside it using a barrier wall to create a separate space. Once inside, the user's cursed techniques are improved and cannot be avoided.
...
https://t.me/RyoikiTenkaiERC
https://twitter.com/RyoikiTenkaiERC
...
contract RyoikiTenkai is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Ryoiki Tenkai", "JJK") {
