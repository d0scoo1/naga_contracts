/*
    ...
    Telegram: https://t.me/BoInuETH
    Twitter: https://twitter.com/rvrfgtggt44g
    Website: https://boinueth.com/
...
contract BO is Context, IERC20, Ownable {
    ...
    string private _name = "Bo Inu";
    string private _symbol = "BO";
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 10000000, "Swap Threshold Amount cannot be less than 100 Million");
