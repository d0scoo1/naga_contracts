...
contract NautiNettis is ERC721, Ownable {
	using Counters
	...
	string public CURR_ROUND_PASSWORD = "ab522cff5dd81f69bfa148b5e5ebaf19";
	uint public CURR_ROUND_SUPPLY = 500;
	uint public CURR_ROUND_TIME = 1639069200000;
	...
	constructor() ERC721("NautiNettis", "NautiNettis") {
		setBaseURI("http://api.nautinettis.com/nauti/");
	}
