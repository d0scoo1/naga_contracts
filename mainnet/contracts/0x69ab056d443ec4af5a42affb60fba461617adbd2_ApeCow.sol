...
contract ApeCow is Context, IERC20 {
    ...
    uint256 buyCoolDown = 0 seconds;

    uint256 private startingSupply = 800_000_000_000;

    string private _name = "ApeCow";
    ...
    uint256 public _marketingRatio = 69;
    ...
    address payable private _marketingWallet = payable(0x33cc92fac17CA4FF5d2D7FCDF5e7b422CC25698b);
    address payable private _teamWallet = payable(0x33cc92fac17CA4FF5d2D7FCDF5e7b422CC25698b);
