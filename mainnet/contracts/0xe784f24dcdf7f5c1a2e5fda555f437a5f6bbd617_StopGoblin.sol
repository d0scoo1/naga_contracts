...
contract StopGoblin is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 2500;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmVZYnkXtttR9MoPJuKvnoNafioRqVoXbpU2Bwz6phuHLd/";
    string public baseExtension = "";
     bool public paused = true;   
    
    constructor() ERC721A("StopGoblin", "SG", MAX_MINTS, MAX_SUPPLY) {  
    }
