 ...
 * GROOVY INU - $GROOVY
 *
 * Website: https://www.GroovyInu.com/
 * Twitter: https://twitter.com/GroovyInu
 * Telegram: https://t.me/GroovyInu
 *
 * 
 *                                                                            
*/                                                                         
...
contract GroovyInu is Context, IERC20, Ownable {
    ...
    string private _name = "GroovyInu";
    string private _symbol = "GROOVY";
    ...
    uint256 public _maxTxAmount = 375000001 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 750000000 * 10**9;
    uint256 public _maxWalletSize = 750000002 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 750000000, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 750000000, "Swap Threshold Amount cannot be less than 69 Million");
