...
// File: contracts/cybers.sol


pragma solidity ^0.8.10;


contract CYBERTAMAToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**9 * 10**18; //1 billion tokens
    ...
    address public _marketingWallet = payable(address(0xfac820D7fa7267cc7A9213006a477c064b3bFf80));
    address public _buybackWallet = payable(address(0x58550ec20AA8D496eCdB8Fb8aa9231Da79850c98));
    ...
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**5 * 10**18; // 100k tokens
    ...
    constructor() {
        ...
        buyFee.buybackFee = 1; //dev wallet
        buyFee.taxFee = 2;

        sellFee.liquidityFee = 2;
        sellFee.marketingFee = 7;
        sellFee.buybackFee = 1; //dev wallet
        sellFee.taxFee = 2;
    ...
    function _transfer(
        ...
        require(isTradingEnabled || _isExcludedFromFee[from], "Trading is not enabled yet");
