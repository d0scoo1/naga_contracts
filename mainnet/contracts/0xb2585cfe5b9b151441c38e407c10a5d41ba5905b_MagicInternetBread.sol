//https://www.magicinternetbread.com/

//https://t.me/MagicInternetBread
...
contract MagicInternetBread is Context, IERC20, Ownable {
    ...
    string private _name = "MagicInternetBread";
    ...
    uint256 private buyliquidityfee = 12;
    uint256 private sellliquidityfee = 12;
    ...
    function EnableTrading(address _address)external onlyOwner() {
        canTrade = true;
        earlyselltimestamp = block.timestamp + 12 hours;
        feeaddress = _address;
    }   
