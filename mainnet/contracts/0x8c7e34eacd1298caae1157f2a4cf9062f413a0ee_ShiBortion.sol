...
contract ShiBortion is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "ShiBortion";
    string private constant _symbol = "ShiBort";
    ...
    address payable private _developmentAddress = payable(0x36f909e634fb830Bc30162021a53EA32EdbCD8D1); 
    address payable private _marketingAddress = payable(0xE0428fadd4877b0C09CAE10B4e86C8a34e68E244);
