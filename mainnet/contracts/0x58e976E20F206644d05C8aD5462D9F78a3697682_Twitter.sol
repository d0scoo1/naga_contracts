...
contract Twitter is Ownable, IERC20 {
    using SafeMath for uint256;
    string private _name = "Twitter Inc.";
    string private _symbol = "TWTR";
    ...
    uint256 public _totalFee = 7;
    bool liquifying = false;
    address public _feeAddressWallet;
