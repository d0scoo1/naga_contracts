...
contract GIJaneInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GIJaneInu";
    string private _symbol = "GIJane";
    ...
    uint256 public _liquidityFee = 10; // means 10% adds to liquidity on each buy and sell will change to 8% after 6 hours
    uint256 public _burnFee = 0; // 0% burn fee however burn wallet receives redistribution 


    address liquidityWallet=0xA38491bF5cc49D98CB582A7DE56d5E3B6164d980;
