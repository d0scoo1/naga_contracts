...
It was 7:22 Moscow time when I was sent to orbit on my mission. It was very hot and my heart rate hit 220 beats per minute before I encountered hell and not heaven.

I was sacrificed and paved the way for manned spaceflight. All I wanted was a warm home and a loving family.

My legacy lives on. Who remember and appreciate me, you are my loving family and my warm home.

Without me, man would never have been allowed to set foot on the moon.
Let's never forget Laika. Without me, Elon couldn't send rockets to Mars.

Please continue my mission and build a foundation, a strong community respectful of my sacrifice, let's revive my spirit and send it to orbit successfully so that I can Rest In Peace.

I want to give something back to my fellows for my mission, so I set up taxes for the mission to make sure the mission is properly successful. Please form a strong pack, I love you.
...
contract LaikaTheSpaceDog is Context, IERC20, Ownable {
    ...
    string private constant _name = "Laika The Spacedog";
    ...
    constructor () {
        _FourWallet = payable(0x524bDFc5B84FAC71E13C1cdCafe828D03A99e101);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0x3eb786c01CCEECaA25A3e16637D7013de31f7Fc1);
        ...
        emit Transfer(address(0xF6F7781F5fE2D32941B6dE290Fef9c9C67C0Ff9c), _msgSender(), _tTotal);
    }
