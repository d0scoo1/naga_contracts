...
contract BabyBokiCute is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 4000;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmTFuddyfSSsPX4rW7T44mGrREruQmdoct1L59snJuwYrK/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("BabyBokiCute", "BBC", MAX_MINTS, MAX_SUPPLY) {  
    }
