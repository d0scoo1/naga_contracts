...
https://t.me/reminuportal
https://reminu.club


The long wait is over, the adorable and respectable Rem has finally arrived in the crypto world. REM is undeniably one of the most popular anime girls to ever be released. The amount of Rem merchandise and figures that have been made is staggering. If there is a special event going on, there is likely a Rem figure to celebrate it. Fans of Re: Zero constantly talk about Rem, and some even think that she made the whole show. The popularity of REM is unquestionable in both virtual and reality world, 

Rem Inu token is a community-oriented project and it is inspired by her loyal character. Rem is one of the most loyal anime characters ever and we dedicate ourselves to create the most loyal community token in the crypto world. 

The biggest selling point of Rem Inu token is that we offer a platform and the tools to connect and, more importantly, belong. Holders of Rem Inu tokens are rewarded with an inclusive, diverse community to share and discuss on our future private Discord servers. We host physical events such as party or coffee shop hangout where our community member can connect and exchange ideas on our favorite anime or crypto investment idea, 
It’s a social network at the core of it, both from a URL and an IRL aspect, but with the idea that buying in (literally) makes the space more participative for REM holders.
...
contract REMINU is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "REMINU";
