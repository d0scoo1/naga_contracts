...
https://twitter.com/BlissInuToken

BlissInu is the ﬁrst project of its kind which features a dua l treasury system.

This enables a split strategy of risk tolerances and asset types when allocating treasury funds.

Both BlissInu have their own unique investment theses and risk appetites.

Sometimes they may ﬁght but they remain inseparable! 

Everyone knows the key to sound investment strategy is a diversiﬁed portfolio!
...
contract BlissInuToken is Context, IERC20, Ownable, dAPPRewards {
    ...
    string private _name = "BlissInu";
    string private _symbol = "BlissInu";
