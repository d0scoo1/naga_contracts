...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd5a942a84928F1a060189234595A8F24Fc08F354,0xb1603FBF078142539fF7CCFc544bFe77eE399785,0x4f53DEbcA97A02A478fF8937e05D5dde21883E08];
  uint256[] public payableFees = [5,32,32,31];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 3, 1991 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "https://gateway.pinata.cloud/ipfs/QmPeiZntDHshpwyFNu8XAf1duU7Yu6rz99Fb5SfKGWnpGJ/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 1991");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 1991");
...
// File: contracts/SaniksanikContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SaniksanikContract is RamppERC721A {
    constructor() RamppERC721A("saniksanik", "SANIKS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gDAw4WN7dzxgCEbSq9RC/contract-metadata";
    }
}
