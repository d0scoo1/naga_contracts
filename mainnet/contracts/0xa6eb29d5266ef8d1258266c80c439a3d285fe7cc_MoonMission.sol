...
$MMSN
Moon Mission was designed to let ordinary community to achieve greatness through their own effort.
Devs will be only responsible for listings such as CG/CMC exchanges and bridges.
Moon Mission has 3% auto liquidity tax on every buy and sell transaction ensuring ever-growing liquidity to support whales.
Moon missions tokenomics.
Supply : 10000000
Tax : 2% Auto Liquidity 1% growth tax for listings on CMC/CG/exchanges and other surprises.

Website : http://www.mmsntoken.com/

Max wallet is set to 1% = 100000 to ensure no one is grabbing to much of the supply (Limitations will be lifted shortly after the launch)
Website will include clues and future development as we grow.
Other socials if needed has to be made by the community.
...
contract MoonMission is Context, IERC20, Ownable {
    ...
    string private _name = "Moon Mission";
    string private _symbol = "MMSN";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 0;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public marketingFeePercent = 33;
