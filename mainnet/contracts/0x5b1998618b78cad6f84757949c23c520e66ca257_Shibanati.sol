/*
 ...
 👁‍🗨 The Shibanati has appeared👁‍🗨 

Or has it always been among us all this time? This token holds many mysteries, wait and you will find out.

https://t.me/ShibanatiERC
...
contract Shibanati is Context, IERC20, Ownable {
    ...
    address public marketingWallet = address(0xC021011c9AE8FfDA15808d1CeFb8B52F94D3f1e0);

    string private _name = "Shibanati";
    string private _symbol = "Shibanati";
    ...
    uint256 public _maxTxAmount = 75000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 50000 * 10**9;
    uint256 public _maxWalletSize = 230000 * 10**9;
    ...
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 200000 );
