// Welcome to SpaceDoge! 
// SpaseDoge is a deflationary, reflection token deployed on the Ethereum Smart Chain (ERC-20). It allows users to earn a passive income simply by holding SpaceDoge. 

//The token contract employs a static rewards system, 10% of every transaction is broken down as follows: 
//• 5% fee will be distributed to all $SpaceDoge holders to create great value and benefit for holders
...
// ✅ Useful links:
// ✅ Telegram: https://t.me/spacedoge_me
// ✅ Website: https://www.spacedoge.me/
// ✅ Twitter: https://twitter.com/Spacedoge_erc20
...
contract SpaceDoge is Context, IERC20, Ownable {
    ...
    string private _name = 'SpaceDoge.me';
