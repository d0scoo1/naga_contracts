...
contract Aholes is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    constructor() ERC721A("aholes", "AHOLE") {
        setBaseURI("");
    ...
    function FreeAhole(uint256 _mintAmount) public payable nonReentrant{
    ...
    function MintAhole(uint256 _mintAmount) public payable nonReentrant {
        uint256 s = totalSupply();
        require(_mintAmount > 0, "Cant mint 0");
