...
contract SiraInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sira Inu";
    string private constant _symbol = "SIRA";
    ...
    constructor () {
        _feeAddrWallet = payable(0xa17FFdEF5AcFbF653496DA2B9Ea6275d3DcbB3E5);
