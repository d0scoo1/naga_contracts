/**
//https://boredgameryacht.club/
//https://t.me/BoredGamerYachtClubETH
//We are an exclusive community club token, we have 2 artists creating NFTs for us, We will have over 200 Bored Gamer NFT& over 800 Mutant Gamer NFT.
*/
...
contract BoredGamerYachtClub is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Bored Gamer Yacht Club";//
    string private constant _symbol = "BGYC";//
    ...
    address payable private _developmentAddress = payable(0xE6C3026625ae5606Bb2241244480cDacfd3CB018);//
    address payable private _marketingAddress = payable(0xE6C3026625ae5606Bb2241244480cDacfd3CB018);//
