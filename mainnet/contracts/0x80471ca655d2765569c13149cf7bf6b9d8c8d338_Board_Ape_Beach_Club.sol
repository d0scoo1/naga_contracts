...
contract Board_Ape_Beach_Club is ERC721A, Ownable {
    // variables
    using Strings for uint256;

    constructor(string memory _NotRevealedUri)
        ERC721A("Board Ape Beach Club Official", "BABC")
    {
        setNotRevealedURI(_NotRevealedUri);
    }

    uint256 public maxsupply = 2222;
    uint256 public reserve = 122;
    ...
    function setCurrentIndex(uint256 _newindex) public onlyOwner {
    ...
    function PreMint( uint256 chosenAmount)
        public
        payable
    {
