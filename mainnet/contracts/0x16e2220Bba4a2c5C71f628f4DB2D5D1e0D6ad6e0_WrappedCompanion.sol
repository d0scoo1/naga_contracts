  ...
  Ownable
{
  ...
  address public originalcompanion = 0x89af532726f48b7E77aE60705E166252e9Dcde15;
...
//////Sets the IPFS/Arweave stores
  ...
  function setOptions(uint _option,bool _onoroff,uint _value,address _address) external onlyOwner
  {
      if (_option==1)
      {
