...
contract SubwaySurferz is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmbGN1hjwRdW9NHWvvdb8KXa527eefre5WJj71fvZxUZRc";
    ...
    constructor(
    ) ERC721A("Subway Surferz", "I0S", 100, maxSupply) {
    }
