...
contract Swirls is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNQGMS561zHY4jVcoSALEQhXj4AYXgDGRNz5qFpi6fQwZ";
    ...
    constructor(
    ) ERC721A("Swirls | Loie Hollowell", "Swirls", 100, maxSupply) {
    }
