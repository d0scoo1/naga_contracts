...
contract Assteroids is Ownable, ERC721Enumerable, ReentrancyGuard {
    using SafeMath for uint256;

    string public Assteroids_PROVENANCE = "";
    string public BASE_URI = "";
    uint256 public constant PRICE = 0.0069 ether;
    uint256 public constant MAX_Assteroids = 6969;
    uint256 public constant PURCHASE_LIMIT = 20;
    uint256 public totalPublicSupply;
    address public chairtyAddress = 0xE855Bf4efc4C607E1740c3b772F9Fd01609Dd916;
    bool public saleIsActive = true;

    constructor() ERC721("Assteroids", "ASS") {}

    function withdraw() public onlyOwner {
        uint256 value = address(this).balance;
        sendValueTo(chairtyAddress, value);
    }
    ...
    */
    ...
    function setWitdrawAddress(address _add) public onlyOwner {
        chairtyAddress = _add;
    }
    ...
    */
    ...
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        Assteroids_PROVENANCE = provenanceHash;
    }

    /**
    * @dev Minting functions
    * Mint used by the public
    * Reserve used by team for giveaways etc
    */
    function mint(uint256 numberOfTokens) public payable nonReentrant {
        require(saleIsActive, 'Contract is not active');
        require(totalSupply().add(numberOfTokens) <= MAX_Assteroids,"All tokens have been minted");
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
            if (totalPublicSupply < MAX_Assteroids) {
