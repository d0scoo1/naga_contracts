...
contract PhunksExpansion is ERC1155, Ownable {
    string public constant name = "PhunksExpansion";
    string public constant symbol = "PHUNX";

    uint32 public totalSupply = 0;
    uint256 public constant phunkPrice = 0.04 ether;
    
    uint32 public saleStart = 1639875600;
    uint32 public constant startSupply = 10000;
    uint32 public maxSupply = 10000;

    address private wallet = 0x6F703195905544F4EC77Ea73Ed73ad98c379a209;
    ...
    function purchase(uint32 count) external payable {
        ...
        require(count <= 20, "Count must be less than or equal to 20");
