...
contract DRAKOZ is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "DRAKOZ";
    string private _symbol = "DRAKOZ";
    uint256 private _tTotal = 1000 * 10**10 * 10**uint256(_decimals);
    ...
    bool public feesOnSellersAndBuyers = false;

    uint256 public _maxTxAmount = _tTotal.div(1).div(100);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0xBe275853409F10AD40eb6D0A81c67D707cdB7683);
