...
// QUOKKA, the sweetest animal in the world has just landed on the ETH chain, P2E game aligned 
...
contract QuokkaInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0x8d487bA309EbB5EC3d7bEcf7cd88C698F187607C);
    ...
    string private _name = "Quokka Inu";
