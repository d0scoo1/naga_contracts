...
contract ELONFIFTYONE is ERC20, Ownable {
    ...
    constructor() ERC20("Elon 51", "ELON51") {
        ...
        uint256 totalSupply = 51_000_000_000 * 1e18; // 1 billion total supply

        maxTransactionAmount = totalSupply / 100; // 1% from total supply
        maxWallet = totalSupply / 100; // 1% from total supply
        ...
        devWallet = address(0x1401E60aC91749460C06dc036244F83754A1D8bB); // set as dev wallet
