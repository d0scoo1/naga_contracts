...
contract EaselyPayout is AccessControlEnumerable, IEaselyPayout {
     ...
     */
    function updateAddressBPS(address newAddress, uint256 easelyFeeBPS) external {
     ...
     */
    function getEaselyBPS(address senderAddress, address creatorAddress) external view returns (uint256) {
