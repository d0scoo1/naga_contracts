...
contract PayslicEscrow is Ownable {
    ...
    address private _vaultAddress = 0xE620adc5d80958C330c787acdc3BCa4b47B79863;
    ...
    event CreateEscrow(address indexed seller, address indexed buyer, string indexed id, uint value); 
    event BuyerConfirm(address indexed seller, address indexed buyer, string indexed id); 
    event SellerConfirm(address indexed seller, address indexed buyer, string indexed id); 
    ...
    function createEscrow(string memory id, address payable seller) external payable {
        ...
        emit CreateEscrow(seller, msg.sender, id, msg.value);
    }
    ...
    function buyConfirm(string memory id) onlyBuyer(id) external {
        ...
        //Emit event
        emit BuyerConfirm(txns[id].seller, txns[id].buyer, id);
    }
    ...
    function sellerConfirm(string memory id) onlySeller(id) external {
        ...
        //Emit event
        emit SellerConfirm(txns[id].seller, txns[id].buyer, id);
    }
