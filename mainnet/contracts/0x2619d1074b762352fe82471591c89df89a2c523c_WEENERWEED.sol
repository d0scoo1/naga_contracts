...
Life is full of hardships, but Weener doesn't care. He's out to make everyone happy. Don't we all need a little break from the mischief? 
...
contract WEENERWEED is Context, IERC20, Ownable {
    ...
    string private constant _name = "Weener Weed";
    ...
    constructor () {
        _projectWallet = payable(0x0B63979E563975Ac67Ca43ab745541433cBd013a);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0x0B63979E563975Ac67Ca43ab745541433cBd013a);
        ...
        emit Transfer(address(0x0B63979E563975Ac67Ca43ab745541433cBd013a), _msgSender(), _tTotal);
    }
