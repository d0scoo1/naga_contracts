...
contract DELTAToken is BotProtected {
 
    mapping (address => uint) public balanceOf;
    mapping (address => mapping (address => uint)) public allowance;
 
    uint constant public decimals = 18;
    uint public totalSupply = 45000000000000000000000000;
    string public name = "DELTA.financial - deep DeFi derivatives";
    string public symbol = "DELTA";
