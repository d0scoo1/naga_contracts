...
Website: https://thecitadeltwo.com/
Twitter: https://twitter.com/thecitadeltwo
Telegram: https://t.me/thecitadeltwo
...
contract CitadelTwo is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("The Citadel Two", "CITADEL2") {
     ...
     uint256 totalSupply = 1 * 10 ** 12 * 10 ** decimals();
        ...
        maxTransactionAmount = 15 * 10 ** 9 * 10 ** decimals(); // 1% maxTransactionAmountTxn
