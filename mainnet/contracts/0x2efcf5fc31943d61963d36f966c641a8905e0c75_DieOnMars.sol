...
Hello Cryptonouts,
Visit us at dieonmars.space 
$DOM | Die On Mars 

Buckle up, fuel the engine, run the show, we are gonna make it together.

How:
- Available to buy on ETH network 
- Auto farm and stake for autonomous profit sharing to $DOM holders. 
- Inspired from $MCC fork, we will have 10% tax fee.

Telegram: https://t.me/dieonmars_space
Website: https://dieonmars.space
...
pragma solidity ^0.6.12;
    ...
    contract DieOnMars is Context, IERC20, Ownable {
        ...
        string private _name = 'DieOnMars';
        ...
        function _setTaxFee(uint256 taxFee) external onlyOwner() {
            require(taxFee >= 1 && taxFee <= 15, 'taxFee should be in 1 - 15');
            _taxFee = taxFee;
        }

        function _setTeamFee(uint256 teamFee) external onlyOwner() {
            require(teamFee >= 1 && teamFee <= 15, 'teamFee should be in 1 - 15');
            _teamFee = teamFee;
        }
