...
Electrochat "Vitalik's favorite cat watch" 

Vitalik Buterin creator of Ethereum Loves Electrochat!

//
Electrochat featured on TIME Magazine & Vitalik's wrist:

https://time.com/6158182/vitalik-buterin-ethereum-profile/

//
Electrochat Featured on TIME twitter & Vitalik's Twitter:
...
//
WEBSITE:
http://electrochat.net

TELEGRAM:
https://t.me/electrochat_ETH

Twitter:
https://twitter.com/electrochat_eth
...
contract ELECTROCHAT is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Electrochat";//
    string private constant _symbol = "ELECTROCHAT";//
    ...
    address payable private _devAddress = payable(0x694482706947f4670a06a6Bf4929f304573ACc7b);//
    address payable private _marketingAddress = payable(0xE6C5f993b1ea76C07Ee1075Cc5AF6d0Ed7B7f869);//
    ...
    uint256 public _maxTxAmount = 345000000001000000000 * 10**9; //
    uint256 public _maxWalletSize = 690000000002000000000 * 10**9; //
