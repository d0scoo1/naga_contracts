...
contract threeacinu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "3AC INU";
    string private constant _symbol = "3AC";
    ...
    address payable private _developmentAddress = payable(0x9304349C94720B56682db61dC807C3b950A7933d); 
    address payable private _marketingAddress = payable(0x9304349C94720B56682db61dC807C3b950A7933d);
