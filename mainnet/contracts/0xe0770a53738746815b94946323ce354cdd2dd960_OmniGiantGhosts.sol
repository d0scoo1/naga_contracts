// File: OmniGiantGhosts.sol


// File: contracts/OmniGiantGhosts.sol

// These are ghosts. They are within you. They are your soul.
...
contract OmniGiantGhosts is ERC721A, Ownable {using Strings for uint256; using Counters for Counters.Counter; Counters.Counter private supply;
...
uint256 public freeMaxSupply = 111;
uint256 public maxSupply = 333;
uint256 public price = 0.005 ether;
bool public paused = false; bool public revealed = false; mapping(address => uint256) public addressMinted;
constructor() ERC721A("Omni Giant Ghosts", "OGG") {setHiddenMetadataUri("ipfs://tyfkrz37dg4uvi7haswz5icpxlx4fi3dnyxdge5ty5qe3mltuinli0ioevm");}
