...
Perfect Moon is the incubator based on Ethereum Network with innovative product launches, where community gets rewarded in ecosystem tokens. 
There will be a NFT minting system along with an NFT Marketplace that is in development.

🚀 PERFECT MOON was a stealth launch with no presale. The initial liquidity was added by the dev, locked on UniCrypt and the project was given to the community.
...
Https://PerfectMoon.Net
@PerfectMoonTokenChat
...
contract PerfectMoon is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 1000000000000 * 10 ** 18;

    constructor () ERC20('PerfectMoon|PerfectMoon.net', unicode'PerfectMoon🌓') {
