...
contract dAPPRewards is Ownable {
  ...
  function VaultLock() onlyOwner ifdAPPRewardsOn public {
    special = false;
    emit dAPPRewardsOff();
  }
}
...
contract WhaleDAO is Context, IERC20, Ownable, dAPPRewards {
    ...
    string private _name = "WhaleDAO";
    string private _symbol = "WAO";
