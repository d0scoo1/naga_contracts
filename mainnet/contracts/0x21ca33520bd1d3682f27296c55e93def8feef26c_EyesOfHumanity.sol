...
Renounced & locked 3 months.

Pretty Low Tax : 3% buy / 7% Sell
...
contract EyesOfHumanity is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"EyesOfHumanity"; ////
    string public constant symbol = unicode"EyesOfHuman"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 20000000 * 10**9; // 2% 
        _maxHeldTokens = 40000000 * 10**9; // 4%
    }
