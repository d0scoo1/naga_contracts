...
contract Verdun is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Verdun", "$V") {
        ...
        maxTransactionAmount = 5 * 10 ** 6 * 10 ** decimals(); // 0.5% maxTransactionAmountTxn
        maxWallet = 10 * 10 ** 6 * 10 ** decimals(); // 1% maxWallet
