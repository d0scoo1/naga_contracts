...
abstract contract Withdrawable is Ownable, Dropysable {
  address[] public payableAddresses = [DROPYSADDRESS,0x6a2fBc3F859a1eABA4587A9F8Ddc43Fe0d31737C];
...
// File: contracts/HummingbirdXRuby.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.2;


contract HummingbirdXRuby is
    ERC1155,
    Ownable,
    Pausable,
    ERC1155Supply,
    ...
    Allowlist
{
    ...
    string public name = "HummingbirdX Ruby";
    string public symbol = "HummingbirdXRuby";
    string public contractURI = "ipfs://bafyreib47vbhvrmasacn2beglvx66zganvv6ybe4o5cfz5gmklyadx5hji/metadata.json";
