...
contract SaveUkraine is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Ownable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    string private _baseURIPrefix;
    uint256 private tokenPrice = 50000000000000000; //0.05 ETH
    constructor() ERC721("SaveUkraine", "UA") {}
    ...
    function buyTokens(uint tokensNumber) public payable {
        ...
        require(tokenPrice * tokensNumber <= msg.value, "Wrong ETH amount");
