...
contract HoneyCoinRaffle is SimpleAccessUpgradable {
    ...
    function reserveRaffleProjectSpot(
        ...
        //require(
        //    projectToUserSpots[projectId][msg.sender] == 0,
        //    "Address already reserve the spot"
        //);
        require(
            project.deadline != 0 && project.price != 0,
            "Project does not exist"
        );
        require(project.supply > 0, "Not enough spots left");
        ...
        projectToUserSpots[projectId][msg.sender] += 1;
    ...
    function findProjectWinner(uint256 projectId) external onlyAuthorized {
        RaffleProject storage project = raffleProjects[projectId];
        ...
        project.winner = projectToUsers[projectId][winnerIndex];
