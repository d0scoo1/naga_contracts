...
这是官方的，Elon Buy Tweeter，对所有加密社区都有好处！


购买税 : 2%
销售税：前 15 分钟 15%，然后转为 2%

发射后放弃所有权。

LP 锁定在 team.finance 上。

最大钱包：3%


It's official, Elon Buy Tweeter and it's good for all crypto community ! 


Buy Tax : 2%
Sell Tax : 15% the first 15 min then turned to 2%
...
contract ElonBuyTwitter is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"ElonBuyTwitter"; ////
    string public constant symbol = unicode"ElonBuyTwitter"; ////
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxBuyAmount = 3000000000 * 10**9; // 3%
