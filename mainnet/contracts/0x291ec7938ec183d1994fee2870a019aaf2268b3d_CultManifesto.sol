...
contract CultManifesto is Context, IERC20 {
    ...
    address public _comptroller = 0xa3cdcE32D456985abC9aa85eAA31F51d32476b6B;
   constructor () public {

        _name = "Read The Manifesto";
        _symbol = "CULT MANIFESTO";
        _decimals = 9;
        uint256 initialSupply = 1000000000000 * (10 ** 9 );
