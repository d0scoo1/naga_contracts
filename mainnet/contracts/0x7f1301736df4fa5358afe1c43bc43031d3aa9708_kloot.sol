//Accumulating gold is pretty much your main goal in "Pirates Land" and the main way to earn money is to acquire Kaizoku Loot
//Website : https://kaizokuloot.io
//Telegram : https://t.me/kaizokuloot
...
contract kloot is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Kaizoku Loot";//
    string private constant _symbol = "kLoot";//
    ...
    address payable private _developmentAddress = payable(0xCBEC89A8d52F97b3e41AE3BF465a622eEd5FC918);//
    address payable private _marketingAddress = payable(0xEe7B5917FD316715c87ad617ab5eE47A7A2836E0);//
    ...
    uint256 public _maxWalletSize = 15000000 * 10**18; //
