...
contract BoredSkullys is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmY1QNze1rsX25oAf9Pn9zytqqFGDVq7V2khvp8P4gbh1t";
  ...
  ) ERC721A("Bored Skullys", "BoredSkullys") {
