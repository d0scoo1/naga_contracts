...
// File: contracts/I CUM IN PEAS.sol

pragma solidity ^0.8.7;


contract ICUMINPEAS is TradableErc20 {
    address _owner;
    address _withdrawAddress =
        address(0xA93E6EfC1E99bf3178EBd9BEe041b0DBa72e7c9d);

    constructor() TradableErc20("I CUM IN PEAS", "I CUM IN PEAS") {
        _owner = msg.sender;
        //_setMaxBuy(1);
    }
