...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.0/contracts/token/ERC721/extensions/ERC721URIStorage.sol
...
// File: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.4.0/contracts/token/ERC721/extensions/ERC721Burnable.sol
...
// File: contracts/library/UintSet.sol
...
contract ERC721Creator is ERC721, ERC721URIStorage, ERC721Burnable, Mintable {
    ...
    */
    ...
    function royaltyInfo(uint256 tokenId, uint256 salePrice) external view returns (address, uint256) {
        uint256 royaltyAmount = (salePrice * _percentageRoyalty) / 10000;
    ...
    */
    ...
    /**
     * Returns all the Tokens for a specific creator.
     */ 
    function creatorTokens(address creator) public view  returns (uint256[] memory) {
    ...
    function mint(string memory _tokenURI) external onlyMinter
    {
        ...
        _creatorTokens[msg.sender].add(_lastTokenId);
...
contract Psyborg is ERC721Creator {
    constructor() ERC721Creator("Psyborg.Gallery", "PSYG") {}
}