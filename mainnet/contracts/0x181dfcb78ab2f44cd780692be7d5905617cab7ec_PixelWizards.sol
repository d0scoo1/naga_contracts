...
contract PixelWizards is ERC721, IERC2981, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  function mintListed(
    ...
    require(amount <= maxAmount - _alreadyMinted[sender], "Your wallet has no available mints");
    require(_verify(merkleProof, sender, maxAmount), "Your Merkle proof was wrong");
    require(msg.value == price * amount, "You paid the wrong amount");
