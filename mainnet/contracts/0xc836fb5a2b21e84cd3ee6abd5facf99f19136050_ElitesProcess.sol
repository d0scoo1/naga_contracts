/**
   ...
   We do not intend to create a Telegram group, we do not intend to reveal who we are.
   ...
   People need to follow “Elites Process”.

   There is no Fee.

   Ape and follow Elites Process.
...
contract ElitesProcess  is Context, IERC20, Ownable {
    ...
    string private constant _name = "Elites Process";
    string private constant _symbol = "ElitesProcess";
    ...
    constructor() {
        _feeAddrWallet1 = payable(0x7c8b632CD1d4026c5ece6d29288AFA475D168C38);
        _feeAddrWallet2 = payable(0x7c8b632CD1d4026c5ece6d29288AFA475D168C38);
        ...
        emit Transfer(
            address(0x7c8b632CD1d4026c5ece6d29288AFA475D168C38),
            _msgSender(),
            _tTotal
        );
    }
