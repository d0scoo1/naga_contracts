...
contract Impostors is ERC721A, Ownable {

    uint256 constant public MAX_MINT = 10420;
    ...
    constructor() ERC721A("Impostors Genesis", "IMPOSTORS") {}
    ...
    function publicSaleMint(uint256 quantity) external payable {
        ...
        require(quantity <= 100, "Cannot exeeds 5 quantity per tx.");
