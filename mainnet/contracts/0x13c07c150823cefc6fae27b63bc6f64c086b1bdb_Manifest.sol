/**
    ...
    Manifest is a community-driven project, designed for the commutative cooperation of
    like-minded individuals looking to achieve a greater objective. 

    Manifest will include a 5% buy and sell fee, which consist of a 3% liquidity fee and a small 2% developer fee.

    We are a two-man developer team, we have no intention to profit, but we do look to be paid for our efforts. 
    Our vision is clear, it is to create the greatest community project the blockchain has ever seen.

    "All of us have within us an amazing capacity to manifest anything that we want into our lives as long as our visions clear" - Steve Harvey

    TOKEN DISTRIBUTION

    Fixed supply: 1,000,000,000 Manifest 
    100% supply into the liquidity pool on day 1
  - No presale
  - No team tokens
  - No whales
    ...
    We the developers do not want our identity to be revealed but IF the community was to setup a telegram group we are more
    than happy to join and reveal ourselves. This is an experiment to see how manifestation really works. 
*/
...
contract Manifest is Context, IERC20, ERC20Ownable {
    ...
    string private constant _na = "Manifest";
    string private constant _sym = "Manifest";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0xa93A5998587bd588587e512618a4bB941a2C26b5);
        OtherWallet = payable(0xa93A5998587bd588587e512618a4bB941a2C26b5);
        DevWallet = payable(0xa93A5998587bd588587e512618a4bB941a2C26b5);
