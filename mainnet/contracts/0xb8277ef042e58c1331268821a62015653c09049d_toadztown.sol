...
contract toadztown is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("toadztown","TDZTN") {
  ...
  function QUAqua(uint256 quantity) external payable callerIsUser {
  ...
  function changeQUAquaPrice(uint256 _newPrice) external onlyOwner
  {
      PRICE = _newPrice;
  }
