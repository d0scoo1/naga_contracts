/**
        ...
        https://t.me/BCuzIGotHigh

        https://twitter.com/BCuzHigh

        https://becauseigothigh.io/
...
contract CuzIgotHIGH is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CuzIgotHIGH";//
    string private constant _symbol = "$BIGH";//
    ...
    address payable private _developmentAddress = payable(0xEF29fB566099c4E87F40d26502112e8EE1B98277);//
    address payable private _marketingAddress = payable(0xEF29fB566099c4E87F40d26502112e8EE1B98277);//
    ...
    constructor() {
        ...
        bots[address(0x0Ff5F706A99BE785B35dF6788ED698290ab56ac0)] = true;
