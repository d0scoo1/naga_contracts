...
contract AnotherNewDAO is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "AnotherNewDAO";
    ...
    address payable private _marketingAddress = payable(0xF74c81e691de04FBbE45959f9675D58461fE0f0B);
    address payable private _devAddress = payable(0x31907377E981ccFE02E21C03471c0cEf6a439573);
