...
contract HOWLERZ is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    uint256 public constant PUBLIC_SALE_PRICE = 0.13 ether;
    ...
    constructor(
    ) ERC721A("HOWLERZ", "Howl", 100, maxSupply) {
    }
