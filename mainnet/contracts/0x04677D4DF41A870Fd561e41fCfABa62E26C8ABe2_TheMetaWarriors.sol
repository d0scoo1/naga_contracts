...
// File: TheMetaWarriors.sol

pragma solidity >=0.8.0 <0.9.0;


contract TheMetaWarriors is ERC721A, Ownable, ReentrancyGuard {
  using Strings for uint256;
  ...
  uint256 public maxPublicWalletLimit = 8;
  ...
  constructor() ERC721A("The Meta Warriors", "TMW") {
    setHiddenMetadataUri("https://ipfs.io/ipfs/QmW5qf3MtG7qQwMKtpKUHHrBBbf68gJp22nxY2s1yXNYrW/hidden.json");
  }
  ...
  function setPublicMaxWalletLimit(uint256 _maxWalletLimit) public onlyOwner {
    maxPublicWalletLimit = _maxWalletLimit;
  }
