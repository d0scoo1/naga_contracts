...
contract CompoundSaverFlashProxy is DFSExchangeCore, CompoundSaverHelper  {
    ...
    address public constant ELIXYRSAVER_LOGGER = 0x4a35CcB1cB7F8388CE640128aE4a744dff42226e;
    ...
    function flashRepay(
        ...
        ElixyrsaverLogger(ELIXYRSAVER_LOGGER).Log(address(this), msg.sender, "CompoundRepay", abi.encode(_exData.srcAmount, swapAmount, collToken, borrowToken));
    }
    ...
    function flashBoost(
        ...
        ElixyrsaverLogger(ELIXYRSAVER_LOGGER).Log(address(this), msg.sender, "CompoundBoost", abi.encode(_exData.srcAmount, swapAmount, collToken, borrowToken));
    }
