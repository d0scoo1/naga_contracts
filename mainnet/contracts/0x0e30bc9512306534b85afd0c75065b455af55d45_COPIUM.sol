...
contract COPIUM is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    uint256 private maxBuyLimit = 690000000 * (10**18);
    uint256 public maxWallet = _tTotal.div(10000).mul(100);

    string private _name = "COPIUM";
    string private _symbol = "COPIUM";
    ...
    uint256 private routerselllimittokens = 1925000000 * 10**18;
