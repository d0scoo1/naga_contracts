/*
    ...
    Vitalik Web3 - $VITALIK3

    💬Telegram: https://t.me/VitalikWeb3
...
contract VitalikWeb3 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal =  99000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "Vitalik Web3";
    string private _symbol = "VITALIK3";
    ...
    uint256 public numTokensSellToAddToLiquidity = 9000000000000000000000 * 10**9;
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount =  99000000000000000000000 * 10**9;
    }
