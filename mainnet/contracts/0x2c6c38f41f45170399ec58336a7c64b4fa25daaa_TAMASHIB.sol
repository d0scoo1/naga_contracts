...
contract TAMASHIB  is Context, IERC20, Ownable {
    ...
    string private _name = "TamaShib";                                          
    string private _symbol = "$TAMASHIB";                                           
    ...
    address payable public marketingWallet = payable(0x2Fbbb1f7cBE74439747f57501a830C2a682475f0);
