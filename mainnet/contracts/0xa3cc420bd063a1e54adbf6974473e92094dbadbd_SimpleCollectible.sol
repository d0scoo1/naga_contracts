...
contract SimpleCollectible is ERC721A, Ownable {
    ...
    string private _baseTokenURI = 'https://gateway.pinata.cloud/ipfs/QmXssTLz5DZbk2QxMeUxWEM5ZmfFrrZq6KngbuJCNaRfj4/0.json';

    constructor () ERC721A ('WallStreet Club', 'WSC', 25, 550)  {
    }

    function mintColletibles(uint256 _count) public {
