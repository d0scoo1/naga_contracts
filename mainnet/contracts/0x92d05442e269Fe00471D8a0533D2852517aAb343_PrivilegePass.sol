...
contract PrivilegePass is Ownable, ERC721A {
    ...
    string public hiddenURI = "ipfs://QmeQz3L1TjZVFDt6p41yzgHYq1mn7ediLXKAfhBVwxV5Dv";

    // OpenSea CONTRACT_URI - https://docs.opensea.io/docs/contract-level-metadata
    string public CONTRACT_URI = "ipfs://QmeQz3L1TjZVFDt6p41yzgHYq1mn7ediLXKAfhBVwxV5Dv";
    ...
    address constant internal DEV_ADDRESS = 0x47b7739156c458417f6a5bd97775a239F2c25f37;
    address constant internal WEB_ADDRESS = 0xC6Dac7759ee2aA6bF66FB0189c8d94aC16e0f399;
    address public teamWallet = 0x9B411BB33a32675B899B2689083e0238734338cC;

    mapping(address => bool) public userMintedFree;
    mapping(address => uint256) public numUserMints;

    constructor() ERC721A("Privilege Pass", "PP") { }
