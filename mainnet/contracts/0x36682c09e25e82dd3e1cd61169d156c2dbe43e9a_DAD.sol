...
This is a token to pay tribute to the unsung hero. 
For centuries, men, especially being Dad in the family, have been stereotyped and usually fallen into the Trap of Masculinity; 
people are criticizing contemporary society system is dominated by the ideology of patriarchy 
while neglect the fact that Men as the stereotyped ‘’bottling things up” role is the actual victim under the so-called patriarchy social system. 

The token is designed to tell every single dad on this planet when you’re feeling down,
we are always for you. Seeking extra support is the responsible thing to do and there is nothing to be ashamed of. 

The mental health of the Dad community is the major issue we concern. Not seeking any further assistance 
but instead trying to go it alone when you’re feeling down increases the risk of depression and it iis a high risk factor for suicide. 
https://dadunion.org/
...
contract DAD is Context, IERC20, Ownable {
    ...
    string private constant _name = "DAD";
