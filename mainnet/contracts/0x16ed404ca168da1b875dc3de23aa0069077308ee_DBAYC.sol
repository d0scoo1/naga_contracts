...
/**
When Bayc, king of NFT, meets Doge, king of Meme Coin, guess what happens?
Doge + Bayc = DBYC
Meme + NFT = Free
Stealth launch
No team, no dev
Please jion in our discord (no TG)
Next free of wealth, are you？
**/
...
contract DBAYC is Context, Ownable, IBEP20, BEP20Detailed {
  ...
  using SafeMath for uint256;
    ...
    address payable public marketingaddress = payable(0xA6BEF0bdBF429c5f1e5f9e925813E86BAd5bc165);
    address payable public utilityAddress = payable(0x9eadcfcF464246B9DcB33ffb759f9a10574919C7);
    address payable public teamAddress = payable(0x109dC733C5f94987d608275b4234630CfF2Fd505);
    ...
    constructor () BEP20Detailed("DogeBAYC", "DBAYC", 18) {
      _owner = msg.sender ;
