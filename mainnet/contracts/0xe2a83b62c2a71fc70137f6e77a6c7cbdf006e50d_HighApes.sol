...
contract  HighApes is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "High Apes";
    string private constant _symbol = "High";
    ...
    uint256 private _buyDevTax = 7;
    uint256 private _sellDevTax = 7;

    uint256 private _marketingTax;
    uint256 private _buyMarketingTax = 7;
    ...
    uint256 private _numOfTokensToExchangeForTeam = 1500000 * 10**9;
