...
contract UPPERCUT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pixel Boxing", "UPPERCUT") {
        ...
        maxTransactionAmount = 9500000000; // 0.95% maxTransactionAmountTxn
        maxWallet = 30000000000; // 3% maxWallet
        swapTokensAtAmount = 2000000000; // 0.2% swap wallet
