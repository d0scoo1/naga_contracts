...
/*
    ________    __    __      __     __________   _______
   /  ______|  |  | /  /    /    \  |___    ___| |  _____|
  |  |_____    |  |/  /    /  /\  \     |  |     | |_____
   \______  \  |     <    |   __   |    |  |     |  _____|
  ________|  | |  | \  \  |  |  |  |    |  |     | |_____
 /__________/  |__|  \__\ |__|  |__|    |__|     |_______|
         ______       __     __________    ________
        |   _  \    /    \  |___    ___|  /   _____|
        |  |_|  |  /  /\  \     |  |      |  |_____
        |     __| |   __   |    |  |       \______  \
        |  |\  \  |  |  |  |    |  |  ___________|  |
...
contract SkateRatsClub is ERC721, Ownable {
  using Strings for uint256;
 
  string public _collectionName= "Skate Rats CLub";
  string public _collectionSymbol="SKRC";
  ...
  bool public whiteListActive=false;
    ...
    //add1= community | add2=Dev | add3=creator | add4/5= team 
    address private addressOne = 0x462b5838799034aC02cBD1c33C21886b67482a9f;
    address private addressTwo = 0xf3447A408cea54D7790449f848439657eAa52258;
    address private addressThree = 0x0a084DC8daDEb882739b3ecF7394c7EdBb8d1dEd;
    address private addressFour = 0x991B46048686aC66035d243b89eb5347406D391a;
  ...
  constructor() ERC721(_collectionName, _collectionSymbol)
   {
    setNotRevealedURI("ipfs://QmSBNgW9d3wa4z6cpgeByYQiMWx3DwL2U1YKGH2rNMCTCx/1.json");
    amountMinted=0;
    addressCount=0;
 ...
 //primary withdraw, withdraw % to address 1 % to address 2
  function primaryWithdraw() public payable onlyOwner {
   uint256 CurrentBalance = address(this).balance;
        payable(addressOne).transfer((CurrentBalance * 52) / 100);
        payable(addressTwo).transfer((CurrentBalance * 15) / 100);
        payable(addressThree).transfer((CurrentBalance * 30) / 100);
