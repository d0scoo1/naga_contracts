...
contract BullInu is ERC20, Ownable {
    ...
    constructor() ERC20("BullInu", "BullInu") {
        ...
        marketingWallet = address(0x5E6050f14f1664780F68dAAcb14627B1873776bA); // set as marketing wallet
        devWallet = address(0x5E6050f14f1664780F68dAAcb14627B1873776bA); // set as dev wallet
