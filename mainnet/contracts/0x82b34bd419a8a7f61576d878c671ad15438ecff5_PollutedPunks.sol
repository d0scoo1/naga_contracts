...
// File: @openzeppelin/contracts/utils/ContextMixin.sol
...
contract ERC1155 is Context, ERC165, IERC1155, IERC1155MetadataURI {
    ...
    constructor(string memory uri_) {
        ...
        _uriBase = "ipfs://QmeUM6hYCCtveZM6RZ8vGSYpjQx9Mr1nQXhfvsKieF8ApM/"; // IPFS base for ParkPics collection
...
contract PollutedPunks is ERC1155, IERC2981, Ownable, Pausable, ContextMixin {
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data)
        ...
        payable
    {
        require(msg.value >= 0.07 ether, "Not enough ETH sent: min .07eth");
    ...
    function uri(uint256 tokenId) override public view returns (string memory) {
        ...
        // eliminate use of >= and <=
        require(tokenId > 0 && tokenId < total_supply + 1, "ERC1155Metadata: URI query for nonexistent token");
    ...
    function contractURI() public pure returns (string memory){
        return "ipfs://QmRCxD23zPET5swpUXmr5q25LQea5Bd5kgU3jQPHkX786F"; // Contract-level metadata for PollutedPunks
    }
}