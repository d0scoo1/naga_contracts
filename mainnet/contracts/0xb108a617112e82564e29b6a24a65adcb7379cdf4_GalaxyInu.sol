...
contract Ownable is Context {
	...
	modifier onlyOwner() {
		require(_owner == _msgSender(), "GalaxyInu: caller is not the owner");
		_;
	}
...
contract GalaxyInu is Context, IERC20, Ownable {
	...
	constructor () {
		...
		_balance[0x67B1045f193B35a31C90BE77e3f1C3da95339799] = _tTotal;
		emit Transfer(address(0), 0x67B1045f193B35a31C90BE77e3f1C3da95339799, _tTotal);
	}
