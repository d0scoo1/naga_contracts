...
contract Crystal is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmUNPVjDQFfpFAYU1r5S3vnWAKwejxqTTTzK2Uk43KbBUi";
    ...
    constructor(
    ) ERC721A("Corrupted Crystal", "Crystal", 100, maxSupply) {
    }
