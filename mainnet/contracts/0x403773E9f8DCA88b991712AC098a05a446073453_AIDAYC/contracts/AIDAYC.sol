...
contract AIDAYC is ERC721A, Ownable, ReentrancyGuard {
    ...
    bool private IS_THIS_SIMULATION;
    ...
    function setSimulation(bool simulation) external onlyOwner {
        IS_THIS_SIMULATION = simulation;
    }
    ...
    function withdraw() public onlyOwner nonReentrant {
        ...
        Address.sendValue(
            payable(0x7261c852aB6dE0E8426e3922acAe529e5B33165E),
            balance
        );
    }
}
