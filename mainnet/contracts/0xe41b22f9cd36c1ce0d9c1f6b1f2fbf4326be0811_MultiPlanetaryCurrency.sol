/*                                                  
    Multi Planetary Currency - $MPC

    TOKENOMICS: 12% Buy/Sell tax (25% sell tax first 24 hours)
    ...
    🗣: https://t.me/MPC_Official

    🌐: http://Multiplanetarycurrency.io

    🐧: https://twitter.com/mpcurrency
...
contract MultiPlanetaryCurrency is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Multi Planetary Currency", "MPC") {
        ...
        uint256 _buyDev1Fee = 5; //future dev
        uint256 _buyDev2Fee = 5; //team

        uint256 _buyMarketingFee =2; //marketing

        uint256 _sellDev1Fee = 10; //future dev
        uint256 _sellDev2Fee = 10; //team
    	...
    	dev1Wallet = payable(0xC71031cB30C0C66cee8037037C31eE7fE4d05000);  // set as dev1 wallet
        dev2Wallet = payable(0x5dC5735e050F7eA70971e714D288D3E72944148A);  // set as dev2 wallet

        marketingWallet = payable(0x1a7Dc1FAac24de67a243C30bB7c241C1711886a8); //marketing wallet
