...
contract BillionaireBunker is ERC721Enumerable, Ownable {
    ...
    uint256 public constant MAX_NFTS = 9999;
    ...
    uint256 public constant FRENSALE_MAX_MINT = 10;
    ...
    function mintFrensale(uint256 amountOfNfts) external payable whenFrensaleStarted {
        require(_presaleEligible[msg.sender], "You are not whitelisted for the frensale");
        require(totalSupply() < MAX_NFTS, "All NFTs have been minted");
    ...
    function withdrawAll() public onlyOwner {
        ...
        _widthdraw(team4Address, address(this).balance);
    }
