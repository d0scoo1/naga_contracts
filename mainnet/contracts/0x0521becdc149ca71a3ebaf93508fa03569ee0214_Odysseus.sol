...
contract Odysseus is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 _buyTheBankFee = 4;
    uint256 _buyLiqFee = 0;

    uint256 _sellTheBankFee = 4;
    ...
    constructor() ERC20("Odysseus Token", "Odysseus") {
        ...
        maxTx = 6000000000 * 1e18; // 1% of supply max transaction allowed at launch
        maxWallet = 3000000000 * 1e18; // 3% of supply max wallet
        ...
        theBank = payable(0x64Ed9552c91B167482e8B414A7afA2d50a09D4d2); 
    ...
    function LiveTrading(uint256 botBlocks) external onlyOwner() {
