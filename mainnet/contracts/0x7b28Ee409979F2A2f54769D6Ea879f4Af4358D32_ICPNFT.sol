...
contract ICPNFT is ERC721, Ownable {
  ...
  uint256 public maxWalletLimitPresale1 = 1;
  ...
  function verify(bytes32 _merkleRoot, bytes32 leaf, bytes32[] memory proof) public pure returns (bool) {
    ...
    function presaleWalletLimit() public view returns (uint256) {
        if(presaleActive) {
            return maxWalletLimitPresale1;
        }
  ...
  function setMaxPresaleMintAmountPerTx(uint256 _maxMintAmountPerTx) public onlyOwner {
  ...
  function setMaxWalletLimitPresale1(uint256 _maxWalletLimit) public onlyOwner {
    maxWalletLimitPresale1 = _maxWalletLimit;
  }
