...
/**
 * Ubuntu Tribe's Gold International Fungible Token (GIFT) is 100% collateral-backed by fine gold.
 * One GIFT is pegged to the price of 1 mg of gold. Most importantly, holders of GIFT may redeem their tokens for
 * physical gold that can be shipped to any location in the world, unless forbidden by International law.
 */
