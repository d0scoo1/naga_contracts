...
contract WIHTS is ERC721Psi, ERC2981ContractWideRoyalties, Ownable {
  ...
  /// @notice Whether the mint has been closed.
  ...
  string public unrevealedURI = 'https://arweave.net/TdxegBMOs1GtUdFHoN2sMC5L9dH5mx_A6SfI5SfyvY0';
  ...
  constructor() ERC721Psi('Wish I Had The Same', 'WIHTS') {
    ...
    _setRoyalties(address(0xb291b5b2C35CD515CCb333b1Ebd688942ed1966c), 250);
    _transferOwnership(address(0xb291b5b2C35CD515CCb333b1Ebd688942ed1966c));
  }
  ...
  function withdraw() external onlyOwner {
    payable(address(0x354Fccdaa678cdebc25CDf297930e32F86EC6E18)).transfer(
