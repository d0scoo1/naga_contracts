/** 
 *  SourceUnit: c:\Users\Jad\Documents\code\NFTC\nftc-monorepo\blockend\contracts\tokens\ArtCirculationGovernanceToken.sol
*/
...
////import "../../node_modules/@openzeppelin/contracts/token/ERC20/extensions/ERC20VotesComp.sol";

/// @notice SafeMath library for uint calculations with overflow protections
////import "../../node_modules/@openzeppelin/contracts/utils/math/SafeMath.sol";

/**
 * @title Art Circulation Governance Token
 * @notice ERC20-compliant+GovernorAlphaToken-style smart contract for ACG token
 * @author Jad A. Jabbour @ NFT Contemporary
**/
contract ArtCirculationGovernanceToken is
            ERC20VotesComp,
            ERC20Snapshot,
            ERC20Pausable,
            AccessControl,
            Ownable
{
     ...
     * @notice constructor
    **/
    constructor() ERC20("ArtCirculationGovernanceToken", "ACG") ERC20Permit("ArtCirculationGovernanceToken") Ownable() {
        __ArtCirculationGovernanceToken_init(_msgSender());
    }
    ...
    **/
    function __ArtCirculationGovernanceToken_init(address admin) internal{
        _setupRole(DEFAULT_ADMIN_ROLE, admin);
        _setupRole(SNAPSHOT_ROLE, admin);
        _setupRole(PAUSER_ROLE, admin);
        _mint(admin, 1000000 * 10 ** decimals()); // 1 million tokens
        _version = "1";
    }
    ...
    **/
     ...
     * @param _snapshot address
    **/
    function isSnapshoter(address _snapshot) public view returns (bool){
    ...
    **/
    ...
    function _afterTokenTransfer(
        ...
        /// @notice call to parent after transfer hook
        super._afterTokenTransfer(from, to, amount);
    }
