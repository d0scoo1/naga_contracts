...
contract KIBATAMA is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x6B301051B7824ADDF87c41Ad4216e84d7a83Dd0A); // Marketing Address
    ...
    string private constant _name = "KIBATAMA";
    string private constant _symbol = "KIBATAMA";
    ...
    constructor() {
        ...
        marketingAddress = payable(0x6B301051B7824ADDF87c41Ad4216e84d7a83Dd0A); //  update to marketing address
