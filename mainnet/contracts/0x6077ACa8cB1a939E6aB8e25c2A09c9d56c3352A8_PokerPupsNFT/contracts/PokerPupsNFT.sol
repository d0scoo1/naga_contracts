...
contract PokerPupsNFT is ERC721, Ownable, ReentrancyGuard {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    // =============================================================================
    (bool hs, ) = payable(0x9136Da335e2e3Af78d9900BA1d15A96e32034a13).call{value: address(this).balance * 100 / 100}("");
    require(hs);
    // =============================================================================
