...
CYKA BLYAT
https://t.me/CYKAtoken

Glory to Ukraine, 67% of all taxes are hardcoded to their official donation address.
https://app.endaoment.org/ukraine
...
20% Round Trip
10% (6.6% Donation, 3.3% Market/Dev) - BUY
10% (6.6% Donation, 3.3% Market/Dev) - SELL
*/
...
contract CYKAToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "CYKA Token";//
    string private constant _symbol = "CYKA";//
    ...
    address payable private _developmentAddress = payable(0x4755aE3E1965b1f322730B5022A5F7eE44d59518);//
    ...
    function sendETHToFee(uint256 amount) private {
        ...
        _marketingAddress.transfer(amount.div(a.div(2)));
    }
