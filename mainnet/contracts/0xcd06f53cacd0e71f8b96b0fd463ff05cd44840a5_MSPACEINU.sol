...
// TG: http://t.me/mspaceinu

// Website: http://mspaceinu.com/
...
contract MSPACEINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "MSpaceINU";
    string private constant _symbol = "MSPACEINU";
    ...
    constructor () {
        _feeAddress = payable(0x2F3508921424986e6220bf479108Fd070CF8E8dC);
        _buyTax = 7;
        _sellTax = 7;
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        if (maxTxAmount > 90_000_000 * 10**9) {
