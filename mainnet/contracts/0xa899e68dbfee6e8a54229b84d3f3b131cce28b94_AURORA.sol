...
Max wallet : 1% ( Per address,you can use multiple addresses)
Max wallet will be lifted to 2% after launch and contract will be renounced after

3% liquidity Fee on buying and selling AURORA

AURORA will be a community led token. No socials will created.
AURORA - Polar lights (aurora polaris) are a natural phenomenon found in both the northern and southern hemispheres that can be truly awe inspiring

AURORA will be the natural phenomenon in ETH that is safe for everyone.
