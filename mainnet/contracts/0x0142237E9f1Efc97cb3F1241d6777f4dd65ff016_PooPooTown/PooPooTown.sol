...
contract PooPooTown is Ownable, ERC721A, PaymentSplitter {
    using Strings for uint256;

    uint256 public immutable maxSupply = 6500;
    uint256 public immutable maxFreeSupply = 2000;

    uint256 public maxTokensPerTx = 3;
    uint256 public price = 0.0035 ether;
    uint32 public saleStartTime = 1654430400;
