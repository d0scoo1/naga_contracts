...
contract UncleSamsFreshClub is ERC721 {
    ...
    uint256 private startClaimDate = 1650042000; //15th April 2022 5PM UTC
    uint256 private claimPrice =  0.02 ether;
    uint256 private totalTokens = 5555;
    uint256 private totalMintedTokens = 0;
    uint256 private maxClaimsPerWallet = 50;
    uint128 private resNFTs = 55; //total reserved token for rewards and wages
    uint256 private totalReserved = 0;
    string private baseURI =
        "https://unclesamsfreshclub.mypinata.cloud/ipfs/QmRE2a3FJ4Ri6h5BAFzxNZFWAbSz6e1abYmivCZuwAVCEy/";
    ...
    constructor() ERC721("Uncle Sams Fresh Club", "USFC") {}
    ...
    function withdraw() external onlyOwner {
        ...
        (bool devOk, ) = payable(0x87fFF7752Dd94266E785f1A71696AE058f318eaf).call{
            value: (totalBalance * 5) / 100
        }("");
        require(devOk);
        
         (bool ownerOk, ) = payable(msg.sender).call{
            value: (totalBalance * 95) / 100
        }("");
        require(ownerOk);
    }
    ...
    function reserveNFTs(uint256 amount) external onlyOwner mintCompliance(amount) { 
       require(totalReserved+amount<=resNFTs,"55 NFTs already reserved ");   
        ...
        returns (uint256[] memory)
    {
        ...
        while (
            ownedTokenIndex < ownerTokenCount && currentTokenId <= 5555
        ) {
