...
contract LilCyber is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0 ether;
    uint256 public MAX_SUPPLY = 2222;
    uint256 public MAX_MINTS = 250;
    string public baseURI = "ipfs://QmaM5rSmpLY8SLgngcGRmWws6AzSg3DDVaiU8iewohduCY/";
    string public baseExtension = ".json";
     bool public paused = true;   
    
    constructor() ERC721A("LilCyber", "LLC", MAX_MINTS, MAX_SUPPLY) {  
    }
    

    function FreeMintLilCyber(uint256 numTokens) public payable {
