...
* out of which 1% will be given back to the community via supplying the liquidity pool and 4% will be used for development and marketing.

Website : https://argosthefaithful.com
Twitter : https://twitter.com/argos_token 

I am ARGOS. I thank you for joining me on this journey!
...
contract THEFAITHFULDOG is Context, IERC20, Ownable {
    ...
    string private _name = "The Faithful Dog";
    string private _symbol = "ARGOS";
    ...
    uint256 public numTokensSellToAddToLiquidity = 8888888 * 10**9;
    uint256 public _maxWalletSize = 18888888 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 8888888, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 8888888, "Swap Threshold Amount cannot be less than 69 Million");
