...
contract KONGOOSE is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kongoose";//
    string private constant _symbol = "KONGOOSE";//
    ...
    address payable private _developmentAddress = payable(0xb98C655246828E1F44479497a057FdEE85026564);//
    address payable private _marketingAddress = payable(0x31BcCFB3d36202281aCdaB8934D5D838fCaE1C2E);//
