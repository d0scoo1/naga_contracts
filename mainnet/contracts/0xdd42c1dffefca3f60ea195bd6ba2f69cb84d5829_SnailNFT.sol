...
contract SnailNFT is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 public  PRICE = 0.5 ether; //0.5 during sale 
  ...
  constructor() ERC721A("SnailNft","SnailNft", MaxMintPerBatch_, TotalCollectionSize_) {
    ...
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmNRVSMiQR7MUx1KsarehdraJ5LUjSPFUnXVnFkuTRvc5L/";
  }
