...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1be1Bf257a5c12965Ae7858b1BA0dC28A852EF31];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 6666 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmaYc6xBSWG6pBeT7ykhPdsUvvvz6NZY9naFx4ht5cxy5b/";
...
// File: contracts/devixelzContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DevixelzContract is RamppERC721A {
    constructor() RamppERC721A("Devixelz", "DVX"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/lrfev6fdrJhHl2ekZOSZ/contract-metadata";
    }
}