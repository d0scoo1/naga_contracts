...
The mystery of Ryoshi, Shiba and its origins are as grand in these days as the original creator Satoshi.

The day has come that we ignite Shiba's fire and move as one, as a collective and as was always the vision.

This will be a test of belief and patience for many.

You may see things moving a little untraditional or not as you like.

Do not fear. 

Trust the process, it's all apart of the test.

The patient and brave shall be rewarded.

You will find your answer in the rhythm.

Website: https://www.ashibavision.com/
...
contract ASHIBAVISION is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("A Shiba Vision", "VSN") {
