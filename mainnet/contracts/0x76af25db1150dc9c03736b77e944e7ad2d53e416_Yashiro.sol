...
Welcome To Yashiro Inu
犬八代へようこそ

“We are friends, don't make a ceremony out of it.” –Yashiro Isana

Yashiro Inu is a community token! We aim to be one of the biggest Anime tokens on ERC20.  We need the power of the community to complete it's mission.
Spread the word, be helpful, answer questions & tell your friends!
Stealth Launch date & timeframe will be announced. Stay tuned

Utility
 ~ NFT collection
 ~ AnimeSwap with staking/farming
...
5% marketing
2% redistribution
Website: Yashiroinu.io (v1)
Twitter: twitter.com/Yashiro_Inu
Contract: TBA
DexTools: TBA
Telegram: t.me/yashiroinu
...
contract Yashiro is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yashiro Inu";
    string private constant _symbol = "YASHIRO";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xFc9A0dBC1342b4b47f26FbA3351AF80e277F64D0);
        _feeAddrWallet2 = payable(0xFc9A0dBC1342b4b47f26FbA3351AF80e277F64D0);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xFc9A0dBC1342b4b47f26FbA3351AF80e277F64D0), _msgSender(), _tTotal);
    }
