...
contract INFLATION is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = 3234567 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 3234567 * 10**9;
    uint256 public _maxWalletSize = 5234567 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 3234567, "Max Tx Amount cannot be less than 69 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 3234567, "Swap Threshold Amount cannot be less than 69 Million");
