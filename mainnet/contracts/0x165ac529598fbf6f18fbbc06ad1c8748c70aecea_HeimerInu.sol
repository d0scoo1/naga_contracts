...
contract HeimerInu  is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Heimer Inu";                                          
    string private _symbol = "$HMI";                                           
    ...
    address payable public marketingWallet = payable(0x178663a29A5A606a522727AC32a8460A73080568);
