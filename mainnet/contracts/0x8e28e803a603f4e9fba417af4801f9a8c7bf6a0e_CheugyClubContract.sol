...
contract CheugyClubContract is ERC721A, Ownable {
	...
	constructor(string memory _prerevealURL) 
    ERC721A('CheugyClub', 'CHC') {
        setPreRevealURL(_prerevealURL);
    }
    ...
    function setPreRevealURL(string memory _prerevealURL) public onlyOwner {
