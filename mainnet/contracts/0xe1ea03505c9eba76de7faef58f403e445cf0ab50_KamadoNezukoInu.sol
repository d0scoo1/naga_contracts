...
contract KamadoNezukoInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 3_000_000 * 10**18;

    string private _name = '竈門 禰豆子 犬';
    string private _symbol = 'KAMADONEZUKOINU';
