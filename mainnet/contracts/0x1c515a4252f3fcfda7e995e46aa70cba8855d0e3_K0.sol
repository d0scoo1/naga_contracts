...
Born to kill 0, we only pursue multiples, we don't care about anything else, the only goal, kill all 0, let's get to 1 USDC, 1 dollar per k0!
...
https://twitter.com/kill0erc

000000000000000000000000000K
*/
...
contract K0 is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x5c37ccB4768F690aC0ab22a5C95712Fd5F285585);
