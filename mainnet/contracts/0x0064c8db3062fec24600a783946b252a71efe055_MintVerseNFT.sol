...
// File: contracts/MonstaNFT.sol

pragma solidity ^0.8.0;
pragma experimental ABIEncoderV2;

contract MintVerseNFT is
    ERC721,
    ERC721Enumerable,
    ERC721URIStorage,
    ERC721Burnable,
    ...
    Ownable
{
    ...
    //royalty's information
    mapping(uint256 => RoyaltyMeta) private _tokenRoyaltyMeta;
    ...
    function mint(
        ...
        //royaltyRate 0-50
        require(royaltyRate <= 50, "royaltyRate should <= 50");
        require(royaltyRate >= 0, "royaltyRate should >= 0");
        ...
        _tokenRoyaltyMeta[tokenId] = RoyaltyMeta({
            royalty: to,
            royaltyRate: royaltyRate
        });
        emit Royalty(tokenId, to, royaltyRate);
    ...
    function getRoyaltyMeta(uint256 tokenId)
        public
        view
        returns (address, uint256)
    {
        RoyaltyMeta memory royaltyMeta = _tokenRoyaltyMeta[tokenId];
        return (royaltyMeta.royalty, royaltyMeta.royaltyRate);
    }
