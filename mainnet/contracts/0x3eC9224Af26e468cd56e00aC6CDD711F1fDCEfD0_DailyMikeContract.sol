...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 10, 222 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmRNxd6H6Xh4EUrn5pz9qfN2Cj2bJq1fKaSDzcdtT5xXgw/";
...
// File: contracts/DailyMikeContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DailyMikeContract is RamppERC721A {
    constructor() RamppERC721A("Daily Mike", "DlyMike"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/9rdOaearx47vIViQGwTl/contract-metadata";
    }
}
