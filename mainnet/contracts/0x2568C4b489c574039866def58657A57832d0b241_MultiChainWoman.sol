...
MultiChainWoman Socials:
Website: https://mcw-eth.com/
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x4730AaDFaC221F5ac233caE11e760cb5E2Cc695d), 5000);
        m_DidDeploy = true;
    }
...
contract MultiChainWoman is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 1000000000 * 10**9;
    string private m_Name = "MultiChainWoman";
    string private m_Symbol = "MCW";
