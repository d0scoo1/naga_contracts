...
$ROCKY is ERC-20 token inspired by rocky balboa the movie! 
He used to smash the enimes like $ROCKY is going to smash the zeros too!

www.rocky-inu.com
www.t.me/rockyinutoken
...
contract ROCKY is ERC20, Ownable {
    ...
    string constant _name = "Rocky Inu";
    ...
    address public treasuryReceiver = 0xbD8997376a83358b819F2DC68D7f7614212054eF;
    address public marketingReceiver = 0xbD8997376a83358b819F2DC68D7f7614212054eF;
    ...
    constructor () Ownable(msg.sender) {
        ...
        buyFee.liquidityFee = 20; buyFee.treasuryFee = 0; buyFee.marketingFee = 80;
        buyFee.total = buyFee.liquidityFee + buyFee.treasuryFee + buyFee.marketingFee;

        // Set Initial Sell Fees -- Base 1000 Set 10 for 1%
        sellFee.liquidityFee = 20; sellFee.treasuryFee = 130; sellFee.marketingFee = 150;
        ...
        maxBuyPercentage = 50; maxBuyAmount = _totalSupply /1000 * maxBuyPercentage;
        maxSellPercentage = 50; maxSellAmount = _totalSupply /1000 * maxSellPercentage;
        maxWalletPercentage = 50; maxWalletAmount = _totalSupply /1000 * maxWalletPercentage;
