...
contract ReturnToSpace is Context, IERC20, ERC20Ownable {
    using SafeMath for uint256;

    string private constant _name = "Return To Space";
    string private constant _symbol = "RTS";
