...
contract FekaInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Feka Inu";
    string private constant _symbol = "FEKA";
    ...
    constructor () {
        _feeAddrWallet = payable(0x666d5652D08FE7488ea88C8A4c404C1913Fa5eBD);
