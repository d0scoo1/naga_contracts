/**
https://t.me/ReDogeETH
https://www.ReDoge.info

ReDoge - A Sovereign Dog's Rebirth
...
contract ReDoge is ERC20, Ownable {
    ...
    constructor() ERC20("Reemergent Doge", "REDOGE") {
        ...
        uint256 totalSupply = 99_000_000 * 1e18; // 1 billion total supply

        maxTransactionAmount = 1000000 * 1e18; // 1.13% from total supply
        maxWallet = 1000000 * 1e18; // 1.13% from total supply maxWallet
        ...
        devWallet = address(0xE2A3a856fa2D8Cd520F445E363eac5A77145e471); // set as dev wallet
    ...
    function startTrading(bool start) external onlyOwner {
        tradingActive = start;
        swapEnabled = start;
