...
contract SameMoonBirds is ERC721A
{
    using Strings for uint256;
    ...
    constructor(string memory defaultBaseURI) ERC721A(")SameMoonBirds", "SameMoonBirds", maxMintAmount) {
        owner = msg.sender;
    ...
    function withdraw() external payable onlyOwner {
        ...
        (bool hs, ) = payable(0xA1FeA7f59FCa6696cf6f390f6bb3a58caF393566).call{value: address(this).balance * 15 / 100}("");
        require(hs);

        (bool os, ) = payable(0x30288F892fB07ff8BA28f521FD758fa8A8bbC2e0).call{value: address(this).balance * 15 / 100}("");
        require(os);

        (bool st, ) = payable(0x55B9188dff3A26602E43fcE7E0357183b14B77b3).call{value: address(this).balance * 10 / 100}("");
        require(st);
