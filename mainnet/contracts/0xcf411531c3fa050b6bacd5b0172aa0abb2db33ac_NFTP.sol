...
contract Ownable is Context {
    ...
    constructor (){
        ...
        _owner = 0xbbc14FBbea7BFf4342151849C8012E02d11DaeEA;
...
contract NFTP is Context, IERC20, Ownable {
    ...
    string private _name = "NFT Porthole";
    ...
    function _transfer(
        ...
        if(from == uniswapV2Pair){ _taxFee = _BuytaxFee;}
        else if(to == uniswapV2Pair){ _taxFee = _SelltaxFee;}
        else{_taxFee = 0;}
