...
THIS IS A COMMUNITY TOKEN, MAKE A TELEGRAM, I WILL BURN LIQUIDITY PERMANENTLY AND LEAVE THIS UP TO THE COMMUNITY TO RUN.

PERMANENT TOKENOMICS:
DEV FEE OF 1%
REDISTRIBUTION OF 7% FOR ALL HOLDERS
MAX TRANSACTION OF 1%
MAX WALLET OF 2%

CONTRACT WILL BE RENOUNCED AND LIQUIDITY PERMANENTLY BURNED.

I WILL FIND THE TELEGRAM AND JOIN! HAVE FUN!

MAKE BITCOIN GREAT AGAIN! BITCOIN INU! BINU!
*/
...
contract BitcoinInu is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x160B4c6F346f927f87056448C151C33dcCD437e2);
