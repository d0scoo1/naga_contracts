/**
    ...
    Watch: https://v.cameo.com/e/RrJFcW2fMlb
...
contract HardRockCapitalDAO is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Hard Rock Capital DAO";
    string private constant _symbol = "HRCD";
    ...
    address payable public marketingWallet = payable(0x3240A07632939bE0762858e60E6C84c75E24013e);
    address payable public treasury = payable(0x3240A07632939bE0762858e60E6C84c75E24013e);
    ...
    constructor (    ) Auth(0x52cfB57DBef54ac092E1Ea9f677cCf086A9c1372) {
        address _owner = 0x52cfB57DBef54ac092E1Ea9f677cCf086A9c1372;
