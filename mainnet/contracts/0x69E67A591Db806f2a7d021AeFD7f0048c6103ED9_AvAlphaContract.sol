...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmZpKK8TpZg3ouiViMH5k1yHFKojZDuELjKggRnkWCXF7E/";
...
// File: contracts/AvAlphaContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract AvAlphaContract is RamppERC721A {
    constructor() RamppERC721A("AV Alpha", "AVALPHA"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/TinXZo0MvQl6LR1EGvPq/contract-metadata";
    }
}
