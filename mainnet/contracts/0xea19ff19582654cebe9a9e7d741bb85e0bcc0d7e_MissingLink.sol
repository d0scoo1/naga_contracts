...
contract MissingLink is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Missing Link";//
    string private constant _symbol = "MLINK";//
    ...
    address payable private _developmentAddress = payable(0x5E3E34Eb82b7FD9Ed405694ccD6045597496F54C);//
