...
Locked & Renounced without any backdoors.
...
contract Game_Is_Over is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"Game Is Over"; ////
    string public constant symbol = unicode"OVER"; ////
