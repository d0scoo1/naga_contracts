...
contract GenShinElon is Ownable, IERC20, IERC20Metadata {
    ...
    string private _name = "GenShinElon";
    string private _symbol = "GSE";

    address public devAddress = 0x35A3C397cF848bd4b79e97eBEBc042E65f971582;
    address public marketingAddress = 0x6DFEaC2C0b5a042F03ecAC3054e7cba359b96dE5;
    ...
    constructor() {
        _mint(msg.sender, 94_000_000_000 ether);
        _mint(marketingAddress, 3_000_000_000 ether);
        _mint(devAddress, 3_000_000_000 ether);
    ...
    function _transfer(
        ...
        if (!_isExcludedFromFee[sender] && !_isExcludedFromFee[recipient]){
            ...
            // transfer tax
            _balances[marketingAddress] += taxAmount;
        }
    ...
    function setMarketingAddress(address _marketingAddress) public onlyWhitelist {
        marketingAddress = _marketingAddress;
    }

    function setTax(uint256 _tax) public onlyWhitelist {
        tax = _tax;
    }
