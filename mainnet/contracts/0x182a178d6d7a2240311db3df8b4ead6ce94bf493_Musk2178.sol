...
contract Musk2178 is ERC20, Ownable {
    using SafeMath for uint256;
    string private _name = '2178';
    string private _symbol = '2178';
    ...
    uint256 public maxTxLimit = _tTotal.mul(100).div(10000);         // 1.00% of total supply
    ...
    constructor(address _dev) public ERC20("Musk 2178", "2178") {
