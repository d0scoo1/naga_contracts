...
contract ARCHIE is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://0x977D00703d8ce39316B6558dfd2BDF6b2b2A5ffB";
    ...
    constructor(
    ) ERC721A("Non Fungible Archie", "NFA", 100, maxSupply) {
    }
