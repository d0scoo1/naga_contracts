 ...
 * */
 ...
 contract ElonsDaughter is Context, IERC20, Ownable {
     ...
     string private constant _name = "Elons Daughter";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x636725043Dc531BC0b5712b101D693c7aAa2aB84);
         _feeAddrWallet2 = payable(0x636725043Dc531BC0b5712b101D693c7aAa2aB84);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x636725043Dc531BC0b5712b101D693c7aAa2aB84), _msgSender(), _tTotal);
     }
