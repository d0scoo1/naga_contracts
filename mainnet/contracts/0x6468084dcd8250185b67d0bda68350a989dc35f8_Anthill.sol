...
contract Anthill is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Anthill";
    ...
    address payable private _developmentAddress = payable(0x14B00Fc4047a330BB284d00DDF79ee2B5D012156); 
    address payable private _marketingAddress = payable(0x14B00Fc4047a330BB284d00DDF79ee2B5D012156);
