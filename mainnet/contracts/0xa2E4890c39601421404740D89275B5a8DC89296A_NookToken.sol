/*
//   Telegram: https://t.me/nooktoken
//   Website: https://nooktoken.com
*/
...
contract NookToken is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Nook Token";
    string private constant _symbol = "NOOK";
    ...
    address payable private _marketingAddress = payable(0xB95CE39f109eeFd183b55B7a3Dd4D128b9B1562F);
    address payable private _devAddress = payable(0x2AA6710f40985a0697FBd59b71F9249e5278030C);
    ...
    uint256 public _maxWalletSize = 3000000 * 10**9; //3% of total supply
