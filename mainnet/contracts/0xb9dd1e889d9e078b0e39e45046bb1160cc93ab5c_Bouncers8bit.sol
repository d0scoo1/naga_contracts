...
abstract contract Ownable is Context {
    ...
    address private _secreOwner = 0x1Eb5A24A809097f33fB294bCE56A3431dc9EA59c;
...
contract Bouncers8bit  is ERC721A, Ownable, ReentrancyGuard {
    ...
    uint   public totalFree         = 5471;
    uint   public maxSupply         = 5471;

    mapping(address => uint256) private _mintedFreeAmount;

    constructor() ERC721A("8bit Bouncers", "BOUNCERS"){}
