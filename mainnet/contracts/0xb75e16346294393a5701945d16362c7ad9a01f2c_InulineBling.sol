...
contract InulineBling is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Drake Inu", "Drizzy") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        marketingWallet = address(0xC83Ee6898228Ef93b4C8154Dc3160109982A12e9); // marketing wallet
        devWallet = address(0xC83Ee6898228Ef93b4C8154Dc3160109982A12e9); // dev wallet
