// Jack Sparroge is a legendary pirate dog of the Seven Dog Breeds and the irreverent trickster of the Ethereum Chain.

// He fought a constant and losing battle with Jeets, Rugs and his own best tendencies.
...
contract JackSparroge is Context, IERC20, Ownable {
    ...
    string private constant _name = "JackSparroge";
    string private constant _symbol = "SPARROGE";
    ...
    address payable private _marketingAddress = payable(0xA7BAd0FcC06a64Afa812342e29f7A3D8b716ef88);
