/*
   ...
   #DOLPHINS PARADISE COMMUNITY TOKEN V. 1.04
   ...
   Dev make this #DOLPHINS to hand over to the community.
   ...
   Dev will renounce the ownership to burn addresses to transfer #DOLPHINS to the community, make sure it's 100% safe.

   Dev will add 3 ETH and all the left 95% total supply to the pool
   Can you make #DOLPHINS 1000X? 
   ...
   it's the best part of the #DOLPHINS idea, increasing the liquidity pool automatically, 
...
contract DOLPHINS is Context, IERC20 {
