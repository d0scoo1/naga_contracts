...
abstract contract WithLimitedSupply {
	...
	uint256 private immutable _maxAvailableSupply = 9099;

	function maxAvailableSupply() public pure returns (uint256) {
...
abstract contract RandomlyAssigned is WithLimitedSupply {
	...
	uint256 private immutable startFrom = 1;
...
// File: contracts/YourSphynxCat.sol
...
contract YourSphynxCat is ERC721, Ownable, RandomlyAssigned {
  using Strings for uint256;
  ...
  uint256 public cost = 10000000 gwei;

  uint256 public maxSupply = 9099;
  uint256 public maxMintAmountPerTx = 10;

  bool public paused = false;
  bool public revealed = false;
  bool public ogmint = true;

  uint256 private constant maxTeamCats = 99;

  address private immutable _teamAddress =
		0xD7c109808Ae28f6618D4596aFc91363521F4C070;

  constructor() ERC721("YourSphynxCat", "YSC") {
    setHiddenMetadataUri("ipfs://bafybeibhpbxwqlksdho4rcpsvrvhpcdlk2h2h3jogtc3hnqwzq6v6kuo3u/metadata/hidden.json");
  }
    ...
    onlyOwner
{
    ...
    function checkOG() public view isWhitelisted(msg.sender) returns(bool){
      return (true);
    }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if (ogmint == true) {
        require(checkOG() == true, "Only OGs can mint now!");
    }
    require(balanceOf(msg.sender)+_mintAmount <= 10, "Each wallet may only own 10 cats!");
  ...
  function setOG(bool _state) public onlyOwner {
    ogmint = _state;
  }

  function withdraw() public onlyOwner {
    // Share
    (bool hs, ) = payable(0xC3638e7e6a8cdbC31Ae7a2D2EaC50d55c16b137a).call{value: address(this).balance * 30 / 100}("");
    require(hs);
    // =============================================================================
