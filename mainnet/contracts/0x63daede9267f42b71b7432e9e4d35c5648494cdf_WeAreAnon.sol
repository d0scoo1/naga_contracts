...
Anonymous is a token on the Ethereum Blockchain.

Ownership will be renounced directly after launch.
...
Tax : 3% : will be used to invest on others DAO & Highest APY project, to burn and buyback ANONYMOUSDAO.

Public chat will be open at 50k MC.

Last project hit 360k from a start at 6k MC.
...
contract WeAreAnon is Context, IERC20, Ownable { ////
    ...
    string public constant name = unicode"WeAreAnonymous"; ////
    string public constant symbol = unicode"ANON"; ////
