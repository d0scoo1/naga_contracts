...
contract BRContract is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Rhino Prime Club Official", "BR") {
    setHiddenMetadataUri("ipfs://QmbEzthiYuJSpPhDrBDAV6Gzp3FBFdp3FV8NostPjTXiir/Hidden-file.json");
  }
