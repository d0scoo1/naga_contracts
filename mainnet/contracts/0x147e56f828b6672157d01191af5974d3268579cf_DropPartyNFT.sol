...
// File: contracts/DropPartyNFT.sol
...
/**
 * @title DropPartyNFT contract
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract DropPartyNFT is ERC721, PaymentSplitter, Ownable {
    using SafeMath for uint256;

    string public PARTY_PROVENANCE = "";
	...
	0x22Ecc87DC88DED9f4C27f00EA611B26cd17BD69F, // DP
    0xfFb9Bf3b2E9d38657E8B8282ADa012a2434561b8, // SYP
    0x4FD891c6726c6e4f9544F7463c1199B828f05B50 // MRKTING
    ];

    uint256[] private _team_shares = [15,55,30];
    ...
    constructor(string memory name, string memory symbol, uint256 maxNftSupply, uint256 saleStart) 
        ...
        REVEAL_TIMESTAMP = saleStart + (86400 * 12);
    }
    ...
    */
    function setProvenanceHash(string memory provenanceHash) public onlyOwner {
        PARTY_PROVENANCE = provenanceHash;
    }
