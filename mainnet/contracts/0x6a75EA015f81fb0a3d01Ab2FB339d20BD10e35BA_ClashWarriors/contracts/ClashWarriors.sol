...
contract ClashWarriors is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;


  string  public  baseTokenURI = "ipfs://QmTWDuiZJJPzg3mrbVzAxbu6WMCoVfgjCSL5jf8xgxdZkh";
  ...
  ) ERC721A("Clash Warriors", "ClashWarriors") {
