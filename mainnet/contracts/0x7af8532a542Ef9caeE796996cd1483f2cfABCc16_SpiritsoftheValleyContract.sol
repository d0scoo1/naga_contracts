...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xF96ff5572E6EafE8EE142BcE21B8a8b7773B57eF];
    ...
    
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://QmPFykyYaYvxLtmBBj9DzhkYxcPX4MAtCtk8ZH1e15ECuG/";
...
// File: contracts/SpiritsoftheValleyContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract SpiritsoftheValleyContract is RamppERC721A {
    constructor() RamppERC721A("Spirits of the Valley", "SOTV"){}
}
