...
contract ZEROISACOOLCONCEPT is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "ZEROISACOOLCONCEPT";                                           // name
    string private _symbol = "ZEROISACOOLCONCEPT";                                            // symbol
    ...
    address payable public marketingWallet = payable(0x644Edb2cEc6e5Ff1967f1aAb47F129107B802845);
