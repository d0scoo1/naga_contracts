...
contract NauticalNarwhals is Ownable, ERC721 {
    uint constant tokenPrice = 0.04 ether;
    uint constant maxSupply = 5757;
    
    uint public totalSupply = 0;
    
    uint public sale_startTime = 1636920000;
    uint public presale_startTime = 1636790460;
    uint public reveal_time = 1637524800;
    bool public pause_sale = false;

    string public baseURI;
    mapping(address => bool) private presaleList;
    constructor() ERC721("Nautical Narwhals", "NN"){}
   ...
   function buy_Presale(uint _count) public payable{
    ...
    function tokenURI(uint tokenId) public view virtual override returns (string memory) {
        ...
        if(block.timestamp < reveal_time ){
            return "https://gateway.pinata.cloud/ipfs/QmeetWKVJtjRnNpMVPqKYAwMJHvjTN9xxDKJ7LjLXEUebg";
        }
