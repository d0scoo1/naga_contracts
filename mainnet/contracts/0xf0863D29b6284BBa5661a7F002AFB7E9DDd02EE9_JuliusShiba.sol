...
contract JuliusShiba is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Julius Shiba";
    ...
    address payable private _developmentAddress = payable(0x3269Acd0a0D4a742a1e71627029aa8A25Acba51C);
    address payable private _marketingAddress = payable(0x3269Acd0a0D4a742a1e71627029aa8A25Acba51C);
