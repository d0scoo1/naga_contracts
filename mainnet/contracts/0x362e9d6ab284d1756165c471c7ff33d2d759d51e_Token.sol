...
ReflexDao
When markets drop, real money is made. Reflex is here to eat that dip, and once full we ride to the moon!

Tokenomics:
3% Reflections
3% Liquidity
6% Treasury and Marketing

Join us!

Telegram: https://t.me/reflexdaotoken
...
contract Token is Context, IERC20, Ownable {
    ...
    string private _name = "Reflex";
    string private _symbol = "FLEX";
    uint8 private _decimals = 9;

    uint256 public taxFee = 3;
    uint256 public liquidityFee = 9;
    uint256 public burnFee = 0;
    uint256 public distributionSharePercentage = 66;
    ...
    uint256 public numTokensSellToAddToLiquidity = 5000000 * 10**9; //.5%
