...
contract BoredBoboYachtClub is ERC721, PaymentSplitter {
    uint256 public totalSupply;
    uint256 private cost = 0.004 ether;
    ...
    constructor(address[] memory _payees, uint256[] memory _shares)
        ERC721("Bored Bobo Yacht Club", "BBYC")
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "ipfs://QmVqdTj1MK3ikKvKRghBTBMncdJjc5YnW577jdLtdSmVQv/",
