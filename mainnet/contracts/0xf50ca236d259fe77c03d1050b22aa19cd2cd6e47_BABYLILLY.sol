...
contract BABYLILLY is Context, IERC20, ERC20Ownable {
    ...
    string private constant _name = "BABY LILLY";
    string private constant _symbol = "BABY LILLY";
    ...
    bool private _liquidityLaunch = true;
    ...
    uint private _liqDiv = _marTax + _liqTax; //for taxes, see function _takeLiquidity(uint256 tLiquidity) for ref
    ...
    constructor() {
        ...
        marketingAddress = payable(0x45aE90EB95e6eA262159e166eC3dC20ee88E3E83);
