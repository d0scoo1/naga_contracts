...
contract ApeGeneNodePool is Context, Ownable {
    ...
    uint256 public rewardPerDay = 30500000000000000000000;
    ...
    address public teamWallet = 0xC65D11Cad3Ae5B48AA0A4AeA234890E066C4e8cB;

    uint256 public teamFee = 150;
    uint256 public burnFee = 50;
    uint256 public feeDenomiator = 1000;

    IERC20 public APEGENE = IERC20(0xfb8B033DC6B4d87B29F11Dc9e13CB08F2da25f13);
    ...
    function createNode(string memory nodeName, uint256 count) external {
        ...
        APEGENE.transferFrom(account, address(this), price);
        APEGENE.transfer(burnAddress, price*burnFee/feeDenomiator);
        APEGENE.transfer(teamWallet, price*teamFee/feeDenomiator);
    ...
    function claimNodeReward(uint256 _creationTime) external {
        ...
        APEGENE.transfer(account, rewardNode);
    }
    ...
    function claimAllNodesReward() external {
        ...
        APEGENE.transfer(account, rewardsTotal);
    }
    ...
    function withdrawReward(uint256 amount) external onlyOwner {
        APEGENE.transfer(msg.sender, amount);
    }
