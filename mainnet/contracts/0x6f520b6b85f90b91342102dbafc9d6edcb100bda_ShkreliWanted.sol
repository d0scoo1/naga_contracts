//** 
// "Martin Shkreli was always the posted boy for corporate greed.
// And now we have the actual poster."
// https://t.me/shkreliwanted
...
contract ShkreliWanted is Context, IERC20, Ownable {
  using SafeMath for uint256;
  using Address for address;

  address payable public treasuryWallet =
    payable(0x5099966eFFD31fdE35cc3560Dd1F7065C3C9B4Ca);
  ...
  string private constant _name = 'Shkreli Wanted';
  string private constant _symbol = 'SHKRELIW';
  ...
  address public buybackTokenAddress = 0x9bD35A17C9C7c8820f89e0277e2046CDC57aCB15;
