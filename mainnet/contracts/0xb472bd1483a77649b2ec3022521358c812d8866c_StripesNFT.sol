...
contract ERC721CappedSale is ERC721Enumerable, Ownable, ReentrancyGuard {
    ...
    bool public _isSalePaused = false;
...
contract StripesNFT is ERC721CappedSale {
    using Strings for uint256;

    string private constant INIT__NFT_NAME = 'Stripes';
    string private constant INIT__NFT_SYMBOL = 'STRIPES';
    string private constant INIT__UNREVEAL_URI = 'ipfs://QmdYGH5ixaNmEZb8y4izG1ew7xx6aTKCNSsvA283QoTRHm';
    uint256 private constant INIT__CAP = 10000;
    uint256 private constant INIT__MAX_BUY_AMOUNT = 20;
    uint256 private constant INIT__PRICE_PER_TOKEN = 4*(10**16);
    ...
    string private _tokenBaseURI = 'ipfs://Qmd3wdigtEMrQLUcCQbnQtb5EPHmWHUbWBA58Qru4TQ5Q8/';
