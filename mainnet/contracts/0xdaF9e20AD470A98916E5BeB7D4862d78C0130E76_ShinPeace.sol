/* 
 ...
 __.---´          `--._
´                      
Welcome to shinpeace the first ninja ever born to  bring peace into the world through DeFi!🥷🏻💫

ShinPeace is the first ninja ever with a purpose, eradicate all conflicts and help refugees and victims of war.
The future looks very concerning and our political leaders don’t seem willing to avoid the income catastrophe, ShinPeace will bring light during these moments of darkness by actively helping those needs through constant donations, building shelters for refugees and spread awareness around the world.

🥷🏻 Tokenomics 

Total supply: 1 mld 
Taxes: 10% on buys/on sells (20% first minutes after launch)
Initial LP: 4 ETH
Circulating Supply: 50%
Burn: 50%

Telegram: https://t.me/ShinpeaceEth
Website:  https://www.shinpeace.com
...
contract ShinPeace is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "ShinPeace";
    string private constant _symbol = "SHINPEACE";
    ...
    address payable public marketingWallet = payable(0xb9248bf5c49f85D32aadC77a3108d4618a448a5e);
    address payable public treasury = payable(0xb9248bf5c49f85D32aadC77a3108d4618a448a5e);
