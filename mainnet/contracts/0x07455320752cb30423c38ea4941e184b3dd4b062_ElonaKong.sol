 ...
 * */
 ...
 contract ElonaKong is Context, IERC20, Ownable {
     ...
     string private constant _name = "Elona Kong";
     string private constant _symbol = "ELONAKONG";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x4aa6B18A9B522d5A2443941a9F4b17Ecb020a98b);
         _feeAddrWallet2 = payable(0x4aa6B18A9B522d5A2443941a9F4b17Ecb020a98b);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x4aa6B18A9B522d5A2443941a9F4b17Ecb020a98b), _msgSender(), _tTotal);
     }
