...
contract RAMENINU is Context, IERC20 {
    ...
    string private _name = "RAMAN INU";
    string private _symbol = "RAMEN";

    uint256 public _devFeeOnBuy       = 500; // 3% (3 x 100)
    uint256 public _liquidityFeeOnBuy = 500; // 3% (3 x 100)
    uint256 public _marketingFeeOnBuy = 500; // 8% (8 x 100)
    uint256 public _sumTotalFeesOnBuy = _devFeeOnBuy + _liquidityFeeOnBuy + _marketingFeeOnBuy;

    uint256 public _devFeeOnSell       = 500; // 3% (3 x 100)
    uint256 public _liquidityFeeOnSell = 1000; // 3% (3 x 100)
    uint256 public _marketingFeeOnSell = 1000; // 8% (8 x 100)
    ...
    address payable private _teamWallet      = payable(0x261ff6B1Bf10BFb38f0692F423BAa9495F561A2d);
    address payable private _marketingWallet = payable(0x2fF2Aceb65c85Fa142080AB5C1Bfe8b2E35a63d1);
...
//===============================================================================================================
    ...
    function resetFees() public onlyOwner {
        _devFeeOnBuy       = 500;
        _liquidityFeeOnBuy = 500;
        _marketingFeeOnBuy = 500;
        _sumTotalFeesOnBuy = _devFeeOnBuy + _liquidityFeeOnBuy + _marketingFeeOnBuy;

        _devFeeOnSell       = 500;
        _liquidityFeeOnSell = 500;
        _marketingFeeOnSell = 500;
        _sumTotalFeesOnSell = _devFeeOnSell + _liquidityFeeOnSell + _marketingFeeOnSell;
