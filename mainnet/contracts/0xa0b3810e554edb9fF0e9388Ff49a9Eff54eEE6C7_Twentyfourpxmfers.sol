// _______  _   ___  _______  __   __    __   __  _______  _______  ______    __   _______ 
//|       || | |   ||       ||  |_|  |  |  |_|  ||       ||       ||    _ |  |  | |       |
//|____   || |_|   ||    _  ||       |  |       ||    ___||    ___||   | ||  |__| |  _____|
// ____|  ||       ||   |_| ||       |  |       ||   |___ |   |___ |   |_||_      | |_____ 
//| ______||___    ||    ___| |     |   |       ||    ___||    ___||    __  |     |_____  |
//| |_____     |   ||   |    |   _   |  | ||_|| ||   |    |   |___ |   |  | |      _____| |
//|_______|    |___||___|    |__| |__|  |_|   |_||___|    |_______||___|  |_|     |_______|
//                                      
// https://24pxmfers.com/
// 24px mfer's Smart Contract                                                              
