/**
 * Telegram https://t.me/ShibAssassin
 * Website https://shibassassin.com/
 * Twitter https://twitter.com/ShibAssassin
...
contract ShibAssassin is Context, IERC20, Ownable {
    ...
    string private constant _name = "ShibAssassin";
    string private constant _symbol = "ShibAss";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x0171abac6a1a3f8913dc93f83c16FdD6B3Ba2A60);
        _feeAddrWallet2 = payable(0x0171abac6a1a3f8913dc93f83c16FdD6B3Ba2A60);
