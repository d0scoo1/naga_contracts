...
contract EGGPLANT is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "EGGPLANT";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x6e313c5ef612312E4705686a6ee7E5D61d80f5e2);
        _feeAddrWallet2 = payable(0x6e313c5ef612312E4705686a6ee7E5D61d80f5e2);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x9804aEef626d1a8E0d5AB141A029e10c874a85e7), _msgSender(), _tTotal);
    }
