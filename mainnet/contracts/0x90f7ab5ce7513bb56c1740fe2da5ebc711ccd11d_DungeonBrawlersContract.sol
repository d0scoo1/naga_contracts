...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmbxWRUFjUzG6MPotT8qwkgULTFjzJj7YLx8KGMe4WtjxN/";
...
// File: contracts/DungeonBrawlersContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DungeonBrawlersContract is RamppERC721A {
    constructor() RamppERC721A("Dungeon Brawlers", "BRWLERS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/FGTHq51jvojC1Re70gY3/contract-metadata";
    }
}