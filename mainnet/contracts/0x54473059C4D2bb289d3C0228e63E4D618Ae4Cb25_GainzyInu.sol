...
We are here to ensure that Gainzy can continue his fat unhealthy eating habits even though he is a rubbish trader that consistently loses. 

Also, we know you are rich in SHEKELS but that water you order through UberEats is going to eat your funds dry.

Either way, Gainzy, we got you covered bruh.

Liquidity will be BURNED and a vote will be taken on the 5% of supply we hold on whether we BURN or send it to the king of CT.

Telegram: https://t.me/GainzyInu
Twitter: https://twitter.com/GainzyInu
...
contract GainzyInu is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Gainzy Inu";//
    string private constant _symbol = "GZI";//
    ...
    address payable private _marketingAddress = payable(0xc85f60bdd1b98a8CEbb75cB41d07a9A60665f339);//
