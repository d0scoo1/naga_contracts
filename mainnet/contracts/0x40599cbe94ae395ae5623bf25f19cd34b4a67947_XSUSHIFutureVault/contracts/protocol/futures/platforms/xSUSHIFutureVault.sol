...
/**
 * @title Contract for xSUSHI Future
 * @notice Handles the future mechanisms for xTokens
 */
contract XSUSHIFutureVault is HybridFutureVault {
    using SafeMathUpgradeable for uint256;

    address public constant STAKED_TOKEN = 0x6B3595068778DD592e39A122f4f5a5cF09C90fE2;
