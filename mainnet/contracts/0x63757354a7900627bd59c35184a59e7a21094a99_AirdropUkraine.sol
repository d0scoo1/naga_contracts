...
// File: contracts/AirdropUkraine.sol
...
contract AirdropUkraine is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant maxSupply = 5000;
    uint256 public constant freeMints = 700;
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Airdrop Ukraine", "AIRDROP") {
        setBaseURI(baseURI);
        isSaleActive = false;
