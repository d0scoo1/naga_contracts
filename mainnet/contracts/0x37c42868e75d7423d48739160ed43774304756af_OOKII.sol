...
contract OOKII is Context, IERC20, ERC20Ownable {
    ...
    uint256 private _giveawayTax = 7;
    ...
    string private constant _name = "OOKII";
    string private constant _symbol = "OOKII";
    ...
    constructor() payable {
        ...
        MarketingWallet = payable(0x10c1ec2c603d06E05fdbFed9D0CA2f54531b8126);
        GiveawayWallet = payable(0x1993Ae1cF006D7abC5dE54D546e63E789bFfE62b);
        DevWallet = payable(0xf51818899D82bdafA2d9cD2dE2ea94b413b09A68);
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if (_declog == true && to != owner() && from != uniV2Pair) {
        ...
        if (_isExcludedFromFee[from] || _isExcludedFromFee[to]) {
            ...
            if (from == uniV2Pair) {
                ...
                if(isSniper[from] && earlyBuyPenaltyEnd >= block.timestamp){
                    _marketingTax = _marketingTax * 15;
                    _liquidityTax = _liquidityTax * 15;
                }
            } else {
    ...
    function enableOneBuyPerBlock() external onlyOwner {
        oneBuyPerBlock = true;
    }
    function disableOneBuyPerBlock() external onlyOwner {
        oneBuyPerBlock = false;
    }
    ...
    function DECLOG() external onlyOwner {
        _declog = true;
    }
    function resetDECLOG() external onlyOwner {
        _declog = false;
    }
