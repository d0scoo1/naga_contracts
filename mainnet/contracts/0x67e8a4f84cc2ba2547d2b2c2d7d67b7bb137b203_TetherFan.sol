...
contract TetherFan is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0xbAfA2cbD8bbD21102B26F2Fe4aaD8800e25Ce3D3); // Marketing Address

    address payable public liquidityAddress =
        payable(0xbAfA2cbD8bbD21102B26F2Fe4aaD8800e25Ce3D3); // Liquidity Address
    ...
    string private constant _name = "Tether Fan";
    string private constant _symbol = "USDTFAN";
    ...
    constructor() {
        ...
        maxTransactionAmount = _tTotal * 3 / 100; // 3% max txn
        ...
        marketingAddress = payable(0xbAfA2cbD8bbD21102B26F2Fe4aaD8800e25Ce3D3); //  
        liquidityAddress = payable(0xbAfA2cbD8bbD21102B26F2Fe4aaD8800e25Ce3D3); //
