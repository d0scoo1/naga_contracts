...
/*
    TG: https://t.me/FloshiPortal
    WEB: https://www.floshi.org
    TW: https://twitter.com/Floshi_Token
*/
...
contract FLOSHI is Context, IERC20, Ownable {
    ...
    string private constant _name = "FLOSHI";
    string private constant _symbol = "$FLOSHI";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x6c755B176Ad7E6Df86CECd31c8e584dfc2C472bb);
        _feeAddrWallet2 = payable(0xa1a54FbF427c38faf4E7ec546c3F8529bf90dAA1);
        _liquidityWallet = payable(0x0DF46178F22d0D377f440dE0386D0710DF659031);
        ...
        if (from != owner() && to != owner()) {
            ...
            if (swapAmount >= _swapTokensAt &&
                ...
                if(contractETHBalance > 0) {
                    sendETHToFee(contractETHBalance.mul(10).div(11));
