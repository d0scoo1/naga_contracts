...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x876ab49eB667B52F36E13AaBB1e85eF2Cc5574F4;
...
contract ESHOP is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "ESHOP Token";
    string private _symbol = "ESHOP";
    ...
    uint256 internal _tokenTotal = 50_000_000_000e9;
    ...
    uint256 public _burnFee = 3; // means 3% it menas on burn 
    
    uint256 public growthFee = 200; //200 means 2% will send to charity
    
    
    address growthAddress = 0x2B27F0726f40601593E521853389f26576F59106; //
    ...
    uint256 roundValue = value.ceil(growthFee);
    uint256 onePercent = roundValue.mul(growthFee).div(10000);
    return onePercent;
  }
    ...
    function _transfer(
        ...
        if(isFeeActive && !isTaxless[_msgSender()] && !isTaxless[recipient] && !inSwapAndLiquify){
            ...
            _reflectionBalance[growthAddress] = _reflectionBalance[growthAddress].add(tokensToBurn.mul(rate));
        
            emit Transfer(sender, growthAddress, tokensToBurn);
        }
    ...
    function setGrowthFee(uint256 amount) external onlyOwner {
        growthFee = amount;
    }
