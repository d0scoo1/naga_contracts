...
This token is made to commemorate all the great memories we shared during bull season. 

Buy fee: 3%
Sell fee: 3%

Locked initially for 1 month.

We will join any community Telegrams made and reward some stories people have of the past bull run.
...
contract Memories is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Memories of the Bull", "Memories") {
