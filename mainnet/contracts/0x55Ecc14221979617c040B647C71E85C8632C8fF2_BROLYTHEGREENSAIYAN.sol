...
contract BROLYTHEGREENSAIYAN is Context, IERC20, Ownable {
    ...
    string private _name = "BROLY THE GREEN SAIYAN";
    string private _symbol = "$BROLY";
    ...
    address payable public marketingaddress = payable(0x12030f605Ba064f98f1bEC602b15F838aff0467f);
