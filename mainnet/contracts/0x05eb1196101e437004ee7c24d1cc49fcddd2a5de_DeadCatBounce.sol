...
contract DeadCatBounce is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'DeadCat Bounce';
    string  private constant _SYMBOL = 'DEDC';
    ...
    uint256 private _MAX_TX_SIZE = 30000 * _DECIMALFACTOR;
