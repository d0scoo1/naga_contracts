...
contract ProbablyPumping is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('Probably Pumping','PP') {
        _mint(0xD4fdd874b1C7b8911e96806175ed15d6dB92297e, 1000000 *10**18);
