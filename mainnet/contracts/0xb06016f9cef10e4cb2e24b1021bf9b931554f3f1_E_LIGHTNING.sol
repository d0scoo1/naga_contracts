...
// File: contracts/E_LIGHTNING.sol


pragma solidity ^0.8.7;

/// @title The first company in the world has developed the blockchain electric
/// @author LINAEL.ETH
...
contract E_LIGHTNING is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public priceSale = 0.10 ether;
    ...
    address[] private _team = [
        0x5680Db41b34323caF237064ce77dbd77E0542Ffa
    ];
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("E-LIGHTNING", "E-LIGHTNING") PaymentSplitter(_team, _teamShares) {
