/*
Snipe the bottom together, then flip everyone on the way. Join us and win.
Website
https://www.jointheflip.net

Twitter
https://twitter.com/JointheFLIP

Telegram
https://t.me/FLIPPortal
...
contract FLIP is ERC20, Ownable {
    ...
    uint256 public maxTxLimit = _tTotal.mul(150).div(10000);         // 1.5% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(250).div(10000);    // 2.5% of total supply
    ...
    constructor(address _dev) public ERC20("FLIP", "🗘") {
