...
// File: contracts/CultureFactor.sol
...
*/
  ...
  function withdraw() external onlyOwner {
        ...
        uint256 balance = address(this).balance;
        require(balance > 0);
        payable(cf).transfer((balance * 900) / 1000);
        payable(dreamyartist).transfer((balance * 50) / 1000);
        payable(dreamydev).transfer((balance * 50) / 1000);
    }
