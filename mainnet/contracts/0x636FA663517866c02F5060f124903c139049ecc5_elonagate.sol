...
📌 $ELONAGATE provides their holders passive income & huge profit!

📌 2% of each transaction goes automatically to $ELONAGATE holders!
 ...
 * */
 ...
 contract elonagate is Context, IERC20, Ownable {
     ...
     string private constant _name = "ELONA GATE TOKEN";
     string private constant _symbol = "ELONAGATE";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0x8aA89464F3EE612abFD024901AfaC405A6374E64);
         _feeAddrWallet2 = payable(0x8aA89464F3EE612abFD024901AfaC405A6374E64);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0x8aA89464F3EE612abFD024901AfaC405A6374E64   ), _msgSender(), _tTotal);
     }
