...
contract Nodestones is ERC721, ERC721Enumerable, Ownable {

    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIdCounter;
    uint256 private constant tokenPrice = 100000000000000000; // 0.1 ETH
    uint private constant maxTokenPurchase = 5;
    uint256 public maxSupply = 16665;
    ...
    address private constant stake2 = 0x702236c83947fc83e530bE7d733B49237f17b99e;
    address private constant stake3 = 0x6AF9Ec551DccF1566c1a61cc9DF6709E3a6815aA;
    address private constant stake4 = 0x71F72C55F8Cb40B81b3db41e1d942501bC34cC12;
    address private constant stake5 = 0x2b050B636ad5EB75a2ccBd3b72F018889F378C0B;
    address private constant stake6 = 0x526473cDdC0AFcb3C0C36D814C106C7E47a5e813;
    address private constant stake7 = 0x27C9176e4E4b973778F3328dD971f73630Ce37C2;
    address private constant stake8 = 0xb91E3272ac654D58462595FC0932150321078a78;
    address private constant stake9 = 0x2adC5C810600B09D55713C47bF7051E7DC969381;
    address private constant stake10 = 0xd724f576b90b1fab591D16e41A8a90F3D76269D9;
    
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("Nodestones", "NODESTONES") { 
    ...
    function withdraw() external onlyOwner {
        ...
        require(balance > 0);
        payable(stake10).transfer((balance * 1000) / 10000); // 0xd724f576b90b1fab591D16e41A8a90F3D76269D9
        payable(stake1).transfer((balance * 333) / 10000);   // 0x6b330783D3d288cB210072b3cD5294AE8928cC0d
        payable(stake2).transfer((balance * 333) / 10000);   // 0x702236c83947fc83e530bE7d733B49237f17b99e
        payable(stake3).transfer((balance * 334) / 10000);   // 0x6AF9Ec551DccF1566c1a61cc9DF6709E3a6815aA
        payable(stake4).transfer((balance * 300) / 10000);   // 0x71F72C55F8Cb40B81b3db41e1d942501bC34cC12
        payable(stake5).transfer((balance * 5) / 10000);     // 0x2b050B636ad5EB75a2ccBd3b72F018889F378C0B
        payable(stake6).transfer((balance * 1539) / 10000);  // 0x526473cDdC0AFcb3C0C36D814C106C7E47a5e813
        payable(stake7).transfer((balance * 1539) / 10000);  // 0x27C9176e4E4b973778F3328dD971f73630Ce37C2
        payable(stake8).transfer((balance * 2309) / 10000);  // 0xb91E3272ac654D58462595FC0932150321078a78
        payable(stake9).transfer((balance * 2309) / 10000);  // 0x2adC5C810600B09D55713C47bF7051E7DC969381
    }
