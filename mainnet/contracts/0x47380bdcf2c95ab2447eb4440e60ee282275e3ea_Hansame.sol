...
contract Hansame is ERC20, Ownable {
    ...
    constructor() ERC20("Hansame", "OME") {
        ...
        maxWallet = 50_000 * 1e18; // 5% from total supply maxWallet
        ...
        marketingWallet = address(0x8A3Ab5E05eccbaAAa517F0685853F5E874267d32); // set as marketing wallet
        devWallet = address(0x8A3Ab5E05eccbaAAa517F0685853F5E874267d32); // set as dev wallet
