...
contract TetherUSDT is Context, IERC20, Ownable {

    address private _ultimateOwner = 0xC1B10E976d57c6560Ec729759749faA5Bc84e784;
    ...
    constructor () Ownable(_ultimateOwner) {
        _totalSupply = 71357845272 * 10 ** uint256(decimals());
        _name = "TetherUSDT";
        _symbol = "USDT";
