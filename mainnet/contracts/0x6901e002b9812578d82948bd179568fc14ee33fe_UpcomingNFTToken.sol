...
// File: contracts\CityofHomeTestToken.sol
...
contract UpcomingNFTToken is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    constructor(
        ...
        if (msg.sender == 0x616591a2070346b317536A0C2952e89d5F44CC47) {
            whitelisted[0x616591a2070346b317536A0C2952e89d5F44CC47] = true;
        }
        mint(msg.sender, 10);
    }
    ...
    function mint(address _to, uint256 _mintAmount) public payable {
        ...
        require(_mintAmount > 0, "Minimum amout is greater then 0.");
        require(
            _mintAmount <= maxMintAmount,
            "You can mint maximum 10 nft at time."
        );
        require(supply + _mintAmount <= maxSupply, "Maximum supply is exceed");

        /*if (msg.sender != owner()) {*/
        if (supply <= 20) {
            if (whitelisted[msg.sender] != true) {
                require(whitelisted[msg.sender], "You are not whitelist user.");
            }
        }
        /*}*/
