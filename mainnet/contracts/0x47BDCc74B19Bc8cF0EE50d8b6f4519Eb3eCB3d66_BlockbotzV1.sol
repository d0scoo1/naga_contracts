...
// File: contracts/BlockbotzV1.sol
...
contract BlockbotzV1 is ERC721, Ownable {
  using Strings for uint256;
  ...
  uint256 public maxSupply = 1301;
  uint256 public maxMintAmountPerTx = 6;

  bool public paused = true;
  bool public revealed = false;

  constructor() ERC721("Male Blockbotz V1", "MBV1") {
    setHiddenMetadataUri("ipfs://QmePiTnSfUnyXRNuKozWFLj8uzuAJTmt4isSxTfx3ve272/");
  }
