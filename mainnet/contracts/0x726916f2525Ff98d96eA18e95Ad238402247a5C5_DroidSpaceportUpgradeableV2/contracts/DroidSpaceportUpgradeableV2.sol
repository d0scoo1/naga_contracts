...
contract DroidSpaceportUpgradeableV2 is OwnableUpgradeable, UUPSUpgradeable {
  ...
  function increaseOwners() external onlyOwner {
    require(_owners.length == 5500, "Owners already increased");

    address[] memory _newOwners = new address[](7500);
    _newOwners = _owners;
    _owners = _newOwners;
  }
}
