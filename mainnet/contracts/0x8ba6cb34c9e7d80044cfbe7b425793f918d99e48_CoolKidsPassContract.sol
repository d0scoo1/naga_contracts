...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x1074Fc12df87638F5B7AA31D2Cf0Af872A239D91];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 777 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmZH5qMMsfEyoUcxk3tFDCuB9U7tT3BN4qRYjMS2GUnpsH/";
...
// File: contracts/CoolKidsPassContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract CoolKidsPassContract is RamppERC721A {
    constructor() RamppERC721A("Cool Kids Pass", "CKP"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/QVDrY6O68vcXncreCG5c/contract-metadata";
    }
}
