...
contract BUZABA is Context, IERC20, Ownable {
    ...
    string private _name = "Buzaba";
    string private _symbol = "BUZA";
    ...
    uint256 public totalTax = _taxFee.add(_liquidityFee);
    ...
    constructor(address payable daoWalletAddress) {
    ...
    function setTaxFeePercent(uint256 taxFee) external onlyOwner {
        totalTax = taxFee.add(_liquidityFee);
        require(totalTax <= 10, "Tax limit exceeding");
        _taxFee = taxFee;
        
    }

    function setLiquidityFeePercent(uint256 liquidityFee) external onlyOwner {
        totalTax = _taxFee.add(liquidityFee);
        require(totalTax <= 10, "Tax limit exceeding");
    ...
    function _transfer(
        ...
        require(totalTax <= 10, "Tax amount exceeding");
