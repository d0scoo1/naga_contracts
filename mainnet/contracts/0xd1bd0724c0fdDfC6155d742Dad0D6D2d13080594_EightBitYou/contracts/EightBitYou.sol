...
contract EightBitYou is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmPwYg7xGBZ3XFSFL5KAvsog5X2pBH4FCV3jCAhQVCTzLn";
  ...
  ) ERC721A("EightBit You", "EightBit You") {
