/**
Missed InnitForTheTech? That's because we're actually Innit For The Money!!

Community Degen Token, Low Taxes
...
contract InnitForTheMONEY is Context, IERC20, Ownable {
	...
	string private constant _name = "InnitForTheMONEY";
	string private constant _symbol = "$INNIT$";
