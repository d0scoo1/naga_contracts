...
// File: contracts/LiterallyABirdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract LiterallyABirdContract is RamppERC721A {
    constructor() RamppERC721A("Literally A Bird", "birdkek"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/vOgcGVvtIZvED5HhtTEl/contract-metadata";
    }
}
