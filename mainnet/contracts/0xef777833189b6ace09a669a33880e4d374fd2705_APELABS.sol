...
contract APELABS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "APELABS";
    string private constant _symbol = "APELABS";
    ...
    address payable private _marketingAddress = payable(0x842dA6bEd034bf5F8437C83c112a3b59e66caAcb);
    address payable private _devAddress = payable(0x842dA6bEd034bf5F8437C83c112a3b59e66caAcb);
    ...
    uint256 public _maxTxAmount = 181000000000000 * 10**9; //1.8% of total supply per txn 
    uint256 public _maxWalletSize = 200000000000000 * 10**9; //2% of total supply
