...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0xA90A421b1e9842eCf22a25402bF1E2754253D7e4] = _marketingwallet;
    }
...
contract TOKEN is ERC20, Ownable {
    ...
    constructor() ERC20("Doge Classic", "DogeC") {
        ...
        excludeFromFees(address(0xA90A421b1e9842eCf22a25402bF1E2754253D7e4), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xA90A421b1e9842eCf22a25402bF1E2754253D7e4), true);
