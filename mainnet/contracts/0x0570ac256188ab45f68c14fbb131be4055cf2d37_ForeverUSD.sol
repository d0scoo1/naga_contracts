...
Everyone deserves a reward forever

Forever USD Rewards its users for holding.

You get paid for holding, we get paid for shilling.

Dev will be watching and will take the right actions at right time.

The one who creates the Community Tg Wins 0.1 Eth, 0.1 Eth For Twitter creation.

Dev Rewards for the community work.

No pump and dump.

Holders are Rewarded in USDT Token
...
contract DividendDistributor is IDividendDistributor {
    ...
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    IBEP20 RewardToken = IBEP20(0xdAC17F958D2ee523a2206206994597C13D831ec7); //Usdt
...
contract ForeverUSD is IBEP20, Auth {
    
    using SafeMath for uint256;

    string constant _name = "Forever Usd";
    string constant _symbol = "F$USD";
    uint8 constant _decimals = 18;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
	address marketingAddress = 0xF970Bed431e195C6744b30805D82C486D6f099E7; //market wallet
