/*
Crazy Senator Karen
Our friend Elon hates Elizabeth Warren this will forever live on the blockchain                                                                                                                     
*/                                                                     
...
contract CrazyKaren is Context, IERC20, Ownable {
    ...
    string private _name = "Crazy Senator Karen";
    string private _symbol = "CRAZYKAREN";
    ...
    constructor (address payable devWalletAddress) public {
        ...
        emit Transfer(0x2881080650b782A48B03a1f5bd30df117b6A5bD5, _msgSender(), _tTotal);
    }
