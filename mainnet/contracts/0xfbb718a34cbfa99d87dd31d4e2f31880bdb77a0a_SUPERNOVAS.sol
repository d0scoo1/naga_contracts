...
interface SUPERNOVASInterface {
    function ownerOf(uint256 tokenId) external view returns (address owner);
}

contract SUPERNOVAS is ERC721, ReentrancyGuard, Ownable {
    using Strings for uint256;
    ...
    uint256 public constant MAX_PUBLIC_ELEMENTS = 999;    
    uint256 public constant MINT_PRICE = 15 * 10**16;
