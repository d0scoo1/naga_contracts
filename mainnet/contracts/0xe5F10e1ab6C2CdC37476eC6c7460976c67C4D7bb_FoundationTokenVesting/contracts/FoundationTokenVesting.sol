...
/**
 * @title FoundationTokenVesting
 * @dev Token vesting contract for adivisory
 */
contract FoundationTokenVesting is Ownable {
    ...
    string public _name = "Foundation Token Vesting (2 years)";
    ...
    uint256 private _duration = 730 days;
