...
// File: @openzeppelin/contracts@4.6.0/utils/math/Math.sol
...
// File: @openzeppelin/contracts@4.6.0/utils/Arrays.sol
...
// File: @openzeppelin/contracts@4.6.0/token/ERC20/extensions/ERC20Snapshot.sol
...
contract VirtualWorld is ERC20, ERC20Burnable, ERC20Snapshot, Ownable {
    constructor() ERC20("VirtualWorld", "VC") {
        _mint(msg.sender, 9008135 * 10 ** decimals());
    }
