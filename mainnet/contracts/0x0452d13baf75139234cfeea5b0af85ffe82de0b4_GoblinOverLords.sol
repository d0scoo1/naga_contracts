...
/**
 * @title GoblinOverlords contract
...
contract GoblinOverLords is ERC721A, Ownable, ReentrancyGuard {

  string public        baseURI;
  uint public          price             = 0.00333 ether;
  ...
  constructor() ERC721A("GoblinOverlords", "GOL"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(totalSupply() + amt < maxSupply + 1,"No more Overlords...");
