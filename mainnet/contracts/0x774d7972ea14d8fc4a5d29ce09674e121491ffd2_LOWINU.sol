...
// TG LINK : https://t.me/LOWINU
pragma solidity ^0.7.5;

/**
 .----------------.  .----------------.  .----------------.  .----------------.  .-----------------. .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |
| |   _____      | || |     ____     | || | _____  _____ | || |     _____    | || | ____  _____  | || | _____  _____ | |
| |  |_   _|     | || |   .'    `.   | || ||_   _||_   _|| || |    |_   _|   | || ||_   \|_   _| | || ||_   _||_   _|| |
| |    | |       | || |  /  .--.  \  | || |  | | /\ | |  | || |      | |     | || |  |   \ | |   | || |  | |    | |  | |
| |    | |   _   | || |  | |    | |  | || |  | |/  \| |  | || |      | |     | || |  | |\ \| |   | || |  | '    ' |  | |
| |   _| |__/ |  | || |  \  `--'  /  | || |  |   /\   |  | || |     _| |_    | || | _| |_\   |_  | || |   \ `--' /   | |
| |  |________|  | || |   `.____.'   | || |  |__/  \__|  | || |    |_____|   | || ||_____|\____| | || |    `.__.'    | |
| |              | || |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
 */
...
contract LOWINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Low Tax Inu", "LOWINU") {
        ...
        marketingWallet = payable(0xAAc447E48E38b7dB2C20402E0d1B4A59EbF0054D);
        devWallet = payable(0x507C7b99927d85C11EC43A914F9cc6659cba9369);
