...
/*
Para nosotros, no hay primavera. Solo el viento que huele fresco antes de la tormenta
*/
...
contract ConaneLBarbaro is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Conan el Barbaro", "Conan") {
     ...
     uint256 totalSupply = 1 * 10 ** 6 * 10 ** decimals();
        ...
        maxTransactionAmount = 12 * 10 ** 3 * 10 ** decimals(); // 1.2% maxTransactionAmountTxn
        maxWallet = 24 * 10 ** 3 * 10 ** decimals(); // 2.4% maxWallet
