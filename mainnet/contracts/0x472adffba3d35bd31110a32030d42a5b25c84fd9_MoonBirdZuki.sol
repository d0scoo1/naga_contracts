...
contract MoonBirdZuki is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;

    //Basic Configs
    uint256 public maxSupply = 4129;
    ...
    constructor(string memory _initBaseURI,string memory _initBaseExt) ERC721A("MoonBirdZuki", "MBZ") {
