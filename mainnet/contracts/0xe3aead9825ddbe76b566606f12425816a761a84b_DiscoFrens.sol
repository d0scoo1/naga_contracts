...
contract DiscoFrens is ERC721A, Ownable {
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Disco Frens", "DSCOFRNS") {
        setBaseURI(baseURI);
        isSaleActive = false;
