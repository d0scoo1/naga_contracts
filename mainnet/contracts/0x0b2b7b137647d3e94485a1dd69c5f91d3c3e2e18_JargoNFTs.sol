...
contract JargoNFTs is ERC721A, Ownable {

    uint256 constant public maxSupply = 2525;
    uint256 public freeSupply = 1515;
    uint256 public mintPrice = 0.0025 ether;
    uint256 constant public maxMint = 10;
    uint256 constant public MaxMintPerWallet = 20; 

    bool public isSaleLive = true;
    string public baseURI = "ipfs://QmbsXWsmDB8n8CPiPoKomJo2VNSDiD8wD12ut9QDEfgaH8/";
     mapping(address => uint) public addressClaimed;

    constructor() ERC721A("JargoNFTs", "J") {}
