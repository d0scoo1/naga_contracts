...
// File: SwitchHeads.sol
contract SwitchHeads is ERC721Tradable {
    constructor(address _proxyRegistryAddress)
        ERC721Tradable("SwitchHeads", "SWHD", _proxyRegistryAddress)
    {}

    function baseTokenURI() override public pure returns (string memory) {
        return "https://switchheads.appspot.com/api/switchheads-nft/";
    }

    function contractURI() public pure returns (string memory) {
        return "https://switchheads.appspot.com/api/switchheads-contract-metadata";
    }
