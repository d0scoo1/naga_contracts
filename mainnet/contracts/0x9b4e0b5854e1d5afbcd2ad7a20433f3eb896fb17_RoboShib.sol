...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external override view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a ROBO shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract RoboShib is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    address payable public marketingWallet = payable(0xB9f3A19458B45DE5620C54040abe784b2731C7Ee);
    address payable public treasury = payable(0xB9f3A19458B45DE5620C54040abe784b2731C7Ee);
    ...
    constructor (    ) Auth(0x584a036683Bf51AA8058F57E07f93BE0f04e3457) {
        address _owner = 0x584a036683Bf51AA8058F57E07f93BE0f04e3457;
