...
contract Grid is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cyborg Inu";//
    string private constant _symbol = "CYBORG";//
    ...
    address payable private _developmentAddress = payable(0xcE8Bd7747B1a557365A8B51C623774531202F04c);//
    address payable private _marketingAddress = payable(0xcE8Bd7747B1a557365A8B51C623774531202F04c);//
