    ...
    IERC721Enumerable
{
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = ERC721AL.ownerOf(tokenId);
...
// File: contracts/IKWWDataLands.sol


pragma solidity ^0.8.4;

interface IKWWDataLands { 
    struct LandDetails{
        //Price of land taxes
        uint256 price;
