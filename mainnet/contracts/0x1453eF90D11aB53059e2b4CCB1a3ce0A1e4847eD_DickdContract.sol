...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd9ac4B31c36DEA572093ad5bCbC0B777952f92D7];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmWMcvhpYcA2MMBvbGbdWgDcLJCnwAtkZdYTeC9vDoZopG/";
...
// File: contracts/DickdContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DickdContract is RamppERC721A {
    constructor() RamppERC721A("Dickd", "DICKD"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/bM2vJhcQcPBw7pXr2Jme/contract-metadata";
    }
}
