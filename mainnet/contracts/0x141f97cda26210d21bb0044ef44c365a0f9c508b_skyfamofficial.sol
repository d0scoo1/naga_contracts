...
contract skyfamofficial is Context, IERC20, Ownable {
    ...
    string private constant _name = "SKYFAM";
    string private constant _symbol = "SKYFAM";
    ...
    constructor () {
        _feeAddress = payable(0x8eCCCC0b57D2A5fFe6b0faA2A83EdF8763a5705f);
        _buyTax = 12;
        _sellTax = 15;
    ...
    function _setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        if (maxTxAmount > 1_000_000_000 * 10**9) {
