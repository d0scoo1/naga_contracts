...
// Web: www.BroomstickRocket.com
// Telegram: https://t.me/broomstickrocket
// Russia says we can't use their rockets anymore
// https://www.newsweek.com/russia-nasa-broomstick-rocket-engines-ukraine-1684522
// https://techcrunch.com/2022/03/03/russia-halts-rocket-engine-sales-to-u-s-suggests-flying-to-space-on-their-broomsticks/

// SPAXEX has awesome rockets. We decided to do our part too and help as much as we can.   
// Broomstick (BROOM) is a new rocket that wants to help us get to the moon and beyond.
...
contract BroomstickRocket is Context, IERC20, IERC20Metadata,Ownable {
    ...
    string private _name = "Broomstick Rocket";
    string private _symbol = "BROOM";
    uint256 private _initSupply = 100000000*10**18;
    
    uint256 public dexTaxFee = 250; //take fee while sell token to dex
