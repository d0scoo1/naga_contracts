...
contract PayInDAI {
    ...
    function payDAI(uint256 amount) external payable {
        ierc20.transferFrom(msg.sender, address(this), amount);
        sushiRouter.swapExactTokensForTokens(ierc20.balanceOf(address(this)), 0, _getPathForDAItoUSDC(), receiver, block.timestamp);
    }
