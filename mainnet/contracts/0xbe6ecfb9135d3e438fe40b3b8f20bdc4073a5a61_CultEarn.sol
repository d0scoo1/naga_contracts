...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a CULT EARN shareholder!");
...
contract CultEarn is IERC20, Auth {
    ...
    address public immutable CULT = address(0xE41Aa9778CeC1bAB2CdF193C21bE20B21884B16c); //UNI
