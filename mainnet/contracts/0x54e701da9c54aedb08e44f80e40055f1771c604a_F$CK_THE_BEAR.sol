...
Pair : USDC so you need to buy with USDC

Feel Free To Make A Telegram.

Will be properly renounced & Locked
...
contract F$CK_THE_BEAR is Context, IERC20, Ownable {
    using SafeMath for uint256;

    uint256 MAX_INT =
        115792089237316195423570985008687907853269984665640564039457584007913129639935;
    string private constant _name = "F*CK THE BEAR";
    string private constant _symbol = "F*CK BEAR";
