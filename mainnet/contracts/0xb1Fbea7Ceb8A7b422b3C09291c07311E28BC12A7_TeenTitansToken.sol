...
contract TeenTitansToken is Context, IERC20, Ownable {
	...
	string private constant _name = "Teen Titans Token";
	string private constant _symbol = "TTTOKEN";
