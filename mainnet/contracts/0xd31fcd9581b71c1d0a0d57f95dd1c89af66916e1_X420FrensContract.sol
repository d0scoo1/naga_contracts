...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xDf83739ec1A7281748c0d179e2C342ba68f526d5];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmSU9b4aEse4JxUWnqk7qTn57pAQV58knaShbTF1wHpma8/";
...
// File: contracts/X420FrensContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract X420FrensContract is RamppERC721A {
    constructor() RamppERC721A("420frens", "420FRENS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/J9qh0y0QDp21iYM9hPEn/contract-metadata";
    }
}