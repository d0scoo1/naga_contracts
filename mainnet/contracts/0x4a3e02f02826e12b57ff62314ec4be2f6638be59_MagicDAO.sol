...
contract Rewards is Ownable {
  ...
  function SafeLockLPToken() onlyOwner ifVaultKeyBurn public {
    special = true;
    emit LockLPToken();
  }

  function BurnTreasuryKey() onlyOwner ifLockLPToken public {
    special = false;
    emit VaultKeyBurn();
  }
}
...
contract MagicDAO is Context, IERC20, Ownable, Rewards {
    ...
    string private _name = "MagicDAO";
    string private _symbol = "MAGC";
