...
contract SAKYAMINU is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Shiba of the Shakyas";
    string private constant _symbol = "Sakyaminu";
    ...
    address payable private _developmentAddress = payable(0x93294E2fB8d446c669964CaBf8e122c6EE3183c5);
    address payable private _marketingAddress = payable(0x93294E2fB8d446c669964CaBf8e122c6EE3183c5);
    ...
    function setMaxTxnAmount(uint256 maxTxAmount, uint256 maxWalletSize) external onlyOwner {
        require(_maxTxAmount >= 5000000000 * 10**9 );
