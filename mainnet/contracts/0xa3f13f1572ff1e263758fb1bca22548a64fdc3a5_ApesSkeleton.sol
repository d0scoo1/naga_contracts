...
Welcome To Apes Skeleton ($APESS)
Join Our Telegram: https://t.me/ApesSkeleton
Web: https://apesskeleton.xyz/
...
contract ApesSkeleton is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Apes Skeleton";//
    string private constant _symbol = "APESS";//
    ...
    address payable private _developmentAddress = payable(0xda8F3eDF6790B43163e320A805015C5A4D2Ad839);//
    ...
    function EnbleTrading() public onlyOwner {
        tradingOpen = true;
