...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x53360357BD29ED1d399d6e1e7A3EFb3eDbBfB46F), 5000);
        m_DidDeploy = true;
    }
...
contract FUCKTHEPATRIACH is Context, IERC20, Taxable {
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(10 days), msg.sender, address(m_UniswapV2Router));
