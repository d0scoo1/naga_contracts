/*
   ...
   𝗦𝗼𝗰𝗶𝗮𝗹 𝗟𝗶𝗻𝗸𝘀:
   Telegram: t.me/NuclearDAOeth
   Discord:  discord.gg/yeSFrBBmSa
   Twitter:  twitter.com/DaoNuclear

   𝗢𝘁𝗵𝗲𝗿 𝗟𝗶𝗻𝗸𝘀:
   Website: nucleardao.tech
   Gitbook: nucleardao.gitbook.io/nucleardao/

   10% Liquidity Fee - *First 24hrs*
...
contract NuclearDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NuclearDAO", "NUKED") {
