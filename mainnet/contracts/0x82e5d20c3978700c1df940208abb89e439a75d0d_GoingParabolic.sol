...
contract GoingParabolic is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Going Parabolic", "$GP") {
    	...
    	marketingWallet = address(0x20CD1407Aee9b04Bd1A07A0b3FBa5a98f638a033); // set as marketing wallet
