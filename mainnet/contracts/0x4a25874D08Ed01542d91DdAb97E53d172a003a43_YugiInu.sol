...
contract YugiInu is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Yugi Inu";                                           // name
    string private _symbol = "Yugi";                                            // symbol
    ...
    address payable public marketingWallet = payable(0xB7A203c9b3CBa82d6b2d31A9148cB248240F0b45);
