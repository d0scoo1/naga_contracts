...
/**
 * @title DeluxeGoatPublicSaleContract.
 *
 ...
 */
contract DeluxeGoatPublicSaleContract is Ownable {

    /** 
     * @notice The Smart Contract of the NFT being sold 
     * @dev ERC-721 Smart Contract 
     */
    IDeluxeGoatERC721 public immutable nft;
    
    /** 
     * @dev MINT DATA 
     */
    uint256 public maxSupplyPermissioned = 4444;
    ...
    uint256 public limitPermissioned = 2;

    uint256 public pricePermissioned = 0.25 ether;
    uint256 public priceOpen = 0.25 ether;

    uint256 public startPermissioned = 1645290000 - 120;
    ...
    constructor(
        ...
        nft = IDeluxeGoatERC721(_nftaddress);
