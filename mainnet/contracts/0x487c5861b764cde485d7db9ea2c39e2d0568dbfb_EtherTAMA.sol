...
$ETHERTAMA - Stealth launched with high liquidity.

We want to create the best possible community. Website and roadmap coming soon.

Our dev team has extensive marketing funds. Most of the marketing at the beginning and early calls will be from out of pocket. We have a budget of 3ETH and will spend it for marketing.

Liquidity will be locked immediately after launch.
50% of tokens will be burned

We are going to attract the maximum number of influencers and make a giveaway to make the largest pump in history.
...
contract EtherTAMA is Context, IERC20, Ownable {
    ...
    string private _name = 'ETHERTAMA';
    string private _symbol = 'ETHERTAMA';
