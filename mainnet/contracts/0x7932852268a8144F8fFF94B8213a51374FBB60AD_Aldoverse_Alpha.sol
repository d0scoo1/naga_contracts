...
contract Aldoverse_Alpha is Ownable, ERC721A, ReentrancyGuard {
    uint256 public adoptionLimit = 5;
    uint256 public adoptionLimitPresale = 2;
    ...
    string private baseURI = "ipfs://QmRf5mjrtG1uRVTGNoRiemCJF9G6hpfC12LScAHfedq1Ck/";
    string public _extension = ".json";
    bool private reveal = false;
    uint256 public price = 0.048 ether;
    ...
    function mintPresale(uint256 _quantity) public payable {
        require(_quantity > 0 && _quantity <= 2, "Wrong Quantity.");
        require(totalSupply() + _quantity < maxSupply, "Reaching max supply");
    ...
    function withdraw() external onlyOwner {
        ...
        payable(0x4190abebDDA6181E5ec135c466f60C5877aDDEDd).transfer(_balance * 50/100); //Owner
        payable(0xd86A2875D2A073538b80CCeED83Ad27d9e877b70).transfer(_balance * 25/100); //Owner
        payable(0xdD493446D36cd3f84B1b9B74781120BbE9eB2547).transfer(_balance * 25/100); //Owner
    }
