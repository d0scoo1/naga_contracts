...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xC6da681413b041b475AaD905D7724AeBB48f6DCe];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 40, 454 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://QmXvxvMeaByuwDykHGxPF99HvtZ13Bvi3aDn18yyjqLibB/";
    ...
    */
    function mintToAdmin(address _to) public onlyOwner {
        require(getNextTokenId() <= collectionSize, "Cannot mint over supply cap of 454");
        _safeMint(_to, 1);
    }
    ...
    */
    function mintToMultiple(address _to, uint256 _amount) public payable {
        ...
        require(currentTokenId() + _amount <= collectionSize, "Cannot mint over supply cap of 454");
...
// File: contracts/metaverseArtStudioContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MetaverseArtStudioContract is RamppERC721A {
    constructor() RamppERC721A("Metaverse Art Studio", "MAS"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/YFyseBDCfb4HSUiteF3W/contract-metadata";
    }
}