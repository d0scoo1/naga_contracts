...
contract IGHMatrix is ERC721A, Ownable, ReentrancyGuard { 
...
// ================== Variables Start =======================
  ...
  uint256 public cost2 = 0 ether; //here you change phase 2 cost
  uint256 public supplyLimitPhase1 = 2999;  //change to your NFT supply for phase1
  uint256 public supplyLimit = 3000;  //change it to your total NFT supply
  uint256 public maxMintAmountPerTxPhase1 = 1; //decide how many NFT's you want to mint with cost1
  uint256 public maxMintAmountPerTxPhase2 = 1; //decide how many NFT's you want to mint with cost2
...
// ================== Constructor Start =======================
  ...
  ) ERC721A("I GOT HIGH", "IGH")  { //change this line to your full and short NFT name
    seturi(_uri);
