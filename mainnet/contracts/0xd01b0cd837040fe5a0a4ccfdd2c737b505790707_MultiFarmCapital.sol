...
Website:
https://multifarmcapital.eth.link

Telegram:
https://t.me/MultiFarmCapital

Twitter:
https://twitter.com/MultiFarmCapital

Medium:
https://multifarmcapital.medium.com
*/
...
pragma solidity ^0.6.12;
    ...
    contract MultiFarmCapital is Context, IERC20, Ownable {
        ...
        string private _name = 'MultiFarmCapital';
        ...
        address payable public _MFCWalletAddress;
        ...
        constructor (address payable MFCWalletAddress, address payable marketingWalletAddress) public {
            _MFCWalletAddress = MFCWalletAddress;
        ...
        function sendETHToTeam(uint256 amount) private {
            _MFCWalletAddress.transfer(amount.div(2));
        ...
        function _setMFCWallet(address payable MFCWalletAddress) external onlyOwner() {
            _MFCWalletAddress = MFCWalletAddress;
        }
