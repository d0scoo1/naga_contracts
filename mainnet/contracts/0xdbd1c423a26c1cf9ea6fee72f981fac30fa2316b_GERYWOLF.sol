...
contract GERYWOLF is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "GERYWOLF";
    ...
    uint256 public _maxTxAmount = 1250000000 * 10**9;
    uint256 public _maxWalletSize = 2500000000 * 10**9;
    uint256 public _swapTokensAtAmount = 12500000 * 10**9;
    ...
    function setProtections() external onlyOwner(){
