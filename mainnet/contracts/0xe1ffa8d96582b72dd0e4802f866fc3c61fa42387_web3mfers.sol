...
contract web3mfers is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("web3 mfers", "W3M") {
    setHiddenMetadataUri("ipfs://QmaNknbXszfxMdY53y8Cgc7ZV4sxQCCnhK48sBNQ2bk8i3/hidden.json");
  }
  ...
  {
      if(_supply < 303 && cost == 6900000000000000){
           return 0.00 ether;
       } 
      else if (_supply < 303 && cost != 6900000000000000){
           return cost;
       }
      else if (_supply <= maxSupply && cost == 6900000000000000){
           return 0.0069 ether;
       }
       else if (_supply <= maxSupply && cost != 6900000000000000){
           return cost;
  ...
  {
       if(_supply < 303 && maxTokensPerWallet == 5) {
           return 5;
       } 
       else if (_supply < 303 &&  maxTokensPerWallet != 5){
