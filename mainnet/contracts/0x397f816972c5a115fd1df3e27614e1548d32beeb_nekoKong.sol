...
contract nekoKong is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "Neko Kong";//
    string private constant _symbol = "NEKOKONG";//
    ...
    //Dev Fee Buy
    uint256 private _devFeeBuy = 3;

    //Marketing Fee Buy
    uint256 private _marketingFeeBuy = 6;

    //Liquidity Fee Sell
    uint256 private _liquidityFeeSell = 4;

    //Sell Fee Dev
    uint256 private _devFeeSell = 4;

    //Sell Fee Marketing
    uint256 private _marketingFeeSell = 7;
    ...
    address payable private _developmentAddress = payable(0xbb4F72677FfEAAB3028640a70751C18e1DBB1a3C);//
    address payable private _marketingAddress = payable(0xf58eC649A65e55D7A6a30B981bFE2074Fb79Aac8);//
