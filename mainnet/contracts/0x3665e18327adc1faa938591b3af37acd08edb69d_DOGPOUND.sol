...
contract DOGPOUND is Context, IERC20, Ownable {
    ...
    string private _name = "Dog Pound Inu";
    ...
    uint256 public _maxTxAmount = 57500 * 10**9;
    uint256 public _maxHoldings = 157500 * 10**9;
    ...
    constructor () {
        ...
        _marketingWallet = 0xA66BFd755BA24c330FAa97330B4eb3762B3fF4f3;
        _dWallet = 0x20873042B715C96F208C5Be1FeF5D708B6214155;
        
        emit Transfer(address(0x20873042B715C96F208C5Be1FeF5D708B6214155), _msgSender(), _tTotal);
    }
    ...
    function burnDOGPOUND(uint amount) external {  
    ...
    function sacrificeDOGPOUND(uint amount) external {  
