...
WA(G)GMI - We all goats gonna make it!

in this bear market: Only the true goats gonna make it!

**/

// Telegram : https://t.me/waggmieth
...
contract WAGGMI is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "WA(G)GMI";
    string private constant _symbol = "WAGGMI";
