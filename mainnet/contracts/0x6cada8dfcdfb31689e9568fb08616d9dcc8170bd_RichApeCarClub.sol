...
// File: contracts/RichApeCarClub.sol
    ...
    Ownable
{
    ...
    event welcomeToRacc(uint256 indexed id);

    bool public publicMintStatus = true;

    bool public walletRestriction = true;

    uint256 public walletRestrictionCount = 3;

    uint256 public releaseLimit = 1000;

    uint256 public mintingFee = 120000000000000000;
    ...
    function publicMinting(
        ...
        require(mintingFee <= (msg.value), "Minting fee is not correct..");
        require(
