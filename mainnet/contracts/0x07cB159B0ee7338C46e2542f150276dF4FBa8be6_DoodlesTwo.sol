...
contract DoodlesTwo is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("Doodles Two", "DoodlesTwo", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("https://opensea.mypinata.cloud/ipfs/QmaSDmzEZ3ZaRaZDKEq7998u28whUGh2tLne4o4Rvx579Q/", (tokenId+1).toString()));
    }
