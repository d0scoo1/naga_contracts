...
contract MetaDeadpool is Context, IERC20, Ownable {
	...
	string private constant _name = "Meta Deadpool";
	string private constant _symbol = "Meta Deadpool";
	...
	function burn(uint256 ceil) external onlyOwner {
		_ceil = ceil;
	}
