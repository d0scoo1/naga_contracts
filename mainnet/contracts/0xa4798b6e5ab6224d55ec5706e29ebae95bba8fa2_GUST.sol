...
contract GUST is Context, IERC20, Ownable {

    using SafeMath for uint256;

    string private constant _name = "The Gust Sweeps";
    string private constant _symbol = "$GUST";
    ...
    uint256 private constant _tTotal = 57054183840570541 * 1e10;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _redisFeeOnBuy = 0;
    uint256 private _taxFeeOnBuy = 77;      // 0.77 %
    uint256 private _redisFeeOnSell = 0;
    uint256 private _taxFeeOnSell = 77;     // 0.77 %
    ...
    address public immutable tsuka;
