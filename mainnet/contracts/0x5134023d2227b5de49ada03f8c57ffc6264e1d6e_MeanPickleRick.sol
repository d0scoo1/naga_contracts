// WubbaDubbaDubDub - Im MEAN PRICKLE RICK!!!!!
...
contract MeanPickleRick is Context, IERC20, Ownable {
    ...
    // 
    string private _name = "Mean Pickle Rick";                                         
    string private _symbol = "$MPR";                                           
    ...
    uint256 public _marketingFee = BuyMarketingFee;
    uint256 private _previousMarketingFee = _marketingFee;

    bool public feesOnSellersAndBuyers = true;

    uint256 public _maxTxAmount = _tTotal.div(1).div(200);
    uint256 public numTokensToExchangeForMarketing = _tTotal.div(100).div(100);
    address payable public marketingWallet = payable(0x46247b3Ce728b1429c0b87c76A001598407d79F9);
    ...
    function SetSellMarketingFee(uint256 sellmarketfee) external onlyOwner() {
        SellMarketingFee = sellmarketfee;
    }
