...
contract xApes is ERC721, Ownable {
    ...
    uint256 public MAX_FREE_MINT = 8000;
    uint256 public MAX_MINT_PER_TXN = 20;
    bool public IS_SALES_ACTIVE = false;

    constructor() ERC721("1xApes", "1xApes") {
        _contractUri = "ipfs://QmU1aQUKXsGq8P865nYhktDTFsvxQrBukaJdfkke99d9uP";
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(totalSupply() + quantity <= MAX_SUPPLY, "ALL APES HAVE BEEN SOLD");
