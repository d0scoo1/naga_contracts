...
Could it be something, or could it be anything? Who knows, maybe it's absolutely nothing.


https://t.me/AbsolutelyNothingETH
...
contract AbsolutelyNothing is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public teamAndMarketingWallet;

    string private _name = "Absolutely Nothing";
    string private _symbol = "ABNO";
    ...
    uint256 public numTokensSellToAddToLiquidity = 800000000000000000000 * 10**9;
    uint256 public _maxWalletSize = 1600000000000000000000 * 10**9;
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 80000000, "Max Tx Amount cannot be less than 80 Million");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 80000000, "Swap Threshold Amount cannot be less than 80 Million");
