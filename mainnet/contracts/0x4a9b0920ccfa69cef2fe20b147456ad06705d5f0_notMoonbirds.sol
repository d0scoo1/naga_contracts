...
// File contracts/notMoonbirds.sol


contract notMoonbirds is ERC721A, Ownable {

    string public baseURI = "ipfs://QmXWBCyXNFcsMJFLyEvfPmybxP3iSGTx3xXWLQd3vvVxFq/";
    string public contractURI = "ipfs://";
    string public constant baseExtension = ".json";
    address public constant proxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;

    uint256 public constant MAX_PER_TX = 1;
    uint256 public constant MAX_SUPPLY = 234;
    mapping(address => uint256) public minted;

    bool public paused = true;

    constructor() ERC721A("notMoonbirds", "BIRDS") {}
