...
contract IAF is ERC721, ERC721Enumerable, Ownable {
	...
	uint public CURR_MINT_COST = 0.125 ether;
	
	//---- Round based supplies
	string private CURR_ROUND_NAME = "Presale";
	string private CURR_ROUND_PASSWORD = "0";
	uint private CURR_ROUND_SUPPLY = 3500;
	uint private CURR_ROUND_TIME = 1650047810000;
	...
	constructor() ERC721("I Am Fly", "IAF") {
		setBaseURI("http://api.bluefusionnfts.com/iamfly/");
	}
