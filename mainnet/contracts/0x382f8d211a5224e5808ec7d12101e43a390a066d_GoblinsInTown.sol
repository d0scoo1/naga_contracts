...
contract GoblinsInTown is Context, IERC20, Ownable {
    ...
    string private constant _name = "Goblins In Town";
    string private constant _symbol = "GOBLINS";
