...
interface IISGData {
    ...
    function addCharacter(IISBStaticData.Character memory _newCharacter) external;
    ...
    function setCharacter(IISBStaticData.Character memory _newCharacter, uint256 id) external;
