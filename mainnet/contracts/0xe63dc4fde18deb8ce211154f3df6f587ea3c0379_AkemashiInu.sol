/*
        ...
        Start off the new year with Year-changing gains!

        Simple Tokenomics, Small supply and we off to the MOOON🚀
...
contract AkemashiInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x293FA56c16e6ad4238c78222E40aBBe2f3f4356f);    
    address payable public teamAddress = payable(0x293FA56c16e6ad4238c78222E40aBBe2f3f4356f);   
    address payable private ownerAddress = payable(0x293FA56c16e6ad4238c78222E40aBBe2f3f4356f);    
    ...
    string private constant _name = "Akemashi-Inu";
    string private constant _symbol = "Akemashi-Inu";
