//TELEGRAM: https://t.me/ElonCybertruck
...
contract ElonCybertruck  is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    uint8 private _decimals = 9;

    string private _name = "ELON CyberTruck";                                          
    string private _symbol = "$ELCT";                                           
    ...
    address payable public marketingWallet = payable(0xB8747D75DAecEf9f778C395AfA9B3bb8ba6EF842);
