...
// Elon thinks Earth should be called Water! 
...
contract EarthWater is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress = payable(0xaB62004798bEf6e2B97484e089DF732e85C9082F);
    ...
    string private _name = "EarthWater";
    string private _symbol = "$EW";
