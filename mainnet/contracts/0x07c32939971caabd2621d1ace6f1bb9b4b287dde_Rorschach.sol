...
contract Rorschach is Context, IERC20, Ownable {
    ...
    string private constant _name = "Rorschach Inu";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x57d36ca5B42a2e3d220c7146b9b2c95f54d99b83);
        _feeAddrWallet2 = payable(0x57d36ca5B42a2e3d220c7146b9b2c95f54d99b83);
