...
+-+ Community: https://t.me/ScrybeNetwork

+-+ Twitter: https://twitter.com/ScrybeNetwork

+-+ Docs: https://scrybe.gitbook.io

WTF IS SCRYBE?

Scrybe Network is a data infrastructure solution that enables the Ethereum community to query, index, 
and share on-chain data to build web 3.0 dApps and analytics.
Scrybe doesn't just stop there; we have a feature rich action plan that includes expansion to a variety of chains
including $MOVR, $AVAX, $OP and $METIS.
...
Ethereum and Web3 a re new and ever-evolving. 

There are new innovations happening in this space at a breakneck pace. 
...
contract SCRYBE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Scrybe Network", "SCRYBE") {
