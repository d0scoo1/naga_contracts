...
contract RocketPoolHelper {
    ...
    ///@notice Check to see if the rETH pool can accept a specified amount of ETH to deposit.
        ...
        returns (bool)
    {
        ...
        // this contains logic to check if there is space to mint rETH from the amount of ETH we have to claim
        return maxAmount > _ethAmount;
    }

    ///@notice Pull our most current address for the rETH deposit address.
