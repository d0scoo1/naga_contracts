...
contract COCKADOO is Context, IERC20, Ownable {
    ...
    string private constant _name = "Cock-A-Doodle-Doo";
    string private constant _symbol = "COCKADOO";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x06CaeD74B785dC7566eBc667BB04c4AdddA92607);
