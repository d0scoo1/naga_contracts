...
contract MutantAssGoblinKidz is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("MutantAssGoblinKidz", "MGK"){}
  ...
  function mint(uint256 amt) external payable
  {
    ...
    require(msg.sender == tx.origin,"dANk U for Da MEENT anOn");
