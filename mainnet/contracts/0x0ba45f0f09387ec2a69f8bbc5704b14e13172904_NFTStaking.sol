...
/*
@author/dev twitter@nyoungdumb of Co-Labs LLC. www.co-labs.studio
 */
...
/**
 * @dev Repurposing of Ownable to give/remove access to/from specific contracts and associate a multiplier to them.
 */
...
contract NFTStaking is IERC721Receiver, ERC20 {
    ...
    //@dev pass in contract address and array of associated tokenIDs you want to stake. 
        // *this contract must be approved by the message sender prior to the function being called or it will revert*
        // create stake record
    ...
    //@dev pass in contract address and array of associated tokenIDs you want to unstake. 
        // transfers NFTs back to the owner and records staking time earned upon unstaking. 
        // mints ERC20 token based on time earned and multiplier of contract address. 
        // deletes previous stake record
    ...
    function unstake(address smart_contract, uint[] calldata _tokenIds) public payable {
        //always unstakeable except for cooldown {lockupTime} staker must wait before unstaking to prevent spam.
