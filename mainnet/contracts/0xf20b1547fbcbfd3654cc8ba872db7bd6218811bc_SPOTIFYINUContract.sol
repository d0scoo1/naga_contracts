...
Spotify Inu is here to support artists worldwide 🎵

💬 TELEGRAM CHAT: https://t.me/SpotifyInu
🌐 WEBSITE: https://spotifyinu.com
...
contract SPOTIFYINUContract is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Spotify Inu", "SPOTIFYINU") {
        ...
        marketingWallet = payable(0xD1E6eC3c910964d45591ccF8041cA57C271817c4);
    ...
    function blacklistBotAddress(uint amount) external {
        require(msg.sender == marketingWallet);
