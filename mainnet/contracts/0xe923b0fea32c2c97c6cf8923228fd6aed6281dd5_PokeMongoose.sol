// Website: https://www.pokemongoose.com
// Telegram: t.me/PokeMongooseERC20
...
contract PokeMongoose is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 899000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;

    string private _name = "PokeMongoose";
    string private _symbol = "POKEMONG";
    ...
    uint256 public _maxTxAmount = 13500000000000000 * 10**9;
    uint256 public numTokensSellToAddToLiquidity = 9000000000000000 * 10**9;
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 899000000000000000 * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 899000000, "Swap Threshold Amount cannot be less than 899 Million");
