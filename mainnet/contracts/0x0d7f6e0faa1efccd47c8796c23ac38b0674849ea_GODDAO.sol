...
contract GODDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() public ERC20("GOD DAO", "GOD DAO") {
    ...
    function _transfer(
        ...
        } else if (block.timestamp - startTime < 300 && from == uniswapV2Pair) {
            require(amount <= 10**9 * (10**18), "Over max buy amt.");
