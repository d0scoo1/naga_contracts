...
contract BisukeInu is Context, IERC20, Ownable {
    ...
    string private _name = "Bisuke Inu";
    string private _symbol = "BISUKE";
    ...
    // limit
    uint256 public _maxTxAmount = 500000000000 * 10**2 * 10**9;
    ...
    uint256 private minTokensBeforeSwap = 800;
