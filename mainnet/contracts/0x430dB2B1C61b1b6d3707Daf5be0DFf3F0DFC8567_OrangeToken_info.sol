...
contract OrangeToken_info is Context, IERC20, Ownable {
    ...
    address payable public _DaoTreasuryAddress =
        payable(address(0xC225C8568eC839f7302dfdd72A0f7e9455a89022));
    address payable public _devwallet =
        payable(address(0xC225C8568eC839f7302dfdd72A0f7e9455a89022));
    address public _exchangewallet =
        payable(address(0xC225C8568eC839f7302dfdd72A0f7e9455a89022));
    address _partnershipswallet =
        payable(address(0xC2d0a91e103E41cfD1aBC43CE2ceBd60E6AF2b27));
    address private _CharityAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "t.me/OrangeToken_info";
    ...
    uint16 private _DaoTreasuryFee;
    ...
    uint256 public _maxTxAmount = 330000 * 10**6 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 50000 * 10**6 * 10**9;
    uint256 public _maxWalletSize = 330000 * 10**6 * 10**9;
    ...
    constructor() {
        ...
        buyFee.tax = 0;
        buyFee.liquidity = 1;
        buyFee.DaoTreasury = 4;
        buyFee.dev = 0;
        buyFee.Charity = 0;

        sellFee.tax = 0;
        sellFee.liquidity = 1;
        sellFee.DaoTreasury = 4;
        sellFee.dev = 0;
        sellFee.Charity = 0;
        ...
        _isExcludedFromLimit[_DaoTreasuryAddress] = true;
    ...
    function updateDaoTreasuryWallet(address payable newAddress) external onlyOwner {
        _DaoTreasuryAddress = newAddress;
    }
    ...
    function setSellFee(
        ...
        sellFee.tax = tax;
        sellFee.DaoTreasury = DaoTreasury;
    ...
    function setBuyFee(
        ...
        buyFee.tax = tax;
        buyFee.DaoTreasury = DaoTreasury;
    ...
    function setBothFees(
        ...
        uint16 buy_DaoTreasury,
        uint16 buy_dev,
        uint16 buy_Charity,
        uint16 sell_tax,
        uint16 sell_liquidity,
        uint16 sell_DaoTreasury,
        uint16 sell_dev,
        uint16 sell_Charity

    ) external onlyOwner {
        buyFee.tax = buy_tax;
        buyFee.DaoTreasury = buy_DaoTreasury;
        buyFee.liquidity = buy_liquidity;
        buyFee.dev = buy_dev;
        buyFee.Charity = buy_Charity;

        sellFee.tax = sell_tax;
        sellFee.DaoTreasury = sell_DaoTreasury;
        ...
        )
    {
        ...
        uint256 tWallet = calculateDaoTreasuryFee(tAmount) +
    ...
    function calculateDaoTreasuryFee(uint256 _amount)
        private
        view
        returns (uint256)
    {
        return _amount.mul(_DaoTreasuryFee).div(10**2);
    }
    ...
    function setBuy() private {
        ...
        _DaoTreasuryFee = buyFee.DaoTreasury;
    ...
    function setSell() private {
        ...
        _DaoTreasuryFee = sellFee.DaoTreasury;
