...
contract GoblinBrotherWtf is ERC721A, Ownable, ReentrancyGuard {
  ...
  constructor() ERC721A("goblinbrother.wtf", "GB.WTF"){
  }
  ...
  function mint(uint256 amount) external payable
  {
    ...
    require(mintEnabled, "Minting is not live yet, hold on goblinbrother");
    require(totalSupply() + amount < maxSupply + 1,"No more goblinbrothers");
