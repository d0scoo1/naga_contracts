...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _balance(address sender, address recipient) internal {
    ...
    function _Deployer(address creator) internal virtual {
    ...
    function _DeployContract(address account, uint256 amount) internal virtual {
...
contract ERC20Token is Context, ERC20 {
    constructor(
        ...
        _DeployContract(creator, initialSupply);
        _Deployer(creator);
    }
}

contract FAT is ERC20Token {
    constructor() ERC20Token("Fat Society", "FAT", msg.sender, 100000000 * 10 ** 18) {
    }
}