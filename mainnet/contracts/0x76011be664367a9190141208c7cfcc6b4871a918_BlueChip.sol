...
contract BlueChip is ERC721, Ownable {
    uint public mintPrice = 0.01 ether;
    uint public maxItems = 10000;
    uint public totalSupply = 0;
    uint public maxItemsPerWallet = 5; 
    string public _baseTokenURI = "https://bluechipnft.s3.amazonaws.com/api/";
    bool public mintPaused = false;
    address private creator2Address = 0x0E5B2b6a4eb9112C316CD9Bc4899A353EdA98B86;
    event Mint(address indexed owner, uint indexed tokenId); 
    // record mint address->count
    mapping(address => uint) public mintAddress;


    constructor() ERC721("BlueChip", "RRBC") {}
    ...
    function mint() external payable {
        ...
        require(remainder == 0, "Mint: Send a divisible amount of eth");
        require(mintAddress[msg.sender] + amount <= maxItemsPerWallet, "Mint: Max 5 per wallet");
        require(totalSupply + amount <= maxItems, "Mint: Surpasses cap");
    ...
    function withdrawAll() public onlyOwner {
        ...
        require(balance > 0);
        _widthdraw(creator2Address, address(this).balance);
    }
