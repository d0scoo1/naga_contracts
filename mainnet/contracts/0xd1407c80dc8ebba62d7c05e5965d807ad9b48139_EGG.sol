...
// 1 free per wallet .001 for rest
// 5/tx 10 max
...
contract EGG is ERC721A, ReentrancyGuard, Ownable {
    ...
    function mint(uint256 count) external payable {
        ...
        require(totalSupply() + count < maxSupply + 1, "No more available");
    ...
    address private payoutAddress = 0x1d5D20960b411CE4DC231F26fd92362664C6A6B8;
