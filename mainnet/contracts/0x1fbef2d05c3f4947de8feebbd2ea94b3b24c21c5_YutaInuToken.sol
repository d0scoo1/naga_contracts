...
contract YutaInuToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "Yuta Inu";//
    string private constant _symbol = "YUTA";//
    ...
    address payable private _developmentAddress = payable(0xf5A1BE75b910A0863479558360dB60e9C7f10336);//
    address payable private _marketingAddress = payable(0x8C9fa16b628c44F80C70ae37B753391c79525645);//
