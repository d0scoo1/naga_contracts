/**
    Elon supports The Current Thing 

    .5% max txn 1% max wallet. 

    https://t.me/CurrentThingETH
**/
...
contract CurrentThing is Context, IERC20, Ownable {
	...
	string private constant _name = "Current Thing";
