...
import { LibAsset } from "../Libraries/LibAsset.sol";
import { InvalidAmount, ContractCallNotAllowed } from "../Errors/GenericErrors.sol";
...
contract Swapper is ILiFi {
        ...
        noLeftovers(_swapData)
    {
        for (uint256 i = 0; i < _swapData.length; i++) {
            ...
            if (!(ls.dexAllowlist[currentSwapData.approveTo] && ls.dexAllowlist[currentSwapData.callTo]))
