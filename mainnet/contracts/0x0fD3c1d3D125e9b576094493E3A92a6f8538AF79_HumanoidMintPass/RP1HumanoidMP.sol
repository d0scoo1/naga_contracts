...
contract HumanoidMintPass is ERC721, Ownable, PaymentSplitter {
    ...
    constructor() ERC721("Humanoid Early Access Pass", "RP1HUMANOID") PaymentSplitter(_team, _teamShares) {
    }
