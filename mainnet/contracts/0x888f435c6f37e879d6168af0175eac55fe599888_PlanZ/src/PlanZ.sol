...
contract PlanZ is ERC721, ERC721Pausable, Ownable {
    ...
    address public immutable izzy = 0x37b7458C5f14822BF423965aed077a20269011C5;

    /// @notice Supply distribution
    uint256 public maxSupply = 888;
    uint256 public maxSummon = 8;
    ...
    constructor(
        ...
        // Reserve 1 for izzy
        totalSupply++;
        _mint(izzy, totalSupply);

        // Transfer ownership to izzy
        _transferOwnership(izzy);
        _pause();
    }
