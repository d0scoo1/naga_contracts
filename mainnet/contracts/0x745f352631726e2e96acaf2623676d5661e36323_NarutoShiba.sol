...
🍀 🍀 Naruto Shiba  Stealth Launch  Erc20 🍀 🍀

🍀 Uzumaki Naruto Dattebayo! SASUKEEEE 🍀

We are bringing back the Anime hyped tokens to ERC starting with our OG CLASSIC FAVOURITE NARUTO DOGEEEE🍀

We are a community driven token that will pave the way for a successful Anime DAO!
...
contract NarutoShiba is Context, IERC20, Ownable {
    ...
    string private constant _name = "Naruto Shiba";
    string private constant _symbol = "NarutoShiba";
