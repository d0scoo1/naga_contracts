...
*/
/** 
As the Witch Doctor advances, a long staff thumps the ground, unleashing a gift for medics, doctors and hodlers alike.

The Witchdoctor ($WD) contract is constructed so that the success of the project is shared with the most dedicated.
The smart contract will be able to pick out transactions done from the previous hour to decide who gets to become the next Doctor and Medic. 
...
MEDIC     - Given to the Biggest Buyer accumulated
DOCTOR    - Given to the Biggest Buyer in one transaction

See more details on our website: www.witchdoctortoken.com

Website: www.witchdoctortoken.com
Telegram: https://t.me/thewitchdoctor
*/
