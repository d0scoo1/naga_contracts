...
// File @openzeppelin/contracts/token/ERC20/presets/ERC20PresetFixedSupply.sol@v4.1.0
...
// File contracts/FleatoCoin.sol

pragma solidity ^0.8.0;

/**
 * @title FleatoCoin
 * Fleato coins (FLTO) utility token
 */
contract FleatoCoin is ERC20PresetFixedSupply {
    /**
     * @dev Mints `initialSupply` amount of token and transfers them to `owner`.
     *
     * See {ERC20-constructor}.
    ...
    constructor(
        address owner
    ) ERC20PresetFixedSupply('Fleato', 'FLEATO', 100000000 ether, owner) {
