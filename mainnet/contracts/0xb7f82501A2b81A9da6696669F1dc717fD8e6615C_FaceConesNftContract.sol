...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmaGMqEvPt8kMddF6EwCn2Vo3BNX4BDuXJjUsGLZCHo69Y/";
...
// File: contracts/FaceConesNftContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract FaceConesNftContract is RamppERC721A {
    constructor() RamppERC721A("Face Cones NFT", "FCCNES"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/ApfLBhEWaWnlvOC2KSCz/contract-metadata";
    }
}
