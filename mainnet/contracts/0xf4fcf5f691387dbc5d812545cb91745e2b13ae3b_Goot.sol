...
contract Goot is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmSsKFcbGNxogYYBRkpB9hwRM4g2Rca7k1sScCjvyWkgci";

  uint256 public  maxSupply = 9999;
  uint256 public  MAX_MINTS_PER_TX = 5;
  uint256 public  FREE_MINTS_PER_TX = 5;
  uint256 public  PUBLIC_SALE_PRICE = 0.01 ether;
  uint256 public  TOTAL_FREE_MINTS = 7999;
