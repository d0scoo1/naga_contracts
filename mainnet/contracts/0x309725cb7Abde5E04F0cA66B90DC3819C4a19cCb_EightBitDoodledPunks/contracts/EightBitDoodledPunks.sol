...
contract EightBitDoodledPunks is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmbPa7rHcEd5hKA9X3tTa9XSPmW6wD1k9NX5xwxiYZdx1B";
  ...
  ) ERC721A("EightBit Doodled Punks", "EightBit Doodled Punks") {
