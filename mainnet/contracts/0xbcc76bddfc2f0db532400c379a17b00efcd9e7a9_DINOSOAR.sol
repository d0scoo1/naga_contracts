...
contract DINOSOAR is Context, IERC20, Ownable {
    ...
    address public marketingWallet = 0x097d5418977507BA16c13BaCB395B8720463952F;

    string private _name = "DINOSOAR";
    string private _symbol = "DINOSOAR";
    ...
    function setMaxTxAmount(uint256 maxTxAmount) external onlyOwner() {
        require(maxTxAmount > 0, "Max Tx Amount cannot be less than 0");
        _maxTxAmount = maxTxAmount * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 0, "Swap Threshold Amount cannot be less than 0");
