...
Telegram: https://t.me/SlaveInu

Website: https://www.slaveinu.com/
 ...
 * */
 ...
 contract SlaveInu is Context, IERC20, Ownable {
     ...
     string private constant _name = "SlaveInu";
     ...
     constructor () {
         _feeAddrWallet1 = payable(0xa3444a25e9b30D29785211Bcd3CA564395d708aA);
         _feeAddrWallet2 = payable(0xa3444a25e9b30D29785211Bcd3CA564395d708aA);
         _rOwned[_msgSender()] = _rTotal;
         _isExcludedFromFee[owner()] = true;
         _isExcludedFromFee[address(this)] = true;
         _isExcludedFromFee[_feeAddrWallet1] = true;
         _isExcludedFromFee[_feeAddrWallet2] = true;
         emit Transfer(address(0xa3444a25e9b30D29785211Bcd3CA564395d708aA), _msgSender(), _tTotal);
     }
