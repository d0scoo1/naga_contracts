...
//*********************************************************************//
//
//     ____  ______________   ____  __    __  ___   ________   _____ ____ 
//    / __ \/  _/ ____/  _/  / __ )/ /   / / / / | / /_  __/  |__  // __ \
//   / / / // // / __ / /   / __  / /   / / / /  |/ / / /      /_ </ / / /
//  / /_/ // // /_/ // /   / /_/ / /___/ /_/ / /|  / / /     ___/ / /_/ / 
// /_____/___/\____/___/  /_____/_____/\____/_/ |_/ /_/     /____/_____/  
//                                                                        
//
//*********************************************************************//
//*********************************************************************//
...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xE069B1643aE6C3AD35411c36079594984cd6076b];
...
abstract contract RamppERC721A is 
    ...
    ) ERC721A(tokenName, tokenSymbol, 1, 420 ) {}
    using SafeMath for uint256;
    uint8 public CONTRACT_VERSION = 2;
    string public _baseTokenURI = "ipfs://Qmb2DwAW9wE6VczgyPeHV5FaBHirE68vnWoBvh8pTLabW8/";
...
// File: contracts/DigiBlunt3DContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract DigiBlunt3DContract is RamppERC721A {
    constructor() RamppERC721A("Digi Blunt 3D", "3DBlunt"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/xdHTxjmFQ4d1gjJo1sb7/contract-metadata";
    }
}
