...
// File: contracts/Gummies/Whitelisting.sol

//SPDX-License-Identifier: MIT
pragma solidity 0.8.7;

/**
 * @title Gummies Whitelist market
...
contract GummiesWL is  Ownable {
    ...
    modifier whitelistindexCheck(uint64 _index) {
        require(_index >= 0 && _index <= _currentWhitelistIndex, "Invalid WL  Index");
        _;
    }
    ...
    function setWlSpots(uint64 _index, uint64 _spots) public onlyOwner whitelistindexCheck(_index) {
     ...
     function burnTokens(address _burnWallet) public payable onlyOwner  {
