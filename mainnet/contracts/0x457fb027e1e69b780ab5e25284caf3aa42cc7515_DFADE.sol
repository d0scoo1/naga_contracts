...
DOONT FADE ($DFADE)
- Dont Fade this coin watch us as we go straight to 100M mcap
...
contract DFADE is ERC20, Ownable {
    ...
    constructor() ERC20("DOONT FADE", "DFADE") {
    ...
    function openTrade(address _mevrepel) external onlyOwner {
