...
Ever spent hours looking for the best gem, the token with the perfect contract,
the tiniest little details, the most rewarding tokenomics, and which token has the most
marketers on board, and then all of a sudden the dumbest tokens to ever exist becomes 
the moonshot of the week while yours became straight loss porn?

Sometimes it pays to be dumb.

Decrease Intellect Increase Profits (INVERSE) is the path to success.
...
contract DIIP is Context, IERC20, Ownable {
    ...
    string private _name = "Decrease Intellect Increase Profits";
    string private _symbol = "INVERSE";
    ...
    function allowdegening()external onlyOwner() {
        canTrade = true;
    }
