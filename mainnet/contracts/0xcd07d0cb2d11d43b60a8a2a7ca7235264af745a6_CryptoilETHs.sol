...
// Contract: CryptoilETHs
// ---- CONTRACT BEGINS HERE ----

pragma solidity ^0.8.0;

contract CryptoilETHs is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 0.01 ether;
  uint256 public maxSupply = 100; // This will be changed to 6969 once the first 500 are sold.
  uint256 public maxMintAmount = 18; // This will be changed to 10 once the first 500 are sold.
  bool public paused = false;
  bool public whitelistOnly = false;
  uint256 public walletLimit = 18; // This will be changed to 6969 once the first 500 are sold.
