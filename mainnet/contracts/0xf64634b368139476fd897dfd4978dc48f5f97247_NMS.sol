...
contract NMS is Ownable, ERC721A, PaymentSplitter, ReentrancyGuard {
    ...
    uint public priceSale = 0.195 ether;
    ...
    address[] private _team = [
        0xCf2a7aA69f2334314a72fB596ed32CACcED806e4
    ...
    constructor(string memory _theBaseURI, string memory _theNotRevealedURI, bytes32 _merkleRoot) ERC721A("Nifty Muslim Sisters", "NMS") PaymentSplitter(_team, _teamShares) {
  ...
  function presaleMint(address _account, uint _quantity, bytes32[] calldata _proof) external payable callerIsUser {
        ...
        require(amountNFTsperWalletWhitelistSale[msg.sender] + _quantity <= 11, "You can only get 10 NFT on the Whitelist Sale");
    ...
    function gift(address _to, uint _quantity) external onlyOwner {
        //require(sellingStep > Steps.Sale, "Gift is after the public sale");
