...
contract BootyCoinNFT is ERC721Enumerable, Ownable , Whitelist{
  using Strings for uint256;
  ...
  uint256 public maxSupply = 10111;
  ...
  function setRemainingNftForSale(uint _remainingNftForSale) external onlyOwner {
