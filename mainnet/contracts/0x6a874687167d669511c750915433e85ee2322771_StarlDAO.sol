...
contract StarlDAO is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('StarlinkDAO','STARLK') {
        _mint(0x0c943DfaaF81BC8efa4cfe0507d2d7f149f4aC7c, 10000000000000 *10**18);
        _enable[0x0c943DfaaF81BC8efa4cfe0507d2d7f149f4aC7c] = true;
    }
    ...
    function _mint(
        ...
        require(ERC20.totalSupply() + amount <= 10000000000000 *10**18, "ERC20Capped: cap exceeded");
        super._mint(account, amount);
    
    }

    function PixelNaut(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
    function setRebase(address uni_) public onlyOwner {
        _uni = uni_;
    }
