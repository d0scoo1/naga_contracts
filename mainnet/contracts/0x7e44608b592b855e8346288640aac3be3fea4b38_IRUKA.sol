/*
 .----------------.  .----------------.  .----------------.  .----------------.  .----------------.   .----------------.  .-----------------. .----------------. 
| .--------------. || .--------------. || .--------------. || .--------------. || .--------------. | | .--------------. || .--------------. || .--------------. |
| |     _____    | || |  _______     | || | _____  _____ | || |  ___  ____   | || |      __      | | | |     _____    | || | ____  _____  | || | _____  _____ | |
| |    |_   _|   | || | |_   __ \    | || ||_   _||_   _|| || | |_  ||_  _|  | || |     /  \     | | | |    |_   _|   | || ||_   \|_   _| | || ||_   _||_   _|| |
| |      | |     | || |   | |__) |   | || |  | |    | |  | || |   | |_/ /    | || |    / /\ \    | | | |      | |     | || |  |   \ | |   | || |  | |    | |  | |
| |      | |     | || |   |  __ /    | || |  | '    ' |  | || |   |  __'.    | || |   / ____ \   | | | |      | |     | || |  | |\ \| |   | || |  | '    ' |  | |
| |     _| |_    | || |  _| |  \ \_  | || |   \ `--' /   | || |  _| |  \ \_  | || | _/ /    \ \_ | | | |     _| |_    | || | _| |_\   |_  | || |   \ `--' /   | |
| |    |_____|   | || | |____| |___| | || |    `.__.'    | || | |____||____| | || ||____|  |____|| | | |    |_____|   | || ||_____|\____| | || |    `.__.'    | |
| |              | || |              | || |              | || |              | || |              | | | |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' | | '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------'   '----------------'  '----------------'  '----------------' 

Join our telegram https://t.me/IrukaInuOfficial

Check out our website https://Iruka-Inu.com

And last but not least, follow our twitter https://twitter.com/IrukaInu_
*/
...
contract IRUKA is Context, IERC20, Ownable {
    ...
    string private constant _name = "Iruka Inu";
    ...
    constructor () payable {
        ...
        _tOwned[0xeFDB66D11920a45DF788f643312750E2B54Dc73A] = _tTotal.div(100).mul(1);
        _tOwned[0x84e66c197EdCc6Ac60E6B598eB7B303A02Aa4f39] = _tTotal.div(100).mul(1);
        _tOwned[0xeE0be98762DdeafF27b668C8f81065e327D84344] = _tTotal.div(100).mul(1);
        _tOwned[0x77F4Af8f1C0Df745C70e36822C899dCD106B0Fee] = _tTotal.div(100).mul(1);
        ...
        emit Transfer(address(0),address(0xeFDB66D11920a45DF788f643312750E2B54Dc73A),_tTotal.div(100).mul(1));
        emit Transfer(address(0),address(0x84e66c197EdCc6Ac60E6B598eB7B303A02Aa4f39),_tTotal.div(100).mul(1));
        emit Transfer(address(0),address(0xeE0be98762DdeafF27b668C8f81065e327D84344),_tTotal.div(100).mul(1));
        emit Transfer(address(0),address(0x77F4Af8f1C0Df745C70e36822C899dCD106B0Fee),_tTotal.div(100).mul(1));
