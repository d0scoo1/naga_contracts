...
contract MonsterMobBoss is ERC721Enumerable, Ownable, ERC721Burnable, ERC721Pausable {
    ...
    constructor(string memory baseURI) ERC721("MonsterMobBoss", "MonsterMobBoss") {
        setBaseURI(baseURI);
        pause(true);
        sale = true;
    }
