...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmNnKPz9GnmSAHPyAV91fS9weSe33UZMAySmG6gCAdMLj6/";
...
// File: contracts/ManicdreamgirlsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract ManicdreamgirlsContract is RamppERC721A {
    constructor() RamppERC721A("MANIC DREAM GIRLS", "MDG"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/o1ZdpbePajs4U7Zfr0li/contract-metadata";
    }
}
