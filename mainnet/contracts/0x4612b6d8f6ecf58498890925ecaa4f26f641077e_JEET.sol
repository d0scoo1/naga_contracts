...
contract JEET is Context, IERC20, ERC20Ownable {
    ...
    uint256 private constant _tTotal = 7.77e20 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _maxWalletSize = 15540000000000000000 * 10**9;
    ...
    uint private _sellMarTax = 10;
    uint private _preSellMarTax = _sellMarTax;
    uint private _sellLiqTax = 6;
    ...
    constructor() {
        ...
        marketingAddress = payable(0xce874172757359e8860002bd023B741F131ca888);
    ...
    function _transfer(address from,address to,uint256 amount) private {
        ...
        if (_buyLimits == true && from == uniV2Pair) {
            require(amount <= 3885000000000000000 * 10**9, "Limits are in place, please lower buying amount");
        }
        if(_initLaunch == true) {
