...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0xa365B5fd2ACF1559d714A53557Fb96539065C100;
...
contract PROTOZOA is Context, IERC20, Ownable { 
    ...
    */
    ...
    address payable private Wallet_Dev = payable(0xa365B5fd2ACF1559d714A53557Fb96539065C100);
    ...
    */
    ...
    string private _name = "PROTOZOA"; 
    string private _symbol = "PROZ";  
    ...
    */
    ...
    function set_Max_Tx(uint256 maxTxPercent_x100) external onlyOwner() {
        _maxTxAmount = _tTotal*maxTxPercent_x100/10000;
    }    
    
    // Set the maximum wallet holding (percent of total supply)
     function set_Max_Wallet(uint256 maxWallPercent_x100) external onlyOwner() {
