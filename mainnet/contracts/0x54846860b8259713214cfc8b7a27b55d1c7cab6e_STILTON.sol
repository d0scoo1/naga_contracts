...
contract STILTON is Context, IERC20, Ownable {
    ...
    string private constant _name = "STILTON 2.0";
    string private constant _symbol = "STILTON 2.0";
    ...
    address payable private _developmentAddress = payable(0x3e7fF2be033670e0AB99F2A4fcf5095a9eAd75ed); 
    address payable private _marketingAddress = payable(0x3e7fF2be033670e0AB99F2A4fcf5095a9eAd75ed);
