...
contract gougou is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public maxPerTx = 10;
    uint256 public maxSupply = 3002;
    uint256 public freeMintMax = 2042; // Free supply
    uint256 public price = 0.003 ether;
    uint256 public maxFreePerWallet = 3; 

    string private baseURI = "https://gateway.pinata.cloud/ipfs/QmQGHtHuV5ekrmWJqEYwZ9BDYCRiuwnSfv8w4VT94tDivM/";
...
// Feel free to sweep the floor, since you're here already xD 
    ...
    constructor() ERC721A("gougou", "GOUGOU") {}
