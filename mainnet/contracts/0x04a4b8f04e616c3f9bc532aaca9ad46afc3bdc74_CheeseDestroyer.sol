...
/*
    $BITE - Cheese Destroyer

    Cheese Destroyer bites through all cheese hype and lives. 

    TG Will be shared after launch VIA callers.
...
contract CheeseDestroyer is Context, IERC20, Ownable {
    ...
    string private _name = "Cheese Destroyer";
