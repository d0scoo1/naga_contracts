...
Cryptocurrency is on a slump, but as a DEFI community. The show must go on. Low tax token for all. Cheers.
...
contract SLUMP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("SLUMP", "$SLUMP") {
        ...
        maxTransactionAmount = totalSupply * 13 / 1000; // 1.3% maxTransactionAmountTxn
        maxWallet = totalSupply * 26 / 1000; // 2.6% maxWallet
