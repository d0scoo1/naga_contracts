...
contract MCPE is ERC721A, Ownable, ReentrancyGuard {
  ...
  * Note: `cost` is in wei. 
  */
  constructor(string memory tokenName, string memory symbol) ERC721A(tokenName, symbol) Ownable() {
    _mintCost = 0.1 ether;
    _maxSupply = 10000;
  ...
  */
  ...
  function getState() public view returns (bool, uint256, uint256, uint256){
    return (_isPublicMintEnabled, _mintCost, _maxSupply, totalSupply());
  }
