...
contract SPLINK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Space Link";
    string private constant _symbol = "SPLINK";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = 10000000000000*1e9; // 1% maxTransactionAmountTxn
        minimumTokensBeforeSwap = 500000000000*1e9; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x39599cEB9C08Eba2566aa2870a4F11E3863EFe80); // Marketing Address
        
        devAddress = payable(0x39599cEB9C08Eba2566aa2870a4F11E3863EFe80); // Dev Address
        
        liquidityAddress = payable(0x39599cEB9C08Eba2566aa2870a4F11E3863EFe80); // Liquidity Address (switches to dead address once launch happens)
