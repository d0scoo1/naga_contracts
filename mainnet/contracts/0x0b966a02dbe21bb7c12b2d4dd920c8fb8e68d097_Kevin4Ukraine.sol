...
contract Kevin4Ukraine is Ownable, ERC721A, ReentrancyGuard {

  uint256 public collection_Size = 2500;
  uint256 public collection_Size_Free = 0;
  ...
  constructor(
  ) ERC721A("Kevin4Ukraine", "Kevin4Ukraine", max_Batch_Size, collection_Size, collection_Size_Free) {
  }
