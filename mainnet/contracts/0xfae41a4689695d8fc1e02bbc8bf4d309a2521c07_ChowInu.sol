...
Twitter: https://twitter.com/chowinuu
...
contract ChowInu is Context, IERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 swapHalf = contractTokenBalance.mul(_previousMarketingFee).div(_previousLiquidityFee);
        ...
        uint256 marketingBalance = newBalance.mul(_previousMarketingFee).div(_previousLiquidityFee);
    ...
    function manualSwapAndLiquify() external onlyOwner() lockTheSwap {
        ...
        uint256 swapHalf = contractBalance.mul(_previousMarketingFee).div(_previousLiquidityFee);
