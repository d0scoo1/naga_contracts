...
contract CatTrap is Context,IERC20, Ownable{
    ...
    uint256 totalFeeFortx = 0;
      uint256 maxWalletTreshold = 20;
    uint256 maxTxTreshold = 20;
    ...
    address _owner;
    address payable public marketingAddress = payable(0x312AFA572bc16E63029f969b644E0EC3d1C6F6BA);
    address payable public prizePoolAddress = payable(0x312AFA572bc16E63029f969b644E0EC3d1C6F6BA);
    ...
    uint256 private sellprizePool = 0;
    uint256 private sellprevPrizePool = 0;
