...
contract SilverbackLegends is ERC721A, Ownable {
    using Strings for uint256;
    
    uint256 public MAX_SUPPLY = 7474;
    ...
    uint256 private MAX_MINT_LIMIT_PER_WHITELIST = 3;
    ...
    constructor() ERC721A("SILVERBACK LEGENDS", "SBL") {}
    ...
    function mintWhitelist(uint256 _mintAmount, uint256 _index, uint256 _amount, bytes32[] calldata _proof) public payable {
        require(ENABLE_WHITELIST_SALE, "Presale is not activated");
