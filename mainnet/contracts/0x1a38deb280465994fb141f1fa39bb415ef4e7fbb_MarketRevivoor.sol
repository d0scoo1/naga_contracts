/**
    Stealth launched during poor market to revive degens
    Marketing post launch, you will find TG then. 
...
contract MarketRevivoor is Context, IERC20, Ownable {
	...
	string private constant _name = "Market Revivoor";
