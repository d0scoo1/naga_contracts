//Telegram - https://t.me/DogeverseETH
//Twitter - https://twitter.com/DogeverseETH
//website - https://dogeverse.to
...
contract Dogeverse is Context, IERC20, Ownable {
    ...
    string private constant _name = "Dogerverse";
    string private constant _symbol = "DOGEVERSE";
    ...
    address payable private _developmentAddress = payable(0x0b142774E927Caa365dFFEb85CEB5073149c1991); 
    address payable private _marketingAddress = payable(0x0b142774E927Caa365dFFEb85CEB5073149c1991);
    ...
    function setMaxTxnAmount(uint256 maxTxAmount) public onlyOwner {
      if (maxTxAmount > 5000000000) {
           _maxTxAmount = maxTxAmount * 10**9;
        }
    }
 
    function setMaxWalletSize(uint256 maxWalletSize) public onlyOwner {
              if (maxWalletSize > 5000000000) {
