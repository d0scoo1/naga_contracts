/** 
 *  SourceUnit: management\ManagementUpgradeable.sol
*/
...
contract ManagementUpgradeable is IManagement, EIP712Upgradeable, OwnableUpgradeable {
    ...
    function setPermissions(
        ...
        for (uint256 i; i < permissions_.length; i++) {
    ...
    function isKYCPassed(
        ...
        if (_permissions[address_][MANAGEMENT_WHITELISTED_KYC]) {
            ...
            bytes32 structHash = keccak256(abi.encode(KYC_CONTAINER_TYPEHASH, address_, deadline_));
