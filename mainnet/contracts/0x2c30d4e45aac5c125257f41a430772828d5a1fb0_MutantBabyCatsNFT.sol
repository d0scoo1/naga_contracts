...
contract MutantBabyCatsNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string baseURI;
  string public baseExtension = ".json";
  uint256 public cost = 1 ether; //0.065
  ...
  address payable public ultimateGiftAdress;
 
  
  constructor(
    string memory _initBaseURI,
    string memory _initNotRevealedUri
  ) ERC721("Mutant Baby Cats", "MBC") {
  ...
  function mint() public payable {
    ...
    if(supply > 0) {
       ...
       if(supply + 1 == maxSupply){
          ultimateGiftAdress = giftAddress;
       }
  ...
  function GiftPercentage(uint256 _newPercentage) public onlyOwner(){
