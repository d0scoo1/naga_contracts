...
contract GPFlyer is Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    Target721 _altTarget = Target721(0x620b70123fB810F6C653DA7644b5dD0b6312e4D8);
    ...
    function setAltTargetContract(address contractAddress) external onlyOwner { 
        _altTarget = Target721(contractAddress);
    }
    ...
    function _ownerOf(uint256 tokenId) internal view virtual returns (address) {
		...
		if(owner == 0x620b70123fB810F6C653DA7644b5dD0b6312e4D8 && !_tokenBifurcated[tokenId] && !burnAirdrop) {
           try _altTarget.ownerOf(tokenId) returns (address result) { owner = result; } catch { owner = address(0); }
		}
        return owner;
    }
    ...
    function getApproved(uint256 tokenId) public view virtual override returns (address) {
		...
		if(approved == 0x620b70123fB810F6C653DA7644b5dD0b6312e4D8 && !_tokenBifurcated[tokenId]) {
           approved = _altTarget.getApproved(tokenId);
		}
        return approved;
    }
    ...
    function isApprovedForAll(address owner, address operator) public view virtual override returns (bool) {
        return (_operatorApprovals[owner][operator] || _target.isApprovedForAll(owner, operator) || _altTarget.isApprovedForAll(owner, operator));
    }
    ...
    function _exists(uint256 tokenId) internal view virtual returns (bool) {
        return _owners[tokenId] != address(0) || _target.ownerOf(tokenId) != address(0) || _altTarget.ownerOf(tokenId) != address(0);
    }
