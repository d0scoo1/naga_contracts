...
/*
 _  _   __   ____  _  _  __    _  _   __    ___  _  _  __
( \/ ) /  \ / ___)/ )( \(  )  ( \/ ) /  \  / __)/ )( \(  )
/ \/ \(  O )\___ \) __ ( )(   / \/ \(  O )( (__ ) __ ( )(
\_)(_/ \__/ (____/\_)(_/(__)  \_)(_/ \__/  \___)\_)(_/(__)
======================== AIRDROPS ========================
...
contract MochiAirdrop is ERC1155, ERC1155Supply, Ownable {
    constructor(string memory _uri) ERC1155(_uri) {
        _setURI(_uri);
    }

    /// @dev set the URI to your base URI, don't forget the {id} placeholder
