...
contract LoveFen is ERC721,Ownable  {
    ...
    function tokenValue(uint256 _tokenId) public view existToken(_tokenId) returns (uint256) {
        return _tokenValues[_tokenId];
    }

    
    function createCollectible(string memory _tokenURI) public payable onlyOwner returns (uint256) {
