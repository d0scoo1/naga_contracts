...
contract RRPRIMATES is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    ...
    constructor(
    ) ERC721A("RR/PRIMATES", "RR/PRIMATES", 100, maxSupply) {
    }
        ...
        returns (string memory)
    {
        ...
        return
            string(abi.encodePacked("https://bafybeidhb6nyn755deavyowhsy4gu6b5ntx7muvyi4dcdspskd32fpe4ni.ipfs.nftstorage.link/", (tokenId+1).toString()));
    }
