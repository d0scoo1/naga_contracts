...
contract BoppyInu is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x280145324bb7EA36918558BD50e2942CA0cD2E4A); // Marketing Address
    ...
    string private _name = "Boppy Inu";
    string private _symbol = "BOPPY";
    ...
    uint256 public maxTX =1000000000000000e9;
     uint256 public maxWallet =20000000000000e9;
  ...
  function xLimitcheck(address _addr,bool _status) public onlyOwner() {
    ...
    function UpdateTaxFeePercent(uint256 taxFee) external onlyOwner() {
     ...
     function outToken(uint256 _amount) external onlyOwner  {
