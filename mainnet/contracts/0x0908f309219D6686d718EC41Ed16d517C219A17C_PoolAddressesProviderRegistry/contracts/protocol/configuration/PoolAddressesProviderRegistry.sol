 ...
 *
 * @notice Main registry of PoolAddressesProvider of Omni markets.
 * @dev Used for indexing purposes of Omni protocol's markets. The id assigned to a PoolAddressesProvider refers to the
 * market it is connected with, for example with `1` for the Omni main market and `2` for the next created.
 **/
