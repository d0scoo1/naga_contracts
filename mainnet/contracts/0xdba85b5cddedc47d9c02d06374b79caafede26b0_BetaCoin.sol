...
//You've got the Alpha, its time to move on to the Beta.

//Access the Beta Telegram by decrypting the code set out below:

//049 053 052 032 049 052 049 032 049 054 052 032 049 054 050 032 049 053 055 032 049 050 048 032 049 053 054 032 049 053 049 032 049 053 055 032 049 048 051 032 049 052 049 032 049 054 052 032 049 052 053 032 049 048 050

//Beta is for the likeminded people, your heard it first, it will be a DAO like never before and we are recruiting.

//If you are too lazy to solve, watch the graph as we moon. 
//Early holders gets to Beta Protocol Early Access for staking and bonding opportunities.

Hints will be given out every hour via the twitter, twitter will be up 30mins after launch to reward smart minds.
...
contract BetaCoin is Context, IERC20, Ownable {
    ...
    string private _name = "Beta Coin";
