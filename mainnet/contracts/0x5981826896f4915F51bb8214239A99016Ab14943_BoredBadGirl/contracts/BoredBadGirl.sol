...
contract BoredBadGirl is ERC721A, Ownable, ReentrancyGuard {
  using Address for address;
  using Strings for uint;

  string  public  baseTokenURI = "ipfs://QmNaWsA19Ppv2VqUNAiKfuWofXVas3rcVKP63cff4nBjgf";
  ...
  ) ERC721A("Bored Bad Girls", "BoredBadGirls") {
