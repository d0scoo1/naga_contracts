...
contract MetaKnights is ERC721Enumerable, Ownable {
   ...
   function setMAX_NFTS_WALLET_PRESALE(uint256 _amount) external onlyOwner {
    ...
    function withdrawAll() public onlyOwner {
        ...
        uint256 Mike = (balance * 35) /100 ;
        uint256 Mathew = (balance * 35) /100 ;
        uint256 Aug = (balance * 7) /100 ;
        uint256 Sean = (balance * 5) /100 ;
        uint256 Ahmed = (balance * 18) /100 ;

        payable(0xb020365CAb82927383db859A10129b6773254602).transfer(Mike);     // Mike
        payable(0x8FA2f269B0Ef3b8b9435AB5aAAcE4f92dA9E8e15).transfer(Mathew);   // Mathew
        payable(0x981bB577A8CFF6A18eB70E06ADc958C60c651FF4).transfer(Aug);      // Aug
        payable(0x87413B2dEb63bB81cB712b75dB02dB594b8d19af).transfer(Sean);     // Sean
        payable(0x7fd290D331a4245E70bb98924143703dB9FB0A06).transfer(Ahmed);    // Ahmed
