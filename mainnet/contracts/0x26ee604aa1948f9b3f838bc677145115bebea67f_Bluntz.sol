...
contract Bluntz is ERC721A, Ownable, ReentrancyGuard {
  ...
  function mintFree(bytes32[] calldata _merkleProof) public mintCompliance(1) {
  ...
  function contractURI() public view returns (string memory) {
    return 'ipfs://QmaQTA9rzfb8R8hWoPxVrAaLa7ktBCnUBokiytoPZtvto3';
  }
