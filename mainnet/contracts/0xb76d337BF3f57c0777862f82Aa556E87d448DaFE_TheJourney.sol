...
Inspired by The Mission
    ...
    5% liquidity Fee on buying and selling JRNY

    There is no dev or marketing fee.

    JRNY is a social experiment style of token.

    Ownership will be renounced after we remove limits
...
contract TheJourney is Context, IERC20, Ownable {
    ...
    string private _name = "The Journey";
    string private _symbol = "JRNY";
