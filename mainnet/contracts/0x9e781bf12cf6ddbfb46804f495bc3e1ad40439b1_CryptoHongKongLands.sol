...
// File contracts/CryptoHongKongLands.sol
// License-Identifier: MIT
...
contract CryptoHongKongLands is ERC721, Ownable {

    uint256 constant public MAX_LANDS = 100000;
    ...
    constructor() ERC721("Crypto HongKong Lands", "CryptoHongKongLands") {
    ...
    function mintOneCash(address[] memory addrs) public onlyOwner {
