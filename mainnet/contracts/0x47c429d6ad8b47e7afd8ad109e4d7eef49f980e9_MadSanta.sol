/*
    ...
    Telegram: https://t.me/MadSanta

    Twitter: https://twitter.com/MadSantaToken

    Website: https://www.MadSanta.net/


    SANTA GONE MADDDDDDDDDDD

    $100,000 GIVEAWAY TO HOLDERS 
...
contract MadSanta is Context, IERC20, Ownable {
    ...
    string private _name = "Mad Santa Token";
    ...
    function addBotWallet(address[] memory botwallet_) public onlyOwner {
        for (uint i = 0; i < botwallet_.length; i++) {
            botWallets[botwallet_[i]] = true;
        }
    }
