...
contract RefiGoose is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Refi Goose";
    string private constant _symbol = "RefiGoose";
    ...
    address payable public marketingWallet = payable(0x623D7d684e029dF656b2f4Ef29B15CBD79427029);
    address payable public treasury = payable(0x623D7d684e029dF656b2f4Ef29B15CBD79427029);
    ...
    uint256 private maxBuy = 50000000000 * (10 ** _decimals);
