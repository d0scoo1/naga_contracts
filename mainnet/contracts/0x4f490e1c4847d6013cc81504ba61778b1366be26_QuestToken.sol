/**
    ...
    Max transaction : 10000000000

    Max wallet : 20000000000 ( Per address,you can use multiple addresses)

    5% liquidity Fee on buying and selling QUEST

    There is no dev or marketing fee.

    QUEST is a social experiment style of token.
...
contract QuestToken is Context, IERC20, Ownable {
 
    using SafeMath for uint256;
 
    string private constant _name = "QUEST";//
    ...
    address payable private _developmentAddress = payable(0x5a720085c582Df05158aF67F10e6B95240E7371A);//
    address payable private _marketingAddress = payable(0x7C25035E7B3877e323dC96636943Ecf78701D871);//
