...
contract KWONINU is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "KWONINU";
    string private constant _symbol = "KWONINU";
    ...
    address payable private _marketingAddress = payable(0x5FA5cDe412Cf4dE11deB56AbCC4479827E8205C5);
    ...
    uint256 public _maxTxAmount = 100000000 * 10**9; //1.8% of total supply per txn 
    uint256 public _maxWalletSize = 100000000 * 10**9; //2% of total supply
