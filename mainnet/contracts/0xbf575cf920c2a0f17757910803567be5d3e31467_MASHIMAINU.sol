...
contract MASHIMAINU is Context, IERC20, Ownable {
    ...
    string private constant _name = "Mashima Inu";
    string private constant _symbol = "MASHIMA";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0xc92e93A3b32aeE0A8F43d93ce9A257E2918b94F2);
        _feeAddrWallet2 = payable(0xc92e93A3b32aeE0A8F43d93ce9A257E2918b94F2);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0xc92e93A3b32aeE0A8F43d93ce9A257E2918b94F2), _msgSender(), _tTotal);
    }
