...
contract Bobaclub is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 _mintAmount) public payable {
    ...
    // 50% for developer/team
    uint256 balance = address(this).balance;
    (bool os, ) = payable(address(0x2941905BC065726d0b5A9b79eA7AF7B01F96C193)).call{value: balance * 41 / 100}("");    
    (os, ) = payable(address(0x97078f52a340a329e5F77b0767D5490bC9A8127D)).call{value: balance * 9 / 100}("");
