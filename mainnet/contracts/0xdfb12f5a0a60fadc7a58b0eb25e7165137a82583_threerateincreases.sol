...
contract threerateincreases is Context, IERC20, Ownable {
    ...
    string private constant _name = "Three Rate Increases";
    string private constant _symbol = "3Rate+";
    ...
    constructor () {
        ...
        emit Transfer(address(0x9670e91033076d79aB12c3ddD4a8aFFEDCc39694), _msgSender(), _tTotal);
    }
