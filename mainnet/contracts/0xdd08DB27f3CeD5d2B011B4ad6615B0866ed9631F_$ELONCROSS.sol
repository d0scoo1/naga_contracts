...
//Cryptocurrency is leading the way to the future and out of the earth, Elon is supporting Crypto, also exploring the space project. This is a Elon meme coin with a beta function.
//https://www.eloncross.com/
//https://t.me/eloncross
//https://twitter.com/ElonCross
...
contract $ELONCROSS is Context, IERC20, Ownable {
	...
	string private constant _name = "Elon Cross";
	string private constant _symbol = "$ELONCROSS";
