...
:   :|-.._  '     `  _..-|:   :
 :   `:| |`:-:-.-:-:'| |:'   :
  `.   `.| | | | | | |.'   .'
    ...
    If you think dog.catcher is good, you shouldn't miss this one.

    cat.catcher = dog.catcher²

    0/0 for the culture.

    Liq will be locked for 30 days. If you are unsafe to ape, just wait for the lock.
...
contract Catcatcher is ERC20 {

    /**
     * @dev Sets the values for {name}, {symbol} and {totalsupply}.
     */
    constructor() ERC20('cat.catcher', 'CC')  {
		deployer = msg.sender;
        _totalSupply = 84365427*10**9;
