...
contract LPCompVesting is Ownable {
    ...
    uint256 public rxtkTotalSupply;
    ...
    constructor(
        IERC20 _xtk,
        bytes32 _root,
        uint256 _rxtkTotalSupply,
        uint256 _totalXtkRedeemable
    ) {
        xtk = _xtk;
        root = _root;

        rxtkTotalSupply = _rxtkTotalSupply;
        rxtkSupplyRemaining = _rxtkTotalSupply;
    ...
    // is this easiest way to make currently available XTK readable off-chain?
