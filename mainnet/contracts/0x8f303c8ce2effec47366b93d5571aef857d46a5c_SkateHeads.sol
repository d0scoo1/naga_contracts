...
contract SkateHeads is Ownable, ERC721 {
  
  using SafeMath for uint256;
  using Counters for Counters.Counter;
  Counters.Counter private _tokenIdCounter;
  
  uint256 public mintPrice = 1.7 ether;
  uint256 public maxSupply = 10000;
  uint256 public freeMintAmount = 10;
  uint256 private mintLimit = 10;
  string private baseURI = "ipfs://Qmf1ZzBFZeadPUtcaqduTk1MweBEB4odByBaixhw3uCruF/";
  bool public publicSaleState = false;
  bool public revealed = true;
  string private base_URI_tail = ".json";
  string private hiddenURI = "ipfs://CHANGE/";

  constructor() ERC721("SkateHeads", "SHEAD") { 
  }
