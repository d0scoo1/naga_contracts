...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0xd5a942a84928F1a060189234595A8F24Fc08F354,0x31652Cbec0740840B49E9f5198ca9955807ffD0E,0xb1603FBF078142539fF7CCFc544bFe77eE399785];
  uint256[] public payableFees = [5,35,30,30];
...
abstract contract RamppERC721A is 
    ...
    string public _baseTokenURI = "ipfs://QmPeiZntDHshpwyFNu8XAf1duU7Yu6rz99Fb5SfKGWnpGJ/";
...
contract MyNftRamppProjectContract is RamppERC721A {
    constructor() RamppERC721A("My NFT Rampp Project", "SANIK"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gvLkRO1PaWAcyTQpHPxy/contract-metadata";
    }
}
