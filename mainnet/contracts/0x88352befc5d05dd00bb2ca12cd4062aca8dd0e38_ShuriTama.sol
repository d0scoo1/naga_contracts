/* 
 ...
 /   _____/|  |__  __ _________|__\__    ___/____    _____ _____   
 \_____  \ |  |  \|  |  \_  __ \  | |    |  \__  \  /     \\__  \  
 /        \|   Y  \  |  /|  | \/  | |    |   / __ \|  Y Y  \/ __ \_
/_______  /|___|  /____/ |__|  |__| |____|  (____  /__|_|  (____  /
        \/      \/                               \/      \/     \/ 

SHURITAMA (ShuriTama) 

The Stealthiest of all Ninja!

https://shuritama.com

https://t.me/ShuriTamaJoin
...
contract DividendDistributor is IDividendDistributor {
   ...
   // receive() external payable { }
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a SHURITAMA shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract ShuriTama is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "ShuriTama";
    string private constant _symbol = "SHURITAMA";
    ...
    address payable public marketingWallet = payable(0x634785CCee01DbE1be6CF475A190418e70e5d823);
    address payable public charities = payable(0x0bc59F629831DCE609DaFEB56dCa14fE8a47fE92);
    ...
    uint256 private maxBuy = 500000 * (10 ** _decimals);
