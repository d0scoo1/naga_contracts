// Contemporary Metti One is the start of a new series of unique artworks from Pumpametti. 
// The artworks will be very limited in numbers, and each series will be different from the previous ones.
// The Contemporary Metti series artworks will be raffled to Metti Art Patrons via Twitter.
// 3 Contemporary Metti One artwork raffled to Pumpametti collectors.
// 1 Contemporary Metti One artwork raffled to Pettametti collectors.
// 1 Contemporary Metti One artwork raffled to Standametti collectors.
// 1 Contemporary Metti One artwork raffled to Metti Landscape collectors.
// 1 Contemporary Metti One artwork raffled to Metti Team Six collectors.
// 1 Contemporary Metti One artwork raffled to Metti Inu holders. 
// The Contemporary Metti One raffle will be held on Pumpametti Twitter and picked via https://twitterpicker.com/. The artworks will only be sent to raffle winners who are Metti Art Patrons. 
// You can only win one Contemporary Metti artwork from each series. 
// As an artist, I seek to be independent of the constraint of all platforms, releasing my art with custom smart contracts without being reliant on any platforms.  If you are an artist and wish to use this smart contract for your artworks, you can find Tutorial at MettiForArtists: https://www.pumpametti.com/mettiforartists
...
contract ContemporaryMettiOne is ERC721, ERC721URIStorage, ERC721Burnable, ERC721Enumerable, Ownable, Royalties {  
    ...
    constructor() ERC721("ContemporaryMettiOne", "ContemporaryMettiOne") {}
