...
contract ToonTown is ERC721, Ownable {
    ...
    uint256 public MAX_FREE_MINT = 4242;
    uint256 public MAX_MINT_PER_TXN = 10;
    bool public IS_SALES_ACTIVE = false;

    constructor() ERC721("Toon Town", "TOONS") {
        _contractUri = "ipfs://QmPCrcsESwP3FRCMTZYNHypKbNZMjzQcmArKBo4Y1Lc4P9";
    }
    ...
    function mint(uint256 quantity) external payable {
        ...
        require(totalSupply() + quantity <= MAX_SUPPLY, "ALL TOONS HAVE BEEN SOLD");
