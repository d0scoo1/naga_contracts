...
// File: contracts/Cloud Dudes NFT Limited (CDNL)1.sol
...
contract CloudDudes is ERC721A, Ownable, Pausable, ReentrancyGuard {
    ...
    uint256 public MaxCloudsPerAddress = 3;
    uint256 public CloudPrice = 0.15 ether;
    bool public IsSaleActive = true;
    mapping(address => uint256) public HowManyCloudsOnAddress;
 
    constructor () ERC721A("Cloud Dudes NFT Limited", "CDNL") {
    ...
    function CloudPublicMint(uint256 _CloudsAmount) public payable nonReentrant {
        uint256 AllCloudsSupply = totalSupply();
        require(_CloudsAmount > 0, "You can't mint 0 Clouds! LOL 0-0!");
        require(_CloudsAmount <= MaxCloudsPerAddress, "You can't mint more Clouds than All Clouds Supply! LOL 0-0!" );
        require(AllCloudsSupply + _CloudsAmount <= maxSupplyClouds, "You can't exceed Clouds supply! LOL 0-0!");
        require(msg.value >= CloudPrice * _CloudsAmount);
