...
contract Revenant is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  constructor() ERC721A("AWE:Revenant","REVENANT", MaxMintPerBatch_, TotalCollectionSize_) {
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmcxGFrBRLs3dBxVnQ4G42kqYSkwc3qRwAuZYUTE1yUbhc/";
