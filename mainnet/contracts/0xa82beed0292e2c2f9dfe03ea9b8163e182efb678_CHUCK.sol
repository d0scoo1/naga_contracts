...
contract CHUCK is Context, IERC20, Ownable {
    ...
    string private constant _name = "Chuck E Cheese";//
    ...
    address payable private _developmentAddress = payable(0xF72271db7014C40b41aC0CeBc0a76e718Ed24Ce7);//
    address payable private _marketingAddress = payable(0xAe9676238B7Da8564fB8abCbD7C7594A32eE9706);//
