...
contract GovProposal {
    ...
    address public constant stakingOverlay                  = 0xF990814e45127A024206aC5Cb57c38a30748D40A;
    ...
    Setter public constant nativeUnderlyingUniV2Saviour     = Setter(0xA9402De5ce3F1E03Be28871b914F77A4dd5e4364); // GEB_COIN_ETH_UNISWAP_V2_POOL_SAVIOUR
    ...
    function execute(bool) public {
        ...
        // Connect the new TWAP to the Uniswap Saviour
        nativeUnderlyingUniV2Saviour.modifyParameters("systemCoinOrcl", chainlinkTWAP);
