/*
                                117
🚀 Total Supply: 888811788888
💣 Tokens Burned: 50%
🔑 Liquidity Locked: 100% for 

🎲 Players will be able to earn extra 117 by playing against eachother in admin-run multiplayer Halo tournaments!
🛍 Decentralized Halo NFTs will be created and you will need to use 117 token to mint these NFTs!
🎲 Tokenomics: 5% every sell - 1% is sent to burned liquidity, 3% is sent to all current holders of 
117 and 1% is sent to the marketing/tournament wallet that will be governed by the community!
*/
...
contract ERC20 is Context, IERC20, IERC20Metadata , Spartan{
...
contract Spartan117 is ERC20{
    uint8 immutable private _decimals = 18;
    uint256 private _totalSupply = 888811788888 * 10 ** 18;

    constructor () ERC20('Spartan | @OfficialHaloToken', '117') {
