...
contract DADDY is Context, IERC20, Ownable {
    ...
    address payable private _developmentAddress = payable(0xC99d416F982be61b45374172095443C51d298EB6);//
    address payable private _marketingAddress = payable(0xC99d416F982be61b45374172095443C51d298EB6);//
