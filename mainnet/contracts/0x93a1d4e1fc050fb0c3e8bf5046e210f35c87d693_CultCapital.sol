/**
 Tg- https://t.me/CultCapitalToken
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    function getDividendsClaimedOf (address shareholder) external view returns (uint256) {
        require (shares[shareholder].amount > 0, "You're not a CULTCAPITAL shareholder!");
        return shares[shareholder].totalClaimed;
    }

    }

contract CultCapital is IERC20, Auth {
    using SafeMath for uint256;
    ...
    string private constant  _name = "Cult Capital";
    string private constant _symbol = "CULT CAPITAL";
    ...
    address payable public marketingWallet = payable(0x62C18F7FdFE0F341022CE52899De661B048fFA7a);
